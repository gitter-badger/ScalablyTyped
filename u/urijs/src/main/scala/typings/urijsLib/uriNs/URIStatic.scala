...
trait URIStatic
  ...
  def build(parts: urijsLib.Anon_Protocol): java.lang.String = js.native
  def buildAuthority(parts: urijsLib.Anon_Username): java.lang.String = js.native
  ...
  def buildUserinfo(parts: urijsLib.Anon_UsernamePassword): java.lang.String = js.native
  ...
  def parse(url: java.lang.String): urijsLib.Anon_Protocol = js.native
  def parseAuthority(url: java.lang.String, parts: urijsLib.Anon_Username): java.lang.String = js.native
  ...
  def parseUserinfo(url: java.lang.String, parts: urijsLib.Anon_UsernamePassword): java.lang.String = js.native

...
@js.native
object angularjsModMembers extends js.Object {
  @JSName("$injector")
  ...
  @JSName("equals")
  val equals_FangularjsModMembers: js.Any = js.native
  ...
  def getLocals(ctx: atUirouterCoreLib.coreMod.ResolveContext): atUirouterCoreLib.libCommonCommonMod.TypedMap[_] = js.native
  ...
  def ng1ViewsBuilder(state: atUirouterCoreLib.coreMod.StateObject): js.Object = js.native

...
object coreNs extends js.Object {
  ...
  class BrowserLocationConfig ()
    extends atUirouterCoreLib.coreMod.BrowserLocationConfig {
  ...
  class ParamFactory protected ()
    extends atUirouterCoreLib.coreMod.ParamFactory {
    def this(router: atUirouterCoreLib.libRouterMod.UIRouter) = this()
  }
  
  @js.native
  class ParamType protected ()
    extends atUirouterCoreLib.coreMod.ParamType {
    /**
  ...
  /** @internalapi */
  class ParamTypes ()
    extends atUirouterCoreLib.coreMod.ParamTypes
  
  @js.native
  class PathNode protected ()
    extends atUirouterCoreLib.coreMod.PathNode {
  ...
  @js.native
  class PathUtils ()
    extends atUirouterCoreLib.coreMod.PathUtils
  
  @js.native
  class PushStateLocationService protected ()
    extends atUirouterCoreLib.coreMod.PushStateLocationService {
    def this(router: atUirouterCoreLib.libRouterMod.UIRouter) = this()
  }
  
  @js.native
  class Queue[T] ()
    extends atUirouterCoreLib.coreMod.Queue[T] {
  ...
  class RegisteredHook protected ()
    extends atUirouterCoreLib.coreMod.RegisteredHook {
  ...
  @js.native
  class StateParams ()
    extends atUirouterCoreLib.coreMod.StateParams {
  ...
  class StateRegistry protected ()
    extends atUirouterCoreLib.coreMod.StateRegistry {
    /** @internalapi */
    def this(router: atUirouterCoreLib.libRouterMod.UIRouter) = this()
  }
  ...
  class StateService protected ()
    extends atUirouterCoreLib.coreMod.StateService {
    /** @internalapi */
  ...
  class TargetState protected ()
    extends atUirouterCoreLib.coreMod.TargetState {
    /**
  ...
  /** @hidden */
  class Trace ()
    extends atUirouterCoreLib.coreMod.Trace
  ...
  class TransitionService protected ()
    extends atUirouterCoreLib.coreMod.TransitionService {
    /** @hidden */
  ...
  /**
    ...
    */
  class UIRouter ()
    extends atUirouterCoreLib.coreMod.UIRouter {
  ...
  class UIRouterGlobals ()
    extends atUirouterCoreLib.coreMod.UIRouterGlobals
  
  @js.native
  abstract class UIRouterPluginBase ()
    extends atUirouterCoreLib.coreMod.UIRouterPluginBase
  
  @js.native
  class UrlConfig protected ()
    extends atUirouterCoreLib.coreMod.UrlConfig {
    /** @hidden */ def this(/** @hidden */ router: atUirouterCoreLib.libRouterMod.UIRouter) = this()
  }
  
  @js.native
  class UrlMatcher protected ()
    extends atUirouterCoreLib.coreMod.UrlMatcher {
    /**
  ...
  class UrlMatcherFactory protected ()
    extends atUirouterCoreLib.coreMod.UrlMatcherFactory {
    def this(/** @hidden */ router: atUirouterCoreLib.libRouterMod.UIRouter) = this()
  }
  
  @js.native
  class UrlRouter protected ()
    extends atUirouterCoreLib.coreMod.UrlRouter {
    /** @hidden */
    def this(/** @hidden */ router: atUirouterCoreLib.libRouterMod.UIRouter) = this()
  }
  ...
  class UrlRuleFactory protected ()
    extends atUirouterCoreLib.coreMod.UrlRuleFactory {
    def this(router: atUirouterCoreLib.libRouterMod.UIRouter) = this()
  }
  
  @js.native
  class UrlRules protected ()
    extends atUirouterCoreLib.coreMod.UrlRules {
    /** @hidden */
    def this(/** @hidden */ router: atUirouterCoreLib.libRouterMod.UIRouter) = this()
  }
  ...
  class UrlService protected ()
    extends atUirouterCoreLib.coreMod.UrlService {
    /** @hidden */
    def this(/** @hidden */ router: atUirouterCoreLib.libRouterMod.UIRouter) = this()
  }
  ...
  class ViewService protected ()
    extends atUirouterCoreLib.coreMod.ViewService {
    /** @hidden */
    def this(/** @hidden */ router: atUirouterCoreLib.libRouterMod.UIRouter) = this()
  }

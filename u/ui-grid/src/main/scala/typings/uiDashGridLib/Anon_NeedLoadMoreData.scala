...
trait Anon_NeedLoadMoreData extends js.Object {
  /**
    ...
    */
  var needLoadMoreData: angularLib.angularMod.Global.Function with js.Function
  /**
    * This event fires when scroll reaches top percentage of grid and needs to load data
    */
  var needLoadMoreDataTop: angularLib.angularMod.Global.Function with js.Function
}

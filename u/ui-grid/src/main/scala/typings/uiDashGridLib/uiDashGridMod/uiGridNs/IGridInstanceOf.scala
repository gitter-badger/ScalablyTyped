...
trait IGridInstanceOf[TEntity] extends js.Object {
  ...
  /**
    ...
    */
  def registerDataChangeCallback(callback: js.Function1[/* grid */ IGridInstanceOf[TEntity], scala.Unit]): angularLib.angularMod.Global.Function with js.Function = js.native

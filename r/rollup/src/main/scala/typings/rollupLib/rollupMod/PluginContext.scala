...
trait PluginContext extends js.Object {
  ...
  var moduleIds: nodeLib.IterableIterator[java.lang.String] with stdLib.IterableIterator[java.lang.String] = js.native
  @JSName("resolveId")
  ...
  def error(err: java.lang.String, pos: rollupLib.Anon_Line): scala.Unit = js.native
  def error(err: RollupError): scala.Unit = js.native
  def error(err: RollupError, pos: rollupLib.Anon_Line): scala.Unit = js.native
  ...
  def warn(warning: java.lang.String, pos: rollupLib.Anon_Line): scala.Unit = js.native
  def warn(warning: RollupWarning): scala.Unit = js.native
  def warn(warning: RollupWarning, pos: rollupLib.Anon_Line): scala.Unit = js.native
}

...
package object reactDashLiveMod {
  ...
  type LiveProviderProps = (reactDashLiveLib.Omit[reactDashLiveLib.DivProps, reactDashLiveLib.reactDashLiveLibStrings.scope]) with reactDashLiveLib.Anon_Scope
}

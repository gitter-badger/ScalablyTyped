...
@js.native
trait Anon_Undef extends js.Object {
  @JSName("array")
  ...
  @JSName("iterable")
  var iterable_Original: reduxDashSagaLib.utilsMod.GuardPredicate[nodeLib.Iterable[_] with stdLib.Iterable[_]] = js.native
  @JSName("iterator")
  var iterator_Original: reduxDashSagaLib.utilsMod.GuardPredicate[nodeLib.Iterator[_] with stdLib.Iterator[_]] = js.native
  @JSName("notUndef")
  ...
  def iterable(arg: js.Any): scala.Boolean = js.native
  def iterator(arg: js.Any): scala.Boolean = js.native

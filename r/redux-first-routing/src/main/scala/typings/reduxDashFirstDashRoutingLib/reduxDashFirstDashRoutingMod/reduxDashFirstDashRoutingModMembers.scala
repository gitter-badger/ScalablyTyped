...
object reduxDashFirstDashRoutingModMembers extends js.Object {
  ...
  def locationChange[P /* <: historyLib.historyMod.Pathname */, S /* <: historyLib.historyMod.Search */, H /* <: historyLib.historyMod.Hash */](`_`: reduxDashFirstDashRoutingLib.Anon_PathnameSearch[P, S, H]): locationChangeAction[P, S, H] = js.native

...
- Dropped {[ P in std.Exclude<keyof react.react.HTMLAttributes<react.HTMLElement & std.HTMLElement>, 'onBlur' | 'onFocus'> ]: react.react.HTMLAttributes<react.HTMLElement & std.HTMLElement>[P]} */ trait WidgetProps extends js.Object {

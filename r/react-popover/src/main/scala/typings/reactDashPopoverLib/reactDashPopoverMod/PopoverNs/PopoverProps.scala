...
trait PopoverProps extends js.Object {
  var appendTarget: js.UndefOr[reactLib.Element with stdLib.Element] = js.undefined
  ...
  var onOuterAction: js.UndefOr[js.Function1[/* event */ reactLib.Event with stdLib.Event, scala.Unit]] = js.undefined

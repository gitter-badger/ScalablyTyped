...
trait Select[OptionType]
  ...
  // Getters
  // ==============================
  def getCommonProps(): reactDashSelectLib.Anon_Cx[OptionType] = js.native
  def getControlRef(ref: reactLib.HTMLElement with stdLib.HTMLElement): scala.Unit = js.native
  @JSName("getElementId")
  ...
  def getFocusedOptionRef(ref: reactLib.HTMLElement with stdLib.HTMLElement): scala.Unit = js.native
  def getInputRef(ref: reactLib.HTMLElement with stdLib.HTMLElement): scala.Unit = js.native
  def getMenuListRef(ref: reactLib.HTMLElement with stdLib.HTMLElement): scala.Unit = js.native
  ...
  def onClearIndicatorTouchEnd(event: reactLib.reactMod.ReactNs.TouchEvent[reactLib.HTMLElement with stdLib.HTMLElement]): scala.Unit = js.native
  ...
  def onControlTouchEnd(event: reactLib.reactMod.ReactNs.TouchEvent[reactLib.HTMLElement with stdLib.HTMLElement]): scala.Unit = js.native
  def onDropdownIndicatorMouseDown(event: MouseOrTouchEvent): scala.Unit = js.native
  def onDropdownIndicatorTouchEnd(event: reactLib.reactMod.ReactNs.TouchEvent[reactLib.HTMLElement with stdLib.HTMLElement]): scala.Unit = js.native
  def onInputBlur(
  ...
  // Keyboard Handlers
  // ==============================
  def onKeyDown(event: reactLib.reactMod.ReactNs.KeyboardEvent[reactLib.HTMLElement with stdLib.HTMLElement]): scala.Unit = js.native
  ...
  def onScroll(event: reactLib.Event with stdLib.Event): scala.Unit = js.native
  def onTouchEnd(event: reactLib.TouchEvent with stdLib.TouchEvent): scala.Unit = js.native
  def onTouchMove(event: reactLib.TouchEvent with stdLib.TouchEvent): scala.Unit = js.native
  def onTouchStart(event: reactLib.TouchEvent with stdLib.TouchEvent): scala.Unit = js.native
  @JSName("openMenu")

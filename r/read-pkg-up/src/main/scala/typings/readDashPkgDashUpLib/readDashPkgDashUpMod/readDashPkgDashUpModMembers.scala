...
object readDashPkgDashUpModMembers extends js.Object {
  def apply(): js.Promise[readDashPkgDashUpLib.Anon_Path] = js.native
  def apply(
  ...
  ): js.Promise[readDashPkgDashUpLib.Anon_Path] = js.native
  def sync(): readDashPkgDashUpLib.Anon_PathPkgString = js.native
  def sync(
    options: readDashPkgDashUpLib.readDashPkgDashUpMod.ReadPkgUpNs.Options with readDashPkgDashUpLib.Anon_Normalize
  ): readDashPkgDashUpLib.Anon_PathPkg = js.native
  @JSName("sync")
  def sync_Anon_PathPkgString(options: readDashPkgDashUpLib.readDashPkgDashUpMod.ReadPkgUpNs.Options): readDashPkgDashUpLib.Anon_PathPkgString = js.native
}

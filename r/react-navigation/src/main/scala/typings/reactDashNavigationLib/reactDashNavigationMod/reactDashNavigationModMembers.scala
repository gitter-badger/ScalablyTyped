...
object reactDashNavigationModMembers extends js.Object {
  ...
  def withNavigationFocus_TP[T, P](Component: reactLib.reactMod.ReactNs.ComponentType[T with NavigationFocusInjectedProps[P]]): reactLib.reactMod.ReactNs.ComponentType[T with (reactDashNavigationLib.Anon_OnRefRefComponent[T, P])] = js.native
  @JSName("withNavigation")
  def withNavigation_TP[T, P](Component: reactLib.reactMod.ReactNs.ComponentType[T with NavigationInjectedProps[P]]): reactLib.reactMod.ReactNs.ComponentType[T with (reactDashNavigationLib.Anon_OnRefRef[T, P])] = js.native
}

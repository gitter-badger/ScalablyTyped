...
trait Observable[T] extends js.Object {
  ...
  def delaySubscription(dueTime: scala.Double, scheduler: rxDashCoreLib.RxNs.IScheduler with rxDashLiteLib.RxNs.IScheduler): Observable[T] = js.native
  ...
  def takeLastWithTime(
    duration: scala.Double,
    timerScheduler: rxDashCoreLib.RxNs.IScheduler with rxDashLiteLib.RxNs.IScheduler
  ): Observable[T] = js.native
  def takeLastWithTime(
    duration: scala.Double,
    timerScheduler: rxDashCoreLib.RxNs.IScheduler with rxDashLiteLib.RxNs.IScheduler,
    loopScheduler: rxDashCoreLib.RxNs.IScheduler with rxDashLiteLib.RxNs.IScheduler
  ): Observable[T] = js.native
  def takeUntilWithTime(duration: scala.Double): Observable[T] = js.native
  def takeUntilWithTime(
    duration: scala.Double,
    scheduler: rxDashCoreLib.RxNs.IScheduler with rxDashLiteLib.RxNs.IScheduler
  ): Observable[T] = js.native
  def takeUntilWithTime(endTime: stdLib.Date): Observable[T] = js.native
  def takeUntilWithTime(endTime: stdLib.Date, scheduler: rxDashCoreLib.RxNs.IScheduler with rxDashLiteLib.RxNs.IScheduler): Observable[T] = js.native

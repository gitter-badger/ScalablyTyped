...
trait UIManagerStatic extends js.Object {
  ...
  def takeSnapshot(view: reactLib.reactMod.ReactNs.ReactElement[_], options: reactDashNativeLib.Anon_WidthHeight): js.Promise[java.lang.String] = js.native
  def takeSnapshot(view: scala.Double): js.Promise[java.lang.String] = js.native
  def takeSnapshot(view: scala.Double, options: reactDashNativeLib.Anon_WidthHeight): js.Promise[java.lang.String] = js.native
  @JSName("takeSnapshot")
  ...
  def takeSnapshot_window(
    ...
    options: reactDashNativeLib.Anon_WidthHeight

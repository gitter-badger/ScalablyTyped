...
trait PushNotificationIOSStatic extends js.Object {
  ...
  def addEventListener_registrationError(
    ...
    handler: js.Function1[/* error */ reactDashNativeLib.Anon_Message, scala.Unit]
  ): scala.Unit = js.native
  /**
  ...
  def removeEventListener(
    ...
    handler: js.Function1[
      (/* error */ reactDashNativeLib.Anon_Message) | (/* notification */ PushNotification) | (/* deviceToken */ java.lang.String), 
      scala.Unit
    ]
  ): scala.Unit = js.native
  /**

...
trait XMLHttpRequest
  ...
  //  msCaching: string;
  var onreadystatechange: (js.ThisFunction1[/* this */ this.type, /* ev */ reactLib.Event with stdLib.Event, _]) | scala.Null = js.native
  ...
  val responseXML: (reactLib.Document with stdLib.Document) | scala.Null = js.native

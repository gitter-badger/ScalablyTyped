...
trait Anon_Type extends js.Object {
  var `aria-activedescendant`: java.lang.String | scala.Null = js.native
  var `aria-autocomplete`: reactDashPlacesDashAutocompleteLib.reactDashPlacesDashAutocompleteLibStrings.list = js.native

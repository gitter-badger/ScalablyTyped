...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "fbemitter" % "2.0.0-dt-20180315Z-c73015",
  "org.scalablytyped" %%% "flux" % "3.1-dt-20180803Z-70aae2",
  ...
  "org.scalablytyped" %%% "react-textarea-autosize" % "4.3.0-dt-20180806Z-6ac632",

...
trait AvatarEditor
  ...
  def getImage(): reactLib.HTMLCanvasElement with stdLib.HTMLCanvasElement = js.native
  def getImageScaledToCanvas(): reactLib.HTMLCanvasElement with stdLib.HTMLCanvasElement = js.native
}

...
object testDashUtilsModMembers extends js.Object {
  ...
  def mockComponent(mocked: MockedComponentClass): reactDashDomLib.Anon_Simulate = js.native
  def mockComponent(mocked: MockedComponentClass, mockTagName: java.lang.String): reactDashDomLib.Anon_Simulate = js.native

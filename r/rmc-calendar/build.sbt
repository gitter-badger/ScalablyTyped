...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "rmc-date-picker" % "6.0.8-1a28ca",
  "org.scalablytyped" %%% "rmc-dialog" % "1.1.1-9930ee",
  "org.scalablytyped" %%% "rmc-feedback" % "2.0.0-2ac3f6",
  "org.scalablytyped" %%% "rmc-picker" % "5.0.5-0d1a25",

...
trait SingleMonth
  ...
  var wrapperDivDOM: (reactLib.HTMLDivElement with stdLib.HTMLDivElement) | scala.Null = js.native
  ...
  def setWarpper(dom: reactLib.HTMLDivElement with stdLib.HTMLDivElement): scala.Unit = js.native

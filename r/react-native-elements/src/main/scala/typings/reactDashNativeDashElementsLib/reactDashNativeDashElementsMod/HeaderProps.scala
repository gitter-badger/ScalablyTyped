...
- Dropped any */ trait HeaderProps extends js.Object {
  ...
  /**
    ...
    */
  var statusBarProps: /* import warning: QualifyReferences.resolveTypeRef Couldn't qualify StatusBarProperties */ js.UndefOr[
    /* import warning: QualifyReferences.resolveTypeRef Couldn't qualify StatusBarProperties */ js.Any
  ] = js.undefined
}

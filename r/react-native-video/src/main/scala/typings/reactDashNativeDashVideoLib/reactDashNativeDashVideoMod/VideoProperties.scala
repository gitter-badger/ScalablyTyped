...
trait VideoProperties
  ...
  var selectedTextTrack: js.UndefOr[reactDashNativeDashVideoLib.Anon_Type] = js.undefined
  /* Wrapper component */
  // Opaque type returned by require('./video.mp4')
  var source: reactDashNativeDashVideoLib.Anon_Uri | scala.Double
  /* Native only */
  var src: js.UndefOr[js.Any] = js.undefined
  var textTracks: js.UndefOr[js.Array[reactDashNativeDashVideoLib.Anon_Title]] = js.undefined

...
class Environment protected () extends js.Object {
  ...
  def execute(config: relayDashRuntimeLib.Anon_OperationCacheConfig): RelayObservable[RelayResponsePayload] = js.native
  def executeMutation(config: relayDashRuntimeLib.Anon_OperationOptimisticUpdater): RelayObservable[RelayResponsePayload] = js.native

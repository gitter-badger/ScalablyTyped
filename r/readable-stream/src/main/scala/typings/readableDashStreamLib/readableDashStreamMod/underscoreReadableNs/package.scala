...
package object underscoreReadableNs {
  ...
  type ReadableOptions = ReadableStateOptions with readableDashStreamLib.Anon_Read
  ...
  type WritableOptions = WritableStateOptions with readableDashStreamLib.Anon_Write
}

...
trait WritableState extends js.Object {
  ...
  var writecb: (js.Function1[/* err */ js.UndefOr[(nodeLib.Error with stdLib.Error) | scala.Null], scala.Unit]) | scala.Null = js.native
  ...
  def onwrite(er: nodeLib.Error with stdLib.Error): js.Any = js.native
}

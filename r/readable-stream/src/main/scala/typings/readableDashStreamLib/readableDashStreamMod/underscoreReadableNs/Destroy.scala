...
trait Destroy extends js.Object {
  ...
  def destroy(`this`: Readable, error: nodeLib.Error with stdLib.Error): Readable | Writable = js.native
  def destroy(
    `this`: Readable,
  ...
  def destroy(`this`: Writable, error: nodeLib.Error with stdLib.Error): Readable | Writable = js.native
  def destroy(
    `this`: Writable,
    error: nodeLib.Error with stdLib.Error,
    callback: js.Function1[/* error */ (nodeLib.Error with stdLib.Error) | scala.Null, scala.Unit]

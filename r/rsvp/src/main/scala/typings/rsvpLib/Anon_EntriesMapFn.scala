...
@js.native
trait Anon_EntriesMapFn extends js.Object {
  def apply[T, U](entries: js.Array[rsvpLib.rsvpMod.RSVPNs.Arg[T]], mapFn: js.Function1[/* item */ T, U]): rsvpLib.rsvpMod.RSVPNs.Promise[js.Array[U] with Anon_Length1] = js.native
  def apply[T, U](
    entries: js.Array[rsvpLib.rsvpMod.RSVPNs.Arg[T]],
    mapFn: js.Function1[/* item */ T, U],
    label: java.lang.String
  ): rsvpLib.rsvpMod.RSVPNs.Promise[js.Array[U] with Anon_Length1] = js.native
  def apply[T1, T2, U](

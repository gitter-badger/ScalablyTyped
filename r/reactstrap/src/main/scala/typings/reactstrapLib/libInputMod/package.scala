...
package object libInputMod {
  ...
  type InputProps[T] = (reactLib.reactMod.ReactNs.InputHTMLAttributes[reactLib.HTMLInputElement with stdLib.HTMLInputElement]) with reactstrapLib.Anon_TypeBsSize with T

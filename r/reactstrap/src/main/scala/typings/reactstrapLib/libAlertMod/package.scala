...
package object libAlertMod {
  ...
  type UncontrolledProps[T] = (reactLib.reactMod.ReactNs.HTMLAttributes[reactLib.HTMLElement with stdLib.HTMLElement]) with reactstrapLib.Anon_ClassName with T
}

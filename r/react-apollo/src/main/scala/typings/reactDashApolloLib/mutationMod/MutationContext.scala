...
trait MutationContext extends js.Object {
  ...
  var operations: (lodashLib.lodashMod.Global.Map[java.lang.String, reactDashApolloLib.Anon_Query]) with (stdLib.Map[java.lang.String, reactDashApolloLib.Anon_Query])
}

...
class ORM[State /* <: ORMCommonState */] () extends js.Object {
  ...
  /* private */ def _attachQuerySetMethods(model: reduxDashOrmLib.Anon_IdAttribute): scala.Unit = js.native
  /* private */ def _setupModelPrototypes(models: js.Array[reduxDashOrmLib.Anon_IdAttribute]): scala.Unit = js.native
  def generateSchemaSpec(): SchemaSpec = js.native
  def get(modelName: java.lang.String): reduxDashOrmLib.Anon_IdAttribute = js.native
  def getDatabase(): DB = js.native
  def getEmptyState(): State = js.native
  def getModelClasses(): js.Array[reduxDashOrmLib.Anon_IdAttribute] = js.native
  ...
  def register(model: reduxDashOrmLib.Anon_IdAttribute*): scala.Unit = js.native
  def registerManyToManyModelsFor(model: reduxDashOrmLib.Anon_IdAttribute): scala.Unit = js.native
  @JSName("register")

...
@js.native
object reduxDashFirstDashRouterModMembers extends js.Object {
  ...
  def connectRoutes[TKeys, TState](routesMap: RoutesMap[TKeys, TState]): reduxDashFirstDashRouterLib.Anon_Reducer[TKeys, TState] = js.native
  def connectRoutes[TKeys, TState](routesMap: RoutesMap[TKeys, TState], options: Options[TKeys, TState]): reduxDashFirstDashRouterLib.Anon_Reducer[TKeys, TState] = js.native

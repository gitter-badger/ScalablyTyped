...
trait Props extends js.Object {
  ...
  var appElement: js.UndefOr[(reactLib.HTMLElement with stdLib.HTMLElement) | js.Object] = js.undefined
  ...
  var contentRef: js.UndefOr[
    js.Function1[/* instance */ reactLib.HTMLDivElement with stdLib.HTMLDivElement, scala.Unit]
  ] = js.undefined
  ...
  var onRequestClose: js.UndefOr[
    js.Function1[
      /* event */ (reactLib.MouseEvent with stdLib.MouseEvent) | (reactLib.KeyboardEvent with stdLib.KeyboardEvent), 
      scala.Unit
    ]
  ] = js.undefined
  ...
  var overlayRef: js.UndefOr[
    js.Function1[/* instance */ reactLib.HTMLDivElement with stdLib.HTMLDivElement, scala.Unit]
  ] = js.undefined
  /* Function that will be called to get the parent element that the modal will be attached to. */
  var parentSelector: js.UndefOr[js.Function0[reactLib.HTMLElement with stdLib.HTMLElement]] = js.undefined

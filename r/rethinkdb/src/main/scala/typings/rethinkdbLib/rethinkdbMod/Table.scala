...
trait Table
  ...
  def indexWait(): Operation[js.Array[rethinkdbLib.Anon_Index]] = js.native
  def indexWait(name: java.lang.String): Operation[js.Array[rethinkdbLib.Anon_Index]] = js.native

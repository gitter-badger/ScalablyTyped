...
object utilsModMembers extends js.Object {
  val FlexboxPropTypes: reactDashFoundationLib.Anon_AlignX = js.native
  val GeneralPropTypes: reactDashFoundationLib.Anon_ShowFor = js.native
  ...
  def generalClassNames(props: GeneralPropTypes): reactDashFoundationLib.Anon_Showformedium = js.native

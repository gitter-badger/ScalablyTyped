...
trait AppBarProps
  ...
  /**
    ...
    */
  var onLeftIconClick: js.UndefOr[coreDashJsLib.Function with js.Function] = js.undefined
  /**
    * Called when the righticon is clicked
    */
  var onRightIconClick: js.UndefOr[coreDashJsLib.Function with js.Function] = js.undefined
  /**

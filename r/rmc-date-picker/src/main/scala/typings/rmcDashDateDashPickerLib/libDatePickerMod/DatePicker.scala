...
@js.native
trait DatePicker
  extends reactLib.reactMod.Component[rmcDashDateDashPickerLib.libIDatePickerPropsMod.IDatePickerProps, js.Any, js.Any] {
  ...
  def getValueCols(): rmcDashDateDashPickerLib.Anon_Value = js.native

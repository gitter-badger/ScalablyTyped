...
class Client ()
  ...
  def captureException(error: nodeLib.Error with stdLib.Error): java.lang.String = js.native
  def captureException(error: nodeLib.Error with stdLib.Error, cb: CaptureCallback): java.lang.String = js.native
  def captureException(error: nodeLib.Error with stdLib.Error, options: CaptureOptions): java.lang.String = js.native
  def captureException(error: nodeLib.Error with stdLib.Error, options: CaptureOptions, cb: CaptureCallback): java.lang.String = js.native

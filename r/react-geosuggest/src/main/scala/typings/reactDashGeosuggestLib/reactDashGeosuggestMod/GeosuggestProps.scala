...
- Dropped {[ P in {[ P in keyof react.react.InputHTMLAttributes<react.HTMLInputElement & std.HTMLInputElement> ]: P} & {[ P in 'style' ]: never} & {[x: string] : never, [x: number] : never}[keyof react.react.InputHTMLAttributes<react.HTMLInputElement & std.HTMLInputElement>] ]: react.react.InputHTMLAttributes<react.HTMLInputElement & std.HTMLInputElement>[P]} */ trait GeosuggestProps extends js.Object {
  ...
  var googleMaps: js.UndefOr[reactDashGeosuggestLib.Anon_Map] = js.undefined

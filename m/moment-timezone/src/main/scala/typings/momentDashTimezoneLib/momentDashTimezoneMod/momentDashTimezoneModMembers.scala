package typings
package momentDashTimezoneLib.momentDashTimezoneMod
...
@js.native
object momentDashTimezoneModMembers extends js.Object {
  var HTML5_FMT: momentLib.Anon_DATETIMELOCAL = js.native
  ...
  val tz: momentDashTimezoneLib.momentDashTimezoneMod.momentMod.MomentTimezone = js.native

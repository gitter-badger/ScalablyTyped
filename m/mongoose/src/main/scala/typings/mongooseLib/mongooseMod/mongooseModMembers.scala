...
object mongooseModMembers extends js.Object {
  ...
  var Mongoose: org.scalablytyped.runtime.Instantiable1[/* args (repeated) */ js.Any, mongooseLib.Anon_Pluralize] = js.native
  ...
  var mongo: mongooseLib.Anon_ConnectUri = js.native
  ...
  def plugin(fn: js.Function): mongooseLib.Anon_Pluralize = js.native
  def plugin[T](fn: js.Function, opts: T): mongooseLib.Anon_Pluralize = js.native

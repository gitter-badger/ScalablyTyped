...
trait Schema
  ...
  /**
    ...
    */
  @JSName("set")
  def set_capped(key: mongooseLib.mongooseLibStrings.capped): scala.Boolean | scala.Double | mongooseLib.Anon_Size = js.native
  @JSName("set")
  def set_capped(key: mongooseLib.mongooseLibStrings.capped, value: mongooseLib.Anon_Size): this.type = js.native
  @JSName("set")

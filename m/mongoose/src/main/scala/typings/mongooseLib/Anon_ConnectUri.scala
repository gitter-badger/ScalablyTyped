...
@js.native
trait Anon_ConnectUri extends js.Object {
  ...
  var Binary: Anon_SUBTYPEDEFAULT = js.native
  ...
  var Decimal128: Anon_FromString = js.native
  ...
  var Logger: Anon_Reset = js.native
  var Long: Anon_MAXVALUE = js.native
  ...
  var MongoClient: Anon_Connect = js.native
  ...
  var ReadPreference: Anon_PRIMARY = js.native
  ...
  var Timestamp: Anon_MAXVALUEMINVALUE = js.native

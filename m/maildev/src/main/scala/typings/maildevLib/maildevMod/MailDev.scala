...
trait MailDev extends js.Object {
  ...
  def deleteAllEmail(callback: js.Function1[/* error */ nodeLib.Error with stdLib.Error, scala.Unit]): scala.Unit = js.native
  /**
  ...
  def end(callback: js.Function1[/* error */ nodeLib.Error with stdLib.Error, scala.Unit]): scala.Unit = js.native
  /**
  ...
  def listen(callback: js.Function1[/* error */ nodeLib.Error with stdLib.Error, scala.Unit]): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def relayMail(
    idOrMailObject: java.lang.String,

...
trait Admin extends js.Object {
  ...
  def command(command: js.Object, options: mongodbLib.Anon_ReadPreferenceMaxTimeMS): js.Promise[_] = js.native
  def command(command: js.Object, options: mongodbLib.Anon_ReadPreferenceMaxTimeMS, callback: MongoCallback[_]): scala.Unit = js.native

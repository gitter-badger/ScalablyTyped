...
class Db protected ()
  ...
  def executeDbAdminCommand(command: js.Object, options: mongodbLib.Anon_ReadPreferenceMaxTimeMS): js.Promise[_] = js.native
  def executeDbAdminCommand(command: js.Object, options: mongodbLib.Anon_ReadPreferenceMaxTimeMS, callback: MongoCallback[_]): scala.Unit = js.native
  ...
  def profilingInfo(options: mongodbLib.Anon_Session): js.Promise[scala.Unit] = js.native
  def profilingInfo(options: mongodbLib.Anon_Session, callback: MongoCallback[scala.Unit]): scala.Unit = js.native
  ...
  def profilingLevel(options: mongodbLib.Anon_Session): js.Promise[ProfilingLevel] = js.native
  def profilingLevel(options: mongodbLib.Anon_Session, callback: MongoCallback[ProfilingLevel]): scala.Unit = js.native
  ...
  def setProfilingLevel(level: ProfilingLevel, options: mongodbLib.Anon_Session): js.Promise[ProfilingLevel] = js.native
  def setProfilingLevel(level: ProfilingLevel, options: mongodbLib.Anon_Session, callback: MongoCallback[ProfilingLevel]): scala.Unit = js.native

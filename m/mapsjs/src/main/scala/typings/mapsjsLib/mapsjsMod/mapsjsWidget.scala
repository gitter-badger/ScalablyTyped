...
trait mapsjsWidget extends js.Object {
  ...
  def addPathGeometry(
    ...
    key: java.lang.String,
    addAction: js.Function1[/* svg */ stdLib.SVGElement, scala.Unit],
    removeAction: js.Function1[/* svg */ stdLib.SVGElement, scala.Unit]
  ): stdLib.SVGElement = js.native
  /**
    ...
    * circleEndAction is similar to envelopeEndAction but takes a geometry.polygon representing the circle,
  	 ...
  	 */
  def beginDigitize(options: beginDigitizeOptions): scala.Unit = js.native
  /**
  	 ...
  	 */
  def computeMapPointFromPixelLocation(x: scala.Double, y: scala.Double): point = js.native
  /**
  	 ...
  	 */
  def deleteNodeOnDigitizePath(setIdx: scala.Double, nodeIdx: scala.Double): scala.Unit = js.native
  def endDigitize(): scala.Unit = js.native
  /**
  ...
  def flyTo(
    ...
    completeAction: js.Function0[scala.Unit]
  ): scala.Unit = js.native
  /**
  	 ...
  	 */
  def getActualMapScale(): scala.Double = js.native
  /**
  	 ...
  	 */
  def getBestFitZoomLevelByExtents(extentsNew: envelope): scala.Double = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def getMapUnitsPerPixel(): scala.Double = js.native
  /**
  	 ...
  	 */
  def getProjectedMapScale(): scala.Double = js.native
  /**
  	 ...
  	 */
  def getTileLayer(key: java.lang.String): mapsjsLib.mapsjsMod.tileNs.layer = js.native
  /**
  	 * Gets the current number of tile layers in the display stack.
  	 * @returns {number} The number of tile layers in the display stack.
  	 */
  def getTileLayerCount(): scala.Double = js.native
  /**
  	 ...
  	 * height in pixels.
  	 */
  def getViewExtentsInPix(): mapsjsLib.Anon_W = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def isDigitizingEnabled(): scala.Boolean = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def removeFixedContentElement(element: stdLib.HTMLElement): scala.Unit = js.native
  /**
  ...
  /**
  	...
  	*/
  def setBackground(b: java.lang.String): scala.Unit = js.native
  /** 
  	...
  	*/
  def setContentExtentsMarginInPixels(cem: scala.Double): scala.Unit = js.native
  /**
  	 ...
  	 */
  def setContentRepositionAction(action: js.Function1[/* vals */ repositionStatsObj, scala.Unit]): scala.Unit = js.native
  /**
  ...
  /** 
  	 ...
  	 */
  def setExtentChangeCompleteAction(action: js.Function1[/* vals */ extentChangeStatsObj, scala.Unit]): scala.Unit = js.native
  /**
  	 ...
  	 */
  def setMapCenter(center: point): scala.Unit = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def setMaxZoomLevel(zl: scala.Double): scala.Unit = js.native
  /**
  	 * Sets the minimum zoom level for the map.
  	 * @param {number} zl Desired minimum zoom level.
  	 */
  def setMinZoomLevel(zl: scala.Double): scala.Unit = js.native
  /**
  	 ...
  	 */
  def setPointerClickAction(action: js.Function1[/* pt */ point, scala.Unit]): scala.Unit = js.native
  /** 
  	 ...
  	 */
  def setPointerHoverAction(action: js.Function1[/* pt */ point, scala.Unit]): scala.Unit = js.native
  /**
  	 ...
  	 * extent changes.
  	 */
  def setSuspendMapExtentChangesByGestures(flag: scala.Boolean): scala.Unit = js.native
  /**
  	 * Sets the current zoom level.
  	 * @param {number} z1 The desired zoom level.
  	 */
  def setZoomLevel(zl: scala.Double): scala.Unit = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def updatePathGeometryStyle(styleNew: geometryStyle, key: java.lang.String): scala.Unit = js.native
  /**
  	 * Changes the current zoom level.
  	 * @param {number} delta Change to be added to the current zoom level.
  	 */
  def zoomDelta(delta: scala.Double): scala.Unit = js.native
  /** 

...
trait Collection[T] extends js.Object {
  ...
  def find(selector: java.lang.String, options: meteorDashTypingsLib.Anon_Sort): Cursor[T] = js.native
  def find(selector: ObjectID): Cursor[T] = js.native
  def find(selector: ObjectID, options: meteorDashTypingsLib.Anon_Sort): Cursor[T] = js.native
  def find(selector: Selector): Cursor[T] = js.native
  def find(selector: Selector, options: meteorDashTypingsLib.Anon_Sort): Cursor[T] = js.native
  def findOne(): T = js.native
  def findOne(selector: java.lang.String): T = js.native
  def findOne(selector: java.lang.String, options: meteorDashTypingsLib.Anon_SortSkip): T = js.native
  def findOne(selector: ObjectID): T = js.native
  def findOne(selector: ObjectID, options: meteorDashTypingsLib.Anon_SortSkip): T = js.native
  def findOne(selector: Selector): T = js.native
  def findOne(selector: Selector, options: meteorDashTypingsLib.Anon_SortSkip): T = js.native

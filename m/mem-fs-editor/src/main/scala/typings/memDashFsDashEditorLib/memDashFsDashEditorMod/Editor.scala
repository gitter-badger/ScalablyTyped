...
trait Editor extends js.Object {
  def append(to: java.lang.String, contents: memDashFsDashEditorLib.Contents): java.lang.String = js.native
  def append(
    to: java.lang.String,
  ...
  def writeJSON(filepath: java.lang.String, contents: js.Any, replacer: memDashFsDashEditorLib.ReplacerFunc): java.lang.String = js.native
  def writeJSON(
    filepath: java.lang.String,
    contents: js.Any,
    replacer: memDashFsDashEditorLib.ReplacerFunc,
    space: memDashFsDashEditorLib.Space
  ): java.lang.String = js.native
}

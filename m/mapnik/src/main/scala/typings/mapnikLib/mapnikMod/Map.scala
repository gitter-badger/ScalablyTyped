...
class Map protected () extends js.Object {
  ...
  def load(
    ...
    callback: js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* map */ this.type, scala.Unit]
  ): scala.Unit = js.native
  def render(images: Image): scala.Unit = js.native
  def render(
    images: Image,
    callback: js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* map */ Image, scala.Unit]
  ): scala.Unit = js.native

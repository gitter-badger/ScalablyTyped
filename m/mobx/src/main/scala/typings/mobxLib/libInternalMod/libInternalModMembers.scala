...
object libInternalModMembers extends js.Object {
  ...
  val comparer: mobxLib.Anon_Identity = js.native
  ...
  def boundActionDecorator(target: js.Any, propertyName: js.Any, descriptor: js.Any): mobxLib.Anon_Configurable | mobxLib.Anon_EnumerableConfigurable | scala.Null = js.native
  def boundActionDecorator(target: js.Any, propertyName: js.Any, descriptor: js.Any, applyToInstance: scala.Boolean): mobxLib.Anon_Configurable | mobxLib.Anon_EnumerableConfigurable | scala.Null = js.native
  ...
  def configure(options: mobxLib.Anon_EnforceActions): scala.Unit = js.native
  ...
  def namedActionDecorator(name: java.lang.String): js.Function3[
    ...
    scala.Unit | mobxLib.Anon_Value | mobxLib.Anon_Enumerable
  ] = js.native

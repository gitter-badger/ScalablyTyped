...
@js.native
trait Anon_PromisifyPathOptionsBufferPathLike extends js.Object {
  /**
  ...
  def __promisify___buffer(path: nodeLib.fsMod.PathLike, options: makeDashDirLib.makeDashDirLibStrings.buffer): js.Promise[js.Array[nodeLib.Buffer]] = js.native
}

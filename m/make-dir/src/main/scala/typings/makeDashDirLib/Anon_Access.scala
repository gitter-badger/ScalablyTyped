...
trait Anon_Access extends js.Object {
  ...
  @JSName("mkdtemp")
  def mkdtemp_buffer(prefix: java.lang.String, options: makeDashDirLib.makeDashDirLibStrings.buffer): js.Promise[nodeLib.Buffer] = js.native
  /**
  ...
  @JSName("readdir")
  def readdir_buffer(path: nodeLib.fsMod.PathLike, options: makeDashDirLib.makeDashDirLibStrings.buffer): js.Promise[js.Array[nodeLib.Buffer]] = js.native
  /**
  ...
  @JSName("readlink")
  def readlink_buffer(path: nodeLib.fsMod.PathLike, options: makeDashDirLib.makeDashDirLibStrings.buffer): js.Promise[nodeLib.Buffer] = js.native
  /**
  ...
  @JSName("realpath")
  def realpath_buffer(path: nodeLib.fsMod.PathLike, options: makeDashDirLib.makeDashDirLibStrings.buffer): js.Promise[nodeLib.Buffer] = js.native
  /**

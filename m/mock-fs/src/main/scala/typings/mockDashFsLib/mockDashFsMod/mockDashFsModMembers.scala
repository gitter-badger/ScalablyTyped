...
@js.native
object mockDashFsModMembers extends js.Object {
  def apply(): scala.Unit = js.native
  def apply(config: mockDashFsLib.mockDashFsMod.mockNs.Config): scala.Unit = js.native
  def apply(
  ...
  def fs(): mockDashFsLib.Anon_Stats = js.native
  def fs(config: mockDashFsLib.mockDashFsMod.mockNs.Config): mockDashFsLib.Anon_Stats = js.native
  def fs(
    config: mockDashFsLib.mockDashFsMod.mockNs.Config,
    options: mockDashFsLib.mockDashFsMod.mockNs.Options
  ): mockDashFsLib.Anon_Stats = js.native

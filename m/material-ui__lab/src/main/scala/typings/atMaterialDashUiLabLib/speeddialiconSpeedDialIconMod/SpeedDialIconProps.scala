...
- Dropped {[ P in std.Exclude<keyof react.react.HTMLAttributes<react.HTMLSpanElement & std.HTMLSpanElement>, 'classes' | never> ]: react.react.HTMLAttributes<react.HTMLSpanElement & std.HTMLSpanElement>[P]} */ trait SpeedDialIconProps

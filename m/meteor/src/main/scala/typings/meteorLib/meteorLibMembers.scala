...
@JSGlobalScope
@js.native
object meteorLibMembers extends js.Object {
  ...
  def execFileSync(command: java.lang.String): nodeLib.String with java.lang.String = js.native
  def execFileSync(command: java.lang.String, args: js.Array[_]): nodeLib.String with java.lang.String = js.native
  def execFileSync(command: java.lang.String, args: js.Array[_], options: Anon_Cwd): nodeLib.String with java.lang.String = js.native
}

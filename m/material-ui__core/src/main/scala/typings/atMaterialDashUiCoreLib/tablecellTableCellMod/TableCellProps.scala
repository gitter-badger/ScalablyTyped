...
- Dropped {[ P in std.Exclude<keyof @material-ui/core.@material-ui/core/TableCell/TableCell.TableCellBaseProps, 'classes' | never> ]: @material-ui/core.@material-ui/core/TableCell/TableCell.TableCellBaseProps[P]}
- Lifted 2 members from Set(@material-ui/core.@material-ui/core.StandardProps<@material-ui/core.@material-ui/core/TableCell/TableCell.TableCellBaseProps, @material-ui/core.@material-ui/core/TableCell/TableCell.TableCellClassKey, never>) */ trait TableCellProps

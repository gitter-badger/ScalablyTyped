...
- Dropped {[ P in std.Exclude<keyof react.react.AnchorHTMLAttributes<react.HTMLElement & std.HTMLElement> & react.react.ButtonHTMLAttributes<react.HTMLElement & std.HTMLElement>, 'classes' | never> ]: react.react.AnchorHTMLAttributes<react.HTMLElement & std.HTMLElement> & react.react.ButtonHTMLAttributes<react.HTMLElement & std.HTMLElement>[P]}
- Lifted 2 members from Set(@material-ui/core.@material-ui/core.StandardProps<react.react.AnchorHTMLAttributes<react.HTMLElement & std.HTMLElement> & react.react.ButtonHTMLAttributes<react.HTMLElement & std.HTMLElement>, @material-ui/core.@material-ui/core/ButtonBase/ButtonBase.ButtonBaseClassKey, never>) */ trait ButtonBaseProps

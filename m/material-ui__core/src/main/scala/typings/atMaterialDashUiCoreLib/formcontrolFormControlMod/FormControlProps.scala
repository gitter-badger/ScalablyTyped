...
- Dropped {[ P in std.Exclude<keyof react.react.HtmlHTMLAttributes<react.HTMLDivElement & std.HTMLDivElement>, 'classes' | never> ]: react.react.HtmlHTMLAttributes<react.HTMLDivElement & std.HTMLDivElement>[P]}
- Lifted 2 members from Set(@material-ui/core.@material-ui/core.StandardProps<react.react.HtmlHTMLAttributes<react.HTMLDivElement & std.HTMLDivElement>, @material-ui/core.@material-ui/core/FormControl/FormControl.FormControlClassKey, never>) */ trait FormControlProps

...
- Dropped {[ P in std.Exclude<keyof react.react.HTMLAttributes<react.HTMLDivElement & std.HTMLDivElement>, 'classes' | 'title'> ]: react.react.HTMLAttributes<react.HTMLDivElement & std.HTMLDivElement>[P]}
- Lifted 2 members from Set(@material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<react.HTMLDivElement & std.HTMLDivElement>, @material-ui/core.@material-ui/core/CardHeader/CardHeader.CardHeaderClassKey, 'title'>) */ trait CardHeaderProps

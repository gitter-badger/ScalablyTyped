...
- Dropped {[ P in std.Exclude<keyof react.react.HTMLAttributes<react.HTMLParagraphElement & std.HTMLParagraphElement>, 'classes' | never> ]: react.react.HTMLAttributes<react.HTMLParagraphElement & std.HTMLParagraphElement>[P]}
- Lifted 2 members from Set(@material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<react.HTMLParagraphElement & std.HTMLParagraphElement>, @material-ui/core.@material-ui/core/FormHelperText/FormHelperText.FormHelperTextClassKey, never>) */ trait FormHelperTextProps

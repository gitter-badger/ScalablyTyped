...
- Dropped {[ P in std.Exclude<keyof react.react.LabelHTMLAttributes<react.HTMLLabelElement & std.HTMLLabelElement>, 'classes' | 'onChange'> ]: react.react.LabelHTMLAttributes<react.HTMLLabelElement & std.HTMLLabelElement>[P]}
- Lifted 2 members from Set(@material-ui/core.@material-ui/core.StandardProps<react.react.LabelHTMLAttributes<react.HTMLLabelElement & std.HTMLLabelElement>, @material-ui/core.@material-ui/core/FormControlLabel/FormControlLabel.FormControlLabelClassKey, 'onChange'>) */ trait FormControlLabelProps

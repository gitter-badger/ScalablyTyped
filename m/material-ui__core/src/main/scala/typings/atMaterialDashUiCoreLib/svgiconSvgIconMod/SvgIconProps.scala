...
- Dropped {[ P in std.Exclude<keyof react.react.SVGProps<react.SVGSVGElement & std.SVGSVGElement>, 'classes' | never> ]: react.react.SVGProps<react.SVGSVGElement & std.SVGSVGElement>[P]}
- Lifted 2 members from Set(@material-ui/core.@material-ui/core.StandardProps<react.react.SVGProps<react.SVGSVGElement & std.SVGSVGElement>, @material-ui/core.@material-ui/core/SvgIcon/SvgIcon.SvgIconClassKey, never>) */ trait SvgIconProps

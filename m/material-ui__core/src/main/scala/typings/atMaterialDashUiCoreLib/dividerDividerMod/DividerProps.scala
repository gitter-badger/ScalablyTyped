...
- Dropped {[ P in std.Exclude<keyof react.react.HTMLAttributes<react.HTMLHRElement & std.HTMLHRElement>, 'classes' | never> ]: react.react.HTMLAttributes<react.HTMLHRElement & std.HTMLHRElement>[P]}
- Lifted 2 members from Set(@material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<react.HTMLHRElement & std.HTMLHRElement>, @material-ui/core.@material-ui/core/Divider/Divider.DividerClassKey, never>) */ trait DividerProps

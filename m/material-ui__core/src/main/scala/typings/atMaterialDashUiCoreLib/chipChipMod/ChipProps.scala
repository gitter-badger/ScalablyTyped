...
- Lifted 2 members from Set(@material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<react.HTMLDivElement & std.HTMLDivElement>, @material-ui/core.@material-ui/core/Chip/Chip.ChipClassKey, never>) */ trait ChipProps

package typings
package meteorDashRolesLib.`alanning:rolesMod`
...
@js.native
object RolesNs extends js.Object {
  ...
  def getUsersInRole(role: java.lang.String, group: java.lang.String, options: meteorDashRolesLib.Anon_Sort): meteorLib.MongoNs.Cursor[meteorLib.MeteorNs.User] = js.native
  ...
  def getUsersInRole(role: js.Array[java.lang.String], group: java.lang.String, options: meteorDashRolesLib.Anon_Sort): meteorLib.MongoNs.Cursor[meteorLib.MeteorNs.User] = js.native
  /**

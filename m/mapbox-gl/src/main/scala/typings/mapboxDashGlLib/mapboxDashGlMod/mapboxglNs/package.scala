...
package object mapboxglNs {
  ...
  type LngLatLike = LngLat | mapboxDashGlLib.Anon_Lng | mapboxDashGlLib.Anon_Lon | (js.Tuple2[scala.Double, scala.Double])
  ...
  type MapboxGeoJSONFeature = (geojsonLib.geojsonMod.Feature[geojsonLib.geojsonMod.Geometry, geojsonLib.geojsonMod.GeoJsonProperties]) with mapboxDashGlLib.Anon_Layer

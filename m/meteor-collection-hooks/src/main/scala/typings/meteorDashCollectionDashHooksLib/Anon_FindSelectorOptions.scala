...
trait Anon_FindSelectorOptions[T] extends js.Object {
  ...
  def find(selector: java.lang.String, options: Anon_SortSkipLimit): meteorDashTypingsLib.MongoNs.Cursor[T] = js.native
  def find(selector: meteorDashTypingsLib.MongoNs.ObjectID): meteorDashTypingsLib.MongoNs.Cursor[T] = js.native
  def find(selector: meteorDashTypingsLib.MongoNs.ObjectID, options: Anon_SortSkipLimit): meteorDashTypingsLib.MongoNs.Cursor[T] = js.native
  def find(selector: meteorDashTypingsLib.MongoNs.Selector): meteorDashTypingsLib.MongoNs.Cursor[T] = js.native
  def find(selector: meteorDashTypingsLib.MongoNs.Selector, options: Anon_SortSkipLimit): meteorDashTypingsLib.MongoNs.Cursor[T] = js.native
  def findOne(): T = js.native
  def findOne(selector: java.lang.String): T = js.native
  def findOne(selector: java.lang.String, options: Anon_SortSkipFields): T = js.native
  def findOne(selector: meteorDashTypingsLib.MongoNs.ObjectID): T = js.native
  def findOne(selector: meteorDashTypingsLib.MongoNs.ObjectID, options: Anon_SortSkipFields): T = js.native
  def findOne(selector: meteorDashTypingsLib.MongoNs.Selector): T = js.native
  def findOne(selector: meteorDashTypingsLib.MongoNs.Selector, options: Anon_SortSkipFields): T = js.native

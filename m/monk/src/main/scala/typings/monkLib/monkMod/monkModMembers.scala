...
object monkModMembers extends js.Object {
  ...
  def default(database: java.lang.String, options: monkLib.Anon_CollectionOptions): js.Promise[IMonkManager] with IMonkManager = js.native
  def default(database: js.Array[java.lang.String]): js.Promise[IMonkManager] with IMonkManager = js.native
  def default(database: js.Array[java.lang.String], options: monkLib.Anon_CollectionOptions): js.Promise[IMonkManager] with IMonkManager = js.native

...
class ICollection[T] () extends js.Object {
  ...
  def dropIndex(): js.Promise[monkLib.Anon_NIndexesWas] = js.native
  def dropIndex(fields: TFields): js.Promise[monkLib.Anon_NIndexesWas] = js.native
  def dropIndex(fields: TFields, options: js.Object): js.Promise[monkLib.Anon_NIndexesWas] = js.native
  def dropIndexes(): js.Promise[monkLib.Anon_NIndexesWasMsg] = js.native
  ...
  def stats(): js.Promise[monkLib.Anon_Ns] = js.native
  def stats(options: js.Object): js.Promise[monkLib.Anon_Ns] = js.native
  def update(query: TQuery, update: js.Object): js.Promise[monkLib.Anon_Ok] = js.native
  def update(query: TQuery, update: js.Object, options: js.Object): js.Promise[monkLib.Anon_Ok] = js.native
}

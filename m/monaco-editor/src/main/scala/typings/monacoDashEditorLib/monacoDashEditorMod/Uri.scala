...
class Uri () extends UriComponents {
  ...
  def `with`(change: monacoDashEditorLib.Anon_Scheme): Uri = js.native
}
...
object Uri extends js.Object {
  ...
  def from(components: monacoDashEditorLib.Anon_SchemeAuthority): monacoDashEditorLib.monacoDashEditorMod.Uri = js.native

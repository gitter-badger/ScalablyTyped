...
object utilsNs extends js.Object {
  ...
  def getError(): nodeLib.Error with stdLib.Error = js.native
  /**
    * Generate an undefined error if `err` is not defined.
    *
    * @see https://mochajs.org/api/module-utils.html#.getError
    */
  def getError(err: nodeLib.Error with stdLib.Error): nodeLib.Error with stdLib.Error = js.native
  /**
  ...
  /**
    ...
    */
  def undefinedError(): nodeLib.Error with stdLib.Error = js.native
}

...
trait Static extends Utils {
  ...
  def applyBindings(viewModel: ViewModel, node: underscoreLib.underscoreMod.Global.Element with stdLib.Element): js.Any = js.native
  ...
  def releaseOnNodeRemove(viewmodel: ViewModel, node: underscoreLib.underscoreMod.Global.Element with stdLib.Element): js.Any = js.native

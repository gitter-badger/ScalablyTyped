...
trait JSONErrorOptions extends js.Object {
  /**
    ...
    */
  var format: js.UndefOr[js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* obj */ js.Any, _]] = js.undefined
  /**
    ...
    */
  var postFormat: js.UndefOr[js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* obj */ js.Any, _]] = js.undefined
  /**
    * Perform some task before calling `options.format`. Must be a function with the original err as its only argument.
    */
  var preFormat: js.UndefOr[js.Function1[/* err */ nodeLib.Error with stdLib.Error, _]] = js.undefined
}

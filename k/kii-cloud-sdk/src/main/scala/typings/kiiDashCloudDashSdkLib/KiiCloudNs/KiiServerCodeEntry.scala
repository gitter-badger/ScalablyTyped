...
class KiiServerCodeEntry () extends js.Object {
  ...
  def execute[T](argument: T, callbacks: kiiDashCloudDashSdkLib.Anon_SuccessEntry[T]): js.Promise[js.Tuple3[KiiServerCodeEntry, T, KiiServerCodeExecResult]] = js.native
  /**
    * Get the entryName of this server code entry.
    *
    * @return entryName.
    */
  def getEntryName(): java.lang.String = js.native
}

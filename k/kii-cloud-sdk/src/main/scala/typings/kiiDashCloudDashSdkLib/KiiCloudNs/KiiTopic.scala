...
class KiiTopic () extends js.Object {
  ...
  def deleteTopic(callbacks: kiiDashCloudDashSdkLib.Anon_SuccessTopic): js.Promise[KiiTopic] = js.native
  /**
  ...
  def exists(callbacks: kiiDashCloudDashSdkLib.Anon_SuccessExisted): js.Promise[scala.Boolean] = js.native
  /**
  ...
  def save(callbacks: kiiDashCloudDashSdkLib.Anon_SuccessTopic): js.Promise[KiiTopic] = js.native
  /**
  ...
  def sendMessage[T](message: T, callbacks: kiiDashCloudDashSdkLib.Anon_SuccessTopicMessage[T]): js.Promise[js.Tuple2[KiiTopic, T]] = js.native
}

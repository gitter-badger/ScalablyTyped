...
class KiiPushSubscription () extends js.Object {
  ...
  def isSubscribed[T /* <: KiiBucket | KiiTopic */](target: T, callbacks: kiiDashCloudDashSdkLib.Anon_SuccessSubscriptionTopic[T]): js.Promise[js.Tuple3[KiiPushSubscription, T, scala.Boolean]] = js.native
  /**
  ...
  def subscribe[T /* <: KiiBucket | KiiTopic */](target: T, callbacks: kiiDashCloudDashSdkLib.Anon_SuccessSubscription[T]): js.Promise[js.Tuple2[KiiPushSubscription, T]] = js.native
  /**
  ...
  def unsubscribe[T /* <: KiiBucket | KiiTopic */](target: T, callbacks: kiiDashCloudDashSdkLib.Anon_SuccessSubscription[T]): js.Promise[js.Tuple2[KiiPushSubscription, T]] = js.native
}

...
object KiiSocialConnect extends js.Object {
  /**
    ...
    */
  def getAccessTokenExpirationForNetwork(networkName: kiiDashCloudDashSdkLib.KiiCloudNs.KiiSocialNetworkName): java.lang.String = js.native
  /**
    ...
    */
  def getAccessTokenForNetwork(networkName: kiiDashCloudDashSdkLib.KiiCloudNs.KiiSocialNetworkName): java.lang.String = js.native
  /**
    ...
    */
  def getAccessTokenObjectForNetwork(networkName: kiiDashCloudDashSdkLib.KiiCloudNs.KiiSocialNetworkName): js.Any = js.native
  /**
  ...
  def linkCurrentUserWithNetwork(
    networkName: kiiDashCloudDashSdkLib.KiiCloudNs.KiiSocialNetworkName,
    options: kiiDashCloudDashSdkLib.KiiCloudNs.KiiSocialConnectOptions,
    callbacks: kiiDashCloudDashSdkLib.Anon_SuccessUser
  ): js.Promise[
    js.Tuple2[
      kiiDashCloudDashSdkLib.KiiCloudNs.KiiUser, 
      kiiDashCloudDashSdkLib.KiiCloudNs.KiiSocialNetworkName

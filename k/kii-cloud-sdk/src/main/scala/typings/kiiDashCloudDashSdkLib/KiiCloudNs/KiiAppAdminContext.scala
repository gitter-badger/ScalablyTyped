...
class KiiAppAdminContext () extends js.Object {
  ...
  def findUserByEmail(email: java.lang.String, callbacks: kiiDashCloudDashSdkLib.Anon_SuccessAdminContextTheMatchedUser): js.Promise[js.Tuple2[KiiAppAdminContext, KiiUser]] = js.native
  /**
  ...
  def findUserByPhone(phone: java.lang.String, callbacks: kiiDashCloudDashSdkLib.Anon_SuccessAdminContextTheMatchedUser): js.Promise[js.Tuple2[KiiAppAdminContext, KiiUser]] = js.native
  /**
  ...
  def findUserByUsername(
    ...
    callbacks: kiiDashCloudDashSdkLib.Anon_SuccessAdminContextTheMatchedUser
  ): js.Promise[js.Tuple2[KiiAppAdminContext, KiiUser]] = js.native
  /**
  ...
  def loadThingWithThingID(thingID: java.lang.String, callbacks: kiiDashCloudDashSdkLib.Anon_SuccessThing): js.Promise[KiiThing] = js.native
  /**
  ...
  def loadThingWithVendorThingID(vendorThingID: java.lang.String, callbacks: kiiDashCloudDashSdkLib.Anon_SuccessThing): js.Promise[KiiThing] = js.native
  /**
  ...
  def registerGroupWithOwnerAndID(
    ...
    user: java.lang.String,
    members: js.Array[KiiUser],
    callbacks: kiiDashCloudDashSdkLib.Anon_SuccessAdminContext
  ): js.Promise[KiiAppAdminContext] = js.native
  /**
  ...
  def registerOwnerWithThingID[T /* <: KiiUser | KiiGroup */](thingID: java.lang.String, owner: T, callbacks: kiiDashCloudDashSdkLib.Anon_SuccessGroup[T]): js.Promise[T] = js.native
  /**
    * Register user/group as owner of specified thing by app admin.
    *
  ...
  def registerOwnerWithVendorThingID[T /* <: KiiUser | KiiGroup */](vendorThingID: java.lang.String, owner: T, callbacks: kiiDashCloudDashSdkLib.Anon_SuccessGroup[T]): js.Promise[T] = js.native
  /**
  ...
  def registerThing(fields: KiiThingFields, callbacks: kiiDashCloudDashSdkLib.Anon_SuccessThing): js.Promise[KiiThing] = js.native
  /**

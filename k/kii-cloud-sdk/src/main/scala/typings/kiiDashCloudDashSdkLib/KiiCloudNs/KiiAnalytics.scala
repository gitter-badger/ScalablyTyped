...
object KiiAnalytics extends js.Object {
  ...
  def trackEventWithExtrasAndCallbacks(eventName: java.lang.String, extras: js.Any, callbacks: kiiDashCloudDashSdkLib.Anon_SuccessFailure): js.Promise[scala.Unit] = js.native
}

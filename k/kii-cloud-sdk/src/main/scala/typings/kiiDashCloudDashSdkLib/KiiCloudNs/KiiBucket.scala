...
class KiiBucket () extends js.Object {
  ...
  def count(callbacks: kiiDashCloudDashSdkLib.Anon_SuccessBucket): js.Promise[js.Tuple3[KiiBucket, KiiQuery, scala.Double]] = js.native
  /**
  ...
  def countWithQuery(query: KiiQuery, callbacks: kiiDashCloudDashSdkLib.Anon_SuccessBucket): js.Promise[js.Tuple3[KiiBucket, KiiQuery, scala.Double]] = js.native
  /**
  ...
  /**
    ...
    */
  def createObjectWithID(objectID: java.lang.String): KiiObject = js.native
  /**
    ...
    */
  def createObjectWithType(`type`: java.lang.String): KiiObject = js.native
  /**
  ...
  def delete(callbacks: kiiDashCloudDashSdkLib.Anon_SuccessDeletedBucket): js.Promise[KiiBucket] = js.native
  /**
  ...
  def executeQuery[T](query: KiiQuery, callbacks: kiiDashCloudDashSdkLib.Anon_SuccessQueryPerformed[T]): js.Promise[js.Tuple3[KiiQuery, js.Array[T], KiiQuery]] = js.native
  /**
    * The name of this bucket
    *
    */
  def getBucketName(): java.lang.String = js.native
}

...
class KiiThing () extends js.Object {
  ...
  def deleteThing(callbacks: kiiDashCloudDashSdkLib.Anon_SuccessThing): js.Promise[KiiThing] = js.native
  /**
    * Disable the thing.
    * <br>This API is authorized by owner of thing.
    * <br>Need user login who owns this thing before execute this API.
  ...
  def disable(callbacks: kiiDashCloudDashSdkLib.Anon_SuccessThing): js.Promise[KiiThing] = js.native
  /**
    * Enable the thing.
    * <br>This API is authorized by owner of thing.
    * <br>Need user login who owns this thing before execute this API.
  ...
  def enable(callbacks: kiiDashCloudDashSdkLib.Anon_SuccessThing): js.Promise[KiiThing] = js.native
  /**
  ...
  def isOwner[T /* <: KiiUser | KiiGroup */](owner: T, callbacks: kiiDashCloudDashSdkLib.Anon_SuccessThingUser[T]): js.Promise[js.Tuple3[KiiThing, T, scala.Boolean]] = js.native
  /**
  ...
  def refresh(callbacks: kiiDashCloudDashSdkLib.Anon_SuccessThing): js.Promise[KiiThing] = js.native
  /**
  ...
  def registerOwner[T /* <: KiiUser | KiiGroup */](owner: T, callbacks: kiiDashCloudDashSdkLib.Anon_SuccessThingGroup[T]): js.Promise[js.Tuple2[KiiThing, T]] = js.native
  /**
  ...
  def unregisterOwner[T /* <: KiiUser | KiiGroup */](owner: T, callbacks: kiiDashCloudDashSdkLib.Anon_SuccessThingGroup[T]): js.Promise[js.Tuple2[KiiThing, T]] = js.native
  /**
  ...
  def update(callbacks: kiiDashCloudDashSdkLib.Anon_SuccessThing): js.Promise[KiiThing] = js.native
}
...
object KiiThing extends js.Object {
  ...
  def loadWithThingID(thingID: java.lang.String, callbacks: kiiDashCloudDashSdkLib.Anon_SuccessThing): js.Promise[kiiDashCloudDashSdkLib.KiiCloudNs.KiiThing] = js.native
  /**
  ...
  def loadWithVendorThingID(vendorThingID: java.lang.String, callbacks: kiiDashCloudDashSdkLib.Anon_SuccessThing): js.Promise[kiiDashCloudDashSdkLib.KiiCloudNs.KiiThing] = js.native
  /**
  ...
  def register(
    ...
    callbacks: kiiDashCloudDashSdkLib.Anon_SuccessThing
  ...
  def registerOwnerWithThingID[T /* <: kiiDashCloudDashSdkLib.KiiCloudNs.KiiUser | kiiDashCloudDashSdkLib.KiiCloudNs.KiiGroup */](thingID: java.lang.String, owner: T, callbacks: kiiDashCloudDashSdkLib.Anon_SuccessGroup[T]): js.Promise[T] = js.native
  /**
    * Register user/group as owner of specified thing.
    * <br>Need user login before execute this API.
    * <br>Note: if you obtain thing instance from {@link KiiAppAdminContext},
  ...
  def registerOwnerWithVendorThingID[T /* <: kiiDashCloudDashSdkLib.KiiCloudNs.KiiUser | kiiDashCloudDashSdkLib.KiiCloudNs.KiiGroup */](vendorThingID: java.lang.String, owner: T, callbacks: kiiDashCloudDashSdkLib.Anon_SuccessGroup[T]): js.Promise[T] = js.native
}

...
class KiiACL () extends js.Object {
  ...
  def listACLEntries(callbacks: kiiDashCloudDashSdkLib.Anon_SuccessTheACL): js.Promise[js.Tuple2[KiiACL, js.Array[KiiACLEntry]]] = js.native
  /**
  ...
  def save(callbacks: kiiDashCloudDashSdkLib.Anon_SuccessTheSavedACL): js.Promise[KiiACL] = js.native
}

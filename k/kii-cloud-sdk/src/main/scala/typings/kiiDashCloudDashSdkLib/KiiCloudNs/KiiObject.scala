...
class KiiObject () extends js.Object {
  ...
  def delete(callbacks: kiiDashCloudDashSdkLib.Anon_SuccessTheDeletedObject): js.Promise[KiiObject] = js.native
  /**
  ...
  def deleteBody(callbacks: kiiDashCloudDashSdkLib.Anon_SuccessTheDeletedObject): js.Promise[KiiObject] = js.native
  /**
  ...
  def downloadBody(callbacks: kiiDashCloudDashSdkLib.Anon_SuccessObjBodyBlob): js.Promise[js.Tuple2[KiiObject, stdLib.Blob]] = js.native
  /**
  ...
  def moveBody(targetObjectUri: java.lang.String, callbacks: kiiDashCloudDashSdkLib.Anon_SuccessTheSrcObject): js.Promise[js.Tuple2[KiiObject, java.lang.String]] = js.native
  /**
  ...
  def publishBody(callbacks: kiiDashCloudDashSdkLib.Anon_SuccessObjPublishedUrl): js.Promise[js.Tuple2[KiiObject, java.lang.String]] = js.native
  /**
  ...
  def publishBodyExpiresAt(expiresAt: stdLib.Date, callbacks: kiiDashCloudDashSdkLib.Anon_SuccessObjPublishedUrl): js.Promise[js.Tuple2[KiiObject, java.lang.String]] = js.native
  /**
  ...
  def publishBodyExpiresIn(expiresIn: scala.Double, callbacks: kiiDashCloudDashSdkLib.Anon_SuccessObjPublishedUrl): js.Promise[js.Tuple2[KiiObject, java.lang.String]] = js.native
  /**
  ...
  def refresh(callbacks: kiiDashCloudDashSdkLib.Anon_SuccessTheRefreshedObject): js.Promise[KiiObject] = js.native
  /**
  ...
  def save(callbacks: kiiDashCloudDashSdkLib.Anon_SuccessTheSavedObject): js.Promise[KiiObject] = js.native
  def save(callbacks: kiiDashCloudDashSdkLib.Anon_SuccessTheSavedObject, overwrite: scala.Boolean): js.Promise[KiiObject] = js.native
  /**
    * Create or update the KiiObject on KiiCloud.
    * <br><br>When call this method for the object that has not saved on cloud, will send all fields.
  ...
  def saveAllFields(callbacks: kiiDashCloudDashSdkLib.Anon_SuccessTheSavedObject): js.Promise[KiiObject] = js.native
  def saveAllFields(callbacks: kiiDashCloudDashSdkLib.Anon_SuccessTheSavedObject, overwrite: scala.Boolean): js.Promise[KiiObject] = js.native
  /**
  ...
  def uploadBody(srcDataBlob: stdLib.Blob, callbacks: kiiDashCloudDashSdkLib.Anon_SuccessObj): js.Promise[KiiObject] = js.native
}

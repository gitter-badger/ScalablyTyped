...
class KiiPushInstallation () extends js.Object {
  ...
  def getMqttEndpoint(
    ...
    callbacks: kiiDashCloudDashSdkLib.Anon_SuccessResponseFailureError
  ): js.Promise[KiiMqttEndpoint] = js.native
  /**
  ...
  def installGcm(
    ...
    callbacks: kiiDashCloudDashSdkLib.Anon_SuccessResponse
  ...
  def installMqtt(development: scala.Boolean, callbacks: kiiDashCloudDashSdkLib.Anon_SuccessResponseFailure): js.Promise[KiiMqttInstallationResponse] = js.native
  /**
  ...
  def uninstallByInstallationID(installationID: java.lang.String, callbacks: kiiDashCloudDashSdkLib.Anon_SuccessFailure): js.Promise[scala.Unit] = js.native
}

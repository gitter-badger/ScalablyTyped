...
class ExternalServerAccess () extends js.Object {
  ...
  def callURL(
    ...
    parameters: knuddelsDashUserappsDashApiLib.Anon_OnSuccessResponseDataExternalServerResponse
  ...
  def getURL(urlString: java.lang.String, parameters: knuddelsDashUserappsDashApiLib.Anon_OnSuccess): scala.Unit = js.native
  /**
  ...
  def postURL(urlString: java.lang.String, parameters: knuddelsDashUserappsDashApiLib.Anon_OnSuccessResponseData): scala.Unit = js.native
  /**
  ...
  def touchURL(urlString: java.lang.String, parameters: knuddelsDashUserappsDashApiLib.Anon_OnSuccess): scala.Unit = js.native
}

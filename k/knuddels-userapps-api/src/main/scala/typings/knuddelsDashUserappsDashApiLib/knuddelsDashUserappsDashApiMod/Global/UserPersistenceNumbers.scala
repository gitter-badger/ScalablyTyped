...
object UserPersistenceNumbers extends js.Object {
  ...
  def addNumber(
    ...
    value: scala.Double,
    parameters: knuddelsDashUserappsDashApiLib.Anon_MinimumValueMaximumValue
  ...
  def each(
    ...
    parameters: knuddelsDashUserappsDashApiLib.Anon_AscendingMinimumValueMaximumValue
  ): scala.Unit = js.native
  /**
  ...
  def getCount(key: java.lang.String, parameters: knuddelsDashUserappsDashApiLib.Anon_MinimumValue): scala.Double = js.native
  /**
  ...
  def getSortedEntries(key: java.lang.String, parameters: knuddelsDashUserappsDashApiLib.Anon_Ascending): js.Array[
    knuddelsDashUserappsDashApiLib.knuddelsDashUserappsDashApiMod.Global.UserPersistenceNumberEntry
  ] = js.native
  /**
  ...
  def getSortedEntriesAdjacent(
    key: java.lang.String,
    user_or_userId: knuddelsDashUserappsDashApiLib.knuddelsDashUserappsDashApiMod.Global.User,
    parameters: knuddelsDashUserappsDashApiLib.Anon_AscendingCount
  ): js.Array[
    knuddelsDashUserappsDashApiLib.knuddelsDashUserappsDashApiMod.Global.UserPersistenceNumberEntry
  ] = js.native

...
object GanttDependency extends js.Object {
  ...
  def define(options: kendoDashUiLib.kendoNs.dataNs.DataSourceSchemaModelWithFieldsArray): kendoDashUiLib.Anon_IdFieldFieldsDefineOptionsData = js.native
  def define(options: kendoDashUiLib.kendoNs.dataNs.DataSourceSchemaModelWithFieldsObject): kendoDashUiLib.Anon_IdFieldFieldsDefineOptionsData = js.native
}

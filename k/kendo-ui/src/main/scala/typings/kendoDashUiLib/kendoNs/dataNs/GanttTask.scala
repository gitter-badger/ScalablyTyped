...
object GanttTask extends js.Object {
  ...
  def define(options: kendoDashUiLib.kendoNs.dataNs.DataSourceSchemaModelWithFieldsArray): kendoDashUiLib.Anon_IdFieldFieldsDefineOptions = js.native
  def define(options: kendoDashUiLib.kendoNs.dataNs.DataSourceSchemaModelWithFieldsObject): kendoDashUiLib.Anon_IdFieldFieldsDefineOptions = js.native
}

...
object kendoNsMembers extends js.Object {
  ...
  var keys: kendoDashUiLib.Anon_INSERT = js.native
  ...
  def culture(): kendoDashUiLib.Anon_Name = js.native
  ...
  def widgetInstance(element: kendoDashUiLib.JQuery, suite: kendoDashUiLib.Anon_Progress): kendoDashUiLib.kendoNs.uiNs.Widget = js.native
  def widgetInstance(element: kendoDashUiLib.JQuery, suite: kendoDashUiLib.Anon_RegisterTheme): kendoDashUiLib.kendoNs.uiNs.Widget = js.native
  def widgetInstance(element: kendoDashUiLib.JQuery, suite: kendoDashUiLib.Anon_Widget): kendoDashUiLib.kendoNs.uiNs.Widget = js.native
}

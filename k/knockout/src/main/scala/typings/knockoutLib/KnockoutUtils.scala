...
trait KnockoutUtils extends js.Object {
  ...
  // utils.domData.js
  //////////////////////////////////
  var domData: Anon_Get = js.native
  //////////////////////////////////
  ...
  def unwrapObservable[T](value: js.Array[T]): js.Array[T] = js.native
  def unwrapObservable[T](value: KnockoutObservable[T]): T = js.native
  def unwrapObservable[T](value: KnockoutObservableArray[T]): js.Array[T] = js.native
}

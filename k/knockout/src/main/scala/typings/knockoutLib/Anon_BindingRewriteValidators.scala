...
trait Anon_BindingRewriteValidators extends js.Object {
  ...
  def parseObjectLiteral(objectLiteralString: java.lang.String): js.Array[_] = js.native
  def writeValueToProperty(property: js.Any, allBindings: KnockoutAllBindingsAccessor, key: java.lang.String, value: js.Any): scala.Unit = js.native
  def writeValueToProperty(
    property: js.Any,
    allBindings: KnockoutAllBindingsAccessor,
    key: java.lang.String,
    value: js.Any,
    checkIfDifferent: scala.Boolean

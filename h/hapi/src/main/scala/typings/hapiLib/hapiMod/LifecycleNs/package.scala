...
package object LifecycleNs {
  ...
  type ReturnValueTypes = scala.Null | java.lang.String | scala.Double | scala.Boolean | nodeLib.Buffer | (nodeLib.Error with stdLib.Error) | boomLib.boomMod.namespaced[js.Any] | nodeLib.streamMod.Stream | js.Object | js.Array[js.Object] | js.Symbol | hapiLib.hapiMod.ResponseToolkit
}

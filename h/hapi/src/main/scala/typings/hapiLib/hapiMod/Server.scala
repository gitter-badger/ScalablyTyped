...
class Server () extends js.Object {
  ...
  /**
    ...
    */
  var listener: nodeLib.httpMod.Server = js.native
  /**
  ...
  /**
    ...
    */
  val methods: hapiLib.hapiMod.UtilNs.Dictionary[ServerMethod] = js.native
  /**
  ...
  /**
    ...
    */
  val `type`: hapiLib.hapiLibStrings.socket | hapiLib.hapiLibStrings.tcp = js.native
  /**
  ...
  /**
    ...
    */
  def bind(context: js.Object): scala.Unit = js.native
  /**
  ...
  /**
    * [See docs](https://github.com/hapijs/hapi/blob/master/API.md#-servercacheoptions)
    */
  def cache[T, O /* <: CachePolicyOptions[T] */](options: O): catboxLib.catboxMod.Policy[T, O] = js.native
  /**
    ...
    * are called, where:
    */
  def control(server: Server): scala.Unit = js.native
  /**
  ...
  def decoder(
    ...
    decoder: js.Function1[/* options */ PayloadCompressionDecoderSettings, nodeLib.zlibMod.Gunzip]
  ...
  /**
    ...
    */
  @JSName("decorate")
  def decorate_handler(`type`: hapiLib.hapiLibStrings.handler, property: DecorateName, method: HandlerDecorationMethod): scala.Unit = js.native
  @JSName("decorate")
  ...
  def decorate_request(
    ...
    options: hapiLib.Anon_ApplyTrue
  ): scala.Unit = js.native
  @JSName("decorate")
  def decorate_request(
    `type`: hapiLib.hapiLibStrings.request,
    ...
    options: hapiLib.Anon_ApplyTrueExtend
  ): scala.Unit = js.native
  @JSName("decorate")
  ...
  def encoder(
    encoding: java.lang.String,
    encoder: js.Function1[/* options */ RouteCompressionEncoderSettings, nodeLib.zlibMod.Gzip]
  ): scala.Unit = js.native
  /**
    ...
    * [See docs](https://github.com/hapijs/hapi/blob/master/API.md#-serverevents)
    */
  def event(events: ServerEventsApplication): scala.Unit = js.native
  def event(events: js.Array[ServerEventsApplication]): scala.Unit = js.native
  /**
    ...
    */
  def expose(key: java.lang.String, value: js.Any): scala.Unit = js.native
  /**
    ...
    */
  def expose(obj: js.Object): scala.Unit = js.native
  /**
    ...
    */
  def ext(event: ServerExtType, method: ServerExtPointFunction): scala.Unit = js.native
  def ext(event: ServerExtType, method: ServerExtPointFunction, options: ServerExtOptions): scala.Unit = js.native
  def ext(event: ServerRequestExtType, method: hapiLib.hapiMod.LifecycleNs.Method): scala.Unit = js.native
  def ext(event: ServerRequestExtType, method: hapiLib.hapiMod.LifecycleNs.Method, options: ServerExtOptions): scala.Unit = js.native
  /**
    ...
    */
  def ext(events: ServerExtEventsObject): scala.Unit = js.native
  def ext(events: ServerExtEventsRequestObject): scala.Unit = js.native
  def ext(events: js.Array[ServerExtEventsObject | ServerExtEventsRequestObject]): scala.Unit = js.native
  /**
  ...
  def log(tags: java.lang.String, data: java.lang.String, timestamp: scala.Double): scala.Unit = js.native
  def log(tags: java.lang.String, data: js.Function0[_]): scala.Unit = js.native
  def log(tags: java.lang.String, data: js.Function0[_], timestamp: scala.Double): scala.Unit = js.native
  def log(tags: java.lang.String, data: js.Object): scala.Unit = js.native
  def log(tags: java.lang.String, data: js.Object, timestamp: scala.Double): scala.Unit = js.native
  ...
  def log(tags: js.Array[java.lang.String], data: java.lang.String, timestamp: scala.Double): scala.Unit = js.native
  def log(tags: js.Array[java.lang.String], data: js.Function0[_]): scala.Unit = js.native
  def log(tags: js.Array[java.lang.String], data: js.Function0[_], timestamp: scala.Double): scala.Unit = js.native
  def log(tags: js.Array[java.lang.String], data: js.Object): scala.Unit = js.native
  def log(tags: js.Array[java.lang.String], data: js.Object, timestamp: scala.Double): scala.Unit = js.native
  /**
    ...
    */
  def lookup(id: java.lang.String): RequestRoute | scala.Null = js.native
  /**
    * Looks up a route configuration where:
    ...
    */
  def `match`(method: hapiLib.hapiMod.UtilNs.HTTP_METHODS, path: java.lang.String): RequestRoute | scala.Null = js.native
  def `match`(method: hapiLib.hapiMod.UtilNs.HTTP_METHODS, path: java.lang.String, host: java.lang.String): RequestRoute | scala.Null = js.native
  /**
    ...
    */
  def method(methods: ServerMethodConfigurationObject): scala.Unit = js.native
  def method(methods: js.Array[ServerMethodConfigurationObject]): scala.Unit = js.native
  /**
    ...
    */
  def method(name: java.lang.String, method: ServerMethod): scala.Unit = js.native
  def method(name: java.lang.String, method: ServerMethod, options: ServerMethodOptions): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def route(route: ServerRoute): scala.Unit = js.native
  def route(route: js.Array[ServerRoute]): scala.Unit = js.native
  /**
    ...
    */
  def rules(processor: js.Function2[/* rules */ js.Object, /* info */ hapiLib.Anon_Method, js.Object]): scala.Unit = js.native
  def rules(
    processor: js.Function2[/* rules */ js.Object, /* info */ hapiLib.Anon_Method, js.Object],
    options: hapiLib.Anon_Validate
  ): scala.Unit = js.native
  ...
  /**
    ...
    */
  def state(name: java.lang.String): scala.Unit = js.native
  def state(name: java.lang.String, options: ServerStateCookieOptions): scala.Unit = js.native
  /**
  ...
  def table(host: java.lang.String): js.Array[RequestRoute] = js.native
}

...
trait ResponseToolkit extends js.Object {
  ...
  def entity(options: hapiLib.Anon_Etag): js.UndefOr[ResponseObject] = js.native
  /**
  ...
  /**
    ...
    */
  def state(name: java.lang.String, value: java.lang.String): scala.Unit = js.native
  def state(name: java.lang.String, value: java.lang.String, options: ServerStateCookieOptions): scala.Unit = js.native
  def state(name: java.lang.String, value: js.Object): scala.Unit = js.native
  def state(name: java.lang.String, value: js.Object, options: ServerStateCookieOptions): scala.Unit = js.native
  /**
    ...
    */
  def unauthenticated(error: nodeLib.Error with stdLib.Error): scala.Unit = js.native
  def unauthenticated(error: nodeLib.Error with stdLib.Error, data: AuthenticationData): scala.Unit = js.native
  /**
    ...
    */
  def unstate(name: java.lang.String): scala.Unit = js.native
  def unstate(name: java.lang.String, options: ServerStateCookieOptions): scala.Unit = js.native
}

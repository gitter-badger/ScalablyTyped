...
trait Request
  ...
  /**
    ...
    */
  val headers: hapiLib.hapiMod.UtilNs.Dictionary[java.lang.String] = js.native
  /**
    * Request information:
  ...
  /**
    ...
    */
  val method: hapiLib.hapiMod.UtilNs.HTTP_METHODS_PARTIAL_LOWERCASE = js.native
  /**
  ...
  /**
    ...
    */
  val params: hapiLib.hapiMod.UtilNs.Dictionary[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  val pre: hapiLib.hapiMod.UtilNs.Dictionary[_] = js.native
  /**
  ...
  /**
    ...
    */
  val raw: hapiLib.Anon_Req = js.native
  /**
  ...
  /**
    ...
    */
  val state: hapiLib.hapiMod.UtilNs.Dictionary[_] = js.native
  /**
  ...
  def generateResponse(source: java.lang.String, options: hapiLib.Anon_Variety): ResponseObject = js.native
  def generateResponse(source: js.Object): ResponseObject = js.native
  def generateResponse(source: js.Object, options: hapiLib.Anon_Variety): ResponseObject = js.native
  def generateResponse(source: scala.Null, options: hapiLib.Anon_Variety): ResponseObject = js.native
  /**
  ...
  /**
    ...
    */
  def setMethod(method: hapiLib.hapiMod.UtilNs.HTTP_METHODS_PARTIAL): scala.Unit = js.native
  /**

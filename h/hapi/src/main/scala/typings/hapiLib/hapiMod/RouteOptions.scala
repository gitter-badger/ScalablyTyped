...
trait RouteOptions extends js.Object {
  ...
  /**
    ...
    * [See docs](https://github.com/hapijs/hapi/blob/master/API.md#-routeoptionsapp)
    */
  var auth: js.UndefOr[hapiLib.hapiLibNumbers.`false` | java.lang.String | RouteOptionsAccess] = js.undefined
  /**
    * Default value: null.
    ...
    */
  var bind: js.UndefOr[js.Object | scala.Null] = js.undefined
  /**
    ...
    */
  var cache: js.UndefOr[hapiLib.hapiLibNumbers.`false` | RouteOptionsCache] = js.undefined
  /**
    ...
    */
  var compression: js.UndefOr[hapiLib.hapiMod.UtilNs.Dictionary[RouteCompressionEncoderSettings]] = js.undefined
  /**
    ...
    */
  var cors: js.UndefOr[scala.Boolean | RouteOptionsCors] = js.undefined
  /**
    * Default value: none.
  ...
  /**
    ...
    */
  var ext: js.UndefOr[hapiLib.hapiLibStrings.RouteOptions with js.Any] = js.undefined
  /**
    ...
    */
  var files: js.UndefOr[hapiLib.Anon_RelativeTo] = js.undefined
  /**
    * Default value: none.
    ...
    */
  var handler: js.UndefOr[hapiLib.hapiMod.LifecycleNs.Method | js.Object] = js.undefined
  /**
    * Default value: none.
  ...
  /**
    ...
    */
  var isInternal: js.UndefOr[scala.Boolean] = js.undefined
  /**
    * Default value: none.
    ...
    */
  var json: js.UndefOr[hapiLib.hapiMod.JsonNs.StringifyArguments] = js.undefined
  /**
    * Default value: none.
  ...
  /**
    ...
    */
  var log: js.UndefOr[hapiLib.Anon_Collect] = js.undefined
  /**
    * Default value: none.

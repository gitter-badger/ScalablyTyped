...
object namespaced extends js.Object {
  ...
  /**
    * Hls error details
    */
  var ErrorDetails: hlsDotJsLib.Anon_MANIFESTLOADERROR = js.native
  /**
    * Hls error types
    */
  var ErrorTypes: hlsDotJsLib.Anon_NETWORKERROR = js.native
  /**
    * Hls events
    */
  var Events: hlsDotJsLib.Anon_MEDIAATTACHING = js.native
  /**

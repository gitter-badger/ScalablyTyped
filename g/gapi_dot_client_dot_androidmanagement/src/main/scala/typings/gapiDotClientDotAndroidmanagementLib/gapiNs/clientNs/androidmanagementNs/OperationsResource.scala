...
trait OperationsResource extends js.Object {
  /**
    ...
    */
  def cancel(request: gapiDotClientDotAndroidmanagementLib.Anon_XgafvAccesstoken): gapiDotClientLib.gapiNs.clientNs.Request[js.Object]
  /**
  ...
  /**
    ...
    * service.
    */
  def get(request: gapiDotClientDotAndroidmanagementLib.Anon_XgafvAccesstoken): gapiDotClientLib.gapiNs.clientNs.Request[Operation]
  /**
    ...
    * id.
    */
  def list(request: gapiDotClientDotAndroidmanagementLib.Anon_XgafvAccesstokenAlt): gapiDotClientLib.gapiNs.clientNs.Request[ListOperationsResponse]
}

...
package object SubscriptionNs {
  type CloseCallback = js.Function1[/* err */ (nodeLib.Error with stdLib.Error) | scala.Null, scala.Unit]
  ...
  type GetMetadataCallback = js.Function2[
    /* err */ (nodeLib.Error with stdLib.Error) | scala.Null, 
    /* apiResponse */ js.Object, 
    scala.Unit
  ]
  ...
  type SetMetadataCallback = js.Function2[
    /* err */ (nodeLib.Error with stdLib.Error) | scala.Null, 
    /* apiResponse */ js.Object, 
    scala.Unit
  ]

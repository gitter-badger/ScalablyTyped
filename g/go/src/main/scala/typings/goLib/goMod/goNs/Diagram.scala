...
trait Diagram extends js.Object {
  ...
  def makeImage(properties: goLib.Anon_Size): stdLib.HTMLImageElement = js.native
  /**
  ...
  def makeImageData(properties: goLib.Anon_Size): java.lang.String = js.native
  /**
  ...
  def makeSvg(properties: goLib.Anon_SizeScale): stdLib.SVGElement = js.native
    // undocumented

...
trait OperationsResource extends js.Object {
  /**
    ...
    */
  def cancel(request: gapiDotClientDotDataprocLib.Anon_XgafvAccesstokenAltBearertokenCallbackFieldsKey): gapiDotClientLib.gapiNs.clientNs.Request[js.Object]
  /**
    ...
    */
  def delete(request: gapiDotClientDotDataprocLib.Anon_XgafvAccesstokenAltBearertokenCallbackFieldsKey): gapiDotClientLib.gapiNs.clientNs.Request[js.Object]
  /**
    ...
    * service.
    */
  def get(request: gapiDotClientDotDataprocLib.Anon_XgafvAccesstokenAltBearertokenCallbackFieldsKey): gapiDotClientLib.gapiNs.clientNs.Request[Operation]
  /**
    ...
    * id.
    */
  def list(request: gapiDotClientDotDataprocLib.Anon_XgafvAccesstokenAltBearertokenCallbackFieldsFilter): gapiDotClientLib.gapiNs.clientNs.Request[ListOperationsResponse]
}

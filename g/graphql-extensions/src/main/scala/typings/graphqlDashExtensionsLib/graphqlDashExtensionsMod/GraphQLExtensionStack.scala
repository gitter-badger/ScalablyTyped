...
class GraphQLExtensionStack[TContext] protected () extends js.Object {
  def this(extensions: apolloDashEnvLib.libPolyfillsArrayMod.Global.Array[GraphQLExtension[TContext]] with coreDashJsLib.Array[GraphQLExtension[TContext]] with js.Array[GraphQLExtension[TContext]]) = this()
  ...
  def requestDidStart(o: graphqlDashExtensionsLib.Anon_RequestUrl[TContext]): EndHandler = js.native

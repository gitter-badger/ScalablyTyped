...
trait State extends js.Object {
  ...
  def toBuffer(callback: js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* buffer */ nodeLib.Buffer, _]): nodeLib.streamMod.PassThrough = js.native
  def toBuffer(
    format: java.lang.String,
    callback: js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* buffer */ nodeLib.Buffer, _]

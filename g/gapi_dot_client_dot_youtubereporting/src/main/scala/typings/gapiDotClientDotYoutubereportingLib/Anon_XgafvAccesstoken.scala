...
trait Anon_XgafvAccesstoken extends js.Object {
  ...
  var createdAfter: js.UndefOr[java.lang.String] = js.undefined
  ...
  /**
    ...
    */
  var startTimeAtOrAfter: js.UndefOr[java.lang.String] = js.undefined
  /**
    * If set, only reports whose start time is smaller than the specified
    * date/time are returned.
    */
  var startTimeBefore: js.UndefOr[java.lang.String] = js.undefined

...
trait Anon_InitializeMsg
  ...
  def toObjectExtension(
    ...
    getExtensionFn: js.Function1[
      /* fieldInfo */ googleDashProtobufLib.googleDashProtobufMod.ExtensionFieldInfo[googleDashProtobufLib.googleDashProtobufMod.Message], 
      googleDashProtobufLib.googleDashProtobufMod.Message
    ]
  ): scala.Unit = js.native
  def toObjectExtension(
    msg: googleDashProtobufLib.googleDashProtobufMod.Message,

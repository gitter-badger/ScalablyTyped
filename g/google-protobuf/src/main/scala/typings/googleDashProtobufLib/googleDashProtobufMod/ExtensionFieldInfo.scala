...
class ExtensionFieldInfo[T] protected () extends js.Object {
  def this(fieldIndex: scala.Double, fieldName: org.scalablytyped.runtime.StringDictionary[scala.Double], ctor: googleDashProtobufLib.Anon_InitializeMsg, toObjectFn: googleDashProtobufLib.googleDashProtobufMod.MessageNs.StaticToObject, isRepeated: scala.Double) = this()
  var ctor: googleDashProtobufLib.Anon_InitializeMsg = js.native

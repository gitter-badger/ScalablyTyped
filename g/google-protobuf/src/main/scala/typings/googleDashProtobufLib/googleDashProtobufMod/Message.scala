...
object Message extends js.Object {
  ...
  def getMapField(
    ...
    valueCtor: googleDashProtobufLib.Anon_Initialize
  ...
  def registerMessageType(id: scala.Double, constructor: googleDashProtobufLib.Anon_Initialize): scala.Unit = js.native

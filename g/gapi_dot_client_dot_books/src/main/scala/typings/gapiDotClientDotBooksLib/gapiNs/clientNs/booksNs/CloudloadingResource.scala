...
trait CloudloadingResource extends js.Object {
  ...
  def updateBook(request: gapiDotClientDotBooksLib.Anon_AltFieldsKeyOauthtokenPrettyPrintQuotaUserUserIpString): gapiDotClientLib.gapiNs.clientNs.Request[BooksCloudloadingResource]
}

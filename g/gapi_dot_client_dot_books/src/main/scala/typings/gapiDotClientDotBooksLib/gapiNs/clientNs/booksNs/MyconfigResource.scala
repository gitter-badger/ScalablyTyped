...
trait MyconfigResource extends js.Object {
  ...
  def getUserSettings(request: gapiDotClientDotBooksLib.Anon_AltFieldsKeyOauthtokenPrettyPrintQuotaUserUserIpString): gapiDotClientLib.gapiNs.clientNs.Request[Usersettings]
  ...
  /**
    ...
    */
  def updateUserSettings(request: gapiDotClientDotBooksLib.Anon_AltFieldsKeyOauthtokenPrettyPrintQuotaUserUserIpString): gapiDotClientLib.gapiNs.clientNs.Request[Usersettings]
}

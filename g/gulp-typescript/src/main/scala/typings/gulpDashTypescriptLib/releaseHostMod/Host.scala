...
class Host protected ()
  ...
  def this(typescript: gulpDashTypescriptLib.Anon_VersionMajorMinor, currentDirectory: java.lang.String, input: gulpDashTypescriptLib.releaseInputMod.FileCache, options: typescriptLib.typescriptMod.tsNs.CompilerOptions) = this()
  ...
  var typescript: gulpDashTypescriptLib.Anon_VersionMajorMinor = js.native

...
trait Grid extends js.Object {
  ...
  def exist(
    ...
    callback: js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* found */ scala.Boolean, scala.Unit]
  ): scala.Unit = js.native
  def findOne(
    options: gridfsDashStreamLib.gridfsDashStreamMod.GridFSStreamNs.Options,
    callback: js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* record */ js.Any, scala.Unit]
  ): scala.Unit = js.native
  def remove(
    options: gridfsDashStreamLib.gridfsDashStreamMod.GridFSStreamNs.Options,

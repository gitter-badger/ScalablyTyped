...
trait FailModule extends js.Object {
  def fatal(error: nodeLib.Error with stdLib.Error): scala.Unit = js.native
  def fatal(error: nodeLib.Error with stdLib.Error, errorCode: ErrorCode): scala.Unit = js.native
  /**
  ...
  def warn(error: nodeLib.Error with stdLib.Error): scala.Unit = js.native
  def warn(error: nodeLib.Error with stdLib.Error, errorCode: ErrorCode): scala.Unit = js.native
  /**
    * Display a warning and abort Grunt immediately.

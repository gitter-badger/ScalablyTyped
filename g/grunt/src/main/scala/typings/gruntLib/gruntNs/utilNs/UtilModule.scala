...
trait UtilModule extends js.Object {
  ...
  def error(error: nodeLib.Error with stdLib.Error): nodeLib.Error with stdLib.Error = js.native
  def error(error: nodeLib.Error with stdLib.Error, origError: nodeLib.Error with stdLib.Error): nodeLib.Error with stdLib.Error = js.native
  def error(error: js.Any): nodeLib.Error with stdLib.Error = js.native
  def error(error: js.Any, origError: nodeLib.Error with stdLib.Error): nodeLib.Error with stdLib.Error = js.native
  /**
    ...
    */
  def error(message: java.lang.String): nodeLib.Error with stdLib.Error = js.native
  def error(message: java.lang.String, origError: nodeLib.Error with stdLib.Error): nodeLib.Error with stdLib.Error = js.native
  /**

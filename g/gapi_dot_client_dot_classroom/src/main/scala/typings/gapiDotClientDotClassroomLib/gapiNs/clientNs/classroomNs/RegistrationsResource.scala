...
trait RegistrationsResource extends js.Object {
  /**
    ...
    */
  def create(request: gapiDotClientDotClassroomLib.Anon_XgafvAccesstokenAltBearertokenCallbackFields): gapiDotClientLib.gapiNs.clientNs.Request[Registration]
  /**
    * Deletes a `Registration`, causing Classroom to stop sending notifications
    * for that `Registration`.
    */
  def delete(request: gapiDotClientDotClassroomLib.Anon_XgafvAccesstokenAltBearertokenCallbackFieldsKey): gapiDotClientLib.gapiNs.clientNs.Request[js.Object]
}

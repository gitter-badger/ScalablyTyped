...
trait Diff extends js.Object {
  ...
  // 新增组合
  var addCombo: js.UndefOr[gaeaDashModelLib.Anon_ParentMapUniqueKey] = js.undefined
  // 新增模板
  var addSource: js.UndefOr[gaeaDashModelLib.Anon_ParentMapUniqueKey] = js.undefined
  // 内部交换顺序
  var exchange: js.UndefOr[gaeaDashModelLib.Anon_OldIndex] = js.undefined
  // 操作组件的 mapUniqueKey
  var mapUniqueKey: java.lang.String
  // 移动到另一个父元素
  var move: js.UndefOr[gaeaDashModelLib.Anon_TargetParentMapUniqueKey] = js.undefined
  // 粘贴操作
  var paste: js.UndefOr[DiffRemove] = js.undefined
  // 删除组件
  var remove: js.UndefOr[DiffRemove] = js.undefined
  // 重置组件
  var reset: js.UndefOr[gaeaDashModelLib.Anon_BeforeProps] = js.undefined
  // 操作类型

...
trait OrganizationsResource extends js.Object {
  ...
  def get(request: gapiDotClientDotCloudresourcemanagerLib.Anon_XgafvAccesstokenAlt): gapiDotClientLib.gapiNs.clientNs.Request[Organization]
  /**
  ...
  /**
    ...
    */
  def search(request: gapiDotClientDotCloudresourcemanagerLib.Anon_XgafvAccesstoken): gapiDotClientLib.gapiNs.clientNs.Request[SearchOrganizationsResponse]
  /**

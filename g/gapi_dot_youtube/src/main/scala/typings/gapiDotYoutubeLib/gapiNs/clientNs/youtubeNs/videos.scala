...
trait videos extends js.Object {
  ...
  /**
    ...
    */
  def insert(`object`: gapiDotYoutubeLib.Anon_PartAutoLevels): gapiLib.gapiNs.clientNs.HttpRequest[gapiDotYoutubeLib.GoogleApiYouTubeVideoResource]
  /**
    * Returns a list of videos that match the API request parameters.
    */
  def list(`object`: gapiDotYoutubeLib.Anon_PartChart): gapiLib.gapiNs.clientNs.HttpRequest[
  ...
  /**
    ...
    */
  def rate(`object`: gapiDotYoutubeLib.Anon_IdRating): gapiLib.gapiNs.clientNs.HttpRequest[_]
  /**
    * Updates a video's metadata.
    */
  def update(`object`: gapiDotYoutubeLib.Anon_PartOnBehalfOfContentOwner): gapiLib.gapiNs.clientNs.HttpRequest[gapiDotYoutubeLib.GoogleApiYouTubeVideoResource]
}

...
package object distTransformsTransformRootFieldsMod {
  type RootTransformer = js.Function3[
    ...
    js.UndefOr[
      (graphqlLib.typeDefinitionMod.GraphQLFieldConfig[js.Any, js.Any, org.scalablytyped.runtime.StringDictionary[js.Any]]) | graphqlDashToolsLib.Anon_NameField | scala.Null
    ]
  ]
}

...
- gulpDashUtilLib.gulpDashUtilMod.PluginErrorOptions because var conflicts: message, name, stack. Inlined fileName, lineNumber, showStack, showProperties, plugin, error- stdLib.Error because var conflicts: stack. Inlined message, name */ @JSImport("gulp-util", "PluginError")
@js.native
class PluginError ()
  extends nodeLib.Error {
  def this(options: PluginErrorOptions) = this()
  def this(pluginName: java.lang.String) = this()
  def this(pluginName: java.lang.String, message: nodeLib.Error with stdLib.Error) = this()
  ...
  def this(pluginName: java.lang.String, message: nodeLib.Error with stdLib.Error, options: PluginErrorOptions) = this()
  def this(pluginName: java.lang.String, message: java.lang.String, options: PluginErrorOptions) = this()
  var error: (nodeLib.Error with stdLib.Error) | (js.UndefOr[nodeLib.Error with stdLib.Error]) = js.native
  ...
  /**
  	 ...
  	 */
  var message: js.Any | java.lang.String = js.native
  /**

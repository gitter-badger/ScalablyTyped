...
trait AppsResource extends js.Object {
  ...
  /**
    ...
    */
  def create(request: gapiDotClientDotAppengineLib.Anon_XgafvAccesstokenAltBearertoken): gapiDotClientLib.gapiNs.clientNs.Request[Operation]
  /** Gets information about an application. */
  def get(request: gapiDotClientDotAppengineLib.Anon_Xgafv): gapiDotClientLib.gapiNs.clientNs.Request[Application]
  /**
    ...
    */
  def patch(
    request: gapiDotClientDotAppengineLib.Anon_XgafvAccesstokenAltAppsIdBearertokenCallbackFieldsKeyOauthtokenPpPrettyPrintQuotaUserUpdateMask
  ...
  /**
    ...
    */
  def repair(request: gapiDotClientDotAppengineLib.Anon_Xgafv): gapiDotClientLib.gapiNs.clientNs.Request[Operation]
}

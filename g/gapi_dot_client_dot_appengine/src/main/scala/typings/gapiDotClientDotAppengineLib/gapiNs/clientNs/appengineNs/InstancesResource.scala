...
trait InstancesResource extends js.Object {
  /**
    ...
    */
  def debug(
    request: gapiDotClientDotAppengineLib.Anon_XgafvAccesstokenAltAppsIdBearertokenCallbackFieldsInstancesId
  ...
  /**
    ...
    */
  def list(
    request: gapiDotClientDotAppengineLib.Anon_XgafvAccesstokenAltAppsIdBearertokenCallbackFieldsKeyOauthtokenPageSize

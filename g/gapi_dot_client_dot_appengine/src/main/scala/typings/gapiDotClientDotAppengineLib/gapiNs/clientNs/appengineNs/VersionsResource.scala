...
trait VersionsResource extends js.Object {
  ...
  def create(
    request: gapiDotClientDotAppengineLib.Anon_XgafvAccesstokenAltAppsIdBearertokenCallbackFieldsKeyOauthtokenPp
  ): gapiDotClientLib.gapiNs.clientNs.Request[Operation]
  /** Deletes an existing Version resource. */
  def delete(
    request: gapiDotClientDotAppengineLib.Anon_XgafvAccesstokenAltAppsIdBearertokenCallbackFieldsKeyOauthtokenPpPrettyPrint
  ): gapiDotClientLib.gapiNs.clientNs.Request[Operation]
  /** Gets the specified Version resource. By default, only a BASIC_VIEW will be returned. Specify the FULL_VIEW parameter to get the full resource. */
  def get(
    request: gapiDotClientDotAppengineLib.Anon_XgafvAccesstokenAltAppsIdBearertokenCallbackFieldsKeyOauthtokenPpPrettyPrintQuotaUser
  ): gapiDotClientLib.gapiNs.clientNs.Request[Version]
  /** Lists the versions of a service. */
  def list(
    request: gapiDotClientDotAppengineLib.Anon_XgafvAccesstokenAltAppsIdBearertokenCallbackFieldsKeyOauthtokenPageSizePageToken
  ...
  /**
    ...
    */
  def patch(
    request: gapiDotClientDotAppengineLib.Anon_XgafvAccesstokenAltAppsIdBearertokenCallbackFieldsKeyOauthtokenPpPrettyPrintQuotaUserServicesId
  ): gapiDotClientLib.gapiNs.clientNs.Request[Operation]
}

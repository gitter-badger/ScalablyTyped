...
trait TouchableProps extends js.Object {
  ...
  var onMouseEnter: js.UndefOr[js.Function1[/* args */ gestaltLib.Anon_EventSyntheticEvent, scala.Unit]] = js.undefined
  var onMouseLeave: js.UndefOr[js.Function1[/* args */ gestaltLib.Anon_EventSyntheticEvent, scala.Unit]] = js.undefined
  ...
  def onTouch(args: gestaltLib.Anon_EventSyntheticEventMouseEvent): scala.Unit
}

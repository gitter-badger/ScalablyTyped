...
trait FilterSetsResource extends js.Object {
  ...
  def create(
    request: gapiDotClientDotAdexchangebuyer2Lib.Anon_XgafvAccesstokenAccountIdAltBearertokenCallbackFieldsIsTransient
  ...
  /**
    ...
    */
  def delete(
    request: gapiDotClientDotAdexchangebuyer2Lib.Anon_XgafvAccesstokenAccountIdAltBearertokenCallbackFieldsFilterSetIdKey
  ...
  def list(request: gapiDotClientDotAdexchangebuyer2Lib.Anon_XgafvAccesstokenAccountIdAltBearertokenCallback): gapiDotClientLib.gapiNs.clientNs.Request[ListFilterSetsResponse]
}

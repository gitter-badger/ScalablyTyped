...
package object requestMod {
  ...
  type CommitCallback = js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* result */ CommitResponse, scala.Unit]
  type CommitResult = js.Array[CommitResponse]
  type GetCallback[T] = js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* entity */ T, scala.Unit]
}

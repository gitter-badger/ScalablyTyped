...
trait TranslationsResource extends js.Object {
  ...
  def list(request: gapiDotClientDotTranslateLib.Anon_XgafvAccesstoken): gapiDotClientLib.gapiNs.clientNs.Request[TranslationsListResponse]
  /** Translates input text, returning translated text. */
  def translate(request: gapiDotClientDotTranslateLib.Anon_XgafvAccesstokenAlt): gapiDotClientLib.gapiNs.clientNs.Request[TranslationsListResponse]
}

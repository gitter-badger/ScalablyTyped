...
object readdirNs extends js.Object {
  ...
  def __promisify___buffer(path: nodeLib.fsMod.PathLike, options: gracefulDashFsLib.gracefulDashFsLibStrings.buffer): js.Promise[js.Array[nodeLib.Buffer]] = js.native
}

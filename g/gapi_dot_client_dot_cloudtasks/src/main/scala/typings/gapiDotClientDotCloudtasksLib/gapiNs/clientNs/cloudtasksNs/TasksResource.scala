...
trait TasksResource extends js.Object {
  /**
    ...
    */
  def acknowledge(request: gapiDotClientDotCloudtasksLib.Anon_Xgafv): gapiDotClientLib.gapiNs.clientNs.Request[js.Object]
  /**
    ...
    */
  def cancelLease(request: gapiDotClientDotCloudtasksLib.Anon_Xgafv): gapiDotClientLib.gapiNs.clientNs.Request[Task]
  /**
    ...
    */
  def create(request: gapiDotClientDotCloudtasksLib.Anon_XgafvAccesstoken): gapiDotClientLib.gapiNs.clientNs.Request[Task]
  /**
    * Deletes a task.
    *
  ...
  /** Gets a task. */
  def get(request: gapiDotClientDotCloudtasksLib.Anon_XgafvAccesstokenAlt): gapiDotClientLib.gapiNs.clientNs.Request[Task]
  /**
    ...
    */
  def list(request: gapiDotClientDotCloudtasksLib.Anon_XgafvAccesstokenAltBearertoken): gapiDotClientLib.gapiNs.clientNs.Request[ListTasksResponse]
  /**
    ...
    */
  def pull(request: gapiDotClientDotCloudtasksLib.Anon_Xgafv): gapiDotClientLib.gapiNs.clientNs.Request[PullTasksResponse]
  /**
    ...
    */
  def renewLease(request: gapiDotClientDotCloudtasksLib.Anon_Xgafv): gapiDotClientLib.gapiNs.clientNs.Request[Task]
  /**
    ...
    * already running.
    */
  def run(request: gapiDotClientDotCloudtasksLib.Anon_Xgafv): gapiDotClientLib.gapiNs.clientNs.Request[Task]
}

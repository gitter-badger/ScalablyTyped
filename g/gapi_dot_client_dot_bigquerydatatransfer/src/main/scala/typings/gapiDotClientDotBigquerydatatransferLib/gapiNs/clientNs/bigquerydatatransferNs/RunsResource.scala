...
trait RunsResource extends js.Object {
  ...
  def get(request: gapiDotClientDotBigquerydatatransferLib.Anon_Xgafv): gapiDotClientLib.gapiNs.clientNs.Request[TransferRun]
  /** Returns information about running and completed jobs. */
  def list(request: gapiDotClientDotBigquerydatatransferLib.Anon_XgafvAccesstokenAltBearertoken): gapiDotClientLib.gapiNs.clientNs.Request[ListTransferRunsResponse]
}

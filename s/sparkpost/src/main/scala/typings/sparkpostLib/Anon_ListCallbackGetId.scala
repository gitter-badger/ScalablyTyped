...
@js.native
trait Anon_ListCallbackGetId extends js.Object {
  /**
  ...
  /**
    ...
    */
  def update(id: java.lang.String, subaccount: sparkpostLib.sparkpostMod.SparkPostNs.UpdateSubaccount): sparkpostLib.sparkpostMod.SparkPostNs.ResultsPromise[Anon_MessageString] = js.native
  /**
    * Update an existing subaccount’s information.
    *
    * @param id the id of the subaccount you want to update

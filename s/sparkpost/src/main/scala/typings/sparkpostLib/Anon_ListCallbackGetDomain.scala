...
@js.native
trait Anon_ListCallbackGetDomain extends js.Object {
  /**
    ...
    */
  def create(options: sparkpostLib.sparkpostMod.SparkPostNs.CreateSendingDomain): sparkpostLib.sparkpostMod.SparkPostNs.ResultsPromise[Anon_Message] = js.native
  /**
    * Create a sending domain by providing a sending domain object as the POST request body.
    * @param options The create options
  ...
  /**
    ...
    * @returns Promise The basic info results
    */
  def update(domain: java.lang.String, updateOpts: sparkpostLib.sparkpostMod.SparkPostNs.UpdateSendingDomain): sparkpostLib.sparkpostMod.SparkPostNs.ResultsPromise[Anon_Message] = js.native
  /**
    * Update the attributes of an existing sending domain by specifying its domain name in the URI path and use a sending domain object as the PUT request body.
    * @param domain The domain
    * @param updateOpts The update options

...
@js.native
trait Anon_ListCallbackOptionsGet extends js.Object {
  /**
  ...
  def getBatchStatus(
    id: java.lang.String,
    callback: sparkpostLib.sparkpostMod.SparkPostNs.ResultsCallback[js.Array[Anon_Batchid]]
  ): scala.Unit = js.native
  /**
    * Gets recent status information about a webhook.
    *
    ...
    */
  def getBatchStatus(id: java.lang.String, options: Anon_Limit): sparkpostLib.sparkpostMod.SparkPostNs.ResultsPromise[js.Array[Anon_Batchid]] = js.native
  /**
    * Gets recent status information about a webhook.
    *
    * @param id The id of the webhook

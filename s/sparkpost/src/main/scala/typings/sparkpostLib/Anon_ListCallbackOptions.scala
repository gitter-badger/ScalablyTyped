...
@js.native
trait Anon_ListCallbackOptions extends js.Object {
  /**
  ...
  def list(options: Anon_Campaignid): sparkpostLib.sparkpostMod.SparkPostNs.ResultsPromise[js.Array[sparkpostLib.sparkpostMod.SparkPostNs.TransmissionSummary]] = js.native
  /**
    * List an overview of all transmissions in the account
    *
    * @param callback The request callback with Transmission results array
  ...
  /**
    ...
    */
  def send(transmission: sparkpostLib.sparkpostMod.SparkPostNs.CreateTransmission): sparkpostLib.sparkpostMod.SparkPostNs.ResultsPromise[Anon_Totalrejectedrecipients] = js.native
  /**
    *
    *
    * @param transmission an object of [transmission attributes]{@link https://developers.sparkpost.com/api/transmissions#header-transmission-attributes}
  ...
  def send(
    ...
    callback: sparkpostLib.sparkpostMod.SparkPostNs.ResultsCallback[Anon_Totalrejectedrecipients]
  ): scala.Unit = js.native
  def send(
    transmission: sparkpostLib.sparkpostMod.SparkPostNs.CreateTransmission,
    options: Anon_Numrcpterrors
  ): sparkpostLib.sparkpostMod.SparkPostNs.ResultsPromise[Anon_Totalrejectedrecipients] = js.native
  /**
    * Sends a message by creating a new transmission
    *
    * @param transmission an object of [transmission attributes]{@link https://developers.sparkpost.com/api/transmissions#header-transmission-attributes}

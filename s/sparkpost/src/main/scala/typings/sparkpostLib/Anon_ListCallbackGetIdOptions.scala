...
@js.native
trait Anon_ListCallbackGetIdOptions extends js.Object {
  /**
  ...
  def preview(id: java.lang.String, options: Anon_Substitutiondata): sparkpostLib.sparkpostMod.SparkPostNs.ResultsPromise[sparkpostLib.sparkpostMod.SparkPostNs.TemplateContent] = js.native
  /**
    * Preview the most recent version of an existing template by id
    *
    * @param id the id of the template you want to look up

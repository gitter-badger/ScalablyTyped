...
object GlobalMembers extends js.Object {
  ...
  @JSName("$iq")
  val $iq: js.Function1[/* attrs */ js.UndefOr[js.Any], stropheDotJsLib.stropheDotJsMod.StropheNs.Builder] = js.native
  @JSName("$msg")
  ...
  val Strophe: stropheDotJsLib.Anon_VERSION = js.native
}

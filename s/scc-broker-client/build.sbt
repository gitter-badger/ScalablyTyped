...
version := "6.1-dt-20181218Z-6f37bb"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "sc-broker" % "5.1-dt-20181218Z-88e320",
  ...
  "org.scalablytyped" %%% "socketcluster-client" % "13.0-dt-20181130Z-204877",
  "org.scalablytyped" %%% "socketcluster-server" % "14.2-dt-20190103Z-6daf47",

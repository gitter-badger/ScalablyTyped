...
@js.native
trait Anon_FromChunks extends js.Object {
  /**
  ...
  /**
    ...
    * @returns A new readable stream
    */
  def fromErroredChunks(err: nodeLib.Error with stdLib.Error, chunks: js.Array[streamtestLib.streamtestMod.Chunk]): nodeLib.streamMod.Readable = js.native
  def fromErroredChunks(
  ...
  /**
    ...
    * @returns A new readable stream
    */
  def fromErroredObjects(err: nodeLib.Error with stdLib.Error, objects: js.Array[streamtestLib.streamtestMod.NonNull]): nodeLib.streamMod.Readable = js.native
  def fromErroredObjects(
    err: nodeLib.Error with stdLib.Error,
  ...
  /**
    ...
    * @returns A new writable stream
    */
  def toText(cb: js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* text */ java.lang.String, _]): nodeLib.streamMod.Writable = js.native
  /**

...
package object superagentLib {
  ...
  type CallbackHandler = js.Function2[
    /* err */ js.Any, 
    /* import warning: QualifyReferences.resolveTypeRef Couldn't qualify request.Response */ /* res */ js.Any, 
    scala.Unit
  ]
  type MultipartValue = MultipartValueSingle | js.Array[MultipartValueSingle]
  type MultipartValueSingle = stdLib.Blob | nodeLib.Buffer | (/* import warning: QualifyReferences.resolveTypeRef Couldn't qualify fs.ReadStream */ js.Any) | java.lang.String | scala.Boolean | scala.Double

...
name := "server"
version := "1.0-dt-20180726Z-33eb09"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "csurf" % "1.9.0-dt-20180214Z-e9b604",
  "org.scalablytyped" %%% "express" % "4.16-dt-20180603Z-365ce8",
  "org.scalablytyped" %%% "express-serve-static-core" % "4.16-dt-20180604Z-7df9aa",
  "org.scalablytyped" %%% "express-session" % "1.15-dt-20180901Z-096ba4",
  "org.scalablytyped" %%% "formidable" % "1.0.16-dt-20180409Z-e337a3",

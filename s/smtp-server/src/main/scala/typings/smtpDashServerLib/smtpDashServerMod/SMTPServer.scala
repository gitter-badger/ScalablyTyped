...
class SMTPServer ()
  ...
  var connections: nodeLib.Set[_] with stdLib.Set[_] = js.native
  ...
  @JSName("emit")
  def emit_error(event: smtpDashServerLib.smtpDashServerLibStrings.error, err: nodeLib.Error with stdLib.Error): scala.Boolean = js.native
  ...
  @JSName("listeners")
  def listeners_error(event: smtpDashServerLib.smtpDashServerLibStrings.error): js.Array[js.Function1[/* err */ nodeLib.Error with stdLib.Error, scala.Unit]] = js.native
  @JSName("off")
  ...
  @JSName("rawListeners")
  def rawListeners_error(event: smtpDashServerLib.smtpDashServerLibStrings.error): js.Array[js.Function1[/* err */ nodeLib.Error with stdLib.Error, scala.Unit]] = js.native

...
class List[T] () extends SecurableObject {
  ...
  def get_created(): microsoftDashAjaxLib.Date with stdLib.Date = js.native
  ...
  def get_lastItemDeletedDate(): microsoftDashAjaxLib.Date with stdLib.Date = js.native
  /** Gets a value that specifies the last time a list item, field, or property of the list was modified. */
  def get_lastItemModifiedDate(): microsoftDashAjaxLib.Date with stdLib.Date = js.native
  ...
  def set_lastItemModifiedDate(value: microsoftDashAjaxLib.Date with stdLib.Date): scala.Unit = js.native

...
object DataConvert extends js.Object {
  def createLocalDateTime(milliseconds: scala.Double): microsoftDashAjaxLib.Date with stdLib.Date = js.native
  ...
  ): microsoftDashAjaxLib.Date with stdLib.Date = js.native
  def createUtcDateTime(milliseconds: scala.Double): microsoftDashAjaxLib.Date with stdLib.Date = js.native
  ...
  def getDateTimeKind(datetime: microsoftDashAjaxLib.Date with stdLib.Date): sharepointLib.SPNs.DateTimeKind = js.native
  ...
  def specifyDateTimeKind(datetime: microsoftDashAjaxLib.Date with stdLib.Date, kind: sharepointLib.SPNs.DateTimeKind): scala.Unit = js.native

...
class UpgradeInfo () extends ClientValueObject {
  ...
  def get_lastUpdated(): microsoftDashAjaxLib.Date with stdLib.Date = js.native
  def get_logFile(): java.lang.String = js.native
  def get_requestDate(): microsoftDashAjaxLib.Date with stdLib.Date = js.native
  def get_retryCount(): scala.Double = js.native
  def get_startTime(): microsoftDashAjaxLib.Date with stdLib.Date = js.native

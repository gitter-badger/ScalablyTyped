...
class Client protected ()
  ...
  def setSCServer(scServer: /* import warning: QualifyReferences.resolveTypeRef Couldn't qualify SCServer */ js.Any): scala.Unit = js.native
  def subscribe(
    channel: java.lang.String,
    callback: js.Function1[/* err */ js.UndefOr[nodeLib.Error with stdLib.Error], scala.Unit]
  ): scala.Unit = js.native
  def subscribeSocket(
    socket: /* import warning: QualifyReferences.resolveTypeRef Couldn't qualify SCServerSocket */ js.Any,
    channel: java.lang.String
  ): scala.Unit = js.native
  def subscribeSocket(
    socket: /* import warning: QualifyReferences.resolveTypeRef Couldn't qualify SCServerSocket */ js.Any,

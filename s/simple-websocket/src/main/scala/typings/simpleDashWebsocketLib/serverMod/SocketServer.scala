...
trait SocketServer
  ...
  var clients: nodeLib.Set[wsLib.wsMod.namespaced] with stdLib.Set[wsLib.wsMod.namespaced] = js.native
  ...
  def close(cb: js.Function1[/* err */ js.UndefOr[nodeLib.Error with stdLib.Error], scala.Unit]): scala.Unit = js.native
  @JSName("emit")
  def emit_connection(
    event: simpleDashWebsocketLib.simpleDashWebsocketLibStrings.connection,
  ...
  @JSName("listeners")
  def listeners_error(event: simpleDashWebsocketLib.simpleDashWebsocketLibStrings.error): js.Array[js.Function1[/* error */ nodeLib.Error with stdLib.Error, scala.Unit]] = js.native
  @JSName("listeners")
  ...
  @JSName("rawListeners")
  def rawListeners_error(event: simpleDashWebsocketLib.simpleDashWebsocketLibStrings.error): js.Array[js.Function1[/* error */ nodeLib.Error with stdLib.Error, scala.Unit]] = js.native
  @JSName("rawListeners")

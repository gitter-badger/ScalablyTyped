...
object streamDashEachMod extends js.Object {
  def apply(
    ...
    iterator: js.Function2[
      ...
      /* next */ js.Function1[/* error */ js.UndefOr[nodeLib.Error with stdLib.Error], scala.Unit], 
      scala.Unit
    ],
    cb: js.Function1[/* error */ js.UndefOr[nodeLib.Error with stdLib.Error], scala.Unit]

...
trait SCBrokerClient
  ...
  def end(callback: js.Function1[/* err */ js.UndefOr[nodeLib.Error with stdLib.Error], scala.Unit]): scala.Unit = js.native
  ...
  def on_error(
    ...
    listener: js.Function1[/* err */ js.UndefOr[nodeLib.Error with stdLib.Error], scala.Unit]
  ): this.type = js.native
  @JSName("on")
  def on_message(
  ...
  def on_warning(
    ...
    listener: js.Function1[/* warning */ js.UndefOr[nodeLib.Error with stdLib.Error], scala.Unit]
  ): this.type = js.native
  def pop(
    keyChain: fleximapLib.fleximapMod.KeyChain,
    callback: js.Function2[
  ...
  def removeAll(callback: js.Function1[/* err */ nodeLib.Error with stdLib.Error, scala.Unit]): scala.Unit = js.native
  ...
  def subscribe(
    channel: java.lang.String,
    ackCallback: js.Function1[/* err */ js.UndefOr[nodeLib.Error with stdLib.Error], scala.Unit]
  ): scala.Unit = js.native
  def subscribe(
    channel: java.lang.String,
    ackCallback: js.Function1[/* err */ js.UndefOr[nodeLib.Error with stdLib.Error], scala.Unit],

...
trait Connection
  ...
  def forwardOut(
    ...
    callback: js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* channel */ ServerChannel, scala.Unit]
  ...
  def rekey(callback: js.Function1[/* err */ nodeLib.Error with stdLib.Error, scala.Unit]): scala.Boolean = js.native
  /**

...
class Client ()
  ...
  def exec(
    ...
    callback: js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* channel */ ClientChannel, scala.Unit]
  ...
  def forwardIn(
    ...
    callback: js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* bindPort */ scala.Double, scala.Unit]
  ): scala.Boolean = js.native
  /**
  ...
  def on_error(
    ...
    listener: js.Function1[/* err */ nodeLib.Error with stdLib.Error with ClientErrorExtensions, scala.Unit]
  ): this.type = js.native
  /**
  ...
  def openssh_forwardInStreamLocal(
  ...
  def openssh_noMoreSessions(callback: js.Function1[/* err */ nodeLib.Error with stdLib.Error, scala.Unit]): scala.Boolean = js.native
  /**
  ...
  def openssh_unforwardInStreamLocal(
    socketPath: java.lang.String,
    callback: js.Function1[/* err */ nodeLib.Error with stdLib.Error, scala.Unit]
  ): scala.Boolean = js.native
  /**
    ...
    */
  def sftp(
    callback: js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* sftp */ SFTPWrapper, scala.Unit]
  ): scala.Boolean = js.native
  /**

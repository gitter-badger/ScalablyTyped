...
package object SCServerNs {
  ...
  type nextAuthenticateMiddlewareFunction = js.Function2[
    /* error */ js.UndefOr[
      socketclusterDashServerLib.socketclusterDashServerLibNumbers.`true` | java.lang.String | (nodeLib.Error with stdLib.Error) | scala.Null
    ], 
  ...
  type nextMiddlewareFunction = js.Function1[
    /* error */ js.UndefOr[
      socketclusterDashServerLib.socketclusterDashServerLibNumbers.`true` | java.lang.String | (nodeLib.Error with stdLib.Error)
    ], 
    scala.Unit
  ]

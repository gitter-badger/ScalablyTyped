...
trait SCClientSocket
  ...
  def deauthenticate(callback: js.Function1[/* err */ nodeLib.Error with stdLib.Error, scala.Unit]): scala.Unit = js.native
  ...
  def emit(
    ...
    data: js.Any,
    callback: js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* responseData */ js.Any, scala.Unit]
  ): scala.Unit = js.native
  ...
  def publish(
    channelName: java.lang.String,
    data: js.Any,
    callback: js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* ackData */ js.Any, scala.Unit]
  ): scala.Unit = js.native

...
class WSDL protected () extends js.Object {
  ...
  def onReady(callback: js.Function1[/* err */ nodeLib.Error with stdLib.Error, scala.Unit]): scala.Unit = js.native
  def processAttributes(child: js.Any, nsContext: js.Any): java.lang.String = js.native
  def processIncludes(callback: js.Function1[/* err */ nodeLib.Error with stdLib.Error, scala.Unit]): scala.Unit = js.native

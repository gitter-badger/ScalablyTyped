...
class default protected () extends PathFinding {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def calculateLinkStartEndCoords(matrix: js.Array[js.Array[scala.Double]], path: js.Array[js.Array[scala.Double]]): stormDashReactDashDiagramsLib.Anon_Start = js.native
}

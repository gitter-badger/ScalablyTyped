...
class Database protected ()
  ...
  def this(filename: java.lang.String, callback: js.Function1[/* err */ (nodeLib.Error with stdLib.Error) | scala.Null, scala.Unit]) = this()
  def this(filename: java.lang.String, mode: scala.Double) = this()
  def this(filename: java.lang.String, mode: scala.Double, callback: js.Function1[/* err */ (nodeLib.Error with stdLib.Error) | scala.Null, scala.Unit]) = this()
  ...
  def close(callback: js.Function1[/* err */ (nodeLib.Error with stdLib.Error) | scala.Null, scala.Unit]): scala.Unit = js.native
  @JSName("configure")

...
trait SendStream
  ...
  def error(status: scala.Double, error: nodeLib.Error with stdLib.Error): scala.Unit = js.native
  /**
  ...
  /**
    ...
    * @private
    */
  def onStatError(error: nodeLib.Error with stdLib.Error): scala.Unit = js.native
  /**
    * Redirect to path.
    * @private
    */

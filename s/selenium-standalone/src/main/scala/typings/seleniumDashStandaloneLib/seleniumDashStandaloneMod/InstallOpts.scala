...
trait InstallOpts extends js.Object {
  ...
  var cb: js.UndefOr[js.Function1[/* error */ nodeLib.Error with stdLib.Error, scala.Unit]] = js.undefined
  var drivers: js.UndefOr[
    org.scalablytyped.runtime.StringDictionary[seleniumDashStandaloneLib.Anon_Version]
  ] = js.undefined

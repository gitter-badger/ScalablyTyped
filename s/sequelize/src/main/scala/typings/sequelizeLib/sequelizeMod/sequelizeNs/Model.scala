...
trait Model[TInstance, TAttributes]
  ...
  def findByPrimary[TCustomAttributes](identifier: nodeLib.Buffer): bluebirdLib.bluebirdMod.namespaced[TInstance | scala.Null] = js.native
  def findByPrimary[TCustomAttributes](identifier: nodeLib.Buffer, options: FindOptions[TAttributes with TCustomAttributes]): bluebirdLib.bluebirdMod.namespaced[TInstance | scala.Null] = js.native

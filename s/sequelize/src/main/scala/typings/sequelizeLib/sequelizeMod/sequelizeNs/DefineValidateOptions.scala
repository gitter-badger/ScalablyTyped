...
/* name */ org.scalablytyped.runtime.StringDictionary[js.Any] {
  ...
  /**
    ...
    */
  var is: js.UndefOr[
    java.lang.String | (js.Array[java.lang.String | stdLib.RegExp]) | stdLib.RegExp | sequelizeLib.Anon_Msg
  ] = js.undefined
  /**
    * only allow date strings after a specific date
    */
  var isAfter: js.UndefOr[java.lang.String | sequelizeLib.Anon_MsgArgsString_852303132] = js.undefined
  /**
  ...
  /**
    * only allow arrays
    */
  var isArray: js.UndefOr[scala.Boolean | sequelizeLib.Anon_MsgArgsStringBoolean] = js.undefined
  /**
    * only allow date strings before a specific date
    */
  var isBefore: js.UndefOr[java.lang.String | sequelizeLib.Anon_MsgArgsString_852303132] = js.undefined
  /**
    * check for valid credit card numbers
    */
  var isCreditCard: js.UndefOr[scala.Boolean | sequelizeLib.Anon_MsgArgsStringBoolean] = js.undefined
  /**
    * only allow date strings
    */
  var isDate: js.UndefOr[scala.Boolean | sequelizeLib.Anon_MsgArgsStringBoolean] = js.undefined
  /**
  ...
  /**
    ...
    */
  var isIn: js.UndefOr[js.Array[js.Array[java.lang.String]] | sequelizeLib.Anon_MsgArgs] = js.undefined
  /**
  ...
  var isUUID: js.UndefOr[
    sequelizeLib.sequelizeLibNumbers.`3` | sequelizeLib.sequelizeLibNumbers.`4` | sequelizeLib.sequelizeLibNumbers.`5` | sequelizeLib.sequelizeLibStrings.`3` | sequelizeLib.sequelizeLibStrings.`4` | sequelizeLib.sequelizeLibStrings.`5` | sequelizeLib.sequelizeLibStrings.all | sequelizeLib.Anon_MsgArgsStringNumber_1220200165
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  var len: js.UndefOr[(js.Tuple2[scala.Double, scala.Double]) | sequelizeLib.Anon_MsgArgsStringNumber] = js.undefined
  /**
    * only allow values
    */
  var max: js.UndefOr[scala.Double | sequelizeLib.Anon_MsgArgsStringNumber_1220200165] = js.undefined
  /**
    * only allow values >= 23
    */
  var min: js.UndefOr[scala.Double | sequelizeLib.Anon_MsgArgsStringNumber_1220200165] = js.undefined
  /**
  ...
  /**
    ...
    */
  var notContains: js.UndefOr[js.Array[java.lang.String] | java.lang.String | sequelizeLib.Anon_MsgArgsString] = js.undefined
  /**
  ...
  /**
    ...
    */
  var notIn: js.UndefOr[js.Array[js.Array[java.lang.String]] | sequelizeLib.Anon_MsgArgs] = js.undefined
  /**
    * won't allow null
    */

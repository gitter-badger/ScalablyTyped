...
trait Anon_Try
  ...
  /**
    ...
    */
  var AggregateError: org.scalablytyped.runtime.Instantiable0[bluebirdLib.bluebirdMod.AggregateError] = js.native
  val BluebirdNs: js.Any = js.native
  /**
    * Signals that an operation has been aborted or cancelled. The default reason used by `.cancel`.
    */
  var CancellationError: org.scalablytyped.runtime.Instantiable0[bluebirdLib.bluebirdMod.CancellationError] = js.native
  /**
    * returned by `Bluebird.disposer()`.
    */
  var Disposer: org.scalablytyped.runtime.Instantiable0[bluebirdLib.bluebirdMod.Disposer[js.Object]] = js.native
  /**
    ...
    */
  var OperationalError: org.scalablytyped.runtime.Instantiable0[bluebirdLib.bluebirdMod.OperationalError] = js.native
  /**
    ...
    */
  var Promise: bluebirdLib.Anon_OperationalError = js.native
  /**
    * Signals that an operation has timed out. Used as a custom cancellation reason in `.timeout`.
    */
  var TimeoutError: org.scalablytyped.runtime.Instantiable0[bluebirdLib.bluebirdMod.TimeoutError] = js.native
  /**
  ...
  /**
    ...
    */
  def getNewLibraryCopy(): bluebirdLib.Anon_OperationalError = js.native
  /**
  ...
  /**
    ...
    */
  def noConflict(): bluebirdLib.Anon_OperationalError = js.native
  /**

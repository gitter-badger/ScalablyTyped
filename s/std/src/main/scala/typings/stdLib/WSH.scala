...
object WSH extends js.Object {
  var Arguments: stdLib.Anon_Length = js.native
  /**
  ...
  /**
    ...
    */
  var StdErr: stdLib.TextStreamWriter = js.native
  /**
    * Exposes the read-only input stream for the current script.
    * Can be accessed only while using CScript.exe.
    */
  var StdIn: stdLib.TextStreamReader = js.native
  /**
    * Exposes the write-only output stream for the current script.
    * Can be accessed only while using CScript.exe.
    */
  var StdOut: stdLib.TextStreamWriter = js.native
  /**

...
trait Snekfetch
  ...
  def `catch`(rejector: js.Function1[/* err */ nodeLib.Error with stdLib.Error, _]): js.Promise[snekfetchLib.snekfetchMod.SnekfetchNs.SnekfetchResponse] = js.native
  ...
  def end[T](
    cb: js.Function2[
      ...
      /* res */ snekfetchLib.snekfetchMod.SnekfetchNs.SnekfetchResponse | (nodeLib.Error with stdLib.Error) | scala.Null, 
      T
    ]
  ...
  def `then`[T](
    ...
    rejector: js.Function1[/* err */ nodeLib.Error with stdLib.Error, _]
  ): js.Promise[T] = js.native
}

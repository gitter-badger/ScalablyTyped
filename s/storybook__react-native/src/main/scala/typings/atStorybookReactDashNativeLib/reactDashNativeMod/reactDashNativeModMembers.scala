...
object reactDashNativeModMembers extends js.Object {
  ...
  def configure(fn: js.Function0[scala.Unit], module: nodeLib.NodeModule with webpackDashEnvLib.NodeModule): scala.Unit = js.native
  ...
  def storiesOf(name: java.lang.String, module: nodeLib.NodeModule with webpackDashEnvLib.NodeModule): atStorybookReactLib.reactMod.Story = js.native
  @JSName("storiesOf")
  def `storiesOf_T<intersection>`[T](name: java.lang.String, module: nodeLib.NodeModule with webpackDashEnvLib.NodeModule): atStorybookReactLib.reactMod.Story with T = js.native
}

...
trait RawMemory extends js.Object {
  /**
    ...
    */
  var foreignSegment: Anon_UsernameId = js.native
  /**
  ...
  /**
    ...
    */
  def set(value: java.lang.String): js.UndefOr[scala.Nothing] = js.native
  ...
  /**
    ...
    */
  def setActiveForeignSegment(username: java.lang.String): js.UndefOr[scala.Nothing] = js.native
  def setActiveForeignSegment(username: java.lang.String, id: scala.Double): js.UndefOr[scala.Nothing] = js.native
  def setActiveForeignSegment(username: scala.Null, id: scala.Double): js.UndefOr[scala.Nothing] = js.native
  /**
    ...
    */
  def setActiveSegments(ids: js.Array[scala.Double]): js.UndefOr[scala.Nothing] = js.native
  ...
  /**
    ...
    */
  def setDefaultPublicSegment(id: scala.Double): js.UndefOr[scala.Nothing] = js.native
  /**
    ...
    */
  def setPublicSegments(ids: js.Array[scala.Double]): js.UndefOr[scala.Nothing] = js.native
}

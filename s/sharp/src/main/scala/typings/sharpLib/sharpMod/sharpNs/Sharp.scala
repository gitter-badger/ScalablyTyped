...
trait Sharp
  ...
  /**
    ...
    */
  def metadata(
    callback: js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* metadata */ Metadata, scala.Unit]
  ): Sharp = js.native
  /**
  ...
  /**
    ...
    * @returns A sharp instance that can be used to chain operations
    */
  def stats(callback: js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* stats */ Stats, scala.Unit]): Sharp = js.native
  /**
  ...
  def toFile(
    ...
    callback: js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* info */ OutputInfo, scala.Unit]
  ): Sharp = js.native
  /**

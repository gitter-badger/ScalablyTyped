...
class Connection protected ()
  ...
  /**
    ...
    */
  def beginTransaction(callback: js.Function1[/* error */ js.UndefOr[nodeLib.Error with stdLib.Error], scala.Unit]): scala.Unit = js.native
  ...
  /**
    ...
    */
  def commitTransaction(callback: js.Function1[/* error */ nodeLib.Error with stdLib.Error, scala.Unit]): scala.Unit = js.native
  /**
    * Executes a BulkLoad.
    */
  ...
  def newBulkLoad(
    ...
    callback: js.Function2[/* error */ nodeLib.Error with stdLib.Error, /* rowCount */ scala.Double, scala.Unit]
  ): BulkLoad = js.native
  /**
  ...
  /**
    ...
    * 					As only one request at a time may be executed on a connection, another request should not be initiated until this callback is called.
    */
  def reset(callback: js.Function1[/* error */ nodeLib.Error with stdLib.Error, scala.Unit]): scala.Unit = js.native
  /**
    ...
    * 						As only one request at a time may be executed on a connection, another request should not be initiated until this callback is called.
    */
  def rollbackTransaction(callback: js.Function1[/* error */ nodeLib.Error with stdLib.Error, scala.Unit]): scala.Unit = js.native
  /**
    ...
    * 					As only one request at a time may be executed on a connection, another request should not be initiated until this callback is called.
    */
  def saveTransaction(callback: js.Function1[/* error */ nodeLib.Error with stdLib.Error, scala.Unit]): scala.Unit = js.native
  /**

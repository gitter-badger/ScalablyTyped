...
@js.native
trait Anon_BubbleParentApiNameLifecycleContainerACCURACYBEST extends js.Object {
  /**
  ...
  /**
  		 ...
  		 */
  val AndroidNs: Anon_BubbleParentApiNameLifecycleContainerManualMode = js.native
  /**

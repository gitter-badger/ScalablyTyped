...
@js.native
trait Anon_BubbleParentApiNameLifecycleContainerBATTERYSTATECHARGING extends js.Object {
  /**
  		 * The Android-specific Platform module, used to access the device's platform-related functionality.
  		 */
  val AndroidNs: Anon_BubbleParentApiNameLifecycleContainerAPILEVEL = js.native
  /**

...
@js.native
trait Anon_BubbleParentApiNameLifecycleContainerACTIONAIRPLANEMODECHANGED extends js.Object {
  /**
  ...
  /**
  		 ...
  		 */
  val CalendarNs: Anon_BubbleParentApiNameLifecycleContainerMETHODALERT = js.native
  /**
  ...
  /**
  		 ...
  		 */
  val NotificationManagerNs: Anon_BubbleParentApiNameLifecycleContainerDEFAULTALL = js.native
  /**
  		 * Not used.
  		 */
  ...
  /**
  		 ...
  		 */
  val RNs: Anon_BubbleParentApiNameLifecycleContainerAnim = js.native
  /**

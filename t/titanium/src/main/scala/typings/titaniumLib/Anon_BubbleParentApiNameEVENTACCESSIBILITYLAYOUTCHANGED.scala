...
@js.native
trait Anon_BubbleParentApiNameEVENTACCESSIBILITYLAYOUTCHANGED extends js.Object {
  /**
  ...
  /**
  			 ...
  			 */
  val UserNotificationCenterNs: Anon_BubbleParentApiNameAddEventListener = js.native
  /**
  ...
  /**
  			 ...
  			 */
  def registerUserNotificationSettings(params: UserNotificationSettings): scala.Unit = js.native
  /**
  ...
  /**
  			 ...
  			 */
  def scheduleLocalNotification(params: NotificationParams): titaniumLib.TitaniumNs.AppNs.iOSNs.LocalNotification = js.native
  /**

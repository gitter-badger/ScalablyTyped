...
@js.native
trait Anon_BubbleParentApiNameLifecycleContainerEVENTACCESSIBILITYANNOUNCEMENT extends js.Object {
  /**
  		 * A module used to access Android application resources.
  		 */
  val AndroidNs: Anon_BubbleParentApiNameLifecycleContainerR = js.native
  /**
  ...
  /**
  		 ...
  		 */
  val PropertiesNs: Anon_BubbleParentApiNameLifecycleContainerAddEventListenerNameCallback = js.native
  /**
  ...
  /**
  		 ...
  		 */
  val iOSNs: Anon_BubbleParentApiNameEVENTACCESSIBILITYLAYOUTCHANGED = js.native
  /**

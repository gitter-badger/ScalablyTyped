...
@js.native
trait Anon_BubbleParentApiNameLifecycleContainerCONTACTSKINDORGANIZATION extends js.Object {
  /**
  ...
  /**
  		 ...
  		 */
  def requestAuthorization(callback: js.Function1[/* param0 */ ContactsAuthorizationResponse, _]): scala.Unit = js.native
  /**
  		 * Requests for contacts access.
  		 */
  def requestContactsPermissions(callback: js.Function1[/* param0 */ ContactsAuthorizationResponse, _]): scala.Unit = js.native
  /**
  ...
  /**
  		 ...
  		 */
  def showContacts(params: showContactsParams): scala.Unit = js.native
}

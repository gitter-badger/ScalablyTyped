...
@js.native
trait Anon_BubbleParentApiNameLifecycleContainerAUDIOFILEFORMAT3GP2 extends js.Object {
  /**
  ...
  /**
  		 ...
  		 */
  val AndroidNs: Anon_BubbleParentApiNameLifecycleContainerAddEventListenerNameCallbackParam0 = js.native
  /**

...
@js.native
trait Anon_BubbleParentApiNameLARGETITLEDISPLAYMODEAUTOMATIC extends js.Object {
  /**
  ...
  /**
  			 ...
  			 */
  val AlertDialogStyleNs: Anon_BubbleParentApiNameDEFAULT = js.native
  /**
  			 ...
  			 */
  val AnimationStyleNs: Anon_BubbleParentApiNameCURLDOWN = js.native
  /**
  ...
  /**
  			 ...
  			 */
  val ProgressBarStyleNs: Anon_BubbleParentApiNameBAR = js.native
  /**
  ...
  /**
  			 ...
  			 */
  val RowAnimationStyleNs: Anon_BubbleParentApiNameBOTTOM = js.native
  /**
  ...
  /**
  			 ...
  			 */
  val ScrollIndicatorStyleNs: Anon_BubbleParentApiNameBLACK = js.native
  /**
  			 * A set of constants for the status bar style.
  			 */
  val StatusBarNs: Anon_BubbleParentApiNameANIMATIONSTYLENONE = js.native
  /**
  			 * A set of constants for creating standard iOS system buttons.
  			 */
  val SystemButtonNs: Anon_BubbleParentApiNameACTION = js.native
  /**
  			 * A set of constants for the system button styles that can be used for the button `style` property.
  			 */
  val SystemButtonStyleNs: Anon_BubbleParentApiNameBORDERED = js.native
  /**
  			 * A set of constants for the system icon styles that can be used on a tab group tab.
  			 */
  val SystemIconNs: Anon_BubbleParentApiNameBOOKMARKS = js.native
  /**
  ...
  /**
  			 ...
  			 */
  val TableViewCellSelectionStyleNs: Anon_BubbleParentApiNameBLUE = js.native
  /**
  			 ...
  			 */
  val TableViewScrollPositionNs: Anon_BubbleParentApiNameBOTTOMMIDDLE = js.native
  /**
  			 * A set of constants for the style that can be used for the button `style` property of
  			 * <Titanium.UI.TableView>.
  			 */
  val TableViewStyleNs: Anon_BubbleParentApiNameGROUPED = js.native
  /**

...
@js.native
trait Anon_BubbleParentApiNameLifecycleContainerINADDRANY extends js.Object {
  /**
  ...
  /**
  		 ...
  		 */
  val SocketNs: Anon_BubbleParentApiNameLifecycleContainerINITIALIZED = js.native
  /**
  ...
  /**
  		 ...
  		 */
  def registerForPushNotifications(config: PushNotificationConfig): scala.Unit = js.native
  /**

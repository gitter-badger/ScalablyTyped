...
object tldjsMod extends js.Object {
  ...
  def fromUserSettings(options: tldjsLib.Anon_Rules): tldjsLib.Anon_ExtractHostnameHost = js.native
  ...
  def parse(host: java.lang.String): tldjsLib.Anon_Hostname = js.native

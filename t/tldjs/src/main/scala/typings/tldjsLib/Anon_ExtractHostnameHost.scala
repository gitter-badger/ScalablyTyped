...
@js.native
trait Anon_ExtractHostnameHost extends js.Object {
  ...
  var fromUserSettings_Original: js.Function1[/* options */ Anon_RulesValidHosts, Anon_ExtractHostname] = js.native
  @JSName("getDomain")
  ...
  @JSName("parse")
  var parse_Original: js.Function1[/* host */ java.lang.String, Anon_HostnameIsValid] = js.native
  @JSName("tldExists")
  ...
  def fromUserSettings(options: Anon_RulesValidHosts): Anon_ExtractHostname = js.native
  ...
  def parse(host: java.lang.String): Anon_HostnameIsValid = js.native

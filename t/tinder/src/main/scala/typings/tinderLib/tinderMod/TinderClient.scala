...
class TinderClient () extends js.Object {
  ...
  /**
    ...
    */
  def authorize(fbToken: java.lang.String, fbId: java.lang.String, callback: Callback[_]): scala.Unit = js.native
  /**
    ...
    * @param {Function} callback the callback to invoke when the request completes
    */
  def changeUsername(username: java.lang.String, callback: Callback[_]): scala.Unit = js.native
  /**
    ...
    * @param {Function} callback the callback to invoke when the request completes
    */
  def createUsername(username: java.lang.String, callback: Callback[_]): scala.Unit = js.native
  /**
    * Delete the current account
    * @param {Function} callback the callback to invoke when the request completes
    */
  def deleteAccount(callback: Callback[_]): scala.Unit = js.native
  /**
    * Delete your current job
    * @param {Function} callback the callback to invoke when the request completes
    */
  def deleteJob(callback: Callback[_]): scala.Unit = js.native
  /**
    * Delete a picture from the current account
    * @param {String} pictureId the id of the picture
    * @param {Function} callback the callback to invoke when the request completes
    */
  def deletePicture(pictureId: java.lang.String, callback: Callback[_]): scala.Unit = js.native
  /**
    * Delete your current school
    * @param {Function} callback the callback to invoke when the request completes
    */
  def deleteSchool(callback: Callback[_]): scala.Unit = js.native
  /**
    * Deletes the existing web username for the current account
    *
    * @param {Function} callback the callback to invoke when the request completes
    */
  def deleteUsername(username: java.lang.String, callback: Callback[_]): scala.Unit = js.native
  /**
    * Gets the current account info
    * @param {Function} callback the callback to invoke when the request completes
    */
  def getAccount(callback: Callback[_]): scala.Unit = js.native
  /**
    * Returns the xAuthToken
    * @return xAuthToken
    */
  def getAuthToken(): java.lang.String = js.native
  /**
  ...
  /**
    ...
    * @param {Function} callback the callback to invoke when the request completes
    */
  def getHistory(callback: Callback[TinderHistory]): scala.Unit = js.native
  /**
    * @deprecated
    * Get authenticated user info
    * @param {Function} callback the callback to invoke when the request completes
    */
  def getProfile(callback: Callback[_]): scala.Unit = js.native
  /**
    * Gets a list of nearby users
    * @param {Number} limit the maximum number of profiles to fetch
    * @param {Function} callback the callback to invoke when the request completes
    */
  def getRecommendations(limit: scala.Double, callback: Callback[TinderRecommendationsResult]): scala.Unit = js.native
  /**
    ...
    * @param {Function} callback the callback to invoke when the request completes
    */
  def getShareLink(userId: java.lang.String, callback: Callback[_]): scala.Unit = js.native
  /**
    * Gets a list of new updates. This will be things like new messages, users who liked you, etc.
    * @param {Function} callback the callback to invoke when the request completes
    */
  def getUpdates(callback: Callback[TinderUpdates]): scala.Unit = js.native
  /**
    * Gets a user by id
    * @param {String} userId the id of the user
    * @param {Function} callback the callback to invoke when the request completes
    */
  def getUser(userId: java.lang.String, callback: Callback[_]): scala.Unit = js.native
  /**
  ...
  /**
    ...
    * @param {Function} callback the callback to invoke when the request completes
    */
  def like(userId: java.lang.String, callback: Callback[_]): scala.Unit = js.native
  /**
    * Passes (swipes left) on a user
    * @param {String} userId the id of the user
    * @param {Function} callback the callback to invoke when the request completes
    */
  def pass(userId: java.lang.String, callback: Callback[_]): scala.Unit = js.native
  /**
    * Report a user
    *
    * @param {String} userId the id of the user
  ...
  def report(
    ...
    causeId: stdLib.Number,
    causeText: java.lang.String,
    callback: Callback[_]
  ...
  /**
    ...
    * @param {Function} callback the callback to invoke when the request completes
    */
  def resetPassport(callback: Callback[_]): scala.Unit = js.native
  /**
    ...
    * @param {Function} callback the callback to invoke when the request completes
    */
  def sendMessage(matchId: java.lang.String, message: java.lang.String, callback: Callback[_]): scala.Unit = js.native
  /**
    * Set auth token if you have it saved, no need to do fb login every time
    */
  def setAuthToken(xAuthToken: java.lang.String): scala.Unit = js.native
  /**
    * Superlikes a user
    * @param {String} userId the id of the user
    * @param {Function} callback the callback to invoke when the request completes
    */
  def superLike(userId: java.lang.String, callback: Callback[_]): scala.Unit = js.native
  /**
    * Unmatch with a user
    * @param {String} matchID the id of the match
    * @param {Function} callback the callback to invoke when the request completes
    */
  def unmatch(matchId: java.lang.String, callback: Callback[_]): scala.Unit = js.native
  /**
    * Update your bio
    * @param {String} bio is you bio (500 characters max.)
    * @param {Function} callback the callback to invoke when the request completes
    */
  def updateBio(bio: java.lang.String, callback: Callback[_]): scala.Unit = js.native
  /**
    * Update your gender
    * @param {Number} gender is your gender (0 = Male, 1 = Female)
    * @param {Function} callback the callback to invoke when the request completes
    */
  def updateGender(gender: scala.Double, callback: Callback[_]): scala.Unit = js.native
  /**
    * Update your job
    * @param {String} id is the facebook id of the job
    * @param {Function} callback the callback to invoke when the request completes
    */
  def updateJob(id: nodeLib.String with java.lang.String, callback: Callback[_]): scala.Unit = js.native
  /**
    ...
    * @param {Function} callback the callback to invoke when the request completes
    */
  def updatePassport(latitude: java.lang.String, longitude: java.lang.String, callback: Callback[_]): scala.Unit = js.native
  /**
    ...
    * @param {Function} callback the callback to invoke when the request completes
    */
  def updatePosition(longitude: stdLib.Number, latitude: stdLib.Number, callback: Callback[_]): scala.Unit = js.native
  /**
  ...
  /**
    ...
    * @param {Function} callback the callback to invoke when the request completes
    */
  def updateSchool(id: nodeLib.String with java.lang.String, callback: Callback[_]): scala.Unit = js.native
  /**
  ...
  /**
    ...
    * @param {Function} callback the callback to invoke when the request completes
    */
  def uploadPicture(file: nodeLib.fsMod.ReadStream, callback: Callback[_]): scala.Unit = js.native
}

...
@js.native
trait Anon_DEFAULTIMAGE
  extends org.scalablytyped.runtime.Instantiable10[
      (/* image */ js.UndefOr[/* image */ stdLib.HTMLImageElement]) | (/* image */ js.UndefOr[/* image */ stdLib.HTMLCanvasElement]) | (/* image */ js.UndefOr[/* image */ stdLib.HTMLVideoElement]), 

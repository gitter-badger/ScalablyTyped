...
trait Anon_REVISION extends js.Object {
  ...
  var AnimationClip: Anon_CreateFromMorphTargetSequence = js.native
  ...
  val AnimationUtilsNs: Anon_ArraySlice = js.native
  ...
  val CacheNs: Anon_Enabled = js.native
  ...
  val ColorKeywordsNs: Anon_Aliceblue = js.native
  ...
  var Curve: Anon_CreateConstructorFunc = js.native
  ...
  val CurveUtilsNs: Anon_TangentQuadraticBezier = js.native
  ...
  var Euler: Anon_RotationOrders = js.native
  var EventDispatcher: org.scalablytyped.runtime.Instantiable0[threeLib.threeMod.EventDispatcher] = js.native
  var ExtrudeBufferGeometry: Anon_WorldUVGeneratorShapes = js.native
  var ExtrudeGeometry: Anon_WorldUVGenerator = js.native
  ...
  val GeometryUtilsNs: Anon_Merge = js.native
  ...
  val ImageUtilsNs: Anon_CrossOrigin = js.native
  ...
  var KeyframeTrack: Anon_Parse = js.native
  ...
  var LensFlareElement: Anon_Shader = js.native
  ...
  var Loader: Anon_Handlers = js.native
  var LoaderUtils: Anon_DecodeText = js.native
  ...
  val MathNs: Anon_DEG2RAD = js.native
  ...
  var Object3D: Anon_DefaultUp = js.native
  ...
  var OutlinePass: Anon_BlurDirectionX = js.native
  ...
  var PropertyBinding: Anon_Create = js.native
  val PropertyBindingNs: Anon_Composite = js.native
  ...
  var Quaternion: Anon_Slerp = js.native
  ...
  var SSAARenderPass: Anon_JitterVectors = js.native
  var STLLoader: js.Any = js.native
  var Scene: org.scalablytyped.runtime.Instantiable0[threeLib.threeMod.Scene] = js.native
  val SceneUtilsNs: Anon_CreateMultiMaterialObject = js.native
  var ShaderChunk: threeLib.Anon_Name = js.native
  var ShaderLib: threeLib.Anon_NameBasic = js.native
  ...
  val ShapeUtilsNs: Anon_Area = js.native
  ...
  var TDSLoader: org.scalablytyped.runtime.Instantiable1[/* three */ threeLib.Anon_REVISION, threeLib.threeMod.TDSLoader] = js.native
  ...
  var Texture: Anon_DEFAULTIMAGE = js.native
  ...
  var Triangle: Anon_GetNormal = js.native
  ...
  var UniformsLib: threeLib.Anon_Common = js.native
  val UniformsUtilsNs: Anon_MergeUniforms = js.native
  var UnrealBloomPass: Anon_BlurDirectionXBlurDirectionY = js.native
  ...
  var WebGLUniforms: Anon_Upload = js.native

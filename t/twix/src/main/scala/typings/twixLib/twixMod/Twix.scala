...
trait Twix extends js.Object {
  def asDuration(period: java.lang.String): momentLib.momentMod.momentNs.Duration with twixLib.twixMod.momentMod.Duration = js.native
  def contains(date: momentLib.momentMod.momentNs.Moment with twixLib.twixMod.momentMod.Moment): scala.Boolean = js.native
  ...
  def iterate(duration: momentLib.momentMod.momentNs.Duration with twixLib.twixMod.momentMod.Duration): TwixIter = js.native
  ...
  def split(duration: momentLib.momentMod.momentNs.Duration with twixLib.twixMod.momentMod.Duration): js.Array[Twix] = js.native
  def split(num: scala.Double, period: java.lang.String): js.Array[Twix] = js.native
  def split(other: momentLib.momentMod.momentNs.Moment with twixLib.twixMod.momentMod.Moment): js.Array[Twix] = js.native
  def split(
    start: momentLib.momentMod.momentNs.Moment with twixLib.twixMod.momentMod.Moment,
    end: momentLib.momentMod.momentNs.Moment with twixLib.twixMod.momentMod.Moment
  ): js.Array[Twix] = js.native

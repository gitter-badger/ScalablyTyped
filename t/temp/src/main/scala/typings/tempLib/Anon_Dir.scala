...
trait Anon_Dir extends js.Object {
  ...
  def track(): /* import warning: ImportType.apply Failed type conversion: typeof temp */ js.Any = js.native
  def track(value: scala.Boolean): /* import warning: ImportType.apply Failed type conversion: typeof temp */ js.Any = js.native
}

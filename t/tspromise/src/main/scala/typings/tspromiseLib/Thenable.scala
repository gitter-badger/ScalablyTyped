...
class Thenable[T] () extends js.Object {
  def `catch`(onRejected: js.Function1[/* error */ nodeLib.Error with stdLib.Error, scala.Unit]): Thenable[T] = js.native
  ...
  def `then`[TR](
    ...
    onRejected: js.Function1[/* error */ nodeLib.Error with stdLib.Error, TR | scala.Unit]

...
class namespaced[T] protected () extends Promise[T] {
  def this(callback: js.Function2[
      ...
      /* reject */ js.UndefOr[js.Function1[/* error */ nodeLib.Error with stdLib.Error, scala.Unit]], 
      scala.Unit
    ]) = this()
}
...
object namespaced extends js.Object {
  ...
  def nfcall[T](obj: js.Any, methodName: nodeLib.String with java.lang.String, args: js.Any*): tspromiseLib.Thenable[T] = js.native
  def reject[T](error: nodeLib.Error with stdLib.Error): tspromiseLib.Thenable[T] = js.native

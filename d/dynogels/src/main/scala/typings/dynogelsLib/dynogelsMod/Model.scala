...
trait Model
  ...
  def batchGetItems(
    ...
    callback: js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* items */ js.Array[_], scala.Unit]
  ...
  def deleteTable(callback: js.Function1[/* err */ nodeLib.Error with stdLib.Error, scala.Unit]): scala.Unit = js.native
  def describeTable(
    callback: js.Function2[
      /* err */ nodeLib.Error with stdLib.Error, 

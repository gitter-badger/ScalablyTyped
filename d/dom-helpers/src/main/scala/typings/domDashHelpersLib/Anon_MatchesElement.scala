...
@js.native
trait Anon_MatchesElement extends js.Object {
  @JSName("closest")
  ...
  var default: Anon_Matches = js.native
  @JSName("height")
  ...
  @JSName("offset")
  var offset_Original: (js.Function1[
    /* element */ stdLib.Element, 
    domDashHelpersLib.queryOffsetMod.DomHelpersOffsetNs.DomHelpersRect
  ]) with Anon_DomHelpersOffset = js.native
  @JSName("position")
  ...
  def offset(element: stdLib.Element): domDashHelpersLib.queryOffsetMod.DomHelpersOffsetNs.DomHelpersRect = js.native
  def offsetParent(element: stdLib.Element): stdLib.Element = js.native
  def position(element: stdLib.Element): domDashHelpersLib.queryOffsetMod.DomHelpersOffsetNs.DomHelpersRect = js.native
  def position(element: stdLib.Element, offsetParent: stdLib.Node): domDashHelpersLib.queryOffsetMod.DomHelpersOffsetNs.DomHelpersRect = js.native

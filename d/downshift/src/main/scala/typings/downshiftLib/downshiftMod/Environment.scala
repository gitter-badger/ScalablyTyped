...
trait Environment extends js.Object {
  ...
  var addEventListener_Original: downshiftLib.Anon_Type = js.native
  var document: reactLib.Document with stdLib.Document = js.native
  @JSName("removeEventListener")
  var removeEventListener_Original: downshiftLib.Anon_TypeAbort = js.native

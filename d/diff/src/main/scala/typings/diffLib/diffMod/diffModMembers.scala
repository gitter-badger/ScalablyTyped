...
@js.native
object diffModMembers extends js.Object {
  ...
  def applyPatches(uniDiff: js.Array[diffLib.diffMod.JsDiffNs.IUniDiff], options: diffLib.Anon_LoadFile): scala.Unit = js.native

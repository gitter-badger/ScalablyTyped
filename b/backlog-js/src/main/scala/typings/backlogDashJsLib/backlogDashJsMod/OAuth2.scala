...
class OAuth2 protected () extends js.Object {
  ...
  def getAccessToken(options: backlogDashJsLib.Anon_HostCode): js.Promise[backlogDashJsLib.backlogDashJsMod.EntityNs.OAuth2Ns.AccessToken] = js.native
  def getAuthorizationURL(options: backlogDashJsLib.Anon_HostRedirectUri): java.lang.String = js.native

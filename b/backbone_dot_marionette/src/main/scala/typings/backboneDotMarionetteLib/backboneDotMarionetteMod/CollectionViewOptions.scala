...
trait CollectionViewOptions[TModel /* <: backboneLib.backboneMod.Model */, TCollection /* <: backboneLib.backboneMod.Collection[TModel] */]
  ...
  var childView: js.UndefOr[
    (js.Function1[/* model */ TModel, backboneDotMarionetteLib.Anon_Extend]) | backboneDotMarionetteLib.Anon_Extend
  ] = js.undefined
  /**
  ...
  var emptyView: js.UndefOr[
    js.Function0[backboneDotMarionetteLib.Anon_Extend] | backboneDotMarionetteLib.Anon_Extend
  ] = js.undefined
  /**

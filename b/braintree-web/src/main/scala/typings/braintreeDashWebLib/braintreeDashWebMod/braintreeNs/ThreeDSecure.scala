...
trait ThreeDSecure extends js.Object {
  ...
  /**
    ...
    * });
    */
  def verifyCard(options: braintreeDashWebLib.Anon_NonceAmount): js.Promise[ThreeDSecureVerifyPayload] = js.native
  def verifyCard(options: braintreeDashWebLib.Anon_NonceAmountAddFrame, callback: callback): scala.Unit = js.native
}

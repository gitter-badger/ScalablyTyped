...
trait Driver extends js.Object {
  ...
  def find(
    ...
    callback: js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* elements */ ElementProxy, scala.Unit]
  ): ElementProxy = js.native
  def findElement(selector: java.lang.String): ElementProxy = js.native
  def findElement(
    selector: java.lang.String,
    callback: js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* element */ ElementProxy, scala.Unit]
  ): ElementProxy = js.native

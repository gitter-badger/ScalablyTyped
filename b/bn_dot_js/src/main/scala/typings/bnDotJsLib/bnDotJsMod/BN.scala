...
trait BN extends js.Object {
  ...
  /**
    ...
    */
  def toArrayLike(ArrayType: bnDotJsLib.Anon_Str): nodeLib.Buffer = js.native
  def toArrayLike(ArrayType: bnDotJsLib.Anon_Str, endian: bnDotJsLib.Endianness): nodeLib.Buffer = js.native
  def toArrayLike(ArrayType: bnDotJsLib.Anon_Str, endian: bnDotJsLib.Endianness, length: scala.Double): nodeLib.Buffer = js.native

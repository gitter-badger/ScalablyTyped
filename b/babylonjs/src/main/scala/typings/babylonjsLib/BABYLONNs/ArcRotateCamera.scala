...
class ArcRotateCamera protected () extends TargetCamera {
  ...
  def focusOn(meshesOrMinMaxVectorAndDistance: babylonjsLib.Anon_MinMax): scala.Unit = js.native
  def focusOn(meshesOrMinMaxVectorAndDistance: babylonjsLib.Anon_MinMax, doNotUpdateMaxZ: scala.Boolean): scala.Unit = js.native
  /**

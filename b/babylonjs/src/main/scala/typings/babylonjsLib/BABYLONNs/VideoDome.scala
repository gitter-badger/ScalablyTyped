...
class VideoDome protected () extends TransformNode {
  def this(name: java.lang.String, urlsOrVideo: babylonjsLib.HTMLVideoElement, options: babylonjsLib.Anon_ResolutionClickToPlay, scene: Scene) = this()
  /**
    ...
    */
  def this(name: java.lang.String, urlsOrVideo: java.lang.String, options: babylonjsLib.Anon_ResolutionClickToPlay, scene: Scene) = this()
  def this(name: java.lang.String, urlsOrVideo: js.Array[java.lang.String], options: babylonjsLib.Anon_ResolutionClickToPlay, scene: Scene) = this()
  /**
    * The skybox material
    */

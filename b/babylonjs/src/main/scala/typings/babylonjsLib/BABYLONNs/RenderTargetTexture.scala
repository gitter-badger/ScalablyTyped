...
class RenderTargetTexture protected () extends Texture {
  ...
  def this(name: java.lang.String, size: babylonjsLib.Anon_WidthHeightNumber, scene: Nullable[Scene], generateMipMaps: js.UndefOr[scala.Boolean], doNotChangeAspectRatio: js.UndefOr[scala.Boolean], `type`: js.UndefOr[scala.Double], isCube: js.UndefOr[scala.Boolean], samplingMode: js.UndefOr[scala.Double], generateDepthBuffer: js.UndefOr[scala.Boolean], generateStencilBuffer: js.UndefOr[scala.Boolean], isMulti: js.UndefOr[scala.Boolean], format: js.UndefOr[scala.Double]) = this()
  /**
  ...
  var _initialSizeParameter: scala.Double | babylonjsLib.Anon_WidthHeightNumber | babylonjsLib.Anon_Ratio = js.native
  ...
  var _size: scala.Double | babylonjsLib.Anon_WidthHeightNumber = js.native
  ...
  def resize(size: babylonjsLib.Anon_WidthHeightNumber): scala.Unit = js.native
  /**

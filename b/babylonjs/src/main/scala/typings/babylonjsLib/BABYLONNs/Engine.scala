...
class Engine protected () extends js.Object {
  ...
  def createDepthStencilTexture(size: babylonjsLib.Anon_WidthHeightNumber, options: DepthTextureCreationOptions): InternalTexture = js.native
  /**
    * Creates a depth stencil texture.
    * This is only available in WebGL 2 or with the depth texture extension available.
    * @param size The size of face edge in the texture.
  ...
  def createRenderTargetTexture(size: babylonjsLib.Anon_WidthHeightNumber, options: RenderTargetCreationOptions): InternalTexture = js.native
  def createRenderTargetTexture(size: babylonjsLib.Anon_WidthHeightNumber, options: scala.Boolean): InternalTexture = js.native
  ...
  /**
    ...
    */
  def getGlInfo(): babylonjsLib.Anon_Vendor = js.native
  /**
...
object Engine extends js.Object {
  ...
  var ExceptionList: js.Array[babylonjsLib.Anon_Key | babylonjsLib.Anon_KeyCapture] = js.native

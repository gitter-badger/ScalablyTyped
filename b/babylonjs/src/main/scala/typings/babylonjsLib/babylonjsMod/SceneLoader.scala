...
object SceneLoader extends js.Object {
  ...
  /**
    ...
    */
  def ImportMeshAsync(meshNames: js.Any, rootUrl: java.lang.String): js.Promise[babylonjsLib.Anon_Meshes] = js.native
  def ImportMeshAsync(meshNames: js.Any, rootUrl: java.lang.String, sceneFilename: java.lang.String): js.Promise[babylonjsLib.Anon_Meshes] = js.native
  def ImportMeshAsync(
    meshNames: js.Any,
    rootUrl: java.lang.String,
    sceneFilename: java.lang.String,
    scene: babylonjsLib.BABYLONNs.Nullable[babylonjsLib.BABYLONNs.Scene]
  ): js.Promise[babylonjsLib.Anon_Meshes] = js.native
  def ImportMeshAsync(
    meshNames: js.Any,
    rootUrl: java.lang.String,
    sceneFilename: java.lang.String,

...
trait Anon_Collection
  ...
  var NoRowsDeletedError: createDashErrorLib.createDashErrorMod.createErrorNs.Error[nodeLib.Error with stdLib.Error] = js.native
  var NoRowsUpdatedError: createDashErrorLib.createDashErrorMod.createErrorNs.Error[nodeLib.Error with stdLib.Error] = js.native
  ...
  var NotFoundError: createDashErrorLib.createDashErrorMod.createErrorNs.Error[nodeLib.Error with stdLib.Error] = js.native

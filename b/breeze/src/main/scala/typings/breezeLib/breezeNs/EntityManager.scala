...
class EntityManager () extends js.Object {
  ...
  def importEntities(exportedData: js.Object, config: breezeLib.Anon_MergeStrategy): breezeLib.Anon_Entities = js.native
  def importEntities(exportedString: java.lang.String): breezeLib.Anon_Entities = js.native
  def importEntities(exportedString: java.lang.String, config: breezeLib.Anon_MergeStrategy): breezeLib.Anon_Entities = js.native
...
object EntityManager extends js.Object {
  ...
  def importEntities(exportedData: js.Object, config: breezeLib.Anon_MergeStrategy): breezeLib.breezeNs.EntityManager = js.native
  def importEntities(exportedString: java.lang.String): breezeLib.breezeNs.EntityManager = js.native
  def importEntities(exportedString: java.lang.String, config: breezeLib.Anon_MergeStrategy): breezeLib.breezeNs.EntityManager = js.native
}

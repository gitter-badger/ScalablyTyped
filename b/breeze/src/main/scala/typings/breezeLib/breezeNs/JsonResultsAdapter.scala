...
class JsonResultsAdapter protected () extends js.Object {
  def this(config: breezeLib.Anon_Name) = this()
  ...
  def visitNode(node: js.Object, queryContext: QueryContext, nodeContext: NodeContext): breezeLib.Anon_EntityType = js.native
}

...
class HotkeysEvents protected () extends js.Object {
  ...
  def handleKeyDown(e: reactLib.KeyboardEvent with stdLib.KeyboardEvent): scala.Unit = js.native
  def handleKeyUp(e: reactLib.KeyboardEvent with stdLib.KeyboardEvent): scala.Unit = js.native

...
class Tree[T] ()
  ...
  /**
    ...
    */
  def getNodeContentElement(nodeId: java.lang.String): js.UndefOr[reactLib.HTMLElement with stdLib.HTMLElement] = js.native
  def getNodeContentElement(nodeId: scala.Double): js.UndefOr[reactLib.HTMLElement with stdLib.HTMLElement] = js.native

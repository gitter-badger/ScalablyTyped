...
object bip38ModMembers extends js.Object {
  def decrypt(string: java.lang.String, passphrase: java.lang.String): bip38Lib.Anon_PrivateKey = js.native
  def decrypt(
    string: java.lang.String,
    passphrase: java.lang.String,
    progressCallback: js.Function1[/* status */ ProgressStatus, scala.Unit]
  ): bip38Lib.Anon_PrivateKey = js.native
  def decrypt(
    string: java.lang.String,
    passphrase: java.lang.String,
    progressCallback: js.Function1[/* status */ ProgressStatus, scala.Unit],
  ...
  def decryptECMult(buffer: nodeLib.Buffer, passphrase: java.lang.String): bip38Lib.Anon_PrivateKey = js.native
  def decryptECMult(
  ...
  def decryptRaw(buffer: nodeLib.Buffer, passphrase: java.lang.String): bip38Lib.Anon_PrivateKey = js.native
  def decryptRaw(
    buffer: nodeLib.Buffer,
    passphrase: java.lang.String,
    progressCallback: js.Function1[/* status */ ProgressStatus, scala.Unit]

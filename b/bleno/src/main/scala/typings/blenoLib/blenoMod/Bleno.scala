...
trait Bleno
  ...
  val Characteristic: blenoLib.Anon_RESULTATTRNOTLONG = js.native
  ...
  def on_advertisingStart(
    ...
    cb: js.Function1[/* err */ js.UndefOr[(nodeLib.Error with stdLib.Error) | scala.Null], scala.Unit]
  ): this.type = js.native
  @JSName("on")
  ...
  def setServices(
    ...
    callback: js.Function1[/* arg */ js.UndefOr[(nodeLib.Error with stdLib.Error) | scala.Null], scala.Unit]

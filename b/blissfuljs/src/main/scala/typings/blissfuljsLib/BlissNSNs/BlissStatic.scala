...
trait BlissStatic extends js.Object {
  ...
  def Class(options: blissfuljsLib.Anon_Constructor): js.Object = js.native
  @JSName("Class")
  def Class_TT[T](options: blissfuljsLib.Anon_Constructor): T = js.native
  ...
  def fetch(url: java.lang.String, options: blissfuljsLib.Anon_Method): js.Promise[stdLib.XMLHttpRequest] = js.native

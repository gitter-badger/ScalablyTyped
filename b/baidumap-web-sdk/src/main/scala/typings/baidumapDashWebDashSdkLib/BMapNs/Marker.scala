...
class Marker protected () extends Overlay {
  ...
  def ondragstart(event: baidumapDashWebDashSdkLib.Anon_TypeTarget): scala.Unit = js.native
  def oninfowindowclose(event: baidumapDashWebDashSdkLib.Anon_TypeTarget): scala.Unit = js.native
  def oninfowindowopen(event: baidumapDashWebDashSdkLib.Anon_TypeTarget): scala.Unit = js.native
  ...
  def onrightclick(event: baidumapDashWebDashSdkLib.Anon_TypeTarget): scala.Unit = js.native

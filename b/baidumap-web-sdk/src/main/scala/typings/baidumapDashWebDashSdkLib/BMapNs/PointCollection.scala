...
class PointCollection protected () extends Overlay {
  ...
  def onclick(event: baidumapDashWebDashSdkLib.Anon_TypeTargetPointString): scala.Unit = js.native
  def onmouseout(event: baidumapDashWebDashSdkLib.Anon_TypeTargetPointString): scala.Unit = js.native
  def onmouseover(event: baidumapDashWebDashSdkLib.Anon_TypeTargetPointString): scala.Unit = js.native

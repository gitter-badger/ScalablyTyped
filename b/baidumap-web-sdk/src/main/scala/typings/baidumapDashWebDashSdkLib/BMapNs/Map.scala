...
class Map protected () extends js.Object {
  ...
  def onaddcontrol(event: baidumapDashWebDashSdkLib.Anon_TypeTarget): scala.Unit = js.native
  def onaddoverlay(event: baidumapDashWebDashSdkLib.Anon_TypeTarget): scala.Unit = js.native
  def onaddtilelayer(event: baidumapDashWebDashSdkLib.Anon_TypeTarget): scala.Unit = js.native
  def onclearoverlays(event: baidumapDashWebDashSdkLib.Anon_TypeTarget): scala.Unit = js.native
  def onclick(event: baidumapDashWebDashSdkLib.Anon_TypeTargetPoint): scala.Unit = js.native
  def ondblclick(event: baidumapDashWebDashSdkLib.Anon_TypeTargetPointPixel): scala.Unit = js.native
  def ondragend(event: baidumapDashWebDashSdkLib.Anon_TypeTargetPointPixel): scala.Unit = js.native
  def ondragging(event: baidumapDashWebDashSdkLib.Anon_TypeTargetPointPixel): scala.Unit = js.native
  def ondragstart(event: baidumapDashWebDashSdkLib.Anon_TypeTargetPointPixel): scala.Unit = js.native
  def onhotspotclick(event: baidumapDashWebDashSdkLib.Anon_TypeTargetSpots): scala.Unit = js.native
  def onhotspotout(event: baidumapDashWebDashSdkLib.Anon_TypeTargetSpots): scala.Unit = js.native
  def onhotspotover(event: baidumapDashWebDashSdkLib.Anon_TypeTargetSpots): scala.Unit = js.native
  def onload(event: baidumapDashWebDashSdkLib.Anon_TypeTargetPointPixelZoom): scala.Unit = js.native
  def onlongpress(event: baidumapDashWebDashSdkLib.Anon_TypeTargetPointPixel): scala.Unit = js.native
  def onmaptypechange(event: baidumapDashWebDashSdkLib.Anon_TypeTarget): scala.Unit = js.native
  def onmousemove(event: baidumapDashWebDashSdkLib.Anon_TypeTargetPoint): scala.Unit = js.native
  ...
  def onmoveend(event: baidumapDashWebDashSdkLib.Anon_TypeTarget): scala.Unit = js.native
  def onmovestart(event: baidumapDashWebDashSdkLib.Anon_TypeTarget): scala.Unit = js.native
  def onmoving(event: baidumapDashWebDashSdkLib.Anon_TypeTarget): scala.Unit = js.native
  def onremovecontrol(event: baidumapDashWebDashSdkLib.Anon_TypeTarget): scala.Unit = js.native
  def onremoveoverlay(event: baidumapDashWebDashSdkLib.Anon_TypeTarget): scala.Unit = js.native
  def onremovetilelayer(event: baidumapDashWebDashSdkLib.Anon_TypeTarget): scala.Unit = js.native
  def onresize(event: baidumapDashWebDashSdkLib.Anon_TypeTargetSize): scala.Unit = js.native
  def onrightclick(event: baidumapDashWebDashSdkLib.Anon_TypeTargetPoint): scala.Unit = js.native
  def onrightdblclick(event: baidumapDashWebDashSdkLib.Anon_TypeTargetPoint): scala.Unit = js.native
  def ontilesloaded(event: baidumapDashWebDashSdkLib.Anon_TypeTarget): scala.Unit = js.native
  def ontouchend(event: baidumapDashWebDashSdkLib.Anon_TypeTargetPointPixel): scala.Unit = js.native
  def ontouchmove(event: baidumapDashWebDashSdkLib.Anon_TypeTargetPointPixel): scala.Unit = js.native
  def ontouchstart(event: baidumapDashWebDashSdkLib.Anon_TypeTargetPointPixel): scala.Unit = js.native
  def onzoomend(event: baidumapDashWebDashSdkLib.Anon_TypeTarget): scala.Unit = js.native
  def onzoomstart(event: baidumapDashWebDashSdkLib.Anon_TypeTarget): scala.Unit = js.native

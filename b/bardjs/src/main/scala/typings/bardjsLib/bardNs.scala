...
object bardNs extends js.Object {
  ...
  /**
    ...
    */
  def appModule(
    fns: (java.lang.String | (angularLib.angularMod.Global.Function with js.Function) | (chaiLib.Object with js.Object))*
  ...
  def inject(context: angularLib.angularMod.Global.Function with js.Function, args: java.lang.String*): scala.Unit = js.native
  ...
  def wrapWithDone(
    ...
    done: angularLib.angularMod.Global.Function with js.Function

...
trait CanvasContext extends js.Object {
  ...
  /**
  		 ...
  		 * 偏移量，初始值为 0 。
  		 */
  var setLineDashOffset: scala.Double = js.native
  /**
  		 * 创建一个颜色的渐变点。
  ...
  /**
  		 ...
  		 *
  		 */
  def createCircularGradient(x: scala.Double, y: scala.Double, r: scala.Double): CanvasGradient = js.native
  /**
  		 * 创建一个线性的渐变颜色。
  		 * Tip: 需要使用 addColorStop() 来指定渐变点，至少要两个。
  		 * @param x0 起点的x坐标
  		 ...
  		 * @param y1 终点的y坐标
  		 */
  def createLinearGradient(x0: scala.Double, y0: scala.Double, x1: scala.Double, y1: scala.Double): CanvasGradient = js.native
  /**
  		 ...
  		 */
  def createPattern(image: java.lang.String, repetition: java.lang.String): java.lang.String = js.native
  /**
  ...
  /**
  		 ...
  		 */
  def drawImage(imageResource: java.lang.String, dx: scala.Double, dy: scala.Double): scala.Unit = js.native
  /**
  		 * 绘制图像，图像保持原始尺寸。
  		 * @param imageResource 所要绘制的图片资源, 通过chooseImage得到一个文件路径或者一个项目目录内的图片
  		 * @param dx            源图像的矩形选择框的左上角 X 坐标
  ...
  /**
  		 ...
  		 *  @param offset 虚线偏移量
  		 */
  def setLineDash(pattern: js.Array[scala.Double], offset: scala.Double): scala.Unit = js.native
  /**
  		 * 设置两线相交处的样式
  ...
  /**
  		 ...
  		 */
  @JSName("setTextBaseline")
  def setTextBaseline_top(textBaseline: baiduDashAppLib.baiduDashAppLibStrings.top): scala.Unit = js.native
  /**
  		 * 使用矩阵重新设置（覆盖）当前变换的方法。
  		 */

...
abstract class HttpExecutor[REQUEST] () extends js.Object {
  ...
  def addErrorAndTimeoutHandlers(request: js.Any, reject: js.Function1[/* error */ nodeLib.Error with stdLib.Error, scala.Unit]): scala.Unit = js.native
  /* protected */ def addRedirectHandlers(
    request: js.Any,
    options: nodeLib.httpMod.RequestOptions,
    reject: js.Function1[/* error */ nodeLib.Error with stdLib.Error, scala.Unit],
    redirectCount: scala.Double,
    handler: js.Function1[/* options */ nodeLib.httpMod.RequestOptions, scala.Unit]
  ): scala.Unit = js.native
  /* protected */ def createMaxRedirectError(): nodeLib.Error with stdLib.Error = js.native

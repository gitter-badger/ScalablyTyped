...
@js.native
trait Anon_OperationalError
  extends org.scalablytyped.runtime.Instantiable1[
      /* callback */ js.Function3[
        /* resolve */ js.Function1[/* thenableOrResult */ js.UndefOr[Resolvable[js.Object]], scala.Unit], 
  ...
  // array with values
  def all[R](values: Resolvable[stdLib.Iterable[Resolvable[R]]]): bluebirdLib.bluebirdMod.Bluebird[js.Array[R]] = js.native
  def all[T1](values: js.Array[Resolvable[T1]]): bluebirdLib.bluebirdMod.Bluebird[js.Array[T1]] = js.native
  def all[T1, T2](values: js.Tuple2[Resolvable[T1], Resolvable[T2]]): bluebirdLib.bluebirdMod.Bluebird[js.Tuple2[T1, T2]] = js.native
  def all[T1, T2, T3](values: js.Tuple3[Resolvable[T1], Resolvable[T2], Resolvable[T3]]): bluebirdLib.bluebirdMod.Bluebird[js.Tuple3[T1, T2, T3]] = js.native
  def all[T1, T2, T3, T4](values: js.Tuple4[Resolvable[T1], Resolvable[T2], Resolvable[T3], Resolvable[T4]]): bluebirdLib.bluebirdMod.Bluebird[js.Tuple4[T1, T2, T3, T4]] = js.native
  /**
  ...
  def all[T1, T2, T3, T4, T5](values: js.Tuple5[Resolvable[T1], Resolvable[T2], Resolvable[T3], Resolvable[T4], Resolvable[T5]]): bluebirdLib.bluebirdMod.Bluebird[js.Tuple5[T1, T2, T3, T4, T5]] = js.native
   // tslint:disable-line:unified-signatures
  /**
    * Like `Promise.some()`, with 1 as `count`. However, if the promise fulfills, the fulfillment value is not an array of 1 but the value directly.
    */
  def any[R](values: Resolvable[stdLib.Iterable[Resolvable[R]]]): bluebirdLib.bluebirdMod.Bluebird[R] = js.native
  def attempt[R](fn: js.Function0[Resolvable[R]]): bluebirdLib.bluebirdMod.Bluebird[R] = js.native
  /**
  ...
  /**
    ...
    */
  def cast[R](value: Resolvable[R]): bluebirdLib.bluebirdMod.Bluebird[R] = js.native
  /**
    ...
    */
  def config(options: Anon_Warnings): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def delay[R](ms: scala.Double, value: Resolvable[R]): bluebirdLib.bluebirdMod.Bluebird[R] = js.native
  /**
    ...
    */
  def each[R](values: Resolvable[stdLib.Iterable[Resolvable[R]]], iterator: IterateFunction[R, _]): bluebirdLib.bluebirdMod.Bluebird[js.Array[R]] = js.native
  /**
    ...
    */
  def filter[R](values: Resolvable[stdLib.Iterable[Resolvable[R]]], filterer: IterateFunction[R, scala.Boolean]): bluebirdLib.bluebirdMod.Bluebird[js.Array[R]] = js.native
  def filter[R](
  ...
  def join[R](values: Resolvable[R]*): bluebirdLib.bluebirdMod.Bluebird[js.Array[R]] = js.native
  /**
    * Promise.join(
    ...
    */
  def join[R, A1](arg1: Resolvable[A1], handler: js.Function1[/* arg1 */ A1, Resolvable[R]]): bluebirdLib.bluebirdMod.Bluebird[R] = js.native
  def join[R, A1, A2](
    arg1: Resolvable[A1],
    arg2: Resolvable[A2],
  ...
  /**
    ...
    * *The original array is not modified.*
    */
  def map[R, U](values: Resolvable[stdLib.Iterable[Resolvable[R]]], mapper: IterateFunction[R, U]): bluebirdLib.bluebirdMod.Bluebird[js.Array[U]] = js.native
  def map[R, U](
    values: Resolvable[stdLib.Iterable[Resolvable[R]]],
  ...
  /**
    ...
    */
  def mapSeries[R, U](values: Resolvable[stdLib.Iterable[Resolvable[R]]], iterator: IterateFunction[R, U]): bluebirdLib.bluebirdMod.Bluebird[js.Array[U]] = js.native
  /**
    ...
    */
  def method[R](fn: js.Function0[Resolvable[R]]): js.Function0[bluebirdLib.bluebirdMod.Bluebird[R]] = js.native
  def method[R](fn: js.Function1[/* repeated */ js.Any, Resolvable[R]]): js.Function1[/* repeated */ js.Any, bluebirdLib.bluebirdMod.Bluebird[R]] = js.native
  def method[R, A1, A2](fn: js.Function2[/* arg1 */ A1, /* arg2 */ A2, Resolvable[R]]): js.Function2[/* arg1 */ A1, /* arg2 */ A2, bluebirdLib.bluebirdMod.Bluebird[R]] = js.native
  def method[R, A1, A2, A3](fn: js.Function3[/* arg1 */ A1, /* arg2 */ A2, /* arg3 */ A3, Resolvable[R]]): js.Function3[/* arg1 */ A1, /* arg2 */ A2, /* arg3 */ A3, bluebirdLib.bluebirdMod.Bluebird[R]] = js.native
  def method[R, A1, A2, A3, A4](fn: js.Function4[/* arg1 */ A1, /* arg2 */ A2, /* arg3 */ A3, /* arg4 */ A4, Resolvable[R]]): js.Function4[
    /* arg1 */ A1, 
    /* arg2 */ A2, 
    /* arg3 */ A3, 
    /* arg4 */ A4, 
  ...
  /**
    ...
    */
  // map
  def props[K, V](map: Resolvable[stdLib.Map[K, Resolvable[V]]]): bluebirdLib.bluebirdMod.Bluebird[stdLib.Map[K, V]] = js.native
  /**
    ...
    */
  def race[R](values: Resolvable[stdLib.Iterable[Resolvable[R]]]): bluebirdLib.bluebirdMod.Bluebird[R] = js.native
  /**
  ...
  /**
    ...
    * *The original array is not modified.*
    */
  def some[R](values: Resolvable[stdLib.Iterable[Resolvable[R]]], count: scala.Double): bluebirdLib.bluebirdMod.Bluebird[js.Array[R]] = js.native
  /**
    ...
    */
  def `try`[R](fn: js.Function0[Resolvable[R]]): bluebirdLib.bluebirdMod.Bluebird[R] = js.native
  /**

...
class ImageCapture protected () extends js.Object {
  def this(videoTrack: webrtcLib.MediaStreamTrack with stdLib.MediaStreamTrack) = this()
  val track: webrtcLib.MediaStreamTrack with stdLib.MediaStreamTrack = js.native

...
abstract class EventRegister () extends js.Object {
  ...
  def forEachAll(
    func: js.Function2[
      /* import warning: QualifyReferences.resolveTypeRef Couldn't qualify Collection<any> */ /* list */ js.Any, 
  ...
  def forEachEventName(
    func: js.Function2[
      /* import warning: QualifyReferences.resolveTypeRef Couldn't qualify Collection<EventRegisterData> */ /* list */ js.Any, 
      /* eventName */ wonderDotJsLib.distEs2015EventObjectEventNameHandlerMod.EEventName, 
      scala.Unit
    ]
  ): scala.Unit = js.native

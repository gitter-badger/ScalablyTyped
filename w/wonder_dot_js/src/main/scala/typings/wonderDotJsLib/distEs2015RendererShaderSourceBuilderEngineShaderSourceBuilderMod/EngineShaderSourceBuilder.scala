...
class EngineShaderSourceBuilder ()
  ...
  var fsSourceDefineList: /* import warning: QualifyReferences.resolveTypeRef Couldn't qualify Collection<SourceDefine> */ js.Any = js.native
  ...
  var vsSourceDefineList: /* import warning: QualifyReferences.resolveTypeRef Couldn't qualify Collection<SourceDefine> */ js.Any = js.native
  ...
  def build(
    libs: /* import warning: QualifyReferences.resolveTypeRef Couldn't qualify Collection<EngineShaderLib> */ js.Any

...
class Face3 protected () extends js.Object {
  def this(aIndex: scala.Double, bIndex: scala.Double, cIndex: scala.Double, faceNormal: wonderDotJsLib.distEs2015MathVector3Mod.Vector3, vertexNormals: /* import warning: QualifyReferences.resolveTypeRef Couldn't qualify Collection<Vector3> */ js.Any) = this()
  ...
  var vertexNormals: /* import warning: QualifyReferences.resolveTypeRef Couldn't qualify Collection<Vector3> */ js.Any = js.native
...
object Face3 extends js.Object {
  ...
  def create(
    ...
    cIndex: scala.Double,
    faceNormal: wonderDotJsLib.distEs2015MathVector3Mod.Vector3,
    vertexNormals: /* import warning: QualifyReferences.resolveTypeRef Couldn't qualify Collection<Vector3> */ js.Any
  ): wonderDotJsLib.distEs2015StructureFace3Mod.Face3 = js.native
}

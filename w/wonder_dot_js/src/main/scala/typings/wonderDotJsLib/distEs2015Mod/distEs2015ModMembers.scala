...
@js.native
object distEs2015ModMembers extends js.Object {
  var CompileConfig: wonderDotJsLib.Anon_IsCompileTest = js.native
  val DEG_TO_RAD: scala.Double = js.native
  var DebugConfig: wonderDotJsLib.Anon_IsTest = js.native

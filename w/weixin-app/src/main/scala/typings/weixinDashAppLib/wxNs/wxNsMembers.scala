...
object wxNsMembers extends js.Object {
  ...
  /**
  	 ...
  	 */
  def onBLECharacteristicValueChange(callback: js.Function1[/* res */ weixinDashAppLib.Anon_DeviceIdServiceId, scala.Unit]): scala.Unit = js.native
  /**
  	 * 监听低功耗蓝牙连接的错误事件，包括设备丢失，连接异常断开等等。
  	 */
  def onBLEConnectionStateChanged(callback: js.Function1[/* res */ weixinDashAppLib.Anon_DeviceId, scala.Unit]): scala.Unit = js.native
  /**
  	 * 监听音乐暂停。
  	 * @deprecated 1.2.0
  	 */

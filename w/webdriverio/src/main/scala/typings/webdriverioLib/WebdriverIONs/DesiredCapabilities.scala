...
trait DesiredCapabilities extends Capabilities {
  ...
  var ensureCleanSession: js.UndefOr[scala.Boolean] = js.undefined
  ...
  // RC
  var honorSystemProxy: js.UndefOr[scala.Boolean] = js.undefined
  ...
  var perfLoggingPrefs: js.UndefOr[webdriverioLib.Anon_EnableNetwork] = js.undefined

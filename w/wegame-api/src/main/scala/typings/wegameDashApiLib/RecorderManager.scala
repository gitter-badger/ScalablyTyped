...
class RecorderManager () extends js.Object {
  ...
  /**
    ...
    */
  def onFrameRecorded(callback: js.Function1[/* res */ Anon_FrameBuffer, scala.Unit]): scala.Unit = js.native
  /**
    * 监听录音暂停事件
    */
  ...
  /**
    ...
    */
  def onStop(callback: js.Function1[/* res */ Anon_TempFilePath, scala.Unit]): scala.Unit = js.native
  /**
    * 暂停录音
    */
  ...
  /**
    * 开始录音
    */
  def start(param: Anon_Duration): scala.Unit = js.native
  /**
    * 停止录音
    */

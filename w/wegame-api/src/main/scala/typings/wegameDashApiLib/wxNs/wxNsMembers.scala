...
object wxNsMembers extends js.Object {
  ...
  /**
    ...
    */
  def authorize(param: wegameDashApiLib.Anon_Scope): scala.Unit = js.native
  // --防沉迷
  /**
    * 根据用户当天游戏时间判断用户是否需要休息
    */
  def checkIsUserAdvisedToRest(param: wegameDashApiLib.Anon_TodayPlayedTime): scala.Unit = js.native
  // --登录
  /**
  ...
  /**
    * 从本地相册选择图片或使用相机拍照。
    */
  def chooseImage(param: wegameDashApiLib.Anon_Count): scala.Unit = js.native
  // --数据缓存
  /**
    * 清理本地数据缓存
    */
  ...
  /**
    * 用户点击后打开意见反馈页面的按钮
    */
  def createFeedbackButton(param: wegameDashApiLib.Anon_TypeTextImage): wegameDashApiLib.FeedbackButton = js.native
  // --游戏圈
  /**
    * 创建游戏圈按钮。游戏圈按钮被点击后会跳转到小游戏的游戏圈。更多关于游戏圈的信息见 游戏圈使用指南
    */
  def createGameClubButton(param: wegameDashApiLib.Anon_TypeTextImageStyle): wegameDashApiLib.GameClubButton = js.native
  /**
    * 创建一个图片对象
    */
  ...
  /**
    * 创建打开设置页面的按钮
    */
  def createOpenSettingButton(param: wegameDashApiLib.Anon_TypeTextImage): wegameDashApiLib.OpenSettingButton = js.native
  /**
  ...
  // --用户信息
  def createUserInfoButton(param: wegameDashApiLib.Anon_TypeText): wegameDashApiLib.UserInfoButton = js.native
  // --视频
  def createVideo(param: wegameDashApiLib.Anon_XY): wegameDashApiLib.Video = js.native
  // --Worker
  /**
  ...
  /**
    ...
    */
  def getFriendCloudStorage(param: wegameDashApiLib.Anon_KeyList): scala.Unit = js.native
  /**
    * 在小游戏是通过群分享卡片打开的情况下，可以通过调用该接口获取群同玩成员的游戏数据。该接口只可在开放数据域下使用。
    */
  def getGroupCloudStorage(param: wegameDashApiLib.Anon_ShareTicket): scala.Unit = js.native
  def getLaunchOptionsSync(): wegameDashApiLib.wxNs.typesNs.LaunchOption = js.native
  // --位置
  /**
    * 获取当前的地理位置、速度。当用户离开小程序后，此接口无法调用；当用户点击“显示在聊天顶部”时，此接口可继续调用。
    */
  def getLocation(param: wegameDashApiLib.Anon_Type): scala.Unit = js.native
  // --菜单
  /**
    * 获取菜单按钮的布局置信息
    */
  def getMenuButtonBoundingClientRect(): wegameDashApiLib.Anon_WidthHeight = js.native
  // --网络
  /**
    * 获取网络类型
    */
  ...
  /**
    ...
    */
  def getUserCloudStorage(param: wegameDashApiLib.Anon_KeyListSuccess): scala.Unit = js.native
  /**
  ...
  /**
    * 触发分包加载，详见 分包加载
    */
  def loadSubpackage(param: wegameDashApiLib.Anon_Name): wegameDashApiLib.LoadSubpackageTask = js.native
  /**
  ...
  def offShow(cb: js.Function1[/* res */ wegameDashApiLib.Anon_Scene, scala.Unit]): scala.Unit = js.native
  ...
  def onShow(cb: js.Function1[/* res */ wegameDashApiLib.Anon_Scene, scala.Unit]): scala.Unit = js.native
  /**
    * 监听WebSocket 连接关闭事件
    */
  ...
  /**
    ...
    */
  def openCustomerServiceConversation(param: wegameDashApiLib.Anon_SessionFrom): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def previewImage(param: wegameDashApiLib.Anon_Urls): scala.Unit = js.native
  /**
    * 从本地缓存中移除指定 key
    */
  ...
  /**
    ...
    */
  def removeUserCloudStorage(param: wegameDashApiLib.Anon_KeyListSuccessFail): scala.Unit = js.native
  // --发起请求
  ...
  /**
    * 发起米大师支付
    */
  def requestMidasPayment(param: wegameDashApiLib.Anon_Mode): scala.Unit = js.native
  /**
  ...
  // --调试
  def setEnableDebug(p: wegameDashApiLib.Anon_EnableDebug): scala.Unit = js.native
  /**
    * 设置是否保持常亮状态。仅在当前小程序生效，离开小程序后设置失效。
    */
  def setKeepScreenOn(p: wegameDashApiLib.wxNs.typesNs.SetKeepScreenOnParams): scala.Unit = js.native
  def setMenuStyle(param: wegameDashApiLib.Anon_Style): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def setStatusBarStyle(param: wegameDashApiLib.Anon_StyleWhite): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def setUserCloudStorage(param: wegameDashApiLib.Anon_KVDataListSuccess): scala.Unit = js.native
  /**
    * 主动拉起转发，进入选择通讯录界面。
    */
  ...
  /**
    * 显示选择器
    */
  def showActionSheet(params: wegameDashApiLib.Anon_ItemList): scala.Unit = js.native
  /**
    * 显示键盘
    */
  def showKeyboard(param: wegameDashApiLib.Anon_DefaultValue): scala.Unit = js.native
  /**
    * 显示 loading 提示框, 需主动调用 wx.hideLoading 才能关闭提示框
    */
  def showLoading(): scala.Unit = js.native
  def showLoading(prms: wegameDashApiLib.Anon_TitleMask): scala.Unit = js.native
  /**
    * 显示模态对话框
    */
  def showModal(param: wegameDashApiLib.Anon_TitleContent): scala.Unit = js.native
  /**
    * 显示当前页面的转发按钮
    */
  ...
  /**
    * 显示消息提示框
    */
  def showToast(param: wegameDashApiLib.Anon_Title): scala.Unit = js.native
  /**
    * 开始监听加速度数据。
    */
  ...
  /**
    ...
    */
  def updateKeyboard(param: wegameDashApiLib.Anon_ValueSuccess): scala.Unit = js.native
  /**
    * 更新转发属性
    */
  def updateShareMenu(param: wegameDashApiLib.Anon_WithShareTicket): scala.Unit = js.native
  // --上传
  def uploadFile(param: wegameDashApiLib.Anon_Url): wegameDashApiLib.UploadTask = js.native
  /**
    * 使手机发生较长时间的振动（400 ms)
    */

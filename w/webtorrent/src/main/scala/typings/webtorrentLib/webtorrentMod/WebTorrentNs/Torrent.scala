...
trait Torrent
  ...
  def addPeer(peer: simpleDashPeerLib.simpleDashPeerMod.SimplePeerNs.Instance): scala.Boolean = js.native
  ...
  def destroy(cb: js.Function1[/* err */ (nodeLib.Error with stdLib.Error) | java.lang.String, scala.Unit]): scala.Unit = js.native
  def on(
  ...
  def on_error(
    ...
    callback: js.Function1[/* err */ (nodeLib.Error with stdLib.Error) | java.lang.String, scala.Unit]
  ): this.type = js.native
  @JSName("on")
  ...
  def on_wire(
    ...
    callback: js.Function2[
      /* wire */ bittorrentDashProtocolLib.bittorrentDashProtocolMod.BittorrentProtocolNs.Wire, 
  ...
  def removePeer(peer: simpleDashPeerLib.simpleDashPeerMod.SimplePeerNs.Instance): scala.Unit = js.native

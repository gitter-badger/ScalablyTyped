...
@js.native
trait Anon_OptionsHandler extends js.Object {
  /**
    * Plugins
    */
  ...
  val CompilerNs: Anon_Watching = js.native
  ...
  val optimizeNs: Anon_ModuleConcatenationPlugin = js.native
  val webpackNs: Anon_Options = js.native

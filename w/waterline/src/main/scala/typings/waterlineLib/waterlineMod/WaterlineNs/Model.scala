...
trait Model extends ModelInstance {
  ...
  def native(cb: js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* collection */ js.Any, scala.Unit]): scala.Unit = js.native
  ...
  def stream(criteria: js.Any, writeEnd: js.Any): nodeLib.NodeJSNs.WritableStream | (nodeLib.Error with stdLib.Error) = js.native

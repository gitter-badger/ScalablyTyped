...
object UsbInterfaceDescriptor extends js.Object {
  ...
  /**
    ...
    */
  def tryParse(descriptor: winrtDashUwpLib.WindowsNs.DevicesNs.UsbNs.UsbDescriptor): winrtDashUwpLib.Anon_ParsedReturnValueUsbInterfaceDescriptor = js.native
}

...
abstract class VideoDeviceController () extends js.Object {
  ...
  var variablePhotoSequenceController: winrtDashUwpLib.WindowsNs.MediaNs.DevicesNs.CoreNs.VariablePhotoSequenceController = js.native
  ...
  /**
    ...
    */
  def tryGetPowerlineFrequency(): winrtDashUwpLib.Anon_ValueReturnValuePowerlineFrequency = js.native
  /**

...
object default extends js.Object {
  ...
  val broadcastUpdate: workboxDashSwLib.Anon_BroadcastCacheUpdate = js.native
  ...
  val precaching: workboxDashSwLib.Anon_PrecacheController = js.native
  val rangeRequests: workboxDashSwLib.Anon_PluginCreatePartialResponse = js.native
  val routing: workboxDashSwLib.Anon_NavigationRoute = js.native

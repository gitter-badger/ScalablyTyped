package typings
package webdriverDashManagerLib.builtLibFilesFileUnderscoreManagerMod
...
object FileManager extends js.Object {
  /**
    ...
    */
  def `checkOS_`(osType: java.lang.String, binary: webdriverDashManagerLib.Anon_Os): scala.Boolean = js.native
  /**

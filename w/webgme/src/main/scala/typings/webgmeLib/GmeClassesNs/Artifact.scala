...
trait Artifact extends js.Object {
  ...
  var addFilesAsSoftLinks_Original: webgmeLib.Anon_FilesName = js.native
  /** Adds multiple files. */
  @JSName("addFiles")
  var addFiles_Original: webgmeLib.Anon_Files = js.native
  /** Adds a metadataHash to the artifact using the given file path. */
  @JSName("addMetadataHash")
  var addMetadataHash_Original: webgmeLib.Anon_NameMetadataHash = js.native
  /** Adds metadataHashes to the artifact using the given file paths. */
  @JSName("addMetadataHashes")
  var addMetadataHashes_Original: webgmeLib.Anon_NameMetadataHashSize = js.native
  /** Adds a metadataHash to the artifact using the given file path. */
  ...
  @JSName("save")
  var save_Original: webgmeLib.Anon_Callback = js.native
  /** Adds content to the artifact as a file. */

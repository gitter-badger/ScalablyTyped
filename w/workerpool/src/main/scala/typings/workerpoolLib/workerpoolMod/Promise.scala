...
class Promise[T, E] () extends js.Object {
  ...
  def always[TT](handler: js.Function0[Promise[TT, nodeLib.Error with stdLib.Error]]): Promise[TT, nodeLib.Error with stdLib.Error] = js.native
  def cancel(): this.type = js.native
  def `catch`[TT](err: js.Function1[/* error */ E, TT]): Promise[TT, nodeLib.Error with stdLib.Error] = js.native

...
trait WorkerPool extends js.Object {
  /**
    ...
    * @deprecated
    */
  def clear(): Promise[js.Array[_], nodeLib.Error with stdLib.Error] = js.native
  def clear(force: scala.Boolean): Promise[js.Array[_], nodeLib.Error with stdLib.Error] = js.native
  def exec(method: java.lang.String): Promise[_, nodeLib.Error with stdLib.Error] = js.native
  def exec(method: java.lang.String, params: js.Array[_]): Promise[_, nodeLib.Error with stdLib.Error] = js.native
  def exec(method: js.Function1[/* repeated */ js.Any, _]): Promise[_, nodeLib.Error with stdLib.Error] = js.native
  /**
    ...
    */
  def exec(method: js.Function1[/* repeated */ js.Any, _], params: js.Array[_]): Promise[_, nodeLib.Error with stdLib.Error] = js.native
  /**
    ...
    */
  def proxy(): Promise[_, nodeLib.Error with stdLib.Error] = js.native
  ...
  /**
    ...
    */
  def terminate(): Promise[js.Array[_], nodeLib.Error with stdLib.Error] = js.native
  def terminate(force: scala.Boolean): Promise[js.Array[_], nodeLib.Error with stdLib.Error] = js.native
  def terminate(force: scala.Boolean, timeout: scala.Double): Promise[js.Array[_], nodeLib.Error with stdLib.Error] = js.native
}

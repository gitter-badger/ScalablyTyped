...
trait Compilation
  ...
  var dependencyFactories: stdLib.Map[webpackLib.Anon_Compare, tapableLib.tapableMod.Tapable] = js.native
  var dependencyTemplates: stdLib.Map[webpackLib.Anon_Compare, tapableLib.tapableMod.Tapable] = js.native
  ...
  def getPath(filename: java.lang.String, data: webpackLib.Anon_HashChunk): java.lang.String = js.native

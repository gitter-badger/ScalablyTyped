...
class ComboBox protected () extends js.Object {
  ...
  def Column(): activexDashInteropLib.SafeArray[_] with stdLib.SafeArray[_] = js.native
  ...
  def List(): activexDashInteropLib.SafeArray[_] with stdLib.SafeArray[_] = js.native

...
trait Vector[TItem] extends js.Object {
  ...
  var BinaryData: activexDashInteropLib.SafeArray[_] with stdLib.SafeArray[_] = js.native
  /** Returns the number of members in the vector */
  val Count: scala.Double = js.native
  /** Returns/Sets the Vector of Integers from a Date */
  var Date: activexDashInteropLib.VarDate with stdLib.VarDate = js.native

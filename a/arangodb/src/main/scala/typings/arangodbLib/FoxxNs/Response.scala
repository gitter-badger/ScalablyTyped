...
trait Response extends js.Object {
  ...
  def cookie(name: java.lang.String, value: java.lang.String, options: arangodbLib.Anon_Ttl): this.type = js.native
  ...
  def `throw`(status: arangodbLib.ArangoDBNs.HttpStatus, error: nodeLib.Error with stdLib.Error): scala.Nothing = js.native
  ...
  def `throw`(status: scala.Double, error: nodeLib.Error with stdLib.Error): scala.Nothing = js.native
  ...
  def `throw`(status: scala.Double, reason: java.lang.String, error: nodeLib.Error with stdLib.Error): scala.Nothing = js.native

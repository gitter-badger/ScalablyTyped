...
class namespaced protected () extends Sender {
  ...
  def this(config: applicationinsightsLib.outLibraryConfigMod.namespaced, onSuccess: js.Function1[/* response */ java.lang.String, scala.Unit], onError: js.Function1[/* error */ nodeLib.Error with stdLib.Error, scala.Unit]) = this()
}

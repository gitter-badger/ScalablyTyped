...
object applicationinsightsModMembers extends js.Object {
  ...
  def setup(): applicationinsightsLib.Anon_Start = js.native
  def setup(instrumentationKey: java.lang.String): applicationinsightsLib.Anon_Start = js.native
  def start(): applicationinsightsLib.Anon_Start = js.native

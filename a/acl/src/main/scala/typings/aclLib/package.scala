...
package object aclLib {
  ...
  type AllowedCallback = js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* allowed */ scala.Boolean, js.Any]
  type AnyCallback = js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* obj */ js.Any, js.Any]
  type Callback = js.Function1[/* err */ nodeLib.Error with stdLib.Error, js.Any]

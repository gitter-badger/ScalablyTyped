...
trait IMeteorService extends js.Object {
  ...
  /**
    ...
    */
  def createUser(options: angularDashMeteorLib.Anon_UsernameEmail): angularLib.angularMod.angularNs.IPromise[scala.Unit] = js.native
  /**
  ...
  def getPicture(options: angularDashMeteorLib.Anon_Width): angularLib.angularMod.angularNs.IPromise[_] = js.native

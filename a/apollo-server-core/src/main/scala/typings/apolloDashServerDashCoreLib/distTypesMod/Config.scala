...
- Dropped {[ P in 'formatError' | 'debug' | 'rootValue' | 'validationRules' | 'formatResponse' | 'fieldResolver' | 'tracing' | 'dataSources' | 'cache' ]: apollo-server-core.apollo-server-core/dist/graphqlOptions.GraphQLServerOptions<apollo-server-core.apollo-server-core/dist/types.Context<any>, any>[P]} */ trait Config extends js.Object {
  ...
  var plugins: js.UndefOr[
    apolloDashEnvLib.libPolyfillsArrayMod.Global.Array[PluginDefinition] with coreDashJsLib.Array[PluginDefinition] with js.Array[PluginDefinition]
  ] = js.undefined
  ...
  var schemaDirectives: js.UndefOr[
    stdLib.Record[java.lang.String, apolloDashServerDashCoreLib.Anon_GetDirectiveDeclaration]
  ] = js.undefined
  ...
  var typeDefs: js.UndefOr[
    graphqlLib.languageAstMod.DocumentNode | (apolloDashEnvLib.libPolyfillsArrayMod.Global.Array[graphqlLib.languageAstMod.DocumentNode] with coreDashJsLib.Array[graphqlLib.languageAstMod.DocumentNode] with js.Array[graphqlLib.languageAstMod.DocumentNode])
  ] = js.undefined

...
@JSImport("@angular/core/src/view", JSImport.Namespace)
@js.native
object srcViewModMembers extends js.Object {
  ...
  def createRendererType2(values: atAngularCoreLib.Anon_Styles): atAngularCoreLib.srcRenderApiMod.RendererType2 = js.native
  ...
  def initServicesIfNeeded(): scala.Unit = js.native
  ...
  def ngContentDef(ngContentIndex: scala.Double, index: scala.Double): atAngularCoreLib.srcViewTypesMod.NodeDef = js.native
  def ngContentDef(ngContentIndex: scala.Null, index: scala.Double): atAngularCoreLib.srcViewTypesMod.NodeDef = js.native
  ...
  def textDef(checkIndex: scala.Double, ngContentIndex: scala.Double, staticText: js.Array[java.lang.String]): atAngularCoreLib.srcViewTypesMod.NodeDef = js.native
  def textDef(checkIndex: scala.Double, ngContentIndex: scala.Null, staticText: js.Array[java.lang.String]): atAngularCoreLib.srcViewTypesMod.NodeDef = js.native

...
trait Anon_Type[T] extends js.Object {
  ...
  /**
    ...
    */
  var inputs: js.UndefOr[atAngularCoreLib.atAngularCoreLibStrings.Anon_Type with js.Any] = js.native
  /**
    ...
    * of properties.
    */
  var outputs: js.UndefOr[atAngularCoreLib.atAngularCoreLibStrings.Anon_Type with js.Any] = js.native
  /**

...
object atAngularCoreLibStrings {
  ...
  @js.native
  sealed trait Anon_Type extends js.Object
  
  @js.native
  sealed trait Anon_TypeSelectors extends js.Object
  ...
  def Anon_Type: Anon_Type = "Anon_Type".asInstanceOf[Anon_Type]
  def Anon_TypeSelectors: Anon_TypeSelectors = "Anon_TypeSelectors".asInstanceOf[Anon_TypeSelectors]

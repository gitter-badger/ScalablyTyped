...
@js.native
trait Anon_TypeSelectors[T] extends js.Object {
  /**
  ...
  /**
    ...
    * of this directive.
    */
  var hostVars: js.UndefOr[scala.Double] = js.native
  /**
    ...
    */
  var inputs: js.UndefOr[atAngularCoreLib.atAngularCoreLibStrings.Anon_TypeSelectors with js.Any] = js.native
  /**
    ...
    * of properties.
    */
  var outputs: js.UndefOr[atAngularCoreLib.atAngularCoreLibStrings.Anon_TypeSelectors with js.Any] = js.native

...
trait GridsterConfig extends js.Object {
  ...
  var draggable: js.UndefOr[angularDashGridsterLib.Anon_EnabledScrollSensitivity] = js.undefined
  ...
  var resizable: js.UndefOr[angularDashGridsterLib.Anon_Enabled] = js.undefined

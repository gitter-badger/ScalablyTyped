...
object srcRouterUnderscoreModuleModMembers extends js.Object {
  ...
  def provideRouterInitializer(): js.Array[
    (org.scalablytyped.runtime.Instantiable1[/* injector */ atAngularCoreLib.coreMod.Injector, RouterInitializer]) | atAngularRouterLib.Anon_Provide | atAngularRouterLib.Anon_ProvideCompRef | atAngularRouterLib.Anon_ProvideCompRefMulti
  ] = js.native

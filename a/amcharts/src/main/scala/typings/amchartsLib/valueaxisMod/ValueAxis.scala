package typings
package amchartsLib.valueaxisMod
...
trait ValueAxis
  ...
  /**
    ...
    */
  var axisTitleOffset: scala.Double = js.native
  /**
    * Read-only. Coordinate of the base value.
    */
  var baseCoord: scala.Double = js.native
  /**
    * Specifies base value of the axis.
    */
  var baseValue: scala.Double = js.native
  /**
  ...
  /**
    ...
    * {DD:"d. ", hh:":", mm:":",ss:""}
    */
  var durationUnits: amchartsLib.Anon_DD = js.native
  /**
  ...
  /**
    ...
    */
  var includeGuidesInMinMax: scala.Boolean = js.native
  /**
    * If true, the axis will include hidden graphs when calculating min and max values.
    */
  var includeHidden: scala.Boolean = js.native
  /**
    * Specifies whether values on axis can only be integers or both integers and doubles.
    */
  var integersOnly: scala.Boolean = js.native
  /**
    * Specifies if this value axis' scale should be logarithmic.
    */
  var logarithmic: scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  var maximumData: stdLib.Date = js.native
  /**
  ...
  /**
    ...
    */
  var minMaxMultiplier: scala.Double = js.native
  /**
  ...
  /**
    ...
    * Can be set as date object, timestamp number or string if dataDateFormat is set.
    */
  var minimumDate: stdLib.Date = js.native
  /**
  ...
  /**
    ...
    * @default true
    */
  var radarCategoriesEnabled: scala.Boolean = js.native
  /**
    * pecifies if graphs's values should be recalculated to percents.
    */
  var recalculateToPercents: scala.Boolean = js.native
  /**
  ...
  /**
    ...
    * @default "none"
    */
  var stackType: java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  var strictMinMax: scala.Boolean = js.native
  /**
    ...
    */
  var synchronizationMultiplier: scala.Double = js.native
  /**
  ...
  /**
    * Color of total text.
    */
  var totalTextColor: java.lang.String = js.native
  /**
    * Distance from data point to total text.
    */
  var totalTextOffset: scala.Double = js.native
  /**
    ...
    */
  var treatZeroAs: scala.Double = js.native
  /**
    * Type of value axis.
  ...
  /**
    ...
    */
  var unitPosition: java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  var useScientificNotation: scala.Boolean = js.native
  /**
    * Adds event listener.
  ...
  def addListener(
    ...
    handler: js.Function1[/* e */ amchartsLib.Anon_TypeStartValue, scala.Unit]
  ): scala.Unit = js.native
  /**
    * Number, - value of coordinate. Returns value of the coordinate.  coordinate - y or x coordinate, in pixels.
    */
  def coordinateToValue(coordinate: scala.Double): scala.Unit = js.native
  /**
    * Number - coordinate Returns coordinate of the value in pixels. value - Number
    */
  def getCoordinate(value: scala.Double): scala.Unit = js.native
  def labelFunction(valueText: java.lang.String, data: stdLib.Date, valueAxis: ValueAxis): java.lang.String = js.native
  /**
    ...
    */
  def labelFunction(value: scala.Double, valueText: java.lang.String, valueAxis: ValueAxis): java.lang.String = js.native
  /**
  ...
  /**
    ...
    * You should set synchronizationMultiplyer in order for this to work.
    */
  def synchronizeWithAxis(axis: ValueAxis): scala.Unit = js.native
  /**
    * XY Chart only. Zooms-in the axis to the provided values.
    */
  def zoomToValues(startValue: scala.Double, endValue: scala.Double): scala.Unit = js.native
}

...
class URLSearchParams ()
  ...
  @JSName(org.scalablytyped.runtime.Symbol.iterator)
  var iterator_URLSearchParams: js.Function0[
    (nodeLib.IterableIterator[js.Tuple2[java.lang.String, java.lang.String]]) with (stdLib.IterableIterator[js.Tuple2[java.lang.String, java.lang.String]])
  ] = js.native
  ...
  def entries(): (nodeLib.IterableIterator[js.Tuple2[java.lang.String, java.lang.String]]) with (stdLib.IterableIterator[js.Tuple2[java.lang.String, java.lang.String]]) = js.native
  ...
  def keys(): nodeLib.IterableIterator[java.lang.String] with stdLib.IterableIterator[java.lang.String] = js.native
  def set(name: java.lang.String, value: java.lang.String): scala.Unit = js.native
  def sort(): scala.Unit = js.native
  def values(): nodeLib.IterableIterator[java.lang.String] with stdLib.IterableIterator[java.lang.String] = js.native
}

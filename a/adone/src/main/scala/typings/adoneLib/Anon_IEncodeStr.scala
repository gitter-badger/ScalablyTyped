...
@js.native
trait Anon_IEncodeStr extends js.Object {
  ...
  def decodeVLQ(value: java.lang.String, index: js.UndefOr[scala.Nothing], rest: adoneLib.adoneLibNumbers.`true`): Anon_ValueIndex = js.native
  def decodeVLQ(value: java.lang.String, index: scala.Double): scala.Double = js.native
  def decodeVLQ(value: java.lang.String, index: scala.Double, rest: adoneLib.adoneLibNumbers.`true`): Anon_ValueIndex = js.native

...
trait Anon_File extends js.Object {
  ...
  def map(
    ...
    options: (adoneLib.adoneNs.fastNs.INs.MapOptions with (Anon_Read | Anon_StreamTrue)) | adoneLib.adoneNs.fastNs.INs.MapOptions
  ...
  def src(
    ...
    options: (adoneLib.adoneNs.fastNs.INs.SrcOptions with (Anon_Read | Anon_StreamTrue)) | adoneLib.adoneNs.fastNs.INs.SrcOptions
  ...
  def watch(
    globs: java.lang.String,
    options: (adoneLib.adoneNs.fastNs.INs.WatchOptions with (Anon_Read | Anon_StreamTrue)) | adoneLib.adoneNs.fastNs.INs.WatchOptions
  ): adoneLib.adoneNs.fastNs.INs.LocalStream[adoneLib.adoneNs.fastNs.INs.NullFile] = js.native
  ...
  def watchMap(
    mappings: adoneLib.adoneNs.fastNs.INs.MapSource,
    options: (adoneLib.adoneNs.fastNs.INs.WatchMapOptions with (Anon_Read | Anon_StreamTrue)) | adoneLib.adoneNs.fastNs.INs.WatchMapOptions
  ): adoneLib.adoneNs.fastNs.INs.LocalMapStream[adoneLib.adoneNs.fastNs.INs.NullFile] = js.native
}

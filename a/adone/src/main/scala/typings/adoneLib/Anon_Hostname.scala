...
trait Anon_Hostname extends js.Object {
  ...
  val constants: nodeLib.Anon_UVUDPREUSEADDR = js.native
  ...
  def userInfo(): nodeLib.Anon_Username = js.native
  def userInfo(options: nodeLib.Anon_Encoding): nodeLib.Anon_Username = js.native
}

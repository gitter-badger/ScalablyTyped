...
@js.native
trait Anon_Undefined extends js.Object {
  ...
  def url(obj: js.Any, options: adoneLib.adoneNs.isNs.INs.FQDNOptions with Anon_Protocols): /* is string */ scala.Boolean = js.native

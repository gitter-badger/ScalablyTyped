...
trait Anon_Noop extends js.Object {
  ...
  /**
    * File system stuff
    */
  val fsNs: Anon_IReadlink = js.native
  /**
    * predicates
    */
  val isNs: Anon_Undefined = js.native
  @JSName("lodash")
  val lodash_Original: lodashLib.lodashMod.underscoreNs.LoDashStatic = js.native
  /**
    * math related things
    */
  val mathNs: Anon_IBigNumber = js.native
  val metaNs: Anon_ITypeOf = js.native
  val netNs: Anon_Http = js.native
  val ok: adoneLib.adoneLibStrings.ok = js.native
  val `package`: js.Object = js.native
  val prettyNs: Anon_IJson = js.native
  /**
    * promise helpers
    */
  val promiseNs: Anon_Defer = js.native
  val regexNs: Anon_Filename = js.native
  val runtime: adoneLib.adoneNs.INs.Runtime = js.native
  val semverNs: Anon_SEMVERSPECVERSION = js.native
  /**
    * testing framework
    */
  ...
  val textNs: Anon_Escape = js.native
  /**
    * various utility functions
    */
  val utilNs: Anon_Arrify = js.native
  val vaultNs: Anon_IVault = js.native
  /**

...
@js.native
trait Anon_IBinary extends js.Object {
  /**
  ...
  /**
    ...
    */
  var Long: Anon_MINVALUE = js.native
  /**
  ...
  /**
    ...
    */
  var ObjectId: Anon_CreatePk = js.native
  /**
  ...
  /**
    ...
    */
  var Timestamp: Anon_MINVALUEMAXVALUE = js.native
  val cNs: Anon_BSONINT32MIN = js.native
  /**

...
trait LocalStreamConstructor
  extends org.scalablytyped.runtime.Instantiable2[
      ...
      (/* options */ LocalStreamConstructorOptions with adoneLib.Anon_Read) | (/* options */ LocalStreamConstructorOptions with adoneLib.Anon_StreamTrue) | (/* options */ LocalStreamConstructorOptions), 

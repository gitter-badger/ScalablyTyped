...
trait Assertion extends LanguageChains {
  ...
  def Throw(errorLike: nodeLib.Error with stdLib.Error): this.type = js.native
  def Throw(errorLike: nodeLib.Error with stdLib.Error, errMsgMatcher: java.lang.String): this.type = js.native
  def Throw(errorLike: nodeLib.Error with stdLib.Error, errMsgMatcher: stdLib.RegExp): this.type = js.native
  /**

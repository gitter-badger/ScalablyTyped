...
class DefaultMap[K, V] ()
  ...
  def this(factory: js.Function1[/* key */ K, V], iterable: (nodeLib.Iterable[js.Tuple2[K, V]]) with (stdLib.Iterable[js.Tuple2[K, V]])) = this()
  def this(factory: org.scalablytyped.runtime.StringDictionary[V], iterable: (nodeLib.Iterable[js.Tuple2[K, V]]) with (stdLib.Iterable[js.Tuple2[K, V]])) = this()
}

...
object jsonNsMembers extends js.Object {
  ...
  def encode(obj: js.Any, options: adoneLib.Anon_Space): nodeLib.Buffer = js.native
  ...
  def encodeStable(obj: js.Any, options: adoneLib.Anon_SpaceCycles): java.lang.String = js.native
}

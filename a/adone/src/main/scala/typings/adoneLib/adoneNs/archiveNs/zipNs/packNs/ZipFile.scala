...
class ZipFile () extends js.Object {
  ...
  def addBuffer(buffer: nodeLib.Buffer, metadataPath: java.lang.String, options: adoneLib.Anon_Mtime): this.type = js.native
  /**
  ...
  def addEmptyDirectory(metadataPath: java.lang.String, options: adoneLib.Anon_MtimeModeNumber): this.type = js.native
  /**
  ...
  def addFile(path: java.lang.String, metadataPath: java.lang.String, options: adoneLib.Anon_Mtime): this.type = js.native
  /**
  ...
  def addReadStream(
    ...
    options: adoneLib.Anon_MtimeMode
  ): this.type = js.native
  /**

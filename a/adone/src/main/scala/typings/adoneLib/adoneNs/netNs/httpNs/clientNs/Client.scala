...
class Client () extends js.Object {
  ...
  def delete(
    ...
    options: (adoneLib.adoneNs.netNs.httpNs.clientNs.INs.Options with (adoneLib.Anon_ResponseTypeBuffer | adoneLib.Anon_ResponseTypeStream | adoneLib.Anon_ResponseTypeString)) | adoneLib.adoneNs.netNs.httpNs.clientNs.INs.Options
  ...
  def request(
    config: (adoneLib.adoneNs.netNs.httpNs.clientNs.INs.Options with (adoneLib.Anon_ResponseType | adoneLib.Anon_ResponseTypeBuffer | adoneLib.Anon_ResponseTypeStream | adoneLib.Anon_ResponseTypeString)) | adoneLib.adoneNs.netNs.httpNs.clientNs.INs.Options,
    args: js.Any*
  ): js.Promise[
    adoneLib.adoneNs.netNs.httpNs.clientNs.INs.Response[js.Object | java.lang.String]
  ] = js.native

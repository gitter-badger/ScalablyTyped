...
@js.native
trait Anon_IEncode extends js.Object {
  ...
  def encode(obj: js.Any, options: Anon_Space): nodeLib.Buffer = js.native
  ...
  def encodeStable(obj: js.Any, options: Anon_SpaceCycles): java.lang.String = js.native
}

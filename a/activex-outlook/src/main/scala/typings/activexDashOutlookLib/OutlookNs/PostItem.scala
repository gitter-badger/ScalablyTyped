...
class PostItem protected () extends js.Object {
  ...
  val ReceivedTime: activexDashInteropLib.VarDate with stdLib.VarDate = js.native
  ...
  var TaskCompletedDate: activexDashInteropLib.VarDate with stdLib.VarDate = js.native
  var TaskDueDate: activexDashInteropLib.VarDate with stdLib.VarDate = js.native
  var TaskStartDate: activexDashInteropLib.VarDate with stdLib.VarDate = js.native

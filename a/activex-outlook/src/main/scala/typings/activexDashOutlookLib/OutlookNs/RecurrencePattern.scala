...
class RecurrencePattern protected () extends js.Object {
  ...
  var EndTime: activexDashInteropLib.VarDate with stdLib.VarDate = js.native
  ...
  var PatternEndDate: activexDashInteropLib.VarDate with stdLib.VarDate = js.native
  var PatternStartDate: activexDashInteropLib.VarDate with stdLib.VarDate = js.native
  var RecurrenceType: OlRecurrenceType = js.native
  var Regenerate: scala.Boolean = js.native
  val Session: NameSpace = js.native
  var StartTime: activexDashInteropLib.VarDate with stdLib.VarDate = js.native
  def GetOccurrence(StartDate: activexDashInteropLib.VarDate with stdLib.VarDate): AppointmentItem = js.native
}

...
class Recipient protected () extends js.Object {
  ...
  var TrackingStatusTime: activexDashInteropLib.VarDate with stdLib.VarDate = js.native
  var Type: scala.Double = js.native
  def Delete(): scala.Unit = js.native
  def FreeBusy(Start: activexDashInteropLib.VarDate with stdLib.VarDate, MinPerChar: scala.Double): java.lang.String = js.native
  def FreeBusy(
    Start: activexDashInteropLib.VarDate with stdLib.VarDate,
    MinPerChar: scala.Double,
    CompleteFormat: js.Any

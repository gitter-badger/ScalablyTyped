...
class Reminder protected () extends js.Object {
  ...
  val NextReminderDate: activexDashInteropLib.VarDate with stdLib.VarDate = js.native
  val OriginalReminderDate: activexDashInteropLib.VarDate with stdLib.VarDate = js.native

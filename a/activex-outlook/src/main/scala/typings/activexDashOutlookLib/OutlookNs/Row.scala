...
class Row protected () extends js.Object {
  ...
  def LocalTimeToUTC(Index: js.Any): activexDashInteropLib.VarDate with stdLib.VarDate = js.native
  def UTCToLocalTime(Index: js.Any): activexDashInteropLib.VarDate with stdLib.VarDate = js.native
}

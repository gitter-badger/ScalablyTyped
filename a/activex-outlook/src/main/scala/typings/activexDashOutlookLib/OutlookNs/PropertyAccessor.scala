...
class PropertyAccessor protected () extends js.Object {
  ...
  def LocalTimeToUTC(Value: activexDashInteropLib.VarDate with stdLib.VarDate): activexDashInteropLib.VarDate with stdLib.VarDate = js.native
  ...
  def UTCToLocalTime(Value: activexDashInteropLib.VarDate with stdLib.VarDate): activexDashInteropLib.VarDate with stdLib.VarDate = js.native
}

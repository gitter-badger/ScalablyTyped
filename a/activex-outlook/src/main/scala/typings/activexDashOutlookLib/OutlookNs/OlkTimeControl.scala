...
class OlkTimeControl protected () extends js.Object {
  ...
  var IntervalTime: activexDashInteropLib.VarDate with stdLib.VarDate = js.native
  ...
  var ReferenceTime: activexDashInteropLib.VarDate with stdLib.VarDate = js.native
  var Style: OlTimeStyle = js.native
  var Text: java.lang.String = js.native
  var TextAlign: OlTextAlign = js.native
  var Time: activexDashInteropLib.VarDate with stdLib.VarDate = js.native

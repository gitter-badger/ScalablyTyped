...
class AppointmentItem protected () extends js.Object {
  ...
  var End: activexDashInteropLib.VarDate with stdLib.VarDate = js.native
  var EndInEndTimeZone: activexDashInteropLib.VarDate with stdLib.VarDate = js.native
  var EndTimeZone: TimeZone = js.native
  var EndUTC: activexDashInteropLib.VarDate with stdLib.VarDate = js.native
  ...
  var ReplyTime: activexDashInteropLib.VarDate with stdLib.VarDate = js.native
  ...
  var Start: activexDashInteropLib.VarDate with stdLib.VarDate = js.native
  var StartInStartTimeZone: activexDashInteropLib.VarDate with stdLib.VarDate = js.native
  var StartTimeZone: TimeZone = js.native
  var StartUTC: activexDashInteropLib.VarDate with stdLib.VarDate = js.native

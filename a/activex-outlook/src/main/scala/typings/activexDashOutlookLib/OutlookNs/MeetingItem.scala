...
class MeetingItem protected () extends js.Object {
  ...
  var DeferredDeliveryTime: activexDashInteropLib.VarDate with stdLib.VarDate = js.native
  ...
  var ExpiryTime: activexDashInteropLib.VarDate with stdLib.VarDate = js.native
  var FlagDueBy: activexDashInteropLib.VarDate with stdLib.VarDate = js.native
  ...
  var ReceivedTime: activexDashInteropLib.VarDate with stdLib.VarDate = js.native
  ...
  val RetentionExpirationDate: activexDashInteropLib.VarDate with stdLib.VarDate = js.native
  ...
  val SentOn: activexDashInteropLib.VarDate with stdLib.VarDate = js.native

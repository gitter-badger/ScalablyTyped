...
class Popup protected () extends js.Object {
  ...
  /**
    ...
    */
  def authorize(options: auth0DashJsLib.Anon_Domain, callback: Auth0Callback[_, Auth0Error]): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def passwordlessVerify(options: auth0DashJsLib.Anon_Type, callback: Auth0Callback[_, Auth0Error]): scala.Unit = js.native
  /**

...
trait Mention
  ...
  def onBlur(ev: reactLib.reactMod.ReactNs.FocusEvent[reactLib.HTMLElement with stdLib.HTMLElement]): scala.Unit = js.native
  def onChange(editorState: js.Any): scala.Unit = js.native
  def onFocus(ev: reactLib.reactMod.ReactNs.FocusEvent[reactLib.HTMLElement with stdLib.HTMLElement]): scala.Unit = js.native

...
package object libButtonButtonMod {
  type AnchorButtonProps = antdLib.Anon_Href with BaseButtonProps with (reactLib.reactMod.ReactNs.AnchorHTMLAttributes[reactLib.HTMLAnchorElement with stdLib.HTMLAnchorElement])
  ...
  type NativeButtonProps = antdLib.Anon_HtmlType with BaseButtonProps with (reactLib.reactMod.ReactNs.ButtonHTMLAttributes[reactLib.HTMLButtonElement with stdLib.HTMLButtonElement])
}

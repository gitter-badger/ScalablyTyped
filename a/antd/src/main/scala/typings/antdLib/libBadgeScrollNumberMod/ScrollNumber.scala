...
trait ScrollNumber
  ...
  def renderCurrentNumber(num: scala.Double, i: scala.Double): reactLib.reactMod.ReactNs.DetailedReactHTMLElement[antdLib.Anon_ClassName, reactLib.HTMLElement with stdLib.HTMLElement] = js.native
  def renderNumberElement(): js.UndefOr[
    java.lang.String | scala.Double | (js.Array[
      reactLib.reactMod.ReactNs.DetailedReactHTMLElement[antdLib.Anon_ClassName, reactLib.HTMLElement with stdLib.HTMLElement]
    ]) | scala.Null
  ] = js.native

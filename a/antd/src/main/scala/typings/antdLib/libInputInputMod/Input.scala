...
trait Input
  ...
  var input: reactLib.HTMLInputElement with stdLib.HTMLInputElement = js.native
  ...
  def saveInput(node: reactLib.HTMLInputElement with stdLib.HTMLInputElement): scala.Unit = js.native

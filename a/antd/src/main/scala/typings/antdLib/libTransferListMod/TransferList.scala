...
trait TransferList
  ...
  var notFoundNode: reactLib.HTMLDivElement with stdLib.HTMLDivElement = js.native
  ...
  def handleFilter(e: reactLib.reactMod.ReactNs.ChangeEvent[reactLib.HTMLInputElement with stdLib.HTMLInputElement]): scala.Unit = js.native
  ...
  def renderItem(item: antdLib.libTransferMod.TransferItem): antdLib.Anon_RenderedText = js.native

...
class default protected ()
  extends antdLib.libFormFormMod.default {
...
object default extends js.Object {
  var Item: antdLib.Anon_DefaultPropsPropTypesContextTypes = js.native
  var childContextTypes: antdLib.Anon_Vertical = js.native
  var createFormField: js.Any = js.native
  var defaultProps: antdLib.Anon_PrefixClsLayout = js.native
  var propTypes: antdLib.Anon_PrefixClsLayoutInline = js.native

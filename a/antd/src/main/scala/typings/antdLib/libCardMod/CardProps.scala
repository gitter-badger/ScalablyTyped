...
- Dropped {[ P in std.Exclude<keyof react.react.HTMLAttributes<react.HTMLDivElement & std.HTMLDivElement>, 'title'> ]: react.react.HTMLAttributes<react.HTMLDivElement & std.HTMLDivElement>[P]} */ trait CardProps extends js.Object {

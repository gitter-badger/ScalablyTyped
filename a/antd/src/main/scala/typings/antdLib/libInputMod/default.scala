...
object default extends js.Object {
  ...
  var Search: antdLib.Anon_DefaultPropsAnonInputPrefixCls = js.native
  var TextArea: antdLib.Anon_DefaultPropsAnonPrefixClsString = js.native
  var defaultProps: antdLib.Anon_PrefixClsType = js.native
  var propTypes: antdLib.Anon_TypeId = js.native

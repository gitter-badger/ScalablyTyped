...
- Dropped {[ P in std.Exclude<keyof react.react.InputHTMLAttributes<react.HTMLInputElement & std.HTMLInputElement>, antd.antd/lib/input-number.OmitAttrs> ]: react.react.InputHTMLAttributes<react.HTMLInputElement & std.HTMLInputElement>[P]} */ trait InputNumberProps extends js.Object {

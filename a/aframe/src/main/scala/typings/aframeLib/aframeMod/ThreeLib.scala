...
trait ThreeLib extends js.Object {
  ...
  var AnimationClip: aframeLib.Anon_CreateFromMorphTargetSequence = js.native
  ...
  val AnimationUtilsNs: aframeLib.Anon_ArraySlice = js.native
  ...
  val BufferGeometryUtilsNs: aframeLib.Anon_MergeBufferGeometries = js.native
  ...
  val CacheNs: aframeLib.Anon_Enabled = js.native
  ...
  var Curve: aframeLib.Anon_CreateConstructorFunc = js.native
  ...
  val CurveUtilsNs: aframeLib.Anon_TangentQuadraticBezier = js.native
  ...
  var Euler: aframeLib.Anon_RotationOrders = js.native
  var EventDispatcher: org.scalablytyped.runtime.Instantiable0[threeLib.threeMod.EventDispatcher] = js.native
  var ExtrudeBufferGeometry: aframeLib.Anon_WorldUVGeneratorShapes = js.native
  var ExtrudeGeometry: aframeLib.Anon_WorldUVGenerator = js.native
  ...
  val GeometryUtilsNs: aframeLib.Anon_Merge = js.native
  ...
  val ImageUtilsNs: aframeLib.Anon_CrossOrigin = js.native
  ...
  var KeyframeTrack: aframeLib.Anon_Parse = js.native
  ...
  var LensFlareElement: aframeLib.Anon_Shader = js.native
  ...
  var LoaderUtils: aframeLib.Anon_DecodeText = js.native
  ...
  val MathNs: aframeLib.Anon_DEG2RAD = js.native
  ...
  var Object3D: aframeLib.Anon_DefaultUp = js.native
  ...
  var Quaternion: aframeLib.Anon_Slerp = js.native
  ...
  var SSAARenderPass: aframeLib.Anon_JitterVectors = js.native
  var STLLoader: js.Any = js.native
  var Scene: org.scalablytyped.runtime.Instantiable0[threeLib.threeMod.Scene] = js.native
  val SceneUtilsNs: aframeLib.Anon_CreateMultiMaterialObject = js.native
  ...
  var Texture: aframeLib.Anon_DEFAULTIMAGE = js.native
  ...
  var Triangle: aframeLib.Anon_GetNormal = js.native
  ...
  val UniformsUtilsNs: aframeLib.Anon_MergeUniforms = js.native
  ...
  var WebGLUniforms: aframeLib.Anon_Upload = js.native

...
trait Job[T /* <: JobAttributesData */] extends js.Object {
  /**
    ...
    */
  var agenda: agendaLib.agendaMod.Agenda = js.native
  /**
  ...
  /**
    ...
    */
  def priority(value: java.lang.String): this.type = js.native
  def priority(value: scala.Double): this.type = js.native
  /**
  ...
  /**
    ...
    * @param time
    */
  def repeatAt(time: java.lang.String): this.type = js.native
  /**
  ...
  /**
    ...
    */
  def schedule(time: java.lang.String): this.type = js.native
  def schedule(time: stdLib.Date): this.type = js.native
  /**
  ...
  def unique(value: js.Any, opts: agendaLib.Anon_InsertOnly): this.type = js.native
}

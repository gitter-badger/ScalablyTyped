...
trait appFrameworkCollection extends js.Object {
  ...
  /**
    ...
    * @title $().addClass(name)
    */
  def addClass(className: java.lang.String): appFrameworkCollection = js.native
  /**
  ...
  /**
    ...
    */
  def attr(attribute: java.lang.String): js.Any = js.native
  def attr(attribute: java.lang.String, value: java.lang.String): appFrameworkCollection = js.native
  def attr(attribute: java.lang.String, value: js.Any): appFrameworkCollection = js.native
  /**
  ...
  def bind(eventName: java.lang.String, fn: js.Function1[/* e */ stdLib.Event, _]): appFrameworkCollection = js.native
  /**
    custom events since people want to do $().blur instead of $().bind("blur")
    */
  def blur(): appFrameworkCollection = js.native
  def blur(fn: js.Function1[/* e */ stdLib.Event, _]): appFrameworkCollection = js.native
  /**
    custom events since people want to do $().change instead of $().bind("change")
    */
  def change(): appFrameworkCollection = js.native
  def change(fn: js.Function1[/* e */ stdLib.Event, _]): appFrameworkCollection = js.native
  /**
  ...
  def click(fn: js.Function1[/* e */ stdLib.Event, _]): appFrameworkCollection = js.native
  def clone(deep: scala.Boolean): appFrameworkCollection = js.native
  /**
  ...
  /**
    ...
    * @title $().computedStyle()
    */
  def computedStyle(css: java.lang.String): appFrameworkCollection = js.native
  ...
  /**
    ...
    */
  def css(property: java.lang.String): js.Any = js.native
  def css(property: java.lang.String, value: js.Any): appFrameworkCollection = js.native
  /**
    ...
    */
  def data(attribute: java.lang.String): js.Any = js.native
  def data(attribute: java.lang.String, value: java.lang.String): appFrameworkCollection = js.native
  def data(attribute: java.lang.String, value: js.Any): appFrameworkCollection = js.native
  /**
  ...
  def delegate(selector: js.Any, eventName: java.lang.String, fn: js.Function1[/* e */ stdLib.Event, _]): appFrameworkCollection = js.native
  /**
    ...
    * @title $().each(function)
    */
  def each(fn: js.Function2[/* index */ scala.Double, /* item */ js.Any, _]): appFrameworkCollection = js.native
  /**
  ...
  /**
    ...
    * @title $().eq(index)
    */
  def eq(index: scala.Double): appFrameworkCollection = js.native
  /**
    custom events since people want to do $().error instead of $().bind("error")
    */
  def error(): appFrameworkCollection = js.native
  def error(fn: js.Function1[/* e */ stdLib.Event, _]): appFrameworkCollection = js.native
  /**
  ...
  /**
    ...
    * @title $().find(selector)
    */
  def find(selector: java.lang.String): appFrameworkCollection = js.native
  /**
    custom events since people want to do $().focus instead of $().bind("focus")
    */
  def focus(): appFrameworkCollection = js.native
  def focus(fn: js.Function1[/* e */ stdLib.Event, _]): appFrameworkCollection = js.native
  def forEach(fn: js.Function2[/* item */ js.Any, /* index */ scala.Double, _]): scala.Unit = js.native
  /**
    ...
    * @title $().get([index])
    */
  def get(): js.Array[stdLib.HTMLElement] = js.native
  ...
  /**
    ...
    */
  def hasClass(className: java.lang.String, element: stdLib.HTMLElement): scala.Boolean = js.native
  /**
    ...
    * @title $().height()
    */
  def height(): java.lang.String = js.native
  /**
  ...
  def html(html: java.lang.String): appFrameworkCollection = js.native
  def html(html: java.lang.String, cleanup: scala.Boolean): appFrameworkCollection = js.native
  /**
  ...
  def index(selector: js.Any): scala.Double = js.native
  def indexOf(searchElement: appFrameworkCollection): scala.Double = js.native
  def indexOf(searchElement: appFrameworkCollection, fromIndex: scala.Double): scala.Double = js.native
  /**
    ...
    */
  def insertAfter(target: js.Any): scala.Unit = js.native
  /**
  ...
  /**
    ...
    * @title $().map(function)
    */
  def map(fn: js.Function2[/* index */ scala.Double, /* item */ js.Any, _]): appFrameworkCollection = js.native
  /**
  ...
  def off(eventName: java.lang.String, fn: js.Function1[/* e */ stdLib.Event, _]): appFrameworkCollection = js.native
  def off(eventName: java.lang.String, selector: java.lang.String, fn: js.Function1[/* e */ stdLib.Event, _]): appFrameworkCollection = js.native
  /**
  ...
  def on(eventName: java.lang.String, fn: js.Function1[/* e */ stdLib.Event, _]): appFrameworkCollection = js.native
  def on(eventName: java.lang.String, selector: java.lang.String, fn: js.Function1[/* e */ stdLib.Event, _]): appFrameworkCollection = js.native
  /**
  ...
  def one(eventName: java.lang.String, fn: js.Function1[/* e */ stdLib.Event, _]): appFrameworkCollection = js.native
  /**
  ...
  /**
    ...
    */
  def prop(attribute: java.lang.String): js.Any = js.native
  def prop(attribute: java.lang.String, value: java.lang.String): appFrameworkCollection = js.native
  def prop(attribute: java.lang.String, value: js.Any): appFrameworkCollection = js.native
  def push(items: appFrameworkCollection*): scala.Double = js.native
  /**
  ...
  def remove(element: stdLib.HTMLElement): appFrameworkCollection = js.native
  def remove(selector: java.lang.String): appFrameworkCollection = js.native
  /**
    ...
    */
  def removeAttr(attribute: java.lang.String): appFrameworkCollection = js.native
  /**
    ...
    */
  def removeClass(className: java.lang.String): appFrameworkCollection = js.native
  /**
    ...
    */
  def removeProp(attribute: java.lang.String): appFrameworkCollection = js.native
  /**
    ...
    */
  def replaceClass(oldClassName: java.lang.String, newClassName: java.lang.String): appFrameworkCollection = js.native
  /**
    custom events since people want to do $().resize instead of $().bind("resize")
    */
  def resize(): appFrameworkCollection = js.native
  def resize(fn: js.Function1[/* e */ stdLib.Event, _]): appFrameworkCollection = js.native
  /**
    custom events since people want to do $().select instead of $().bind("select")
    */
  def select(): appFrameworkCollection = js.native
  def select(fn: js.Function1[/* e */ stdLib.Event, _]): appFrameworkCollection = js.native
  /**
  ...
  def slice(start: scala.Double): js.Array[appFrameworkCollection] = js.native
  def slice(start: scala.Double, end: scala.Double): js.Array[appFrameworkCollection] = js.native
  /**
    custom events since people want to do $().submit instead of $().bind("submit")
    */
  def submit(): appFrameworkCollection = js.native
  def submit(fn: js.Function1[/* e */ stdLib.Event, _]): appFrameworkCollection = js.native
  /**
  ...
  def text(text: java.lang.String): appFrameworkCollection = js.native
  /**
  ...
  def toggle(show: scala.Boolean): appFrameworkCollection = js.native
  /**
    ...
    */
  def toggleClass(name: java.lang.String): appFrameworkCollection = js.native
  def toggleClass(name: java.lang.String, state: scala.Boolean): appFrameworkCollection = js.native
  ...
  /**
    ...
    */
  def trigger(eventName: java.lang.String): appFrameworkCollection = js.native
  def trigger(eventName: java.lang.String, data: js.Any): appFrameworkCollection = js.native
  ...
  def unbind(eventName: java.lang.String): appFrameworkCollection = js.native
  def unbind(eventName: java.lang.String, fn: js.Function1[/* e */ stdLib.Event, _]): appFrameworkCollection = js.native
  /**
  ...
  def undelegate(selector: js.Any, eventName: java.lang.String, fn: js.Function1[/* e */ stdLib.Event, _]): appFrameworkCollection = js.native
  /**
  ...
  def `val`(value: java.lang.String): appFrameworkCollection = js.native
  /**
    ...
    */
  def vendorCss(transform: java.lang.String): appFrameworkCollection = js.native
  /**
    ...
    * @title $().width()
    */
  def width(): java.lang.String = js.native
}

...
trait Recordset extends js.Object {
  ...
  val BatchCollisions: activexDashInteropLib.SafeArray[Bookmark] with stdLib.SafeArray[Bookmark] = js.native
  ...
  val LastUpdated: activexDashInteropLib.VarDate with stdLib.VarDate = js.native

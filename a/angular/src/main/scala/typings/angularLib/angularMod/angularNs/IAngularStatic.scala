...
trait IAngularStatic extends js.Object {
  ...
  var version: angularLib.Anon_Full = js.native
  ...
  def isFunction(value: js.Any): /* is angular.angular.Global.Function */ scala.Boolean = js.native
  def isNumber(value: js.Any): /* is number */ scala.Boolean = js.native
  def isObject(value: js.Any): /* is std.Object */ scala.Boolean = js.native
  @JSName("isObject")

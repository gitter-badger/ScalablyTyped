...
class IFaxOutgoingJob protected () extends js.Object {
  ...
  val OriginalScheduledTime: activexDashInteropLib.VarDate with stdLib.VarDate = js.native
  ...
  val ScheduledTime: activexDashInteropLib.VarDate with stdLib.VarDate = js.native
  ...
  val SubmissionTime: activexDashInteropLib.VarDate with stdLib.VarDate = js.native
  /** Transmitting Station ID */
  val TSID: java.lang.String = js.native
  /** The time the fax job finished its transmission */
  val TransmissionEnd: activexDashInteropLib.VarDate with stdLib.VarDate = js.native
  /** The time the fax job started its transmission */
  val TransmissionStart: activexDashInteropLib.VarDate with stdLib.VarDate = js.native

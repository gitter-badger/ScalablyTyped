...
class FaxConfiguration protected () extends js.Object {
  ...
  var DiscountRateEnd: activexDashInteropLib.VarDate with stdLib.VarDate = js.native
  /** Start of the discount rate period */
  var DiscountRateStart: activexDashInteropLib.VarDate with stdLib.VarDate = js.native

...
class FaxDevice protected () extends js.Object {
  ...
  val UsedRoutingMethods: activexDashInteropLib.SafeArray[java.lang.String] with stdLib.SafeArray[java.lang.String] = js.native
  /** Answer the call */
  def AnswerCall(): scala.Unit = js.native
  /** Get the device level extention property */
  def GetExtensionProperty(bstrGUID: java.lang.String): activexDashInteropLib.SafeArray[_] with stdLib.SafeArray[_] = js.native
  /** Refresh the object */
  def Refresh(): scala.Unit = js.native
  /** Save the object */
  def Save(): scala.Unit = js.native
  /** Set the device level extention property */
  def SetExtensionProperty(bstrGUID: java.lang.String, vProperty: activexDashInteropLib.SafeArray[_] with stdLib.SafeArray[_]): scala.Unit = js.native

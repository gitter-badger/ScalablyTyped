...
class FaxDocument protected () extends js.Object {
  ...
  var ScheduleTime: activexDashInteropLib.VarDate with stdLib.VarDate = js.native
  ...
  def ConnectedSubmit(pFaxServer: IFaxServer): activexDashInteropLib.SafeArray[java.lang.String] with stdLib.SafeArray[java.lang.String] = js.native
  /** Submit the fax document on the already connected server */
  def ConnectedSubmit2(
    pFaxServer: IFaxServer,
    pvFaxOutgoingJobIDs: activexDashInteropLib.SafeArray[java.lang.String] with stdLib.SafeArray[java.lang.String]
  ): scala.Double = js.native
  /** Collection of recipients */
  def Recipients(lIndex: scala.Double): FaxRecipient = js.native
  /** Connect to server, submit the fax document, disconnect */
  def Submit(bstrFaxServerName: java.lang.String): activexDashInteropLib.SafeArray[scala.Double] with stdLib.SafeArray[scala.Double] = js.native
  /** Connect to server, submit the fax document, disconnect */

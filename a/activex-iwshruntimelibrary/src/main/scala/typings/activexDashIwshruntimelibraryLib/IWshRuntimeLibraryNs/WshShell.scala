...
class WshShell protected () extends js.Object {
  ...
  /**
    ...
    */
  def RegRead(Name: java.lang.String): java.lang.String | scala.Double | (activexDashInteropLib.SafeArray[java.lang.String] with stdLib.SafeArray[java.lang.String]) | (activexDashInteropLib.SafeArray[scala.Double] with stdLib.SafeArray[scala.Double]) = js.native
  /**

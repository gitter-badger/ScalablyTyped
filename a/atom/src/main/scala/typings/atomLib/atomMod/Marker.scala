...
trait Marker extends js.Object {
  ...
  def onDidChange(callback: js.Function1[/* event */ MarkerChangedEvent, scala.Unit]): Disposable = js.native
  // Event Subscription
  ...
  def setRange(range: RangeCompatible, params: atomLib.Anon_ReversedExclusive): scala.Boolean = js.native
  /**

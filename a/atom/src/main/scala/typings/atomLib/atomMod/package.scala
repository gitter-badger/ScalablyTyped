...
package object atomMod {
  type CommandRegistryListener[TargetType /* <: stdLib.EventTarget */] = atomLib.Anon_DidDispatch[TargetType] | (js.Function1[/* event */ CommandEvent[TargetType], scala.Unit | js.Promise[scala.Unit]])

...
trait DisplayMarkerLayer extends js.Object {
  ...
  def markBufferPosition(bufferPosition: PointCompatible, options: atomLib.Anon_InvalidateNever): DisplayMarker = js.native
  /** Create a marker with the given buffer range. */
  def markBufferRange(range: RangeCompatible): DisplayMarker = js.native
  def markBufferRange(range: RangeCompatible, options: atomLib.Anon_ReversedInvalidateNever): DisplayMarker = js.native
  /**
  ...
  def markScreenPosition(screenPosition: PointCompatible, options: atomLib.Anon_Invalidate): DisplayMarker = js.native
  // Marker creation
  /** Create a marker with the given screen range. */
  def markScreenRange(range: RangeCompatible): DisplayMarker = js.native
  def markScreenRange(range: RangeCompatible, options: atomLib.Anon_ReversedInvalidate): DisplayMarker = js.native
  /**

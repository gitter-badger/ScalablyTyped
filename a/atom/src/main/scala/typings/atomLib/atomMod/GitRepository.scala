...
class GitRepository protected () extends js.Object {
  ...
  def this(path: java.lang.String, options: atomLib.Anon_RefreshOnWindowFocusConfig) = this()
  // Checking Out
  /**
  ...
  /**
    ...
    *  and the given text.
    */
  def getLineDiffs(path: java.lang.String, text: java.lang.String): js.Array[atomLib.Anon_OldStart] = js.native

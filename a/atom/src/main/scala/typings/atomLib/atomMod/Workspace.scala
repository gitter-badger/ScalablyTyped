...
trait Workspace extends js.Object {
  ...
  def activateNextPane(): scala.Boolean = js.native
  /** Make the previous pane active. */
  def activatePreviousPane(): scala.Boolean = js.native
  /** Adds a panel item to the bottom of the editor window. */
  def addBottomPanel[T](options: atomLib.Anon_ItemVisible[T]): Panel[T] = js.native
  /** Adds a panel item to the footer. */
  def addFooterPanel[T](options: atomLib.Anon_ItemVisible[T]): Panel[T] = js.native
  /** Adds a panel item to the header. */
  def addHeaderPanel[T](options: atomLib.Anon_ItemVisible[T]): Panel[T] = js.native
  /** Adds a panel item to the left of the editor window. */
  def addLeftPanel[T](options: atomLib.Anon_ItemVisible[T]): Panel[T] = js.native
  /** Adds a panel item as a modal dialog. */
  def addModalPanel[T](options: atomLib.Anon_ItemVisiblePriority[T]): Panel[T] = js.native
  ...
  def addRightPanel[T](options: atomLib.Anon_ItemVisible[T]): Panel[T] = js.native
  /** Adds a panel item to the top of the editor window above the tabs. */
  def addTopPanel[T](options: atomLib.Anon_ItemVisible[T]): Panel[T] = js.native
  ...
  def onDidAddPaneItem(callback: js.Function1[/* event */ PaneItemObservedEvent, scala.Unit]): Disposable = js.native
  /** Invoke the given callback when a text editor is added to the workspace. */
  def onDidAddTextEditor(callback: js.Function1[/* event */ TextEditorObservedEvent, scala.Unit]): Disposable = js.native
  /** Invoke the given callback when the active pane changes. */
  def onDidChangeActivePane(callback: js.Function1[/* pane */ Pane, scala.Unit]): Disposable = js.native
  ...
  def paneContainerForURI(uri: java.lang.String): js.UndefOr[Dock | WorkspaceCenter] = js.native

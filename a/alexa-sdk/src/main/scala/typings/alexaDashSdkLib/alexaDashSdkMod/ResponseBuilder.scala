...
class ResponseBuilder protected () extends js.Object {
  ...
  /**
    ...
    */
  def audioPlayer(
    directiveType: java.lang.String,
    behavior: java.lang.String,
    url: java.lang.String,
    token: java.lang.String,
    expectedPreviousToken: java.lang.String,
  ...
  /**
    ...
    * @returns ResponseBuilder
    */
  def audioPlayerClearQueue(clearBehavior: java.lang.String): ResponseBuilder = js.native
  /**
  ...
  /**
    ...
    * @returns ResponseBuilder
    */
  def cardRenderer(cardTitle: java.lang.String, cardContent: java.lang.String, cardImage: CardImage): ResponseBuilder = js.native
  /**
    ...
    * @returns ResponseBuilder
    */
  def hint(hintText: java.lang.String): ResponseBuilder = js.native
  def hint(hintText: java.lang.String, hintType: HintType): ResponseBuilder = js.native
  /**
  ...
  /**
    ...
    * @returns ResponseBuilder
    */
  def listen(repromptSpeech: java.lang.String): ResponseBuilder = js.native
  /**
  ...
  /**
    ...
    * @returns ResponseBuilder
    */
  def speak(speechOutput: java.lang.String): ResponseBuilder = js.native
}

...
object utilsNs extends js.Object {
  ...
  object ImageUtilsNs extends js.Object {
    /**
      ...
      * @returns Image
      */
    def makeImage(url: java.lang.String): alexaDashSdkLib.alexaDashSdkMod.Image = js.native
    def makeImage(url: java.lang.String, widthPixels: scala.Double): alexaDashSdkLib.alexaDashSdkMod.Image = js.native
    def makeImage(url: java.lang.String, widthPixels: scala.Double, heightPixels: scala.Double): alexaDashSdkLib.alexaDashSdkMod.Image = js.native
    def makeImage(
      url: java.lang.String,
      widthPixels: scala.Double,
      heightPixels: scala.Double,
      size: alexaDashSdkLib.alexaDashSdkMod.ImageSourceSize
    ): alexaDashSdkLib.alexaDashSdkMod.Image = js.native
    def makeImage(
      url: java.lang.String,
      widthPixels: scala.Double,
      heightPixels: scala.Double,
  ...
  @JSName("TextUtils")
  @js.native
  object TextUtilsNs extends js.Object {
    /**
      * Creates a plain TextField object with contents : text
      * @param text contents of plain text object
      * @returns TextField
      */
    def makePlainText(text: java.lang.String): alexaDashSdkLib.alexaDashSdkMod.TextField = js.native
    /**
      * Creates a rich TextField object with contents : text
      * @param text text
      * @returns TextField
      */
    def makeRichText(text: java.lang.String): alexaDashSdkLib.alexaDashSdkMod.TextField = js.native
    /**

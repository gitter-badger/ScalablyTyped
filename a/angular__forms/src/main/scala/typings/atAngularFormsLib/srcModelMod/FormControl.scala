...
class FormControl () extends AbstractControl {
  ...
  def patchValue(value: js.Any, options: atAngularFormsLib.Anon_OnlySelfEmitEventEmitModelToViewChange): scala.Unit = js.native
  /**
  ...
  def reset(formState: js.Any, options: atAngularFormsLib.Anon_OnlySelfEmitEvent): scala.Unit = js.native
  def setValue(value: js.Any, options: atAngularFormsLib.Anon_OnlySelfEmitEventEmitModelToViewChange): scala.Unit = js.native
}

...
class DataStore[TSerialized] protected () extends js.Object {
  ...
  def markMutationComplete(hasMutationIdOptimisticResponse: apolloDashClientLib.Anon_MutationIdOptimisticResponse): scala.Unit = js.native
  def markMutationInit(mutation: apolloDashClientLib.Anon_MutationId): scala.Unit = js.native
  def markMutationResult(mutation: apolloDashClientLib.Anon_MutationIdResult): scala.Unit = js.native
  def markQueryResult(

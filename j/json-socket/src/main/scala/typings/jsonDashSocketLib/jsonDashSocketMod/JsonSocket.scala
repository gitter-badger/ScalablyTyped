...
trait JsonSocket
  ...
  /**
    ...
    */
  def sendEndMessage(message: js.Any, callback: js.Function1[/* err */ nodeLib.Error with stdLib.Error, scala.Unit]): scala.Unit = js.native
  /**
  ...
  /**
    ...
    * @param callback will be called after the message has been sent
    */
  def sendMessage(message: js.Any, callback: js.Function1[/* err */ nodeLib.Error with stdLib.Error, scala.Unit]): scala.Unit = js.native
}

...
class Connection protected () extends BaseConnection {
  ...
  def authorize(
    ...
    callback: js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* res */ UserInfo, scala.Unit]
  ...
  def limits(
    callback: js.Function2[
      ...
      /* res */ js.UndefOr[scala.Nothing], 
      scala.Unit
    ]
  ): js.Promise[jsforceLib.limitsDashInfoMod.LimitsInfo] = js.native

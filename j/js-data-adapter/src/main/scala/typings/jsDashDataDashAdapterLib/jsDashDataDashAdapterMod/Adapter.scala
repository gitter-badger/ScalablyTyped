...
object Adapter extends js.Object {
  def extend(): jsDashDataDashAdapterLib.Anon_Extend = js.native
  def extend(instanceProps: jsDashDataDashAdapterLib.jsDashDataDashAdapterMod.IDict): jsDashDataDashAdapterLib.Anon_Extend = js.native
  def extend(
  ...
  ): jsDashDataDashAdapterLib.Anon_Extend = js.native
}

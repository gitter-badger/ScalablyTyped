...
trait ActionButton extends ActionButtonState {
  ...
  def state(target: ActionButton, state: jpmLib.Anon_DisabledLabel): ActionButtonState = js.native
  ...
  def state(target: BrowserWindow, state: jpmLib.Anon_DisabledLabel): ActionButtonState = js.native
  def state(target: Tab): ActionButtonState = js.native
  def state(target: Tab, state: jpmLib.Anon_DisabledLabel): ActionButtonState = js.native
  @JSName("state")
  def state_tab(target: jpmLib.jpmLibStrings.tab): ActionButtonState = js.native
  @JSName("state")
  def state_tab(target: jpmLib.jpmLibStrings.tab, state: jpmLib.Anon_DisabledLabel): ActionButtonState = js.native
  @JSName("state")
  def state_window(target: jpmLib.jpmLibStrings.window): ActionButtonState = js.native
  @JSName("state")
  def state_window(target: jpmLib.jpmLibStrings.window, state: jpmLib.Anon_DisabledLabel): ActionButtonState = js.native
}

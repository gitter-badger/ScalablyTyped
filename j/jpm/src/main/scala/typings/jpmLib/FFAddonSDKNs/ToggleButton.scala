...
trait ToggleButton extends ToggleButtonState {
  ...
  def state(target: BrowserWindow, state: jpmLib.Anon_Disabled): ToggleButtonState = js.native
  def state(target: Tab): ToggleButtonState = js.native
  def state(target: Tab, state: jpmLib.Anon_Disabled): ToggleButtonState = js.native
  def state(target: ToggleButton): ToggleButtonState = js.native
  def state(target: ToggleButton, state: jpmLib.Anon_Disabled): ToggleButtonState = js.native
  @JSName("state")
  def state_tab(target: jpmLib.jpmLibStrings.tab): ToggleButtonState = js.native
  @JSName("state")
  def state_tab(target: jpmLib.jpmLibStrings.tab, state: jpmLib.Anon_Disabled): ToggleButtonState = js.native
  @JSName("state")
  def state_window(target: jpmLib.jpmLibStrings.window): ToggleButtonState = js.native
  @JSName("state")
  def state_window(target: jpmLib.jpmLibStrings.window, state: jpmLib.Anon_Disabled): ToggleButtonState = js.native
}

...
object diaNs extends js.Object {
  ...
  class Cell ()
    ...
    def getEmbeddedCells(opt: jointjsLib.Anon_Deep): js.Array[Cell] = js.native
  ...
  class Element () extends Cell {
    ...
    def position(opt: jointjsLib.Anon_ParentRelative): jointjsLib.jointjsMod.gNs.Point = js.native
    def position(x: scala.Double, y: scala.Double): this.type = js.native
    def position(x: scala.Double, y: scala.Double, opt: jointjsLib.Anon_ParentRelativeDeep): this.type = js.native
  ...
  class LinkView () extends CellViewGeneric[Link] {
    var options: jointjsLib.Anon_ShortLinkLength = js.native
    ...
    def sendToken(token: stdLib.SVGElement, opt: jointjsLib.Anon_Duration): scala.Unit = js.native
    def sendToken(token: stdLib.SVGElement, opt: jointjsLib.Anon_Duration, callback: js.Function0[scala.Unit]): scala.Unit = js.native
  ...
  object ElementNs extends js.Object {
    ...
    type PositionType = java.lang.String | jointjsLib.Anon_Name
  }
  ...
  object PaperNs extends js.Object {
    ...
    trait GradientOptions extends js.Object {
      var id: js.UndefOr[java.lang.String] = js.undefined
      var stops: js.Array[jointjsLib.Anon_Offset]

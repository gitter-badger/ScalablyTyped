...
trait CreateElement extends js.Object {
  ...
  /**
    ...
    * Note that unlike with React itself, multiple children must be placed into an array.
    */
  def apply[P](specString: java.lang.String): reactLib.reactMod.ReactNs.DOMElement[P, reactLib.Element with stdLib.Element] = js.native
  /**
    ...
    * Note that unlike with React itself, multiple children must be placed into an array.
    */
  def apply[P](specString: java.lang.String, children: reactLib.reactMod.ReactNs.ReactNode): reactLib.reactMod.ReactNs.DOMElement[P, reactLib.Element with stdLib.Element] = js.native
  def apply[P](specString: java.lang.String, props: reactLib.reactMod.ReactNs.HTMLAttributes[js.Object]): reactLib.reactMod.ReactNs.DOMElement[P, reactLib.Element with stdLib.Element] = js.native
  def apply[P](
    specString: java.lang.String,
    props: reactLib.reactMod.ReactNs.HTMLAttributes[js.Object],
    children: reactLib.reactMod.ReactNs.ReactNode
  ): reactLib.reactMod.ReactNs.DOMElement[P, reactLib.Element with stdLib.Element] = js.native
}

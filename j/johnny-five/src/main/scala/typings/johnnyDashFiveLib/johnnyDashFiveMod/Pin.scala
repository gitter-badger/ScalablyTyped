...
class Pin protected () extends js.Object {
  ...
  def read(
    cb: js.Function2[/* error */ nodeLib.Error with stdLib.Error, /* value */ scala.Double, scala.Unit]
...
object Pin extends js.Object {
  def read(
    pin: scala.Double,
    cb: js.Function2[/* error */ nodeLib.Error with stdLib.Error, /* data */ scala.Double, scala.Unit]
  ): scala.Unit = js.native

...
trait Visitor extends js.Object {
  ...
  def discoverVertex(req: jsgraphLib.Anon_U): scala.Unit
  def examineEdge(req: jsgraphLib.Anon_E): scala.Unit
  def examineVertex(req: jsgraphLib.Anon_U): scala.Unit
  def finishVertex(req: jsgraphLib.Anon_U): scala.Unit
  def grayTarget(req: jsgraphLib.Anon_E): scala.Unit
  def initializeVertex(req: jsgraphLib.Anon_U): scala.Unit
  def nonTreeEdge(req: jsgraphLib.Anon_E): scala.Unit
  def startVertex(req: jsgraphLib.Anon_U): scala.Unit
}

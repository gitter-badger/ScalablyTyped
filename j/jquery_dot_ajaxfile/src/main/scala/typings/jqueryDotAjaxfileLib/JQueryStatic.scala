...
trait JQueryStatic extends js.Object {
  ...
  /**
    ...
    */
  def apply(elementArray: js.Array[stdLib.Element]): JQuery = js.native
  /**
    * Accepts a string containing a CSS selector which is then used to match a set of elements.
    *
    * @param element A DOM element to wrap in a jQuery object.
    */
  def apply(element: stdLib.Element): JQuery = js.native
  /**
  ...
  def apply(html: java.lang.String, ownerDocument: stdLib.Document): JQuery = js.native
  /**
    * Accepts a string containing a CSS selector which is then used to match a set of elements.
    *
  ...
  /**
    ...
    */
  def apply(selector: java.lang.String): JQuery = js.native
  def apply(selector: java.lang.String, context: JQuery): JQuery = js.native
  def apply(selector: java.lang.String, context: stdLib.Element): JQuery = js.native
  /**
  ...
  /**
    ...
    */
  def queue(element: stdLib.Element, queueName: java.lang.String, callback: js.Function): JQuery = js.native
  /**
    * Manipulate the queue of functions to be executed on the matched element.
    *
    ...
    */
  def queue(element: stdLib.Element, queueName: java.lang.String, newQueue: js.Array[js.Function]): JQuery = js.native
  /**
    ...
    */
  def removeData(element: stdLib.Element): JQuery = js.native
  def removeData(element: stdLib.Element, name: java.lang.String): JQuery = js.native
  /**

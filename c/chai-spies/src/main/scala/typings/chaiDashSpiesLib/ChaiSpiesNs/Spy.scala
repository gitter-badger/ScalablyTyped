...
trait Spy extends js.Object {
  /**
    ...
    */
  def apply(): SpyFunc0Proxy[scala.Unit] = js.native
  def apply[R](fn: SpyFunc0[R]): SpyFunc0Proxy[R] = js.native
  def apply[R](name: java.lang.String, fn: SpyFunc0[R]): SpyFunc0Proxy[R] = js.native
  def apply[A1, R](fn: SpyFunc1[A1, R]): SpyFunc1Proxy[A1, R] = js.native
  def apply[A1, R](name: java.lang.String, fn: SpyFunc1[A1, R]): SpyFunc1Proxy[A1, R] = js.native
  def apply[A1, A2, R](fn: SpyFunc2[A1, A2, R]): SpyFunc2Proxy[A1, A2, R] = js.native
  def apply[A1, A2, R](name: java.lang.String, fn: SpyFunc2[A1, A2, R]): SpyFunc2Proxy[A1, A2, R] = js.native
  def apply[A1, A2, A3, R](fn: SpyFunc3[A1, A2, A3, R]): SpyFunc3Proxy[A1, A2, A3, R] = js.native
  def apply[A1, A2, A3, R](name: java.lang.String, fn: SpyFunc3[A1, A2, A3, R]): SpyFunc3Proxy[A1, A2, A3, R] = js.native
  def apply[A1, A2, A3, A4, R](fn: SpyFunc4[A1, A2, A3, A4, R]): SpyFunc4Proxy[A1, A2, A3, A4, R] = js.native
  def apply[A1, A2, A3, A4, R](name: java.lang.String, fn: SpyFunc4[A1, A2, A3, A4, R]): SpyFunc4Proxy[A1, A2, A3, A4, R] = js.native
  def apply[A1, A2, A3, A4, A5, R](fn: SpyFunc5[A1, A2, A3, A4, A5, R]): SpyFunc5Proxy[A1, A2, A3, A4, A5, R] = js.native
  def apply[A1, A2, A3, A4, A5, R](name: java.lang.String, fn: SpyFunc5[A1, A2, A3, A4, A5, R]): SpyFunc5Proxy[A1, A2, A3, A4, A5, R] = js.native
  def apply[A1, A2, A3, A4, A5, A6, R](fn: SpyFunc6[A1, A2, A3, A4, A5, A6, R]): SpyFunc6Proxy[A1, A2, A3, A4, A5, A6, R] = js.native
  def apply[A1, A2, A3, A4, A5, A6, R](name: java.lang.String, fn: SpyFunc6[A1, A2, A3, A4, A5, A6, R]): SpyFunc6Proxy[A1, A2, A3, A4, A5, A6, R] = js.native
  def apply[A1, A2, A3, A4, A5, A6, A7, R](fn: SpyFunc7[A1, A2, A3, A4, A5, A6, A7, R]): SpyFunc7Proxy[A1, A2, A3, A4, A5, A6, A7, R] = js.native
  def apply[A1, A2, A3, A4, A5, A6, A7, R](name: java.lang.String, fn: SpyFunc7[A1, A2, A3, A4, A5, A6, A7, R]): SpyFunc7Proxy[A1, A2, A3, A4, A5, A6, A7, R] = js.native
  ...
  def apply[A1, A2, A3, A4, A5, A6, A7, A8, R](name: java.lang.String, fn: SpyFunc8[A1, A2, A3, A4, A5, A6, A7, A8, R]): SpyFunc8Proxy[A1, A2, A3, A4, A5, A6, A7, A8, R] = js.native
  ...
  def apply[A1, A2, A3, A4, A5, A6, A7, A8, A9, R](name: java.lang.String, fn: SpyFunc9[A1, A2, A3, A4, A5, A6, A7, A8, A9, R]): SpyFunc9Proxy[A1, A2, A3, A4, A5, A6, A7, A8, A9, R] = js.native
  ...
  def apply[A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, R](name: java.lang.String, fn: SpyFunc10[A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, R]): SpyFunc10Proxy[A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, R] = js.native
  def `object`(methods: js.Array[java.lang.String]): js.Any = js.native
  /**
    ...
    */
  def `object`(name: java.lang.String, methods: js.Array[java.lang.String]): js.Any = js.native
  def `object`[T](methods: T): T = js.native
  def `object`[T](name: java.lang.String, methods: T): T = js.native
  /**

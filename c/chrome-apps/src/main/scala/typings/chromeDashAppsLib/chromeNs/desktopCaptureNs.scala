...
object desktopCaptureNs extends js.Object {
  val DesktopCaptureSourceType: chromeDashAppsLib.Anon_SCREEN = js.native
  /**
  ...
  def chooseDesktopMedia(
    sources: js.Array[
      chromeDashAppsLib.chromeNs.ToStringLiteral[
        chromeDashAppsLib.Anon_SCREEN, 
        java.lang.String, 
        stdLib.Exclude[
          java.lang.String, 
          /* import warning: ImportType.apply Failed type conversion: chrome-apps.Anon_SCREEN[keyof chrome-apps.Anon_SCREEN] */ js.Any
        ]
      ]
    ],

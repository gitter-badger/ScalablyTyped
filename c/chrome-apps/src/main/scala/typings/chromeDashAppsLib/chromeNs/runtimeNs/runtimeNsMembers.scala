...
object runtimeNsMembers extends js.Object {
  ...
  val onRestartRequired: chromeDashAppsLib.chromeNs.eventsNs.Event[
    js.Function1[
      /* reason */ chromeDashAppsLib.chromeNs.ToStringLiteral[
        chromeDashAppsLib.Anon_APPUPDATE, 
        java.lang.String, 
        stdLib.Exclude[
          java.lang.String, 
  ...
  /**
    ...
    */
  def getBackgroundPage(callback: js.Function1[/* backgroundPage */ js.UndefOr[chromeDashAppsLib.Window], scala.Unit]): scala.Unit = js.native
  /**

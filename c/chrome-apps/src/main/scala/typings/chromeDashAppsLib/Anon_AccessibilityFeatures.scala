...
trait Anon_AccessibilityFeatures extends js.Object {
  ...
  /**
    ...
    */
  val bluetoothLowEnergyNs: Anon_Connect
  // #endregion
  ...
  /**
    ...
    */
  val bluetoothNs: Anon_GetAdapterState
  /**
    * @since Chrome 37
    * @requires Manifest: 'bluetooth': {...}
    ...
    */
  val bluetoothSocketNs: Anon_CreateCallback
  // #endregion
  ...
  /**
    ...
    */
  val certificateProviderNs: Anon_PinRequestType
  // #endregion
  ...
  /**
    ...
    */
  val clipboardNs: Anon_DataItemType
  // #endregion
  ...
  /**
    ...
    */
  val desktopCaptureNs: Anon_DesktopCaptureSourceType
  // #endregion
  ...
  /**
    ...
    */
  val diagnosticsNs: Anon_SendPacket
  // #endregion
  ...
  /**
    ...
    */
  val displaySourceNs: Anon_ErrorType
  // #endregion
  // #region chrome.dns
  /////////
  // DNS //
  ...
  /**
    ...
    * @since Chrome 39.
    **/
  val extensionTypesNs: Anon_Internal
  // #endregion
  ...
  /**
    ...
    */
  val fileSystemNs: Anon_ChildChangeType
  // #endregion
  ...
  /**
    ...
    */
  val fileSystemProviderNs: Anon_ProviderError
  // #endregion
  // #region chrome.gcm
  ////////////////////////////
  ...
  /**
    ...
    * @since Chrome 38.
    */
  val hidNs: Anon_GetDevicesOptions
  // #endregion
  // #region chrome.i18n
  /////////////////////////////////
  ...
  /**
    ...
    */
  val managementNs: Anon_ExtensionDisabledReason
  // #endregion
  // #region chrome.mdns
  //////////
  // mDNS //
  ...
  /**
    ...
    * @since Chrome 31
    */
  val mdnsNs: Anon_MAXSERVICEINSTANCESPEREVENT
  // #endregion
  ...
  /**
    ...
    */
  val mediaGalleriesNs: Anon_GetMediaFileSystems
  ...
  /**
    ...
    */
  val notificationsNs: Anon_TemplateType
  // #endregion
  ...
  /**
    ...
    */
  val platformKeysNs: Anon_ClientCertificateType
  // #endregion
  // #region chrome.power
  ///////////
  // Power //
  ...
  /**
    ...
    * @since Chrome 22
    */
  val runtimeNs: Anon_OnInstalledReason
  // #endregion
  ...
  /**
    ...
    */
  val signedInDevicesNs: Anon_Get
  // #endregion
  ...
  /**
    ...
    * @since Chrome 33.
    */
  val socketsNs: Anon_TcpTcpServer
  ...
  /**
    ...
    * @since Chrome 27
    */
  val syncFileSystemNs: Anon_ServiceStatus
  ...
  /**
    ...
    */
  val virtualKeyboardNs: Anon_RestrictFeatures
  // #endregion
  ...
  /**
    ...
    * @since Chrome 43.
    */
  val vpnProviderNs: Anon_PlatformMessage
  // #endregion
  ...
  /**
    ...
    */
  val webViewRequestNs: Anon_RequestMatcher
  // #endregion
  // #region methods
  /////////////
  // METHODS //

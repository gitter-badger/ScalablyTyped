...
@js.native
trait Anon_ServiceStatus extends js.Object {
  ...
  /**
    ...
    */
  val FileStatus: Anon_SYNCED = js.native
  /**
    * @enum
    * 'initializing'
    ...
    */
  val ServiceStatus: Anon_INITIALIZING = js.native
  ...
  /**
    ...
    * @see ServiceStatus
    */
  val onServiceStatusChanged: chromeDashAppsLib.chromeNs.eventsNs.Event[js.Function1[/* detail */ Anon_StateDescription, scala.Unit]] = js.native
  /**
  ...
  def getUsageAndQuota(
    ...
    callback: js.Function1[/* info */ Anon_UsageBytes, scala.Unit]
  ): scala.Unit = js.native
  /**

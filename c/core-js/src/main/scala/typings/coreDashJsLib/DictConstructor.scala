...
trait DictConstructor
  ...
  def entries[T](`object`: Dict[T]): (nodeLib.IterableIterator[js.Tuple2[stdLib.PropertyKey, T]]) with (stdLib.IterableIterator[js.Tuple2[stdLib.PropertyKey, T]]) = js.native
  def every[T](
    `object`: Dict[T],
  ...
  def keys[T](`object`: Dict[T]): nodeLib.IterableIterator[stdLib.PropertyKey] with stdLib.IterableIterator[stdLib.PropertyKey] = js.native
  def map[T, U](
    `object`: Dict[T],
  ...
  def values[T](`object`: Dict[T]): nodeLib.IterableIterator[T] with stdLib.IterableIterator[T] = js.native
}

...
@js.native
object libraryWebImmediateModMembers extends js.Object {
  ...
  def addLocale(lang: java.lang.String, locale: coreDashJsLib.coreNs.Locale): coreDashJsLib.Anon_Version = js.native

...
trait ModelAnimationCollection extends js.Object {
  ...
  def add(options: cesiumLib.Anon_NameStartTime): ModelAnimation = js.native
  def addAll(): js.Array[ModelAnimation] = js.native
  def addAll(options: cesiumLib.Anon_StartTimeDelay): js.Array[ModelAnimation] = js.native

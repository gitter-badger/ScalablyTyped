...
trait Resource extends js.Object {
  ...
  def delete(options: cesiumLib.Anon_ResponseType): js.UndefOr[js.Promise[_]] = js.native
  def fetch(): js.UndefOr[js.Promise[_]] = js.native
  def fetch(options: cesiumLib.Anon_ResponseType): js.UndefOr[js.Promise[_]] = js.native
  ...
  def getDerivedResource(options: cesiumLib.Anon_UrlQueryParametersTemplateValuesHeadersProxyRetryCallback): Resource = js.native
  ...
  def head(options: cesiumLib.Anon_ResponseType): js.UndefOr[js.Promise[_]] = js.native
  def options(): js.UndefOr[js.Promise[_]] = js.native
  def options(options: cesiumLib.Anon_ResponseType): js.UndefOr[js.Promise[_]] = js.native
  def patch(data: js.Any): js.UndefOr[js.Promise[_]] = js.native
  def patch(data: js.Any, options: cesiumLib.Anon_ResponseType): js.UndefOr[js.Promise[_]] = js.native
  def post(data: js.Any): js.UndefOr[js.Promise[_]] = js.native
  def post(data: js.Any, options: cesiumLib.Anon_Data): js.UndefOr[js.Promise[_]] = js.native
  def put(data: js.Any): js.UndefOr[js.Promise[_]] = js.native
  def put(data: js.Any, options: cesiumLib.Anon_ResponseType): js.UndefOr[js.Promise[_]] = js.native

...
class PolygonGeometry protected ()
  ...
  def this(options: cesiumLib.Anon_PolygonHierarchy) = this()
}
...
object PolygonGeometry extends js.Object {
  ...
  def fromPositions(options: cesiumLib.Anon_PositionsHeight): cesiumLib.cesiumMod.CesiumNs.PolygonGeometry = js.native

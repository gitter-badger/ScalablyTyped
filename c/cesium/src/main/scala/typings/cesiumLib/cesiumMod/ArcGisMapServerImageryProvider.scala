...
class ArcGisMapServerImageryProvider protected ()
  ...
  def this(options: cesiumLib.Anon_UrlTileDiscardPolicy) = this()
  def this(options: cesiumLib.Anon_UrlTileDiscardPolicy, layers: java.lang.String) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var usingPrecachedTiles: scala.Boolean = js.native
  /* CompleteClass */

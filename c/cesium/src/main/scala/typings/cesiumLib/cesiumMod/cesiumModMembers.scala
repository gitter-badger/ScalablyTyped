...
@js.native
object cesiumModMembers extends js.Object {
  def barycentricCoordinates(
    point: cesiumLib.cesiumMod.CesiumNs.Cartesian2,
    p0: cesiumLib.cesiumMod.CesiumNs.Cartesian2,
    p1: cesiumLib.cesiumMod.CesiumNs.Cartesian2,
    p2: cesiumLib.cesiumMod.CesiumNs.Cartesian2
  ...
  def binarySearch(
    array: js.Array[_],
    itemToFind: js.Any,
    comparator: cesiumLib.cesiumMod.CesiumNs.binarySearchNs.Comparator
  ): scala.Double = js.native
  def cancelAnimationFrame(requestID: scala.Double): js.UndefOr[scala.Nothing] = js.native
  def clone(`object`: js.Any): js.Any = js.native
  def clone(`object`: js.Any, deep: scala.Boolean): js.Any = js.native
  def combine(): js.Any = js.native
  def combine(object1: js.Any): js.Any = js.native
  def combine(object1: js.Any, object2: js.Any): js.Any = js.native
  ...
  def createOpenStreetMapImageryProvider(options: cesiumLib.Anon_UrlFileExtensionRectangle): cesiumLib.cesiumMod.CesiumNs.UrlTemplateImageryProvider = js.native
  def createTangentSpaceDebugPrimitive(options: cesiumLib.Anon_GeometryLength): cesiumLib.cesiumMod.CesiumNs.Primitive = js.native
  ...
  def createTileMapServiceImageryProvider(options: cesiumLib.Anon_UrlFileExtensionCredit): cesiumLib.cesiumMod.CesiumNs.UrlTemplateImageryProvider = js.native
  ...
  def formatError(`object`: js.Any): java.lang.String = js.native
  def getFilenameFromUri(uri: java.lang.String): java.lang.String = js.native
  ...
  def loadWithXhr(options: cesiumLib.Anon_UrlResponseType): js.Promise[_] = js.native
  ...
  def mergeSort(
    array: js.Array[_],
    comparator: cesiumLib.cesiumMod.CesiumNs.mergeSortNs.Comparator,
    userDefinedObject: js.Any
  ): js.UndefOr[scala.Nothing] = js.native
  def objectToQuery(obj: js.Any): java.lang.String = js.native
  ...
  def requestAnimationFrame(callback: cesiumLib.cesiumMod.CesiumNs.requestAnimationFrameNs.Callback): scala.Double = js.native
  def sampleTerrain(
  ...
  def viewerDragDropMixin(viewer: cesiumLib.cesiumMod.CesiumNs.Viewer, options: cesiumLib.Anon_DropTarget): js.UndefOr[scala.Nothing] = js.native

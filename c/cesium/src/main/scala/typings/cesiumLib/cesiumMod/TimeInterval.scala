...
class TimeInterval ()
  ...
  def this(options: cesiumLib.Anon_Start) = this()
}
...
object TimeInterval extends js.Object {
  ...
  def fromIso8601(options: cesiumLib.Anon_Iso8601): cesiumLib.cesiumMod.CesiumNs.TimeInterval = js.native
  def fromIso8601(options: cesiumLib.Anon_Iso8601, result: cesiumLib.cesiumMod.CesiumNs.TimeInterval): cesiumLib.cesiumMod.CesiumNs.TimeInterval = js.native
  def intersect(
    left: cesiumLib.cesiumMod.CesiumNs.TimeInterval,
    right: cesiumLib.cesiumMod.CesiumNs.TimeInterval,
    result: cesiumLib.cesiumMod.CesiumNs.TimeInterval

...
trait Viewer extends js.Object {
  ...
  def flyTo(target: DataSource, options: cesiumLib.Anon_DurationMaximumHeight): js.Promise[scala.Boolean] = js.native
  ...
  def flyTo(target: EntityCollection, options: cesiumLib.Anon_DurationMaximumHeight): js.Promise[scala.Boolean] = js.native
  def flyTo(target: Entity, options: cesiumLib.Anon_DurationMaximumHeight): js.Promise[scala.Boolean] = js.native
  def flyTo(target: js.Array[Entity]): js.Promise[scala.Boolean] = js.native
  def flyTo(target: js.Array[Entity], options: cesiumLib.Anon_DurationMaximumHeight): js.Promise[scala.Boolean] = js.native
  ...
  def flyTo(
    ...
    options: cesiumLib.Anon_DurationMaximumHeight

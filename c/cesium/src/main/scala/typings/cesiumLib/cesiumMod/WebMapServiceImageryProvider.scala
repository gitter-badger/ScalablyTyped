...
class WebMapServiceImageryProvider protected ()
  ...
  def this(options: cesiumLib.Anon_UrlLayers) = this()
  /* CompleteClass */
...
object WebMapServiceImageryProvider extends js.Object {
  var DefaultParameters: cesiumLib.Anon_Service = js.native
  var GetFeatureInfoDefaultParameters: cesiumLib.Anon_ServiceVersion = js.native
}

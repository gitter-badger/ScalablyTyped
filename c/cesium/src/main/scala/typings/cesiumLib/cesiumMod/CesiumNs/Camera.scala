...
trait Camera extends js.Object {
  ...
  def flyTo(options: cesiumLib.Anon_Destination): scala.Unit = js.native
  def flyToBoundingSphere(boundingSphere: BoundingSphere): scala.Unit = js.native
  def flyToBoundingSphere(boundingSphere: BoundingSphere, options: cesiumLib.Anon_Duration): scala.Unit = js.native
  ...
  def setView(options: cesiumLib.Anon_DestinationOrientation): scala.Unit = js.native

...
object GeoJsonDataSource extends js.Object {
  ...
  def load(data: cesiumLib.cesiumMod.CesiumNs.Resource, options: cesiumLib.Anon_SourceUriMarkerSize): js.Promise[cesiumLib.cesiumMod.CesiumNs.GeoJsonDataSource] = js.native
  def load(data: java.lang.String): js.Promise[cesiumLib.cesiumMod.CesiumNs.GeoJsonDataSource] = js.native
  def load(data: java.lang.String, options: cesiumLib.Anon_SourceUriMarkerSize): js.Promise[cesiumLib.cesiumMod.CesiumNs.GeoJsonDataSource] = js.native
  def load(data: js.Object): js.Promise[cesiumLib.cesiumMod.CesiumNs.GeoJsonDataSource] = js.native
  def load(data: js.Object, options: cesiumLib.Anon_SourceUriMarkerSize): js.Promise[cesiumLib.cesiumMod.CesiumNs.GeoJsonDataSource] = js.native
}

...
class GridImageryProvider ()
  ...
  def this(options: cesiumLib.Anon_TilingSchemeEllipsoid) = this()
  def this(options: cesiumLib.Anon_TilingSchemeEllipsoid, backgroundColor: cesiumLib.cesiumMod.CesiumNs.Color) = this()
  /* CompleteClass */

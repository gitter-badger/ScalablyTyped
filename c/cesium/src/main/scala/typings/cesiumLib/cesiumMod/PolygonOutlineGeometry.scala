...
class PolygonOutlineGeometry protected ()
  ...
  def this(options: cesiumLib.Anon_PolygonHierarchyHeight) = this()
}
...
object PolygonOutlineGeometry extends js.Object {
  ...
  def fromPositions(options: cesiumLib.Anon_PositionsHeightExtrudedHeight): cesiumLib.cesiumMod.CesiumNs.PolygonOutlineGeometry = js.native

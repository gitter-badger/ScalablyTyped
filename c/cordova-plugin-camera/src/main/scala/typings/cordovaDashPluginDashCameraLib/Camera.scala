...
object Camera extends js.Object {
  ...
  var PictureSourceType: cordovaDashPluginDashCameraLib.Anon_PHOTOLIBRARY = js.native
  // Used only on iOS
  var PopoverArrowDirection: cordovaDashPluginDashCameraLib.Anon_ARROWUP = js.native
}

...
trait ChaiJQueryStatic extends js.Object {
  @JSName("Event")
  var Event_Original: jqueryLib.JQueryEventConstructor = js.native
  var ajaxSettings: jqueryLib.JQueryAjaxSettings = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("param")
  var param_Original: jqueryLib.JQueryParam = js.native
  // Properties
  var support: jqueryLib.JQuerySupport = js.native
  /**
  ...
  /**
    ...
    */
  def apply(`object`: jqueryLib.JQuery[stdLib.HTMLElement]): ChaiJQuery = js.native
  /**
    * Accepts a string containing a CSS selector which is then used to match a set of elements.
    *
  ...
  def apply(selector: java.lang.String, context: jqueryLib.JQuery[stdLib.HTMLElement]): ChaiJQuery = js.native
  ...
  /**
    ...
    */
  def Callbacks(): jqueryLib.JQueryCallback = js.native
  def Callbacks(flags: java.lang.String): jqueryLib.JQueryCallback = js.native
  /**
    * A constructor function that returns a chainable utility object with methods to register multiple callbacks into callback queues, invoke callback queues, and relay the success or failure state of any synchronous or asynchronous function.
    *
    * @param beforeStart A function that is called just before the constructor returns.
    */
  def Deferred[T](): jqueryLib.JQueryDeferred[T] = js.native
  def Deferred[T](beforeStart: js.Function1[/* deferred */ jqueryLib.JQueryDeferred[T], _]): jqueryLib.JQueryDeferred[T] = js.native
  /**
  ...
  /**
    ...
    */
  def ajax(settings: jqueryLib.JQueryAjaxSettings): jqueryLib.JQueryXHR = js.native
  /**
    * Perform an asynchronous HTTP (Ajax) request.
    *
    ...
    * @param settings A set of key/value pairs that configure the Ajax request. All settings are optional. A default can be set for any option with $.ajaxSetup().
    */
  def ajax(url: java.lang.String): jqueryLib.JQueryXHR = js.native
  def ajax(url: java.lang.String, settings: jqueryLib.JQueryAjaxSettings): jqueryLib.JQueryXHR = js.native
  /**
  ...
  def ajaxPrefilter(
    ...
    handler: js.Function3[
      /* opts */ js.Any, 
      /* originalOpts */ jqueryLib.JQueryAjaxSettings, 
  ...
  /**
    ...
    */
  def ajaxSetup(options: jqueryLib.JQueryAjaxSettings): scala.Unit = js.native
  /**
  ...
  /**
    ...
    * @param success A callback function that is executed if the request succeeds.
    */
  def getScript(url: java.lang.String): jqueryLib.JQueryXHR = js.native
  def getScript(
    url: java.lang.String,
    success: js.Function3[
  ...
  /**
    ...
    */
  def when[T](deferreds: (T | jqueryLib.JQueryPromise[T])*): jqueryLib.JQueryPromise[T] = js.native
}

...
trait Event extends js.Object {
  ...
  /**
    ...
    */
  @JSName("fire")
  var fire_Original: consulLib.Anon_NamePayload = js.native
  /**
  ...
  /**
    * Fires a new user event
    */
  def fire[TData](opts: consulLib.consulMod.ConsulNs.EventNs.FireOptions): Thenable[TData] = js.native
  /**
    * Fires a new user event
    */
  def fire[TData](opts: consulLib.consulMod.ConsulNs.EventNs.FireOptions, callback: Callback[TData]): scala.Unit = js.native
  /**
    * Lists the most recent events an agent has seen
    */
  ...
  def list[TData](opts: consulLib.consulMod.ConsulNs.EventNs.ListOptions): Thenable[TData] = js.native
  /**
    * Lists the most recent events an agent has seen
    */
  def list[TData](opts: consulLib.consulMod.ConsulNs.EventNs.ListOptions, callback: Callback[TData]): scala.Unit = js.native
}

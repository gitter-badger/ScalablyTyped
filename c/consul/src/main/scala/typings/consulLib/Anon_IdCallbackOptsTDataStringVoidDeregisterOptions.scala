...
@js.native
trait Anon_IdCallbackOptsTDataStringVoidDeregisterOptions extends js.Object {
  ...
  def apply[TData](opts: consulLib.consulMod.ConsulNs.AgentNs.ServiceNs.DeregisterOptions): consulLib.consulMod.ConsulNs.Thenable[TData] = js.native
  def apply[TData](

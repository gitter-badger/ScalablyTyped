...
trait ChartAPI extends js.Object {
  var axis: c3Lib.Anon_Labels = js.native
  @JSName("data")
  var data_Original: c3Lib.Anon_TargetIds = js.native
  var legend: c3Lib.Anon_ShowTargetIds = js.native
  @JSName("regions")
  ...
  /**
    ...
    */
  def flow(args: c3Lib.Anon_Json): scala.Unit = js.native
  /**
    * Force to redraw.
    */
  ...
  /**
    ...
    */
  def load(args: c3Lib.Anon_Url): scala.Unit = js.native
  /**
    * Update regions.
  ...
  def resize(size: c3Lib.Anon_Width): scala.Unit = js.native
  /**

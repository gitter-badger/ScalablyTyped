...
object toolsNs extends js.Object {
  ...
  def keystrokeToArray(lang: org.scalablytyped.runtime.StringDictionary[js.Any], keystroke: scala.Double): ckeditorLib.Anon_Display = js.native
  def keystrokeToString(lang: org.scalablytyped.runtime.StringDictionary[js.Any], keystroke: scala.Double): ckeditorLib.Anon_DisplayAria = js.native
  ...
  object styleNs extends js.Object {
    ...
    object parseNs extends js.Object {
      ...
      def border(value: java.lang.String): ckeditorLib.Anon_Width = js.native
      def margin(value: java.lang.String): ckeditorLib.Anon_Top = js.native
    }

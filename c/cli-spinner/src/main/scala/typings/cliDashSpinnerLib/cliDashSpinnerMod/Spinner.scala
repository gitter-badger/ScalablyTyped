...
object Spinner extends js.Object {
  def setDefaultSpinnerDelay(spinnerDelay: scala.Double): cliDashSpinnerLib.Anon_SetDefaultSpinnerString = js.native
  def setDefaultSpinnerString(spinnerString: java.lang.String): cliDashSpinnerLib.Anon_SetDefaultSpinnerString = js.native
  def setDefaultSpinnerString(spinnerString: scala.Double): cliDashSpinnerLib.Anon_SetDefaultSpinnerString = js.native
}

...
trait CreateDomainOptions extends js.Object {
  /**
    ...
    */
  var aggregateLock: js.UndefOr[cqrsDashDomainLib.Anon_TypeHost] = js.undefined
  /**
  ...
  /**
    ...
    * hint settings like: [eventstore](https://github.com/adrai/node-eventstore#provide-implementation-for-storage)
    */
  var deduplication: js.UndefOr[cqrsDashDomainLib.Anon_TypeMongodb] = js.undefined
  /**
  ...
  /**
    ...
    */
  var eventStore: js.UndefOr[cqrsDashDomainLib.Anon_Type] = js.undefined
  /**

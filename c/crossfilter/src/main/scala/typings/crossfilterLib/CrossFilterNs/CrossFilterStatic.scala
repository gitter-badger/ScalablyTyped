...
trait CrossFilterStatic extends js.Object {
  @JSName("bisect")
  var bisect_Original: crossfilterLib.Anon_Array = js.native
  @JSName("heap")
  var heap_Original: crossfilterLib.Anon_ArrayLo = js.native
  @JSName("heapselect")
  var heapselect_Original: crossfilterLib.Anon_ArrayLoHi = js.native
  @JSName("insertionsort")
  var insertionsort_Original: crossfilterLib.Anon_ArrayLoHiBy = js.native
  @JSName("quicksort")
  var quicksort_Original: crossfilterLib.Anon_ArrayLoHiBy = js.native

...
object conversionNs extends js.Object {
  ...
  def upcastAttributeToAttribute(config: atCkeditorCkeditor5DashEngineLib.Anon_View): js.Function = js.native
  def upcastElementToAttribute(config: atCkeditorCkeditor5DashEngineLib.Anon_ViewModel): js.Function = js.native
  def upcastElementToElement(config: atCkeditorCkeditor5DashEngineLib.Anon_ViewModelConverterPriority): js.Function = js.native
  def upcastElementToMarker(config: atCkeditorCkeditor5DashEngineLib.Anon_ViewModelConverterPriorityMatcherPattern): js.Function = js.native
}

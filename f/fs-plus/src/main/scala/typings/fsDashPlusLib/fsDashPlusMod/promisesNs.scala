...
object promisesNs extends js.Object {
  ...
  @JSName("mkdtemp")
  def mkdtemp_buffer(prefix: java.lang.String, options: fsDashPlusLib.fsDashPlusLibStrings.buffer): js.Promise[nodeLib.Buffer] = js.native
  /**
  ...
  @JSName("readdir")
  def readdir_buffer(path: nodeLib.fsMod.PathLike, options: fsDashPlusLib.fsDashPlusLibStrings.buffer): js.Promise[js.Array[nodeLib.Buffer]] = js.native
  /**
  ...
  @JSName("readlink")
  def readlink_buffer(path: nodeLib.fsMod.PathLike, options: fsDashPlusLib.fsDashPlusLibStrings.buffer): js.Promise[nodeLib.Buffer] = js.native
  /**
  ...
  @JSName("realpath")
  def realpath_buffer(path: nodeLib.fsMod.PathLike, options: fsDashPlusLib.fsDashPlusLibStrings.buffer): js.Promise[nodeLib.Buffer] = js.native
  /**

...
class Default protected () extends js.Object {
  ...
  def build(date: js.Any, direction: js.Any): fullcalendarLib.Anon_ValidUnzonedRange = js.native
  def build(date: js.Any, direction: js.Any, forceToValid: scala.Boolean): fullcalendarLib.Anon_ValidUnzonedRange = js.native
  ...
  def buildNext(currentDateProfile: js.Any): fullcalendarLib.Anon_ValidUnzonedRange = js.native
  def buildPrev(currentDateProfile: js.Any): fullcalendarLib.Anon_ValidUnzonedRange = js.native

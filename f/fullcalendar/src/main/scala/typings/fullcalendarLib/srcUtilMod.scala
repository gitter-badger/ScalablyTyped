...
object srcUtilMod extends js.Object {
  ...
  def constrainPoint(point: js.Any, rect: js.Any): fullcalendarLib.Anon_LeftTop = js.native
  ...
  def diffPoints(point1: js.Any, point2: js.Any): fullcalendarLib.Anon_LeftTop = js.native
  ...
  def getClientRect(el: js.Any): fullcalendarLib.Anon_Left = js.native
  def getClientRect(el: js.Any, origin: js.Any): fullcalendarLib.Anon_Left = js.native
  def getContentRect(el: js.Any, origin: js.Any): fullcalendarLib.Anon_Left = js.native
  ...
  def getOuterRect(el: js.Any): fullcalendarLib.Anon_Left = js.native
  def getOuterRect(el: js.Any, origin: js.Any): fullcalendarLib.Anon_Left = js.native
  def getRectCenter(rect: js.Any): fullcalendarLib.Anon_LeftTop = js.native
  ...
  def intersectRects(rect1: js.Any, rect2: js.Any): fullcalendarLib.fullcalendarLibNumbers.`false` | fullcalendarLib.Anon_LeftRight = js.native

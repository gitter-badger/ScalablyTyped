...
class Monitor protected ()
  ...
  /**
    ...
    */
  def parseCommand(command: java.lang.String): foreverDashMonitorLib.foreverDashMonitorLibNumbers.`false` | foreverDashMonitorLib.Anon_CommandArgs = js.native
  def parseCommand(command: java.lang.String, args: js.Array[java.lang.String]): foreverDashMonitorLib.foreverDashMonitorLibNumbers.`false` | foreverDashMonitorLib.Anon_CommandArgs = js.native
  /**

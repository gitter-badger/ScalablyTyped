...
class Object ()
  ...
  /**
    ...
    * @param calculateopt use coordinates of current position instead of .oCoords / .aCoords
  	 ...
  	 */
  def getBoundingRect(): fabricLib.Anon_Left = js.native
  def getBoundingRect(absoluteopt: scala.Boolean): fabricLib.Anon_Left = js.native
  def getBoundingRect(absoluteopt: scala.Boolean, calculateopt: scala.Boolean): fabricLib.Anon_Left = js.native
  /**

...
class Connection () extends js.Object {
  ...
  /**
    ...
    */
  def commit(callback: js.Function1[/* err */ (nodeLib.Error with stdLib.Error) | scala.Null, scala.Unit]): scala.Unit = js.native
  /**
    * @summary
  ...
  def connect(
    ...
    callback: js.Function1[/* err */ (nodeLib.Error with stdLib.Error) | scala.Null, scala.Unit]
  ...
  /**
    ...
    * @param callback function(err), where err is error object in case of error.
    */
  def rollback(callback: js.Function1[/* err */ (nodeLib.Error with stdLib.Error) | scala.Null, scala.Unit]): scala.Unit = js.native
  /**
  ...
  /**
    ...
    * @param callback function(err), where err is error object in case of error.
    */
  def start(callback: js.Function1[/* err */ (nodeLib.Error with stdLib.Error) | scala.Null, scala.Unit]): scala.Unit = js.native
  /**

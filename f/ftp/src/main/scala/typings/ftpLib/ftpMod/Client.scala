...
trait Client
  ...
  /**
    ...
    */
  def abort(callback: js.Function1[/* error */ nodeLib.Error with stdLib.Error, scala.Unit]): scala.Unit = js.native
  def append(
  ...
  /**
    ...
    */
  def ascii(callback: js.Function1[/* error */ nodeLib.Error with stdLib.Error, scala.Unit]): scala.Unit = js.native
  /**
    * Sets the transfer data type to binary (default at time of connection).
    */
  def binary(callback: js.Function1[/* error */ nodeLib.Error with stdLib.Error, scala.Unit]): scala.Unit = js.native
  /**
    * Optional "standard" commands (RFC 959)
    * Changes the working directory to the parent of the current directory
    */
  def cdup(callback: js.Function1[/* error */ nodeLib.Error with stdLib.Error, scala.Unit]): scala.Unit = js.native
  /**
  ...
  def cwd(
    ...
    callback: js.Function2[
      ...
      /* currentDir */ js.UndefOr[java.lang.String], 
      scala.Unit
    ]
  ): scala.Unit = js.native
  /**
  ...
  def lastMod(
    path: java.lang.String,
    callback: js.Function2[/* error */ nodeLib.Error with stdLib.Error, /* lastMod */ stdLib.Date, scala.Unit]
  ): scala.Unit = js.native
  def list(
    callback: js.Function2[
      /* error */ nodeLib.Error with stdLib.Error, 
  ...
  /**
    ...
    */
  def logout(callback: js.Function1[/* error */ nodeLib.Error with stdLib.Error, scala.Unit]): scala.Unit = js.native
  def mkdir(
    path: java.lang.String,
    callback: js.Function1[/* error */ nodeLib.Error with stdLib.Error, scala.Unit]
  ): scala.Unit = js.native
  ...
  /**
    ...
    */
  def pwd(
    callback: js.Function2[/* error */ nodeLib.Error with stdLib.Error, /* path */ java.lang.String, scala.Unit]
  ): scala.Unit = js.native
  /**
  ...
  def size(
    path: java.lang.String,
    callback: js.Function2[/* error */ nodeLib.Error with stdLib.Error, /* size */ scala.Double, scala.Unit]
  ): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def system(
    callback: js.Function2[/* error */ nodeLib.Error with stdLib.Error, /* OS */ java.lang.String, scala.Unit]
  ): scala.Unit = js.native
}

...
trait FeedParser
  ...
  var errors: js.Array[nodeLib.Error with stdLib.Error] = js.native
  ...
  def handleError(e: nodeLib.Error with stdLib.Error): scala.Unit = js.native
  def handleItem(
  ...
  def handleSaxError(e: nodeLib.Error with stdLib.Error): scala.Unit = js.native

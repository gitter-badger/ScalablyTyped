...
object fluxxorModMembers extends js.Object {
  ...
  def FluxChildMixin(react: fluxxorLib.Anon_CreateFactory): fluxxorLib.fluxxorMod.FluxxorNs.FluxChildMixin = js.native
  def FluxMixin(react: fluxxorLib.Anon_CreateFactory): fluxxorLib.fluxxorMod.FluxxorNs.FluxMixin = js.native

...
object ffiDashNapiModMembers extends js.Object {
  ...
  val DynamicLibrary: ffiDashNapiLib.Anon_FLAGS = js.native
  ...
  val ForeignFunction: ffiDashNapiLib.Anon_Ptr = js.native
  ...
  val VariadicForeignFunction: ffiDashNapiLib.Anon_PtrRet = js.native
  val ffiType: ffiDashNapiLib.Anon_Type = js.native
  val types: ffiDashNapiLib.Anon_Void = js.native

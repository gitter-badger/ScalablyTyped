...
class Class_Buffer () extends Class__object {
  ...
  /**
  	 ...
  	 * 
  	 */
  def entries(): nodeLib.Iterable[_] with stdLib.Iterable[_] = js.native
  /**
  	 * 
  ...
  /**
  	 ...
  	 * 
  	 */
  def keys(): nodeLib.Iterable[_] with stdLib.Iterable[_] = js.native
  /**
  	 * 
  ...
  /**
  	 ...
  	 * 
  	 */
  def values(): nodeLib.Iterable[_] with stdLib.Iterable[_] = js.native
  /**
  	 * 

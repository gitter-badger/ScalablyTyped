...
trait QuerySnapshot extends js.Object {
  ...
  val docs: coreDashJsLib.Array[QueryDocumentSnapshot] with js.Array[QueryDocumentSnapshot] = js.native
  ...
  /**
    ...
    * snapshot events.
    */
  def docChanges(): coreDashJsLib.Array[DocumentChange] with js.Array[DocumentChange] = js.native
  def docChanges(options: SnapshotListenOptions): coreDashJsLib.Array[DocumentChange] with js.Array[DocumentChange] = js.native
  /**

...
object fractalNs extends js.Object {
  ...
  object apiNs extends js.Object {
    ...
    object assetsNs extends js.Object {
      @js.native
      class Asset ()
        extends atFrctlFractalLib.fractalMod.fractalNs.coreNs.entitiesNs.Entity {
      ...
      trait AssetCollection
        extends atFrctlFractalLib.fractalMod.fractalNs.coreNs.entitiesNs.EntityCollection[Asset] {
      ...
      @js.native
      trait AssetSource
        extends atFrctlFractalLib.fractalMod.fractalNs.coreNs.mixinsNs.Source[vinylLib.vinylMod.File, js.Any] {
    ...
    object componentsNs extends js.Object {
      ...
      class Component protected ()
        extends atFrctlFractalLib.fractalMod.fractalNs.coreNs.entitiesNs.Entity {
        def this(config: js.Object, files: atFrctlFractalLib.fractalMod.fractalNs.apiNs.filesNs.FileCollection, resources: atFrctlFractalLib.fractalMod.fractalNs.apiNs.assetsNs.AssetCollection, parent: atFrctlFractalLib.fractalMod.fractalNs.coreNs.entitiesNs.Entity) = this()
        ...
        def variants(): atFrctlFractalLib.fractalMod.fractalNs.apiNs.variantsNs.VariantCollection = js.native
      }
      
      @js.native
      trait ComponentCollection
        extends atFrctlFractalLib.fractalMod.fractalNs.coreNs.entitiesNs.EntityCollection[Component] {
      ...
      trait ComponentSource
        extends atFrctlFractalLib.fractalMod.fractalNs.coreNs.entitiesNs.EntitySource[Component, ComponentConfig] {
    ...
    object docsNs extends js.Object {
      ...
      class Doc protected ()
        extends atFrctlFractalLib.fractalMod.fractalNs.coreNs.entitiesNs.Entity {
        def this(config: js.Any, content: java.lang.String, parent: atFrctlFractalLib.fractalMod.fractalNs.coreNs.entitiesNs.Entity) = this()
        val isAsset: js.UndefOr[scala.Nothing] = js.native
        @JSName("isCollection")
      ...
      @js.native
      trait DocCollection
        extends atFrctlFractalLib.fractalMod.fractalNs.coreNs.entitiesNs.EntityCollection[Doc] {
      ...
      @js.native
      trait DocSource
        extends atFrctlFractalLib.fractalMod.fractalNs.coreNs.entitiesNs.EntitySource[Doc, DocConfig] {
    ...
    object filesNs extends js.Object {
      ...
      trait FileCollection
        extends atFrctlFractalLib.fractalMod.fractalNs.coreNs.mixinsNs.Collection[File] {
        ...
        def matchItems(
          items: atFrctlFractalLib.fractalMod.fractalNs.coreNs.mixinsNs.Collection[File],
    ...
    object variantsNs extends js.Object {
      ...
      class Variant protected ()
        extends atFrctlFractalLib.fractalMod.fractalNs.coreNs.entitiesNs.Entity {
        def this(config: js.Object, view: js.Any, resources: atFrctlFractalLib.fractalMod.fractalNs.apiNs.assetsNs.AssetCollection, parent: atFrctlFractalLib.fractalMod.fractalNs.apiNs.componentsNs.Component) = this()
        val baseHandle: java.lang.String = js.native
        val content: java.lang.String = js.native
        var editorMode: java.lang.String = js.native
        var editorScope: java.lang.String = js.native
      ...
      trait VariantCollection
        extends atFrctlFractalLib.fractalMod.fractalNs.coreNs.entitiesNs.EntityCollection[Variant] {
        val referencedBy: js.Array[_] = js.native
        val references: js.Array[_] = js.native
      ...
      object Variant extends js.Object {
        def create(
          ...
          view: js.Any,
          resources: atFrctlFractalLib.fractalMod.fractalNs.apiNs.assetsNs.AssetCollection,
          parent: atFrctlFractalLib.fractalMod.fractalNs.apiNs.componentsNs.Component
        ): atFrctlFractalLib.fractalMod.fractalNs.apiNs.variantsNs.Variant = js.native
      }
  ...
  object cliNs extends js.Object {
    ...
    class Console () extends js.Object {
      var theme: atFrctlFractalLib.fractalMod.CliTheme = js.native
  ...
  object coreNs extends js.Object {
    ...
    object entitiesNs extends js.Object {
      ...
      abstract class Entity ()
        extends atFrctlFractalLib.fractalMod.fractalNs.coreNs.mixinsNs.Entity {
      ...
      trait EntityCollection[T /* <: Entity */]
        extends atFrctlFractalLib.fractalMod.fractalNs.coreNs.mixinsNs.Entity
           with atFrctlFractalLib.fractalMod.fractalNs.coreNs.mixinsNs.Collection[T] {
    ...
    object mixinsNs extends js.Object {
      ...
      abstract class Entity () extends js.Object {
        ...
        val source: atFrctlFractalLib.fractalMod.fractalNs.coreNs.entitiesNs.EntitySource[atFrctlFractalLib.fractalMod.fractalNs.coreNs.entitiesNs.Entity, _] = js.native
  ...
  object webNs extends js.Object {
    ...
    @js.native
    class Web ()
      extends atFrctlFractalLib.fractalMod.fractalNs.coreNs.mixinsNs.ConfigurableEmitter[WebConfig] {
      def builder(): Builder = js.native
      def builder(config: WebBuilderConfig): Builder = js.native
      def defaultTheme(): atFrctlFractalLib.fractalMod.WebTheme = js.native
      def defaultTheme(instance: atFrctlFractalLib.fractalMod.WebTheme): this.type = js.native
    ...
    trait WebBuilderConfig extends js.Object {
      ...
      var ext: js.UndefOr[java.lang.String] = js.undefined
      var theme: js.UndefOr[atFrctlFractalLib.fractalMod.WebTheme | java.lang.String] = js.undefined
    ...
    trait WebConfig extends js.Object {
      ...
      var `builder.theme`: js.UndefOr[atFrctlFractalLib.fractalMod.WebTheme | java.lang.String] = js.undefined
      ...
      var `server.theme`: js.UndefOr[atFrctlFractalLib.fractalMod.WebTheme | java.lang.String] = js.undefined

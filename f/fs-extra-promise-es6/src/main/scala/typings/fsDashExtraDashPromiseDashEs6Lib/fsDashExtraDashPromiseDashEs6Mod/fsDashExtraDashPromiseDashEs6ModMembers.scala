...
object fsDashExtraDashPromiseDashEs6ModMembers extends js.Object {
  ...
  def appendFileAsync(filename: java.lang.String, data: js.Any): js.Promise[scala.Unit] = js.native
  def appendFileAsync(filename: java.lang.String, data: js.Any, option: OpenOptions): js.Promise[scala.Unit] = js.native
  def appendFileAsync(filename: java.lang.String, data: js.Any, option: java.lang.String): js.Promise[scala.Unit] = js.native
  ...
  def chmodAsync(path: java.lang.String, mode: java.lang.String): js.Promise[scala.Unit] = js.native
  def chmodAsync(path: java.lang.String, mode: scala.Double): js.Promise[scala.Unit] = js.native
  ...
  def chownAsync(path: java.lang.String, uid: scala.Double, gid: scala.Double): js.Promise[scala.Unit] = js.native
  ...
  def close(fd: scala.Double, callback: js.Function1[/* err */ nodeLib.Error with stdLib.Error, scala.Unit]): scala.Unit = js.native
  def closeAsync(fd: scala.Double): js.Promise[scala.Unit] = js.native
  ...
  def copy(
    ...
    callback: js.Function1[
      (/* err */ nodeLib.Error with stdLib.Error) | (/* src */ java.lang.String), 
  ...
  def copyAsync(src: java.lang.String, dest: java.lang.String): js.Promise[scala.Unit] = js.native
  def copyAsync(
    src: java.lang.String,
    dest: java.lang.String,
    filter: js.Function1[/* src */ java.lang.String, scala.Boolean]
  ...
  def createFileAsync(file: java.lang.String): js.Promise[scala.Unit] = js.native
  ...
  def createReadStream(path: java.lang.String, options: fsDashExtraDashPromiseDashEs6Lib.Anon_Flags): ReadStream = js.native
  def createReadStream(path: nodeLib.Buffer): ReadStream = js.native
  def createReadStream(path: nodeLib.Buffer, options: fsDashExtraDashPromiseDashEs6Lib.Anon_Flags): ReadStream = js.native
  def createWriteStream(path: java.lang.String): WriteStream = js.native
  def createWriteStream(path: java.lang.String, options: fsDashExtraDashPromiseDashEs6Lib.Anon_FlagsEncoding): WriteStream = js.native
  def createWriteStream(path: nodeLib.Buffer): WriteStream = js.native
  def createWriteStream(path: nodeLib.Buffer, options: fsDashExtraDashPromiseDashEs6Lib.Anon_FlagsEncoding): WriteStream = js.native
  def ensureDir(path: java.lang.String, cb: js.Function1[/* err */ nodeLib.Error with stdLib.Error, scala.Unit]): scala.Unit = js.native
  ...
  def existsAsync(path: java.lang.String): js.Promise[scala.Boolean] = js.native
  ...
  def fchmodAsync(fd: scala.Double, mode: java.lang.String): js.Promise[scala.Unit] = js.native
  def fchmodAsync(fd: scala.Double, mode: scala.Double): js.Promise[scala.Unit] = js.native
  ...
  def fchownAsync(fd: scala.Double, uid: scala.Double, gid: scala.Double): js.Promise[scala.Unit] = js.native
  ...
  def fstat(
    fd: scala.Double,
    callback: js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* stats */ Stats, scala.Unit]
  ): scala.Unit = js.native
  def fstatAsync(fd: scala.Double): js.Promise[Stats] = js.native
  def fstatSync(fd: scala.Double): Stats = js.native
  def fsync(fd: scala.Double): scala.Unit = js.native
  def fsync(fd: scala.Double, callback: js.Function1[/* err */ nodeLib.Error with stdLib.Error, scala.Unit]): scala.Unit = js.native
  def fsyncAsync(fd: scala.Double): js.Promise[scala.Unit] = js.native
  ...
  def futimesAsync(fd: scala.Double, atime: scala.Double, mtime: scala.Double): js.Promise[scala.Unit] = js.native
  ...
  def isDirectoryAsync(path: java.lang.String): js.Promise[scala.Boolean] = js.native
  ...
  def lchmodAsync(path: java.lang.String, mode: java.lang.String): js.Promise[scala.Unit] = js.native
  def lchmodAsync(path: java.lang.String, mode: scala.Double): js.Promise[scala.Unit] = js.native
  ...
  def lchownAsync(path: java.lang.String, uid: scala.Double, gid: scala.Double): js.Promise[scala.Unit] = js.native
  ...
  def linkAsync(srcpath: java.lang.String, dstpath: java.lang.String): js.Promise[scala.Unit] = js.native
  ...
  def lstatAsync(path: java.lang.String): js.Promise[Stats] = js.native
  ...
  def mkdirAsync(path: java.lang.String): js.Promise[scala.Unit] = js.native
  def mkdirAsync(path: java.lang.String, mode: java.lang.String): js.Promise[scala.Unit] = js.native
  def mkdirAsync(path: java.lang.String, mode: scala.Double): js.Promise[scala.Unit] = js.native
  ...
  def mkdirpAsync(dir: java.lang.String): js.Promise[scala.Unit] = js.native
  ...
  def mkdirsAsync(dir: java.lang.String): js.Promise[scala.Unit] = js.native
  ...
  def open(
    ...
    mode: java.lang.String,
    callback: js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* fs */ scala.Double, scala.Unit]
  ): scala.Unit = js.native
  def openAsync(path: java.lang.String, flags: java.lang.String): js.Promise[scala.Double] = js.native
  def openAsync(path: java.lang.String, flags: java.lang.String, mode: java.lang.String): js.Promise[scala.Double] = js.native
  ...
  def outputFileAsync(file: java.lang.String, data: js.Any): js.Promise[scala.Unit] = js.native
  ...
  def outputJSONAsync(file: java.lang.String, data: js.Any): js.Promise[scala.Unit] = js.native
  ...
  def readFile(
    filename: java.lang.String,
    callback: js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* data */ nodeLib.Buffer, scala.Unit]
  ): scala.Unit = js.native
  def readFile(
    filename: java.lang.String,
    options: OpenOptions,
    callback: js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* data */ java.lang.String, scala.Unit]
  ): scala.Unit = js.native
  def readFile(
    filename: java.lang.String,
  ...
  def readFileAsync(filename: java.lang.String): js.Promise[nodeLib.Buffer] = js.native
  def readFileAsync(filename: java.lang.String, options: OpenOptions): js.Promise[java.lang.String] = js.native
  def readFileAsync(filename: java.lang.String, options: java.lang.String): js.Promise[java.lang.String] = js.native
  ...
  def readJSONAsync(file: java.lang.String): js.Promise[scala.Unit] = js.native
  def readJSONAsync(file: java.lang.String, options: OpenOptions): js.Promise[scala.Unit] = js.native
  ...
  def readdirAsync(path: java.lang.String): js.Promise[js.Array[java.lang.String]] = js.native
  ...
  def readlinkAsync(path: java.lang.String): js.Promise[java.lang.String] = js.native
  ...
  def realpathAsync(path: java.lang.String): js.Promise[java.lang.String] = js.native
  def realpathAsync(path: java.lang.String, cache: java.lang.String): js.Promise[java.lang.String] = js.native
  ...
  def removeAsync(dir: java.lang.String): js.Promise[scala.Unit] = js.native
  ...
  def renameAsync(oldPath: java.lang.String, newPath: java.lang.String): js.Promise[scala.Unit] = js.native
  ...
  def rmdirAsync(path: java.lang.String): js.Promise[scala.Unit] = js.native
  ...
  def statAsync(path: java.lang.String): js.Promise[Stats] = js.native
  ...
  def symlinkAsync(srcpath: java.lang.String, dstpath: java.lang.String): js.Promise[scala.Unit] = js.native
  def symlinkAsync(srcpath: java.lang.String, dstpath: java.lang.String, `type`: nodeLib.fsMod.symlinkNs.Type): js.Promise[scala.Unit] = js.native
  ...
  def truncateAsync(fd: scala.Double, len: scala.Double): js.Promise[scala.Unit] = js.native
  ...
  def unlinkAsync(path: java.lang.String): js.Promise[scala.Unit] = js.native
  ...
  def utimesAsync(path: java.lang.String, atime: scala.Double, mtime: scala.Double): js.Promise[scala.Unit] = js.native
  ...
  def watch(filename: java.lang.String, options: fsDashExtraDashPromiseDashEs6Lib.Anon_PersistentBoolean): FSWatcher = js.native
  def watch(
    filename: java.lang.String,
    options: fsDashExtraDashPromiseDashEs6Lib.Anon_PersistentBoolean,
  ...
  def writeFileAsync(filename: java.lang.String, data: js.Any): js.Promise[scala.Unit] = js.native
  def writeFileAsync(filename: java.lang.String, data: js.Any, options: OpenOptions): js.Promise[scala.Unit] = js.native
  def writeFileAsync(filename: java.lang.String, data: js.Any, options: java.lang.String): js.Promise[scala.Unit] = js.native
  ...
  def writeJSONAsync(file: java.lang.String, `object`: js.Any): js.Promise[scala.Unit] = js.native
  def writeJSONAsync(file: java.lang.String, `object`: js.Any, options: OpenOptions): js.Promise[scala.Unit] = js.native

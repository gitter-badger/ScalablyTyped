...
trait Anon_Find extends js.Object {
  ...
  def find(queryphrase: java.lang.String, params: Anon_TabIdCaseSensitive): js.Promise[Anon_Count] = js.native
  /**
    * Highlight a range
    * @param [params] highlightResults parameters
    */
  def highlightResults(): scala.Unit = js.native
  def highlightResults(params: Anon_RangeIndex): scala.Unit = js.native
  /**

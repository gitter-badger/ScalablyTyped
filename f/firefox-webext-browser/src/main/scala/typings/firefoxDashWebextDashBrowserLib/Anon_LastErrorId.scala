...
@js.native
trait Anon_LastErrorId extends js.Object {
  ...
  /**
    ...
    */
  val onBrowserUpdateAvailable: js.UndefOr[WebExtEvent[js.Function0[scala.Unit]]] = js.native
  /** Fired when a connection is made from either an extension process or a content script. */
  val onConnect: WebExtEvent[
    js.Function1[/* port */ firefoxDashWebextDashBrowserLib.browserNs.runtimeNs.Port, scala.Unit]
  ] = js.native
  /** Fired when a connection is made from another extension. */
  val onConnectExternal: WebExtEvent[
    js.Function1[/* port */ firefoxDashWebextDashBrowserLib.browserNs.runtimeNs.Port, scala.Unit]
  ] = js.native
  /**
    ...
    */
  val onInstalled: WebExtEvent[js.Function1[/* details */ Anon_Reason, scala.Unit]] = js.native
  /**
  ...
  val onMessage: WebExtEvent[
    js.Function3[
      ...
      /* sendResponse */ js.Function1[/* response */ js.UndefOr[_], scala.Unit], 
      scala.Boolean | js.Promise[_] | scala.Unit
    ]
  ] = js.native
  /**
  ...
  /**
    ...
    * profiles.
    */
  val onStartup: WebExtEvent[js.Function0[scala.Unit]] = js.native
  /**
    ...
    * @deprecated Unsupported on Firefox at this time.
    */
  val onSuspend: js.UndefOr[WebExtEvent[js.Function0[scala.Unit]]] = js.native
  /**
    * Sent after onSuspend to indicate that the app won't be unloaded after all.
    * @deprecated Unsupported on Firefox at this time.
    */
  val onSuspendCanceled: js.UndefOr[WebExtEvent[js.Function0[scala.Unit]]] = js.native
  /**
    ...
    */
  val onUpdateAvailable: WebExtEvent[js.Function1[/* details */ Anon_Version, scala.Unit]] = js.native
  /**
  ...
  def connect(extensionId: java.lang.String, connectInfo: Anon_NameIncludeTlsChannelId): firefoxDashWebextDashBrowserLib.browserNs.runtimeNs.Port = js.native
  /**
  ...
  /**
    ...
    * manifest file.
    */
  def getManifest(): firefoxDashWebextDashBrowserLib.browserNs.underscoreManifestNs.WebExtensionManifest = js.native
  /**
  ...
  def sendMessage(extensionId: java.lang.String, message: js.Any, options: Anon_IncludeTlsChannelId): js.Promise[_] = js.native
  /**
    * Sends a single message to event listeners within your extension/app or a different extension/app. Similar to
    * `runtime.connect` but only sends a single message, with an optional response. If sending to your extension, the
    * `runtime.onMessage` event will be fired in each page, or `runtime.onMessageExternal`, if a different extension.
  ...
  def sendMessage(message: js.Any, options: Anon_IncludeTlsChannelId): js.Promise[_] = js.native
  /**

...
@js.native
trait Anon_ACTIONMENUTOPLEVELLIMITCreate extends js.Object {
  /* menus properties */
  /**
  ...
  /**
    ...
    */
  def create(createProperties: Anon_TypeIdIcons): scala.Double | java.lang.String = js.native
  def create(createProperties: Anon_TypeIdIcons, callback: js.Function0[scala.Unit]): scala.Double | java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  def overrideContext(contextOptions: Anon_ShowDefaultsContext): scala.Unit = js.native
  /**
  ...
  def update(id: java.lang.String, updateProperties: Anon_TypeIconsKey): js.Promise[scala.Unit] = js.native
  /**
    * Updates a previously created context menu item.
    * @param id The ID of the item to update.
    * @param updateProperties The properties to update. Accepts the same values as the create function.
    */
  def update(id: scala.Double, updateProperties: Anon_TypeIconsKey): js.Promise[scala.Unit] = js.native
}

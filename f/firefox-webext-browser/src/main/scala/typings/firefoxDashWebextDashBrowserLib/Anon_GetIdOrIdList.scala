...
@js.native
trait Anon_GetIdOrIdList extends js.Object {
  /**
  ...
  val onMoved: WebExtEvent[
    js.Function2[/* id */ java.lang.String, /* moveInfo */ Anon_ParentIdIndexOldParentId, scala.Unit]
  ] = js.native
  /**
  ...
  val onRemoved: WebExtEvent[
    js.Function2[/* id */ java.lang.String, /* removeInfo */ Anon_ParentIdIndex, scala.Unit]
  ] = js.native
  /**
  ...
  def move(id: java.lang.String, destination: Anon_ParentId): js.Promise[
    js.UndefOr[firefoxDashWebextDashBrowserLib.browserNs.bookmarksNs.BookmarkTreeNode]
  ] = js.native

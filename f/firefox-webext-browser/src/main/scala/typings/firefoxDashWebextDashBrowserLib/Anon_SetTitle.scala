...
@js.native
trait Anon_SetTitle extends js.Object {
  ...
  /**
    ...
    */
  def setBadgeBackgroundColor(details: Anon_Color): js.Promise[scala.Unit] = js.native
  /**
    * Sets the badge text for the browser action. The badge is displayed on top of the icon.
    * @param details Specifies to which tab or window the value should be set, or from which one it should be
    *     retrieved. If no tab nor window is specified, the global value is set or retrieved.
    */
  def setBadgeText(details: Anon_Text): js.Promise[scala.Unit] = js.native
  /**
    * Sets the text color for the badge.
    * @param details Specifies to which tab or window the value should be set, or from which one it should be
    *     retrieved. If no tab nor window is specified, the global value is set or retrieved.
    */
  def setBadgeTextColor(details: Anon_Color): js.Promise[_] = js.native
  /**
    ...
    *     retrieved. If no tab nor window is specified, the global value is set or retrieved.
    */
  def setIcon(details: Anon_ImageData): js.Promise[scala.Unit] = js.native
  /**
    * Sets the html document to be opened as a popup when the user clicks on the browser action's icon.
    * @param details Specifies to which tab or window the value should be set, or from which one it should be
    *     retrieved. If no tab nor window is specified, the global value is set or retrieved.
    */
  def setPopup(details: Anon_Popup): js.Promise[scala.Unit] = js.native
  ...
  /**
    ...
    *     retrieved. If no tab nor window is specified, the global value is set or retrieved.
    */
  def setTitle(details: Anon_TitleTabId): js.Promise[scala.Unit] = js.native
}

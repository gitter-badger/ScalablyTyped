...
@js.native
trait Anon_TabIdEval extends js.Object {
  ...
  def eval(expression: java.lang.String, options: Anon_FrameURL): js.Promise[js.UndefOr[js.Object]] = js.native
  /**
  ...
  def reload(reloadOptions: Anon_IgnoreCache): scala.Unit = js.native
}

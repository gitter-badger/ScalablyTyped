...
@js.native
trait Anon_GetAccounts extends js.Object {
  /* identity events */
  /**
  ...
  def getAuthToken(details: Anon_Interactive): js.Promise[
    js.UndefOr[js.Array[firefoxDashWebextDashBrowserLib.browserNs.identityNs.AccountInfo]]
  ] = js.native
  /**
  ...
  def launchWebAuthFlow(details: Anon_UrlInteractive): js.Promise[java.lang.String] = js.native
  /**

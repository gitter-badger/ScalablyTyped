...
trait Anon_ACTIONMENUTOPLEVELLIMIT extends js.Object {
  ...
  /**
    ...
    */
  def create(createProperties: Anon_TypeId): scala.Double | java.lang.String = js.native
  def create(createProperties: Anon_TypeId, callback: js.Function0[scala.Unit]): scala.Double | java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  def overrideContext(contextOptions: Anon_ShowDefaults): scala.Unit = js.native
  /**
  ...
  def update(id: java.lang.String, updateProperties: Anon_TypeIcons): js.Promise[scala.Unit] = js.native
  /**
    * Updates a previously created context menu item.
    * @param id The ID of the item to update.
    * @param updateProperties The properties to update. Accepts the same values as the create function.
    */
  def update(id: scala.Double, updateProperties: Anon_TypeIcons): js.Promise[scala.Unit] = js.native
}

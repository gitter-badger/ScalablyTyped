...
@js.native
trait Anon_LastError extends js.Object {
  /**
  ...
  /**
    ...
    */
  def getBackgroundPage(): Window | scala.Unit = js.native
  /* extension functions */
  /**
  ...
  def getViews(fetchProperties: Anon_Type): js.Array[Window] = js.native
  /**

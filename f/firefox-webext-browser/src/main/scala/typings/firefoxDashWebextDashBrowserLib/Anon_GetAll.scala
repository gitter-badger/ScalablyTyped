...
trait Anon_GetAll extends js.Object {
  ...
  def install(options: Anon_UrlHash): js.Promise[js.UndefOr[Anon_IdExtensionID]] = js.native
  /**
  ...
  def uninstallSelf(options: Anon_ShowConfirmDialog): js.Promise[scala.Unit] = js.native
}

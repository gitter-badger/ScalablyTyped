...
object historyNsMembers extends js.Object {
  ...
  val onTitleChanged: firefoxDashWebextDashBrowserLib.WebExtEvent[
    js.Function1[/* changed */ firefoxDashWebextDashBrowserLib.Anon_UrlTitleString, scala.Unit]
  ] = js.native
  /**
  ...
  /**
    ...
    */
  def addUrl(details: firefoxDashWebextDashBrowserLib.Anon_UrlTitle): js.Promise[scala.Unit] = js.native
  ...
  /**
    ...
    */
  def deleteRange(range: firefoxDashWebextDashBrowserLib.Anon_StartTime): js.Promise[scala.Unit] = js.native
  /** Removes all occurrences of the given URL from the history. */
  def deleteUrl(details: firefoxDashWebextDashBrowserLib.Anon_UrlString): js.Promise[scala.Unit] = js.native
  /** Retrieves information about visits to a URL. */
  def getVisits(details: firefoxDashWebextDashBrowserLib.Anon_UrlString): js.Promise[js.Array[VisitItem]] = js.native
  /* history functions */
  /** Searches the history for the last visit time of each page matching the query. */
  def search(query: firefoxDashWebextDashBrowserLib.Anon_TextStartTime): js.Promise[js.Array[HistoryItem]] = js.native
}

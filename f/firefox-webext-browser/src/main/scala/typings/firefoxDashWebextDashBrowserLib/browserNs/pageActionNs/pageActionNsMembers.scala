...
object pageActionNsMembers extends js.Object {
  ...
  /**
    ...
    */
  def setIcon(details: firefoxDashWebextDashBrowserLib.Anon_TabIdImageData): js.Promise[scala.Unit] = js.native
  ...
  def setTitle(details: firefoxDashWebextDashBrowserLib.Anon_TabIdTitle): scala.Unit = js.native

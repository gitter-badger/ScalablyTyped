...
object webRequestNsMembers extends js.Object {
  ...
  val onAuthRequired: _WebRequestOnAuthRequiredEvent[
    js.Function1[
      /* details */ firefoxDashWebextDashBrowserLib.Anon_RequestIdUrlMethodFrameIdParentFrameId, 
  ...
  val onBeforeRedirect: _WebRequestOnBeforeRedirectEvent[
    js.Function1[
      /* details */ firefoxDashWebextDashBrowserLib.Anon_RequestIdUrlMethodFrameIdParentFrameIdOriginUrlDocumentUrl, 
      scala.Unit
    ]
  ] = js.native
  /* webRequest events */
  ...
  val onBeforeRequest: _WebRequestOnBeforeRequestEvent[
    js.Function1[
      /* details */ firefoxDashWebextDashBrowserLib.Anon_RequestIdUrl, 
      BlockingResponse | js.Promise[BlockingResponse] | scala.Unit
    ]
  ] = js.native
  /**
  ...
  val onBeforeSendHeaders: _WebRequestOnBeforeSendHeadersEvent[
    js.Function1[
      /* details */ firefoxDashWebextDashBrowserLib.Anon_RequestIdUrlMethod, 
      BlockingResponse | js.Promise[BlockingResponse] | scala.Unit
    ]
  ] = js.native
  ...
  val onCompleted: _WebRequestOnCompletedEvent[
    js.Function1[
      /* details */ firefoxDashWebextDashBrowserLib.Anon_RequestIdUrlMethodFrameIdParentFrameIdOriginUrl, 
      scala.Unit
    ]
  ] = js.native
  ...
  val onErrorOccurred: _WebRequestOnErrorOccurredEvent[
    js.Function1[
      /* details */ firefoxDashWebextDashBrowserLib.Anon_RequestIdUrlMethodFrameIdParentFrameIdOriginUrlDocumentUrlTabId, 
      scala.Unit
    ]
  ] = js.native
  /**
  ...
  val onHeadersReceived: _WebRequestOnHeadersReceivedEvent[
    js.Function1[
      /* details */ firefoxDashWebextDashBrowserLib.Anon_RequestIdUrlMethodFrameId, 
      BlockingResponse | js.Promise[BlockingResponse] | scala.Unit
    ]
  ] = js.native
  /**
  ...
  val onSendHeaders: _WebRequestOnSendHeadersEvent[
    js.Function1[/* details */ firefoxDashWebextDashBrowserLib.Anon_RequestIdUrlMethod, scala.Unit]
  ] = js.native
  /** ... */

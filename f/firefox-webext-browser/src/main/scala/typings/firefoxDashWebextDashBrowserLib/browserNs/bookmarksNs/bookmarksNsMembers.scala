...
object bookmarksNsMembers extends js.Object {
  ...
  val onMoved: firefoxDashWebextDashBrowserLib.WebExtEvent[
    js.Function2[
      /* id */ java.lang.String, 
      /* moveInfo */ firefoxDashWebextDashBrowserLib.Anon_ParentIdIndexOldParentId, 
      scala.Unit
    ]
  ] = js.native
  /**
  ...
  val onRemoved: firefoxDashWebextDashBrowserLib.WebExtEvent[
    js.Function2[
      /* id */ java.lang.String, 
      /* removeInfo */ firefoxDashWebextDashBrowserLib.Anon_ParentIdIndex, 
      scala.Unit
    ]
  ] = js.native
  /**
  ...
  def move(id: java.lang.String, destination: firefoxDashWebextDashBrowserLib.Anon_ParentId): js.Promise[js.UndefOr[BookmarkTreeNode]] = js.native

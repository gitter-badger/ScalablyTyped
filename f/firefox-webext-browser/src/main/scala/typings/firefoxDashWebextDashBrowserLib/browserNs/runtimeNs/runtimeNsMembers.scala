...
object runtimeNsMembers extends js.Object {
  ...
  val onInstalled: firefoxDashWebextDashBrowserLib.WebExtEvent[
    js.Function1[/* details */ firefoxDashWebextDashBrowserLib.Anon_Reason, scala.Unit]
  ] = js.native
  /**
  ...
  /**
    ...
    * profiles.
    */
  val onStartup: firefoxDashWebextDashBrowserLib.WebExtEvent[js.Function0[scala.Unit]] = js.native
  /**
    ...
    * @deprecated Unsupported on Firefox at this time.
    */
  val onSuspend: js.UndefOr[firefoxDashWebextDashBrowserLib.WebExtEvent[js.Function0[scala.Unit]]] = js.native
  /**
    * Sent after onSuspend to indicate that the app won't be unloaded after all.
    * @deprecated Unsupported on Firefox at this time.
    */
  val onSuspendCanceled: js.UndefOr[firefoxDashWebextDashBrowserLib.WebExtEvent[js.Function0[scala.Unit]]] = js.native
  /**
    ...
    */
  val onUpdateAvailable: firefoxDashWebextDashBrowserLib.WebExtEvent[
    js.Function1[/* details */ firefoxDashWebextDashBrowserLib.Anon_Version, scala.Unit]
  ] = js.native
  /**
  ...
  def connect(
    ...
    connectInfo: firefoxDashWebextDashBrowserLib.Anon_NameIncludeTlsChannelId
  ): Port = js.native
  /**
  ...
  def sendMessage(
    extensionId: java.lang.String,
    message: js.Any,
    options: firefoxDashWebextDashBrowserLib.Anon_IncludeTlsChannelId
  ...
  def sendMessage(message: js.Any, options: firefoxDashWebextDashBrowserLib.Anon_IncludeTlsChannelId): js.Promise[_] = js.native
  /**

...
object downloadsNsMembers extends js.Object {
  ...
  val onChanged: firefoxDashWebextDashBrowserLib.WebExtEvent[
    js.Function1[/* downloadDelta */ firefoxDashWebextDashBrowserLib.Anon_Id, scala.Unit]
  ] = js.native
  /* downloads events */
  ...
  /**
    ...
    */
  def download(options: firefoxDashWebextDashBrowserLib.Anon_UrlFilename): js.Promise[js.UndefOr[scala.Double]] = js.native
  /**

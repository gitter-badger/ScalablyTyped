...
@js.native
trait Anon_WINDOWIDNONE extends js.Object {
  ...
  def create(createData: Anon_UrlTabId): js.Promise[js.UndefOr[firefoxDashWebextDashBrowserLib.browserNs.windowsNs.Window]] = js.native
  /* windows functions */
  ...
  def getAll(getInfo: Anon_WindowTypes): js.Promise[js.Array[firefoxDashWebextDashBrowserLib.browserNs.windowsNs.Window]] = js.native
  ...
  /**
    ...
    */
  def update(windowId: scala.Double, updateInfo: Anon_Left): js.Promise[js.UndefOr[firefoxDashWebextDashBrowserLib.browserNs.windowsNs.Window]] = js.native
}

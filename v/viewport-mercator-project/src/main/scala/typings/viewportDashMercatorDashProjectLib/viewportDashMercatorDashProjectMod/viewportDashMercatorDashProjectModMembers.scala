...
object viewportDashMercatorDashProjectModMembers extends js.Object {
  def fitBounds(options: viewportDashMercatorDashProjectLib.Anon_Width): FittedBounds = js.native
  ...
  def getViewMatrix(input: viewportDashMercatorDashProjectLib.Anon_Height): ViewMatrix = js.native
  def getWorldPosition(input: viewportDashMercatorDashProjectLib.Anon_Longitude): Vector3 = js.native

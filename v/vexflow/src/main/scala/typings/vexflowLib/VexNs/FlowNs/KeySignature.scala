...
class KeySignature protected () extends StaveModifier {
  ...
  def addAccToStave(stave: Stave, acc: vexflowLib.Anon_Type): scala.Unit = js.native
  def addAccToStave(stave: Stave, acc: vexflowLib.Anon_Type, next: vexflowLib.Anon_Type): scala.Unit = js.native

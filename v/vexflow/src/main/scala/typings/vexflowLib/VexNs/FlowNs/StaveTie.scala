...
class StaveTie protected () extends js.Object {
  ...
  def renderTie(params: vexflowLib.Anon_Firstys): scala.Unit = js.native
  ...
  def setNotes(notes: vexflowLib.Anon_FirstnoteLastnoteFirstindicesLastindices): StaveTie = js.native
}

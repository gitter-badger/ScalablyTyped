...
class StaveHairpin protected () extends js.Object {
  ...
  def renderHairpin(params: vexflowLib.Anon_FirstxLastx): scala.Unit = js.native
  ...
  def setRenderOptions(options: vexflowLib.Anon_HeightYshift): StaveHairpin = js.native
}

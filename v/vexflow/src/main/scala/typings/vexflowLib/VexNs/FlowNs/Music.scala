...
class Music () extends js.Object {
  ...
  def getKeyParts(noteString: java.lang.String): vexflowLib.Anon_RootAccidental = js.native
  def getNoteParts(noteString: java.lang.String): vexflowLib.Anon_Root = js.native

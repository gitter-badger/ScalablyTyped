...
package object typesSpecDataMod {
  type Data = (vegaDashTypingsLib.Anon_Source | vegaDashTypingsLib.Anon_Values | vegaDashTypingsLib.Anon_Url | js.Object) with vegaDashTypingsLib.Anon_Name
  ...
  type FormatTopoJSON = vegaDashTypingsLib.Anon_TypeTopojson with (vegaDashTypingsLib.Anon_Feature | vegaDashTypingsLib.Anon_Mesh)

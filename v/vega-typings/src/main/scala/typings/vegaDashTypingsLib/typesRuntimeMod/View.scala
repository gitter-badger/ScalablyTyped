...
class View protected () extends js.Object {
  ...
  def getState(): vegaDashTypingsLib.Anon_Signals = js.native
  def getState(options: vegaDashTypingsLib.Anon_SignalsName): vegaDashTypingsLib.Anon_Signals = js.native
  ...
  def padding(p: vegaDashTypingsLib.Anon_Left): this.type = js.native
  ...
  def setState(state: vegaDashTypingsLib.Anon_Signals): this.type = js.native

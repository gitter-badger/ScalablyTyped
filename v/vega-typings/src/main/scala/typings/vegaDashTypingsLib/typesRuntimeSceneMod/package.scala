...
package object typesRuntimeSceneMod {
  type SceneGroup = SceneItem with vegaDashTypingsLib.Anon_Context
  type SceneLine = SceneItem with vegaDashTypingsLib.Anon_Opacity
  type SceneRect = SceneItem with vegaDashTypingsLib.Anon_Fill

...
package object typesSpecEncodeMod {
  ...
  type FontStyle = vegaDashTypingsLib.vegaDashTypingsLibStrings.normal | vegaDashTypingsLib.vegaDashTypingsLibStrings.italic
  ...
  type ScaledValueRef[T] = BaseValueRef[T] | (BaseValueRef[T] with vegaDashTypingsLib.Anon_Scale) | vegaDashTypingsLib.Anon_ScaleBand
  type StringValueRef = ScaledValueRef[java.lang.String]
  type SymbolShape = vegaDashTypingsLib.vegaDashTypingsLibStrings.circle | vegaDashTypingsLib.vegaDashTypingsLibStrings.square | vegaDashTypingsLib.vegaDashTypingsLibStrings.cross | vegaDashTypingsLib.vegaDashTypingsLibStrings.diamond | vegaDashTypingsLib.vegaDashTypingsLibStrings.`triangle-up` | vegaDashTypingsLib.vegaDashTypingsLibStrings.`triangle-down` | vegaDashTypingsLib.vegaDashTypingsLibStrings.`triangle-right` | vegaDashTypingsLib.vegaDashTypingsLibStrings.`triangle-left` | java.lang.String

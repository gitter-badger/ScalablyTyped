...
package object victoryMod {
  ...
  /**
    ...
    */
  type DataGetterPropType = scala.Double | java.lang.String | js.Array[java.lang.String] | victoryLib.Anon_DataAnyNumber
  /**
    * Domain padding
    */
  ...
  type NumberOrCallback = victoryLib.Anon_Number | scala.Double

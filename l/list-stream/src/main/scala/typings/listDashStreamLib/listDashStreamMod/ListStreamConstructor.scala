...
trait ListStreamConstructor
  extends ListStreamMethod
     with org.scalablytyped.runtime.Instantiable2[
      ...
      /* callback */ js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* data */ js.Array[js.Any], scala.Unit], 
      ListStream
    ]
     with org.scalablytyped.runtime.Instantiable0[ListStream]
     with org.scalablytyped.runtime.Instantiable1[
      (/* options */ nodeLib.streamMod.internalNs.DuplexOptions) | (/* callback */ js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* data */ js.Array[js.Any], scala.Unit]), 
      ListStream
    ] {
  @JSName("obj")
  ...
  def obj(
    callback: js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* data */ js.Array[_], scala.Unit]

...
trait LobiboxStatic extends js.Object {
  @JSName("alert")
  var alert_Original: lobiboxLib.Anon_Type = js.native
  var base: lobiboxLib.Anon_OPTIONS = js.native
  @JSName("confirm")
  var confirm_Original: lobiboxLib.Anon_Options = js.native
  @JSName("notify")
  var notify_Original: lobiboxLib.Anon_TypeOptionsDEFAULTS = js.native
  @JSName("progress")
  var progress_Original: lobiboxLib.Anon_OptionsDEFAULTS = js.native
  @JSName("prompt")
  var prompt_Original: lobiboxLib.Anon_TypeOptions = js.native
  @JSName("window")
  var window_Original: lobiboxLib.Anon_OptionsDEFAULTST = js.native

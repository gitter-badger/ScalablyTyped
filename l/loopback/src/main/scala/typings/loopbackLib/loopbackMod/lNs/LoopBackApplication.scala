...
trait LoopBackApplication
  ...
  /**
    ...
    */
  def middlewareFromConfig(factory: js.Function0[scala.Unit], config: loopbackLib.Anon_Phase): js.Any = js.native
  ...
  /**
    ...
    */
  def models(): js.Array[loopbackLib.Anon_ModelName] = js.native
  /**

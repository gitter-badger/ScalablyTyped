...
/**
  ...
  */
@js.native
trait Application extends PersistedModel {
  ...
  /**
    ...
    * @param {Error} err
    */
  def resetKeys(appId: js.Any, callback: js.Function1[/* err */ nodeLib.Error with stdLib.Error, scala.Unit]): scala.Unit = js.native
}

...
object PersistedModel extends js.Object {
  ...
  /**
    ...
    */
  def findOrCreate[T](data: js.Any): js.Promise[loopbackLib.Anon_Instance[T] | scala.Null] = js.native
  /**
    * Finds one record matching the optional filter object. If not found, creates
    * the object using the data provided as second argument. In this sense it is
    * the same as `find`, but limited to one object. Returns an object, not
  ...
  def findOrCreate[T](data: js.Any, filter: loopbackLib.Anon_Fields): js.Promise[loopbackLib.Anon_Instance[T] | scala.Null] = js.native
  /**
    * Finds one record matching the optional filter object. If not found, creates
    * the object using the data provided as second argument. In this sense it is
    * the same as `find`, but limited to one object. Returns an object, not
  ...
  /**
    ...
    * @param {Error} err Error object; see [Error object](docs.strongloop.com/display/LB/Error+object)
    */
  def handleChangeError(err: nodeLib.Error with stdLib.Error): scala.Unit = js.native
  /**

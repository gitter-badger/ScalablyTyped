...
class Conflict protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def resolve(callback: js.Function1[/* err */ nodeLib.Error with stdLib.Error, scala.Unit]): scala.Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def resolveManually(data: js.Any, callback: js.Function1[/* err */ nodeLib.Error with stdLib.Error, scala.Unit]): scala.Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def resolveUsingSource(callback: js.Function1[/* err */ nodeLib.Error with stdLib.Error, scala.Unit]): scala.Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def resolveUsingTarget(callback: js.Function1[/* err */ nodeLib.Error with stdLib.Error, scala.Unit]): scala.Unit = js.native
  /**

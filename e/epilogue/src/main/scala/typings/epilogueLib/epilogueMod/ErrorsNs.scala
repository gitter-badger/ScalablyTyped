...
object ErrorsNs extends js.Object {
  ...
  class BadRequestError () extends EpilogueError {
    ...
    def this(message: java.lang.String, errors: js.Array[java.lang.String], cause: nodeLib.Error with stdLib.Error) = this()
  }
  ...
  class EpilogueError protected ()
    ...
    def this(status: EpilogueError, message: java.lang.String, errors: js.Array[java.lang.String], cause: nodeLib.Error with stdLib.Error) = this()
    def this(status: scala.Double, message: java.lang.String, errors: js.Array[java.lang.String], cause: nodeLib.Error with stdLib.Error) = this()
    var cause: nodeLib.Error with stdLib.Error = js.native

...
trait SeriesThemeRiver extends js.Object {
  ...
  var emphasis: js.UndefOr[
    echartsLib.Anon_LabelItemStyleAnonShowPositionDistanceRotateOffsetColorFontStyleFontWeightFontFamily
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  var label: js.UndefOr[echartsLib.Anon_ShowPositionDistanceRotateOffsetColorFontStyleFontWeight] = js.undefined
  /**

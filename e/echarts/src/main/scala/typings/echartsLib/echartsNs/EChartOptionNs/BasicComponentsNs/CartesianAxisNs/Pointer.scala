...
trait Pointer extends js.Object {
  var handle: js.UndefOr[echartsLib.Anon_Show] = js.undefined
  var label: js.UndefOr[PointerLabel] = js.undefined
  var lineStyle: js.UndefOr[echartsLib.Anon_ColorWidthType] = js.undefined
  var shadowStyle: js.UndefOr[echartsLib.Anon_ColorShadowBlurShadowColor] = js.undefined

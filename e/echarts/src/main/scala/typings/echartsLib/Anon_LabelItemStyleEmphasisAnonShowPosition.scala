...
@js.native
trait Anon_LabelItemStyleEmphasisAnonShowPosition extends js.Object {
  /**
    * @see https://ecomfe.github.io/echarts-doc/public/en/option.html#series-tree.leaves.emphasis
    */
  var emphasis: js.UndefOr[Anon_LabelItemStyleAnonShowPositionAnonColorBorderColor] = js.native
  /**

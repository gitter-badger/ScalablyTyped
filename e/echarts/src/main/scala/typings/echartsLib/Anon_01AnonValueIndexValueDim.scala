...
trait Anon_01AnonValueIndexValueDim extends js.Object {
  /**
    ...
    */
  var `0`: js.UndefOr[Anon_ValueIndexValueDim] = js.undefined
  /**
    ...
    */
  var `1`: js.UndefOr[Anon_ValueIndexValueDim] = js.undefined
}

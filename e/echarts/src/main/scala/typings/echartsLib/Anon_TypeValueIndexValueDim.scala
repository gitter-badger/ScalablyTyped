...
trait Anon_TypeValueIndexValueDim extends js.Object {
  /**
  ...
  /**
    ...
    */
  var itemStyle: js.UndefOr[Anon_ColorBorderColorBorderWidth] = js.undefined
  /**
    ...
    */
  var label: js.UndefOr[Anon_ShowPositionDistanceRotateOffset] = js.undefined
  /**

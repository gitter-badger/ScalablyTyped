...
trait Anon_ShowLengthLineStyle extends js.Object {
  /**
    ...
    */
  var emphasis: js.UndefOr[Anon_ShowLineStyle] = js.undefined
  /**
  ...
  /**
    ...
    */
  var lineStyle: js.UndefOr[Anon_ColorWidthType] = js.undefined
  /**

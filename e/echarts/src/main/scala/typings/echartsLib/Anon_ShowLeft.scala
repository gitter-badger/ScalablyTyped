...
@js.native
trait Anon_ShowLeft extends js.Object {
  /**
  ...
  var emphasis: js.UndefOr[
    Anon_ItemStyleAnonColorBorderColorBorderWidthBorderTypeShadowBlurShadowColorShadowOffsetX
  ] = js.native
  /**
  ...
  /**
    ...
    */
  var itemStyle: js.UndefOr[Anon_ColorBorderColorBorderWidthBorderTypeShadowBlurShadowColorShadowOffsetX] = js.native
  /**

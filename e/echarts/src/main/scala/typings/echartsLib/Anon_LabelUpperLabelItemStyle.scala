...
@js.native
trait Anon_LabelUpperLabelItemStyle extends js.Object {
  /**
    * @see https://ecomfe.github.io/echarts-doc/public/en/option.html#series-treemap.data.emphasis.itemStyle
    */
  var itemStyle: js.UndefOr[Anon_ColorString] = js.native
  /**
  ...
  /**
    ...
    */
  var upperLabel: js.UndefOr[Anon_ShowPositionDistanceRotateOffsetFormatterColorFontStyleFontWeightFontFamily] = js.native
}

...
trait Anon_TypeValueIndex extends js.Object {
  /**
  ...
  /**
    ...
    */
  var label: js.UndefOr[Anon_ShowPositionFormatterEmphasis] = js.undefined
  /**
    ...
    */
  var lineStyle: js.UndefOr[Anon_ColorWidthTypeShadowBlurShadowColorShadowOffsetX] = js.undefined
  /**

...
trait Anon_ColorBorderColorBorderWidthBorderTypeShadowBlurShadowColorShadowOffsetX extends js.Object {
  /**
  ...
  /**
    ...
    */
  var textStyle: js.UndefOr[Anon_ColorFontStyleFontWeightFontFamily] = js.undefined
}

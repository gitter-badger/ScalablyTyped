...
@js.native
trait Anon_SourceTarget extends js.Object {
  /**
    * @see https://ecomfe.github.io/echarts-doc/public/en/option.html#series-sankey.links.emphasis
    */
  var emphasis: js.UndefOr[Anon_LineStyleAnonColorOpacityCurveness] = js.native
  /**
    ...
    */
  var lineStyle: js.UndefOr[Anon_ColorOpacityCurveness] = js.native
  /**
    * The

...
trait Anon_ItemStyleLabelAnonAreaColor extends js.Object {
  /**
    ...
    */
  var itemStyle: js.UndefOr[Anon_AreaColor] = js.native
  /**
    * @see https://ecomfe.github.io/echarts-doc/public/en/option.html#series-map.data.emphasis.label
    */
  var label: js.UndefOr[Anon_ShowPositionDistanceRotateOffsetFormatterColorFontStyleFontWeight] = js.native
}

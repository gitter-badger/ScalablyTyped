...
trait Anon_Arguments extends js.Object {
  /**
    ...
    */
  var arguments: js.UndefOr[Anon_Params] = js.native
  /**
  ...
  /**
    ...
    */
  var return_arc: js.UndefOr[Anon_TypeIdPositionRotationScaleOriginZ2NameInfo] = js.native
  /**
    ...
    */
  var return_bezierCurve: js.UndefOr[Anon_TypeIdPositionRotationScaleOriginZ2NameInfoSilentInvisibleIgnore] = js.native
  /**
    * Circle element.
    *
    *
    ...
    */
  var return_circle: js.UndefOr[Anon_TypeIdPositionRotationScaleOriginZ2] = js.native
  /**
    ...
    */
  var return_group: js.UndefOr[Anon_TypeId] = js.native
  /**
    * @see https://ecomfe.github.io/echarts-doc/public/en/option.html#series-custom.renderItem.return_image
    */
  var return_image: js.UndefOr[Anon_TypeIdPositionRotation] = js.native
  /**
    * Line element.
    *
    *
    ...
    */
  var return_line: js.UndefOr[Anon_TypeIdPositionRotationScaleOriginZ2NameInfoSilentInvisible] = js.native
  /**
    * Use
    ...
    */
  var return_path: js.UndefOr[Anon_TypeIdPosition] = js.native
  /**
    * Polygon element.
    *
    *
    ...
    */
  var return_polygon: js.UndefOr[Anon_TypeIdPositionRotationScaleOriginZ2NameInfoSilent] = js.native
  /**
    * Polyline element.
    *
    *
    ...
    */
  var return_polyline: js.UndefOr[Anon_TypeIdPositionRotationScaleOriginZ2NameInfoSilent] = js.native
  /**
    * Rectangle element.
    *
    *
    ...
    */
  var return_rect: js.UndefOr[Anon_TypeIdPositionRotationScaleOrigin] = js.native
  /**
    * Ring element.
    *
    *
    ...
    */
  var return_ring: js.UndefOr[Anon_TypeIdPositionRotationScaleOriginZ2Name] = js.native
  /**
    * Sector element.
    *
    *
    ...
    */
  var return_sector: js.UndefOr[Anon_TypeIdPositionRotationScaleOriginZ2NameInfo] = js.native
  /**
    * Text block.
    *
    *
    ...
    */
  var return_text: js.UndefOr[Anon_TypeIdPositionRotationScale] = js.native
}

...
trait Anon_ColorWidthTypeShadowBlurShadowColorShadowOffsetX extends js.Object {
  /**
    * Line color.
    *
  ...
  /**
    ...
    */
  var emphasis: js.UndefOr[Anon_ColorWidthTypeShadowBlurShadowColor] = js.undefined
  /**

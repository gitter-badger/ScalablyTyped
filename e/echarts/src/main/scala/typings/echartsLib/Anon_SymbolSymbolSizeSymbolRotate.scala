...
@js.native
trait Anon_SymbolSymbolSizeSymbolRotate extends js.Object {
  /**
  ...
  /**
    ...
    */
  var data: js.UndefOr[Anon_NameValueIndex] = js.native
  /**
    * Mark point style.
    *
    *
  ...
  /**
    ...
    */
  var label: js.UndefOr[Anon_ShowPositionDistance] = js.native
  /**

...
@js.native
trait Anon_LabelItemStyleEmphasis extends js.Object {
  /**
    ...
    */
  var downplay: js.UndefOr[Anon_LabelItemStyleAnonRotateAlignAnonColorBorderColor] = js.native
  /**
    ...
    */
  var emphasis: js.UndefOr[Anon_LabelItemStyleAnonRotateAlignAnonColorBorderColor] = js.native
  /**
    ...
    */
  var highlight: js.UndefOr[Anon_LabelItemStyleAnonRotateAlignAnonColorBorderColor] = js.native
  /**
  ...
  /**
    ...
    */
  var label: js.UndefOr[Anon_RotateAlign] = js.native
}

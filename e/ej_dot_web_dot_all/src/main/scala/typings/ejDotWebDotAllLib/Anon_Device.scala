...
trait Anon_Device extends js.Object {
  var Accordion: Anon_FnLocaleElementOptionsAccordion = js.native
  val AccordionNs: js.Any = js.native
  var Adaptor: org.scalablytyped.runtime.Instantiable1[/* ds */ js.Any, ejDotWebDotAllLib.ejNs.Adaptor] = js.native
  var Autocomplete: Anon_FnLocaleElementOptionsAutocomplete = js.native
  val AutocompleteNs: js.Any = js.native
  var Button: Anon_FnLocaleElementOptionsButton = js.native
  val ButtonNs: js.Any = js.native
  var CacheAdaptor: org.scalablytyped.runtime.Instantiable0[ejDotWebDotAllLib.ejNs.CacheAdaptor] = js.native
  var Calculate: Anon_FnLocaleElementOptionsCalculate = js.native
  val CalculateNs: js.Any = js.native
  var Captcha: Anon_FnLocaleElementOptionsCaptcha = js.native
  val CaptchaNs: js.Any = js.native
  var CheckBox: Anon_FnLocaleElementOptionsCheckBox = js.native
  val CheckBoxNs: js.Any = js.native
  var ColorPicker: Anon_FnLocaleElementOptionsColorPicker = js.native
  val ColorPickerNs: js.Any = js.native
  var ComboBox: Anon_FnLocaleElementOptionsComboBox = js.native
  ...
  var DatePicker: Anon_FnLocaleElementOptionsDatePicker = js.native
  val DatePickerNs: js.Any = js.native
  var DateRangePicker: Anon_FnLocaleElementOptionsDateRangePicker = js.native
  val DateRangePickerNs: js.Any = js.native
  var DateTimePicker: Anon_FnLocaleElementOptionsDateTimePicker = js.native
  val DateTimePickerNs: js.Any = js.native
  var Dialog: Anon_FnLocaleElementOptionsDialog = js.native
  val DialogNs: js.Any = js.native
  var DocumentEditor: Anon_FnLocaleElementOptionsDocumentEditor = js.native
  val DocumentEditorNs: js.Any = js.native
  var Draggable: Anon_FnLocale = js.native
  val DraggableNs: js.Any = js.native
  var DropDownList: Anon_FnLocaleElementOptionsDropDownList = js.native
  val DropDownListNs: js.Any = js.native
  var DropDownTree: Anon_FnLocaleElementOptionsDropDownTree = js.native
  val DropDownTreeNs: js.Any = js.native
  var Droppable: Anon_FnLocaleElement = js.native
  val DroppableNs: js.Any = js.native
  var Editor: Anon_FnLocaleElementOptionsEditor = js.native
  val EditorNs: js.Any = js.native
  var FileExplorer: Anon_FnLocaleElementOptionsFileExplorer = js.native
  val FileExplorerNs: js.Any = js.native
  var ForeignKeyAdaptor: org.scalablytyped.runtime.Instantiable2[
    /* data */ js.Any, 
    /* type */ java.lang.String, 
    ejDotWebDotAllLib.ejNs.ForeignKeyAdaptor
  ] = js.native
  var Gantt: Anon_FnLocaleElementOptionsGantt = js.native
  val GanttNs: js.Any = js.native
  var Grid: Anon_FnLocaleElementOptionsGrid = js.native
  val GridNs: js.Any = js.native
  var GroupButton: Anon_FnLocaleElementOptionsGroupButton = js.native
  val GroupButtonNs: js.Any = js.native
  var JsonAdaptor: org.scalablytyped.runtime.Instantiable0[ejDotWebDotAllLib.ejNs.JsonAdaptor] = js.native
  var Kanban: Anon_FnLocaleElementOptionsKanban = js.native
  val KanbanNs: js.Any = js.native
  var ListBox: Anon_FnLocaleElementOptionsListBox = js.native
  val ListBoxNs: js.Any = js.native
  var ListView: Anon_FnLocaleElementOptionsListView = js.native
  val ListViewNs: js.Any = js.native
  var MaskEdit: Anon_FnLocaleElementOptionsMaskEdit = js.native
  val MaskEditNs: js.Any = js.native
  var Menu: Anon_FnLocaleElementOptionsMenu = js.native
  val MenuNs: js.Any = js.native
  ...
  var NavigationDrawer: Anon_FnLocaleElementOptionsNavigationDrawer = js.native
  val NavigationDrawerNs: js.Any = js.native
  ...
  var Pager: Anon_FnLocaleElementOptionsPager = js.native
  val PagerNs: js.Any = js.native
  var PdfViewer: Anon_FnLocaleElementOptionsPdfViewer = js.native
  val PdfViewerNs: js.Any = js.native
  var PercentageTextbox: org.scalablytyped.runtime.Instantiable0[ejDotWebDotAllLib.ejNs.PercentageTextbox] = js.native
  val PivotAnalysisNs: js.Any = js.native
  var PivotChart: Anon_FnLocaleElementOptionsPivotChart = js.native
  val PivotChartNs: js.Any = js.native
  var PivotClient: Anon_FnLocaleElementOptionsPivotClient = js.native
  val PivotClientNs: js.Any = js.native
  var PivotGauge: Anon_FnLocaleElementOptionsPivotGauge = js.native
  val PivotGaugeNs: js.Any = js.native
  var PivotGrid: Anon_FnLocaleElementOptionsPivotGrid = js.native
  val PivotGridNs: js.Any = js.native
  val PivotNs: js.Any = js.native
  var PivotPager: Anon_FnLocaleElementOptionsPivotPager = js.native
  val PivotPagerNs: js.Any = js.native
  var PivotSchemaDesigner: Anon_FnLocaleElementOptionsPivotSchemaDesigner = js.native
  val PivotSchemaDesignerNs: js.Any = js.native
  var PivotTreeMap: Anon_FnLocaleElementOptionsPivotTreeMap = js.native
  val PivotTreeMapNs: js.Any = js.native
  var Predicate: org.scalablytyped.runtime.Instantiable0[ejDotWebDotAllLib.ejNs.Predicate] = js.native
  var Print: Anon_FnLocaleElementOptionsPrint = js.native
  val PrintNs: js.Any = js.native
  var ProgressBar: Anon_FnLocaleElementOptionsProgressBar = js.native
  val ProgressBarNs: js.Any = js.native
  var Query: Anon_FnExtend = js.native
  var RTE: Anon_FnLocaleElementOptionsRTE = js.native
  val RTENs: js.Any = js.native
  var RadialMenu: Anon_FnLocaleElementOptionsRadialMenu = js.native
  val RadialMenuNs: js.Any = js.native
  var RadialSlider: Anon_FnLocaleElementOptionsRadialSlider = js.native
  val RadialSliderNs: js.Any = js.native
  var RadioButton: Anon_FnLocaleElementOptionsRadioButton = js.native
  val RadioButtonNs: js.Any = js.native
  var Rating: Anon_FnLocaleElementOptionsRating = js.native
  val RatingNs: js.Any = js.native
  var RecurrenceEditor: Anon_FnLocaleElementOptionsRecurrenceEditor = js.native
  val RecurrenceEditorNs: js.Any = js.native
  var ReportDesigner: Anon_FnLocaleElementOptionsReportDesigner = js.native
  val ReportDesignerNs: js.Any = js.native
  var ReportViewer: Anon_FnLocaleElementOptionsReportViewer = js.native
  val ReportViewerNs: js.Any = js.native
  var Resizable: Anon_FnLocaleElementOptions = js.native
  val ResizableNs: js.Any = js.native
  var Ribbon: Anon_FnLocaleElementOptionsRibbon = js.native
  val RibbonNs: js.Any = js.native
  var Rotator: Anon_FnLocaleElementOptionsRotator = js.native
  val RotatorNs: js.Any = js.native
  var Schedule: Anon_FnLocaleElementOptionsSchedule = js.native
  val ScheduleNs: js.Any = js.native
  var Scroller: Anon_FnLocaleElementOptionsScroller = js.native
  val ScrollerNs: js.Any = js.native
  var Signature: Anon_FnLocaleElementOptionsSignature = js.native
  val SignatureNs: js.Any = js.native
  var Slider: Anon_FnLocaleElementOptionsSlider = js.native
  val SliderNs: js.Any = js.native
  var Sparkline: Anon_FnLocaleElementOptionsSparkline = js.native
  val SparklineNs: js.Any = js.native
  var SpellCheck: Anon_FnLocaleElementOptionsSpellCheck = js.native
  val SpellCheckNs: js.Any = js.native
  var SplitButton: Anon_FnLocaleElementOptionsSplitButton = js.native
  val SplitButtonNs: js.Any = js.native
  var Splitter: Anon_FnLocaleElementOptionsSplitter = js.native
  val SplitterNs: js.Any = js.native
  var Spreadsheet: Anon_FnLocaleElementOptionsSpreadsheet = js.native
  val SpreadsheetNs: js.Any = js.native
  var SunburstChart: Anon_FnLocaleElementOptionsSunburstChart = js.native
  val SunburstChartNs: js.Any = js.native
  val SunburstNs: js.Any = js.native
  var Tab: Anon_FnLocaleElementOptionsTab = js.native
  val TabNs: js.Any = js.native
  ...
  var TagCloud: Anon_FnLocaleElementOptionsTagCloud = js.native
  val TagCloudNs: js.Any = js.native
  var Tile: Anon_FnLocaleElementOptionsTile = js.native
  val TileNs: js.Any = js.native
  var TimePicker: Anon_FnLocaleElementOptionsTimePicker = js.native
  val TimePickerNs: js.Any = js.native
  var ToggleButton: Anon_FnLocaleElementOptionsToggleButton = js.native
  val ToggleButtonNs: js.Any = js.native
  var Toolbar: Anon_FnLocaleElementOptionsToolbar = js.native
  val ToolbarNs: js.Any = js.native
  var Tooltip: Anon_FnLocaleElementOptionsTooltip = js.native
  val TooltipNs: js.Any = js.native
  var TreeGrid: Anon_FnLocaleElementOptionsTreeGrid = js.native
  val TreeGridNs: js.Any = js.native
  var TreeView: Anon_FnLocaleElementOptionsTreeView = js.native
  val TreeViewNs: js.Any = js.native
  var Uploadbox: Anon_FnLocaleElementOptionsUploadbox = js.native
  val UploadboxNs: js.Any = js.native
  var UrlAdaptor: org.scalablytyped.runtime.Instantiable0[ejDotWebDotAllLib.ejNs.UrlAdaptor] = js.native
  var WaitingPopup: Anon_FnLocaleElementOptionsWaitingPopup = js.native
  val WaitingPopupNs: js.Any = js.native
  ...
  val datavisualizationNs: Anon_SymbolPalette = js.native
  val deviceNs: Anon_IsAndroid = js.native
  ...
  val util: Anon_ValueFunction = js.native
  val widgetNs: Anon_AutoInit = js.native
  ...
  def buildTag(tag: java.lang.String): JQuery = js.native
  def buildTag(tag: java.lang.String, innerHtml: java.lang.String): JQuery = js.native
  def buildTag(tag: java.lang.String, innerHtml: java.lang.String, styles: js.Any): JQuery = js.native
  def buildTag(tag: java.lang.String, innerHtml: java.lang.String, styles: js.Any, attrs: js.Any): JQuery = js.native
  ...
  def createObject(nameSpace: java.lang.String, value: js.Any, initIn: js.Any): JQuery = js.native

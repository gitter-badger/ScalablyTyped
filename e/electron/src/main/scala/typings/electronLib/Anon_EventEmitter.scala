...
trait Anon_EventEmitter extends js.Object {
  ...
  var Menu: Anon_BuildFromTemplate
  ...
  var NativeImage: Anon_CreateEmpty
  var Notification: Anon_IsSupported
  var Session: Anon_FromPartition
  var TouchBar: Anon_TouchBarButton

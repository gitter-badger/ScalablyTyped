...
trait MainInterface extends CommonInterface {
  ...
  var Menu: electronLib.Anon_BuildFromTemplate
  ...
  var TouchBar: electronLib.Anon_TouchBarButton
  ...
  var session: electronLib.Anon_FromPartition
  var systemPreferences: SystemPreferences
  var webContents: electronLib.Anon_FromIdId
}

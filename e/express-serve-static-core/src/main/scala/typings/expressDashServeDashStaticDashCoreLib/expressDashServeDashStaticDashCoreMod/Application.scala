...
trait Application
  ...
  @JSName("get")
  var get_Original: (js.Function1[/* name */ java.lang.String, _]) with IRouterMatcher[this.type] = js.native
  ...
  @JSName("use")
  var use_Original: ApplicationRequestHandler[this.type] = js.native
  /**

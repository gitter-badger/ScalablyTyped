...
trait Global extends js.Object {
  ...
  var Buffer: easyDashXapiDashSupertestLib.Anon_Str = js.native
  ...
  var Intl: easyDashXapiDashSupertestLib.Anon_PluralRules = js.native
  ...
  @JSName("parseInt")
  var parseInt_Original: easyDashXapiDashSupertestLib.Anon_S = js.native

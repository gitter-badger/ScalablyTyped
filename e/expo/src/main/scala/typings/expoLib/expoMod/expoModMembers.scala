...
object expoModMembers extends js.Object {
  ...
  def takeSnapshotAsync(view: reactLib.reactMod.ReactNs.ReactElement[_], options: expoLib.Anon_WidthHeightFormat): js.Promise[java.lang.String] = js.native
  def takeSnapshotAsync(view: scala.Double): js.Promise[java.lang.String] = js.native
  def takeSnapshotAsync(view: scala.Double, options: expoLib.Anon_WidthHeightFormat): js.Promise[java.lang.String] = js.native
}

...
object FacebookAdsNs extends js.Object {
  ...
  def withNativeAd(component: reactLib.reactMod.Component[expoLib.Anon_IconCoverImage, js.Object, _]): reactLib.reactMod.Component[expoLib.Anon_AdsManager, expoLib.Anon_Ad, _] = js.native
  /**
    * Ad Settings
    */
  @JSName("AdSettings")

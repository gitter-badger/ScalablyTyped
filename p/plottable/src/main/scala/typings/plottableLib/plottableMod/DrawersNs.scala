...
object DrawersNs extends js.Object {
  ...
  class CanvasDrawer protected ()
    ...
    /**
      ...
      */
    def this(_context: d3DashShapeLib.d3DashShapeMod.Global.CanvasRenderingContext2D with stdLib.CanvasRenderingContext2D, _drawStep: plottableLib.buildSrcDrawersCanvasDrawerMod.CanvasDrawStep) = this()
  }
  ...
  class ProxyDrawer protected ()
    ...
    def this(_svgDrawerFactory: js.Function0[plottableLib.buildSrcDrawersSvgDrawerMod.SVGDrawer], _canvasDrawerFactory: js.Function1[
          /* ctx */ d3DashShapeLib.d3DashShapeMod.Global.CanvasRenderingContext2D with stdLib.CanvasRenderingContext2D, 
  ...
  class RectangleCanvasDrawer protected ()
    ...
    def this(ctx: d3DashShapeLib.d3DashShapeMod.Global.CanvasRenderingContext2D with stdLib.CanvasRenderingContext2D) = this()
  }

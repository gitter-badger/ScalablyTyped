...
object utilsNs extends js.Object {
  ...
  object isMobileNs extends js.Object {
    val amazon: pixiDotJsLib.Anon_PhoneTablet = js.native
    val android: pixiDotJsLib.Anon_PhoneTablet = js.native
    val any: scala.Boolean = js.native
    val apple: pixiDotJsLib.Anon_Phone = js.native
    val other: pixiDotJsLib.Anon_Blackberry10 = js.native
    val phone: scala.Boolean = js.native
    val seven_inch: scala.Boolean = js.native
    val tablet: scala.Boolean = js.native
    val windows: pixiDotJsLib.Anon_PhoneTablet = js.native
  }

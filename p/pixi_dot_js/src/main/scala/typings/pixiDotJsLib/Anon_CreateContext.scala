...
@js.native
trait Anon_CreateContext extends js.Object {
  var GLBuffer: Anon_CreateVertexBuffer = js.native
  var GLFramebuffer: Anon_CreateRGBA = js.native
  ...
  var GLTexture: Anon_FromSource = js.native

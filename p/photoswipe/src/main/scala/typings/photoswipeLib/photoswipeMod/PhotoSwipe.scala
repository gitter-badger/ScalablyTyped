...
trait PhotoSwipe[T /* <: photoswipeLib.photoswipeMod.PhotoSwipeNs.Options */] extends js.Object {
  ...
  /**
    ...
    */
  var viewportSize: photoswipeLib.Anon_XY = js.native
  /**
  ...
  /**
    ...
    *
    */
  def zoomTo(destZoomLevel: scala.Double, centerPoint: photoswipeLib.Anon_XY, speed: scala.Double): scala.Unit = js.native
  def zoomTo(
    destZoomLevel: scala.Double,
    centerPoint: photoswipeLib.Anon_XY,
    speed: scala.Double,

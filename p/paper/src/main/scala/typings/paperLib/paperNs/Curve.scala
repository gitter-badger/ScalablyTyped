...
class Curve protected () extends js.Object {
  ...
  def divide(offset: scala.Double): Curve = js.native
  def divide(offset: scala.Double, isTime: scala.Boolean): Curve = js.native
  ...
  /**
    ...
    * @returns the second part of the divided curve if the location is valid, {code null} otherwise
    */
  def divideAt(location: scala.Double): Curve = js.native
  /**
    * Divides the curve into two curves at the given offset or location. The curve itself is modified and becomes the first part, the second part is returned as a new curve. If the curve belongs to a path item, a new segment is inserted into the path at the given location, and the second part becomes a part of the path as well.
    ...
    * @returns the second part of the divided curve if the location is valid, {code null} otherwise
    */
  def divideAtTime(time: scala.Double): Curve = js.native
  def divideAtTime(time: scala.Double, setHandles: scala.Boolean): Curve = js.native
  /**
    ...
    */
  def getCurvatureAt(offset: scala.Double): Point = js.native
  def getCurvatureAt(offset: scala.Double, isTime: scala.Boolean): Point = js.native
  /**
  ...
  /**
    ...
    */
  def getOffsetAtTime(time: scala.Double): scala.Double = js.native
  /**
  ...
  /**
    ...
    */
  def getParameterAt(offset: scala.Double): scala.Double = js.native
  def getParameterAt(offset: scala.Double, start: scala.Double): scala.Double = js.native
  /**
    ...
    */
  def getParameterOf(point: Point): scala.Double = js.native
  /**
    ...
    */
  def getPart(from: scala.Double, to: scala.Double): Curve = js.native
  /**
  ...
  /**
    ...
    * @param start [optional] - the curve-time in relation to which the offset is determined
    */
  def getTimeAt(offset: scala.Double): scala.Double = js.native
  def getTimeAt(offset: scala.Double, start: scala.Double): scala.Double = js.native
  /**
    ...
    * @param point - the point on the curve
    */
  def getTimeOf(point: Point): scala.Double = js.native
  /**
  ...
  /**
    ...
    */
  def hasLength(): scala.Boolean = js.native
  def hasLength(epsilon: scala.Double): scala.Boolean = js.native
  /**
    ...
    */
  def isCollinear(curve: Curve): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def isLinear(): scala.Boolean = js.native
  /**
    ...
    */
  def isStraight(): scala.Boolean = js.native
  /**
  ...
  def split(offset: scala.Double, isParameter: scala.Boolean): Path = js.native
  ...
  /**
    ...
    */
  def splitAt(location: scala.Double): Path = js.native
  /**
    * Splits the path this curve belongs to at the given offset. After splitting, the path will be open. If the path was open already, splitting will result in two paths.
    * @param time - the curve-time parameter on the curve at which to split
    */
  def splitAtTime(time: scala.Double): Path = js.native
}

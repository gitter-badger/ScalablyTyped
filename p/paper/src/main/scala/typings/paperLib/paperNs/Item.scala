...
class Item () extends js.Object {
  ...
  def exportSVG(options: paperLib.Anon_AsStringPrecision): stdLib.SVGElement = js.native
  /**
  ...
  def importSVG(svg: java.lang.String, options: paperLib.Anon_ExpandShapes): Item = js.native
  /**
  ...
  def importSVG(svg: stdLib.SVGElement, options: paperLib.Anon_ExpandShapes): Item = js.native
  /**
  ...
  /**
    ...
    */
  def off(`object`: paperLib.Anon_Frame): Item = js.native
  /**
  ...
  /**
    ...
    * @param object - an object containing one or more of the following properties: frame, mousedown, mouseup, mousedrag, click, doubleclick, mousemove, mouseenter, mouseleave
    */
  def on(`object`: paperLib.Anon_Frame): Item = js.native
  /**

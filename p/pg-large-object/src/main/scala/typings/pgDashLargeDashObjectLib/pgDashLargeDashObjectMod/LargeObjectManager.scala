...
class LargeObjectManager protected () extends js.Object {
  ...
  def create(
    callback: js.Function2[/* error */ nodeLib.Error with stdLib.Error, /* oid */ scala.Double, scala.Unit]
  ...
  def open(
    oid: scala.Double,
    mode: scala.Double,
    callback: js.Function2[/* error */ nodeLib.Error with stdLib.Error, /* result */ LargeObject, scala.Unit]
  ): scala.Unit = js.native
  ...
  def unlink(oid: scala.Double, callback: js.Function1[/* error */ nodeLib.Error with stdLib.Error, scala.Unit]): scala.Unit = js.native

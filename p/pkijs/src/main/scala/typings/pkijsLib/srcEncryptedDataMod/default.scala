...
class default () extends EncryptedData {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def decrypt(parameters: pkijsLib.Anon_PasswordString): js.Thenable[stdLib.ArrayBuffer] = js.native
  /**
    * Create a new CMS Encrypted Data content
    * @param {*} parameters Parameters neccessary for encryption
    * @returns {Promise}
    */
  /* CompleteClass */
  override def encrypt(parameters: pkijsLib.Anon_Password): js.Thenable[stdLib.ArrayBuffer] = js.native
  /* CompleteClass */

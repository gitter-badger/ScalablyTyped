...
trait EncryptedData extends js.Object {
  ...
  /**
    ...
    */
  def decrypt(parameters: pkijsLib.Anon_PasswordString): js.Thenable[stdLib.ArrayBuffer]
  /**
    * Create a new CMS Encrypted Data content
    * @param {*} parameters Parameters neccessary for encryption
    * @returns {Promise}
    */
  def encrypt(parameters: pkijsLib.Anon_Password): js.Thenable[stdLib.ArrayBuffer]

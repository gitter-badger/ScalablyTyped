...
class PKCS11 () extends js.Object {
  ...
  def C_Decrypt(
    ...
    cb: js.Function2[/* error */ nodeLib.Error with stdLib.Error, /* data */ nodeLib.Buffer, scala.Unit]
  ...
  def C_DeriveKey(
    ...
    key: Handle,
    template: Template,
    cb: js.Function2[/* error */ nodeLib.Error with stdLib.Error, /* hKey */ Handle, scala.Unit]
  ): scala.Unit = js.native
  /**
    * Destroys an object
    *
  ...
  def C_GenerateKey(
    ...
    mechanism: Mechanism,
    template: Template,
    cb: js.Function2[/* error */ nodeLib.Error with stdLib.Error, /* key */ Handle, scala.Unit]
  ): scala.Unit = js.native
  /**
  ...
  def C_GenerateKeyPair(
    ...
    cb: js.Function2[/* error */ nodeLib.Error with stdLib.Error, /* keys */ KeyPair, scala.Unit]
  ): scala.Unit = js.native
  /**
  ...
  def C_Verify(
    ...
    cb: js.Function2[/* error */ nodeLib.Error with stdLib.Error, /* verify */ scala.Boolean, scala.Unit]
  ): scala.Unit = js.native
  /**

...
trait EventTargetArgs extends js.Object {
  ...
  /**
    ...
    */
  val inputTransformer: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.Anon_InputPathsKey]] = js.undefined
  /**
  ...
  val runCommandTargets: js.UndefOr[
    atPulumiPulumiLib.resourceMod.Input[
      js.Array[atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.Anon_KeyValuesInput]]
    ]
  ] = js.undefined
  /**

...
trait DomainState extends js.Object {
  ...
  /**
    ...
    */
  val encryptAtRest: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.Anon_EnabledKmsKeyIdInput]] = js.undefined
  /**
  ...
  /**
    ...
    */
  val nodeToNodeEncryption: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.Anon_EnabledInputBoolean]] = js.undefined
  /**

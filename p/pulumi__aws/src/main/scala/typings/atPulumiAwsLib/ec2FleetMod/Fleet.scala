...
class Fleet protected ()
  ...
  /**
    ...
    */
  val launchTemplateConfig: atPulumiPulumiLib.pulumiMod.Output[
    atPulumiAwsLib.Anon_LaunchTemplateSpecificationOverridesAnonLaunchTemplateIdLaunchTemplateNameVersion
  ] = js.native
  /**

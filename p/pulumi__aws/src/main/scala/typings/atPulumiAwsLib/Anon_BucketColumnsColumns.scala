...
trait Anon_BucketColumnsColumns extends js.Object {
  ...
  var serDeInfo: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[Anon_NameParametersKey]] = js.undefined
  var skewedInfo: js.UndefOr[
    atPulumiPulumiLib.resourceMod.Input[Anon_SkewedColumnNamesSkewedColumnValueLocationMaps]
  ] = js.undefined

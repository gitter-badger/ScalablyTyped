...
trait BucketArgs extends js.Object {
  ...
  /**
    ...
    */
  val serverSideEncryptionConfiguration: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.Anon_RuleInput]] = js.undefined
  /**
  ...
  /**
    ...
    */
  val versioning: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.Anon_EnabledMfaDeleteInput]] = js.undefined
  /**

...
trait Anon_AuthenticateCognitoAuthenticateOidc extends js.Object {
  var authenticateCognito: js.UndefOr[
    atPulumiPulumiLib.resourceMod.Input[Anon_AuthenticationRequestExtraParamsKeyOnUnauthenticatedRequestScope]
  ] = js.undefined
  var authenticateOidc: js.UndefOr[
    atPulumiPulumiLib.resourceMod.Input[Anon_AuthenticationRequestExtraParamsKeyAuthorizationEndpointClientId]
  ] = js.undefined

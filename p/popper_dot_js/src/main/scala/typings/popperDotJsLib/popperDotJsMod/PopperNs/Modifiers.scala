...
trait Modifiers
  ...
  var computeStyle: js.UndefOr[BaseModifier with popperDotJsLib.Anon_GpuAcceleration] = js.undefined
  ...
  var preventOverflow: js.UndefOr[BaseModifier with popperDotJsLib.Anon_Priority] = js.undefined

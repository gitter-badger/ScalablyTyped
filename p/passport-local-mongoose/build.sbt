...
version := "4.0.0-dt-20181119Z-3d97eb"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20180328Z-985bd6",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20180815Z-156bb0",

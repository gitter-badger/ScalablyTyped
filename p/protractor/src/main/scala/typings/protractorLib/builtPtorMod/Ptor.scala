...
class Ptor () extends js.Object {
  ...
  var WebElement: protractorLib.Anon_BuildId = js.native
  ...
  var error: protractorLib.Anon_IError = js.native
  var logging: protractorLib.Anon_Preferences = js.native
  var promise: protractorLib.Anon_USEPROMISEMANAGER = js.native
  var until: protractorLib.Anon_AbleToSwitchToFrame = js.native
  var utils: protractorLib.Anon_FirefoxHttp = js.native
  @JSName("$")

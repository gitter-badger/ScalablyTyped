...
class Application protected () extends js.Object {
  ...
  def this(canvas: stdLib.HTMLCanvasElement, options: ApplicationOptions) = this()
  /**
  ...
  /**
    ...
    */
  var autoRender: scala.Boolean = js.native
  /**
  ...
  /**
    ...
    * }
    */
  var renderNextFrame: scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def configure(url: java.lang.String, callback: js.Function1[/* repeated */ js.Any, js.Object]): scala.Unit = js.native
  /**
    * @function
  ...
  /**
    ...
    */
  def disableFullscreen(success: js.Function1[/* repeated */ js.Any, js.Object]): scala.Unit = js.native
  /**
    * @function
    ...
    * }, false);
    */
  def enableFullscreen(): scala.Unit = js.native
  def enableFullscreen(element: stdLib.Element): scala.Unit = js.native
  def enableFullscreen(element: stdLib.Element, success: js.Function1[/* repeated */ js.Any, js.Object]): scala.Unit = js.native
  ...
  /**
    ...
    * });
    */
  def loadScene(url: java.lang.String, callback: js.Function1[/* repeated */ js.Any, js.Object]): scala.Unit = js.native
  /**
    * @function
    ...
    * });
    */
  def loadSceneHierarchy(url: java.lang.String, callback: js.Function1[/* repeated */ js.Any, js.Object]): scala.Unit = js.native
  /**
    * @function
    ...
    * });
    */
  def loadSceneSettings(url: java.lang.String, callback: js.Function1[/* repeated */ js.Any, js.Object]): scala.Unit = js.native
  /**
    * @function
  ...
  /**
    ...
    * been loaded
    */
  /* private */ def onLibrariesLoaded(): scala.Unit = js.native
  /**
    * @private
    * @function
    ...
    */
  /* private */ def onVisibilityChange(e: js.Any): scala.Unit = js.native
  /**
    * @function
  ...
  /**
    ...
    */
  def preload(callback: js.Function1[/* repeated */ js.Any, js.Object]): scala.Unit = js.native
  /**
    * @function
  ...
  /**
    ...
    */
  def renderLine(start: Vec3, end: Vec3, color: Color): scala.Unit = js.native
  /**
    * @function
    ...
    */
  def renderLine(start: Vec3, end: Vec3, color: Color, lineType: scala.Double): scala.Unit = js.native
  /**
    * @function
    ...
    */
  def renderLine(start: Vec3, end: Vec3, color: Color, options: js.Object): scala.Unit = js.native
  /**
    * @function
    ...
    */
  def renderLine(start: Vec3, end: Vec3, startColor: Color, endColor: Color): scala.Unit = js.native
  /**
    * @function
    ...
    */
  def renderLine(start: Vec3, end: Vec3, startColor: Color, endColor: Color, lineType: scala.Double): scala.Unit = js.native
  /**
    * @function
    ...
    */
  def renderLines(position: js.Array[Vec3], color: js.Array[Color]): scala.Unit = js.native
  def renderLines(position: js.Array[Vec3], color: js.Array[Color], lineType: scala.Double): scala.Unit = js.native
  /**
    * @function
  ...
  /**
    ...
    */
  def setCanvasFillMode(mode: java.lang.String): scala.Unit = js.native
  def setCanvasFillMode(mode: java.lang.String, width: scala.Double): scala.Unit = js.native
  def setCanvasFillMode(mode: java.lang.String, width: scala.Double, height: scala.Double): scala.Unit = js.native
  /**
    * @function
    ...
    */
  def setCanvasResolution(mode: java.lang.String): scala.Unit = js.native
  def setCanvasResolution(mode: java.lang.String, width: scala.Double): scala.Unit = js.native
  def setCanvasResolution(mode: java.lang.String, width: scala.Double, height: scala.Double): scala.Unit = js.native
  /**
    * @function
    ...
    */
  def setSkybox(asset: Asset): scala.Unit = js.native
  /**
    * @function
...
object Application extends js.Object {
  def getApplication(): playcanvasLib.pcNs.Application = js.native
  def getApplication(id: java.lang.String): playcanvasLib.pcNs.Application = js.native
}

...
class SoundComponent protected () extends Component {
  ...
  var positional: scala.Boolean = js.native
  ...
  def addSlot(name: java.lang.String, options: playcanvasLib.Anon_VolumePitch): SoundSlot = js.native
  /**
    * @function
    ...
    */
  def pause(name: java.lang.String): scala.Unit = js.native
  /**
    * @function
    ...
    */
  def play(name: java.lang.String): SoundInstance = js.native
  /**
    * @function
    ...
    */
  def removeSlot(name: java.lang.String): scala.Unit = js.native
  /**
    * @function
    ...
    */
  def resume(name: java.lang.String): scala.Unit = js.native
  /**
    * @function
    ...
    *
    */
  def slot(name: java.lang.String): SoundSlot = js.native
  /**
    * @function

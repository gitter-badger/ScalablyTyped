...
class RenderTarget protected () extends js.Object {
  ...
  /**
    ...
    * </ul>
    */
  val face: scala.Double = js.native
  /**
    * @readonly
  ...
  /**
    ...
    */
  def copy(source: RenderTarget, color: scala.Boolean, depth: scala.Boolean): RenderTarget = js.native
  /**
    * @function
  ...
  /**
    ...
    */
  def resolve(color: scala.Boolean, depth: scala.Boolean): scala.Unit = js.native
}

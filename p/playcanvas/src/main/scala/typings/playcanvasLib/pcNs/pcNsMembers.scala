...
object pcNsMembers extends js.Object {
  ...
  def createBox(device: GraphicsDevice, opts: playcanvasLib.Anon_HalfExtentsWidthSegments): Mesh = js.native
  /**
    * @function
  ...
  def createCapsule(device: GraphicsDevice, opts: playcanvasLib.Anon_RadiusHeight): Mesh = js.native
  /**
    * @function
    * @name pc.createCone
  ...
  def createCylinder(device: GraphicsDevice, opts: playcanvasLib.Anon_Radius): Mesh = js.native
  /**
    * @function
    * @name pc.createMesh
  ...
  def createMesh(device: GraphicsDevice, positions: js.Array[scala.Double], opts: playcanvasLib.Anon_Normals): Mesh = js.native
  /**
    * @function
    * @name pc.createPlane
  ...
  def createSphere(device: GraphicsDevice, opts: playcanvasLib.Anon_RadiusSegments): Mesh = js.native
  /**
    * @function
    * @name pc.createStyle
  ...
  /**
    ...
    */
  def createURI(options: playcanvasLib.Anon_Scheme): java.lang.String = js.native
  /**
    * @private
    * @function
    * @name pc.extend

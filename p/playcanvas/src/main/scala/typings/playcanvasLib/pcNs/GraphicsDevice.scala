...
class GraphicsDevice protected () extends js.Object {
  ...
  def this(canvas: stdLib.HTMLCanvasElement, options: js.Object) = this()
  ...
  /**
    ...
    */
  val maxAnisotropy: scala.Double = js.native
  /**
    * @readonly
    ...
    */
  val maxCubeMapSize: scala.Double = js.native
  var maxPixelRatio: scala.Double = js.native
  /**
    * @readonly
    ...
    */
  val maxTextureSize: scala.Double = js.native
  /**
    * @readonly
    ...
    */
  val maxVolumeSize: scala.Double = js.native
  /**
    * @readonly
    ...
    */
  val precision: java.lang.String = js.native
  /**
    * @readonly
  ...
  /**
    ...
    */
  def clearShaderCache(): scala.Unit = js.native
  /**
    * @function
  ...
  /**
    ...
    */
  def getBlending(): scala.Boolean = js.native
  /**
    * @private
    * @function
    ...
    */
  /* private */ def getBoneLimit(): scala.Double = js.native
  /**
    * @function
    ...
    */
  def getDepthTest(): scala.Boolean = js.native
  /**
    * @function
    ...
    */
  def getDepthWrite(): scala.Unit = js.native
  /**
    * @public
    * @function
  ...
  /**
    ...
    */
  def resizeCanvas(width: scala.Double, height: scala.Double): scala.Unit = js.native
  /**
    * @private
    * @function
    ...
    */
  /* private */ def setAlphaToCoverage(state: scala.Boolean): scala.Unit = js.native
  /**
    * @function
    ...
    * </ul>
    */
  def setBlendEquation(blendEquation: scala.Double): scala.Unit = js.native
  /**
    * @function
    ...
    * </ul>
    */
  def setBlendEquationSeparate(blendEquation: scala.Double, blendAlphaEquation: scala.Double): scala.Unit = js.native
  /**
    * @function
    ...
    */
  def setBlendFunction(blendSrc: scala.Double, blendDst: scala.Double): scala.Unit = js.native
  /**
    * @function
    ...
    */
  def setBlendFunctionSeparate(blendSrc: scala.Unit, blendDst: scala.Unit, blendSrcAlpha: scala.Unit, blendDstAlpha: scala.Unit): scala.Unit = js.native
  /**
    * @function
    ...
    */
  def setBlending(blending: scala.Boolean): scala.Unit = js.native
  /**
    * @private
    * @function
    ...
    */
  /* private */ def setBoneLimit(maxBones: scala.Double): scala.Unit = js.native
  /**
    * @function
    ...
    */
  def setColorWrite(
    writeRed: scala.Boolean,
    writeGreen: scala.Boolean,
    writeBlue: scala.Boolean,
    writeAlpha: scala.Boolean
  ...
  /**
    ...
    * </ul>
    */
  def setCullMode(cullMode: scala.Double): scala.Unit = js.native
  /**
    * @function
    ...
    * </ul>
    */
  def setDepthFunc(func: scala.Double): scala.Unit = js.native
  /**
    * @function
    ...
    */
  def setDepthTest(depthTest: scala.Boolean): scala.Unit = js.native
  /**
    * @function
    ...
    */
  def setDepthWrite(writeDepth: scala.Boolean): scala.Unit = js.native
  /**
    * @function
    ...
    */
  def setIndexBuffer(indexBuffer: IndexBuffer): scala.Unit = js.native
  /**
    * @private
    * @function
  ...
  /**
    ...
    */
  /* private */ def setRaster(on: scala.Boolean): scala.Unit = js.native
  /**
    * @function
  ...
  /**
    ...
    */
  def setScissor(x: scala.Double, y: scala.Double, w: scala.Double, h: scala.Double): scala.Unit = js.native
  /**
    * @function
    ...
    */
  def setShader(shader: Shader): scala.Unit = js.native
  /**
    * @function
    ...
    */
  def setStencilFunc(func: scala.Double, ref: scala.Double, mask: scala.Double): scala.Unit = js.native
  /**
    * @function
    * @name pc.GraphicsDevice#setStencilFuncBack
    * @description Same as pc.GraphicsDevice#setStencilFunc, but only for back faces.
    */
  def setStencilFuncBack(func: scala.Boolean, ref: scala.Boolean, mask: scala.Boolean): scala.Unit = js.native
  /**
    * @function
    * @name pc.GraphicsDevice#setStencilFuncFront
    * @description Same as pc.GraphicsDevice#setStencilFunc, but only for front faces.
    */
  def setStencilFuncFront(func: scala.Double, ref: scala.Double, mask: scala.Double): scala.Unit = js.native
  /**
    * @function
    ...
    */
  def setStencilOperation(fail: scala.Double, zfail: scala.Double, zpass: scala.Double, writeMask: scala.Double): scala.Unit = js.native
  /**
    * @function
    ...
    */
  def setStencilOperationBack(fail: scala.Double, zfail: scala.Double, zpass: scala.Double, writeMask: scala.Double): scala.Unit = js.native
  /**
    * @function
    ...
    */
  def setStencilOperationFront(fail: scala.Double, zfail: scala.Double, zpass: scala.Double, writeMask: scala.Double): scala.Unit = js.native
  /**
    * @function
    ...
    */
  def setStencilTest(enable: scala.Boolean): scala.Unit = js.native
  /**
    * @private
    * @function
    ...
    */
  /* private */ def setTransformFeedbackBuffer(tf: VertexBuffer): scala.Unit = js.native
  /**
    * @function
    ...
    */
  def setVertexBuffer(vertexBuffer: VertexBuffer, stream: scala.Double): scala.Unit = js.native
  def setVertexBuffer(vertexBuffer: VertexBuffer, stream: scala.Double, vbOffset: scala.Double): scala.Unit = js.native
  /**
    * @function
    ...
    */
  def setViewport(x: scala.Double, y: scala.Double, w: scala.Double, h: scala.Double): scala.Unit = js.native
  /**
    * @function
    ...
    */
  def updateBegin(): scala.Unit = js.native
  /**
    * @function
    ...
    * and pc.GraphicsDevice#updateEnd must not be nested.
    */
  def updateEnd(): scala.Unit = js.native
}

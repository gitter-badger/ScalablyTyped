...
class Channel protected () extends js.Object {
  ...
  /**
    ...
    */
  /* private */ def getLoop(): scala.Boolean = js.native
  /**
    * @private
    * @function
    ...
    */
  /* private */ def getPitch(): scala.Double = js.native
  /**
    * @private
    * @function
    ...
    */
  /* private */ def getVolume(): scala.Double = js.native
  /**
    * @private
    * @function
    ...
    */
  /* private */ def onManagerResume(): scala.Unit = js.native
  /**
    * @private
    * @function
    ...
    */
  /* private */ def onManagerSuspend(): scala.Unit = js.native
  /**
    * @private
    * @function
    ...
    */
  /* private */ def onManagerVolumeChange(): scala.Unit = js.native
  /**
    * @private
    * @function
    ...
    */
  /* private */ def pause(): scala.Unit = js.native
  /**
    * @private
    * @function
    ...
    */
  /* private */ def play(): scala.Unit = js.native
  /**
    * @private
    * @function
    ...
    */
  /* private */ def setLoop(loop: scala.Boolean): scala.Unit = js.native
  /**
    * @private
    * @function
    ...
    */
  /* private */ def setVolume(volume: scala.Double): scala.Unit = js.native
  /**
    * @private
    * @function

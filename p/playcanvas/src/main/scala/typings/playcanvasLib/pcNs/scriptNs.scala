...
object scriptNs extends js.Object {
  /**
    ...
    * }
    */
  def attribute(name: java.lang.String, `type`: java.lang.String, defaultValue: js.Any): scala.Unit = js.native
  def attribute(
    name: java.lang.String,
    `type`: java.lang.String,
    defaultValue: js.Any,
    options: playcanvasLib.Anon_Min
  ...
  /**
    ...
    * }
    */
  def create(name: java.lang.String, callback: js.Function): scala.Unit = js.native
  /**
    * @function
    ...
    * });
    */
  def createLoadingScreen(callback: js.Function): scala.Unit = js.native
}

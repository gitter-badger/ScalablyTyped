...
trait Client
  ...
  def authenticateUser(base: java.lang.String, dn: java.lang.String, password: java.lang.String): js.Promise[promisedDashLdapLib.Anon_Name | scala.Null] = js.native

...
trait ConnectionManager extends EventsDispatcher {
  var connection: js.Any = js.native
   // TODO: Type this
  var connectionCallbacks: pusherDashJsLib.Anon_Message = js.native
   // TODO: Type this
  var encrypted: scala.Boolean = js.native
  var errorCallbacks: pusherDashJsLib.Anon_Sslonly = js.native
  var handshakeCallbacks: pusherDashJsLib.Anon_SslonlyRefused = js.native

...
class EditorView[S /* <: prosemirrorDashModelLib.prosemirrorDashModelMod.Schema[_, _] */] protected () extends js.Object {
  ...
  /**
    ...
    */
  var dragging: js.UndefOr[prosemirrorDashViewLib.Anon_Slice[S] | scala.Null] = js.native
  /**
  ...
  /**
    ...
    */
  def coordsAtPos(pos: scala.Double): prosemirrorDashViewLib.Anon_LeftRight = js.native
  /**
  ...
  /**
    ...
    */
  def posAtCoords(coords: prosemirrorDashViewLib.Anon_Left): js.UndefOr[prosemirrorDashViewLib.Anon_Pos | scala.Null] = js.native
  /**

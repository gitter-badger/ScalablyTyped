...
object powerDashAssertModMembers extends js.Object {
  ...
  val strict: (js.Function2[/* value */ js.Any, /* message */ js.UndefOr[java.lang.String], scala.Unit]) with powerDashAssertLib.Anon_AssertionError = js.native
  ...
  def customize(options: powerDashAssertLib.powerDashAssertMod.assertNs.Options): (js.Function2[/* value */ js.Any, /* message */ js.UndefOr[java.lang.String], scala.Unit]) with powerDashAssertLib.Anon_AssertionError = js.native

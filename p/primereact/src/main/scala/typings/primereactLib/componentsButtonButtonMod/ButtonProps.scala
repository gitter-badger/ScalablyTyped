...
- Dropped {[ P in std.Exclude<keyof react.react.HTMLProps<react.HTMLButtonElement & std.HTMLButtonElement>, 'ref'> ]: react.react.HTMLProps<react.HTMLButtonElement & std.HTMLButtonElement>[P]} */ trait ButtonProps

...
class Request protected () extends Property[RequestDefinition] {
  ...
  def getHeaders(options: postmanDashCollectionLib.Anon_IgnoreCase): js.Any = js.native
  def removeHeader(toRemove: java.lang.String): scala.Unit = js.native
  def removeHeader(toRemove: java.lang.String, options: postmanDashCollectionLib.Anon_IgnoreCaseBoolean): scala.Unit = js.native
  def removeHeader(toRemove: Header): scala.Unit = js.native
  def removeHeader(toRemove: Header, options: postmanDashCollectionLib.Anon_IgnoreCaseBoolean): scala.Unit = js.native

...
package object OverlayScrollbarsNs {
  ...
  type Coordinates = overlayscrollbarsLib.Anon_X | overlayscrollbarsLib.Anon_L | overlayscrollbarsLib.Anon_Left | (js.Tuple2[Position, Position]) | Position | stdLib.HTMLElement | overlayscrollbarsLib.overlayscrollbarsMod.JQuery | overlayscrollbarsLib.Anon_El

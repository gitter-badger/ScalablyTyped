...
object openpgpModMembers extends js.Object {
  ...
  def decryptKey(options: openpgpLib.Anon_PrivateKeyPassphrase): js.Promise[KeyContainer] = js.native
  def destroyWorker(): scala.Unit = js.native
  def encrypt(options: EncryptOptions): js.Promise[EncryptedMessage] = js.native
  def encryptKey(options: openpgpLib.Anon_PrivateKeyPassphrase): js.Promise[KeyContainer] = js.native
  ...
  def reformatKey(options: openpgpLib.Anon_PrivateKey): js.Promise[KeyPair] = js.native

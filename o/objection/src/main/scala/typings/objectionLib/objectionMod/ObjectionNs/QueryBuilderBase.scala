...
trait QueryBuilderBase[QM /* <: Model */, RM, RV] extends QueryInterface[QM, RM, RV] {
  ...
  def modelClass(): objectionLib.Anon_TableName = js.native
  ...
  def omit(modelClass: objectionLib.Anon_TableName, properties: js.Array[java.lang.String]): this.type = js.native
  ...
  def onError(fn: js.Function2[/* error */ nodeLib.Error with stdLib.Error, /* builder */ this.type, _]): this.type = js.native
  ...
  def pick(modelClass: objectionLib.Anon_TableName, properties: js.Array[java.lang.String]): this.type = js.native
  ...
  def traverse(modelClass: objectionLib.Anon_TableName, traverser: TraverserFunction): this.type = js.native

...
trait Model extends js.Object {
  ...
  def $appendRelated[T, RelatedM /* <: Model */](`this`: T, relation: nodeLib.String with java.lang.String): T = js.native
  @JSName("$appendRelated")
  def $appendRelated[T, RelatedM /* <: Model */](`this`: T, relation: nodeLib.String with java.lang.String, related: RelatedM): T = js.native
  @JSName("$appendRelated")
  def $appendRelated[T, RelatedM /* <: Model */](`this`: T, relation: nodeLib.String with java.lang.String, related: js.Array[RelatedM]): T = js.native
  @JSName("$appendRelated")
  ...
  @JSName("$setRelated")
  def $setRelated[T, RelatedM /* <: Model */](`this`: T, relation: nodeLib.String with java.lang.String): T = js.native
  @JSName("$setRelated")
  def $setRelated[T, RelatedM /* <: Model */](`this`: T, relation: nodeLib.String with java.lang.String, related: RelatedM): T = js.native
  @JSName("$setRelated")
  def $setRelated[T, RelatedM /* <: Model */](`this`: T, relation: nodeLib.String with java.lang.String, related: js.Array[RelatedM]): T = js.native
  @JSName("$setRelated")

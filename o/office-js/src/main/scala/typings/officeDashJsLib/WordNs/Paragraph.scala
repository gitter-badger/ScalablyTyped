...
class Paragraph ()
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsLib.WordNs.InterfacesNs.ParagraphUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsLib.WordNs.InterfacesNs.ParagraphUpdateData,
  ...
  def toJSON(): officeDashJsLib.WordNs.InterfacesNs.ParagraphData = js.native
  /**

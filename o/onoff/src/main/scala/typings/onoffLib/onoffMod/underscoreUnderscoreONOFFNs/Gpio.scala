...
trait Gpio extends js.Object {
  ...
  var listeners: js.Array[
    js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* value */ scala.Double, scala.Unit]
  ] = js.native
  ...
  def read(cb: js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* value */ scala.Double, scala.Unit]): scala.Unit = js.native
  ...
  def unwatch(cb: js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* value */ scala.Double, scala.Unit]): scala.Unit = js.native
  def unwatchAll(): scala.Unit = js.native
  def watch(cb: js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* value */ scala.Double, scala.Unit]): scala.Unit = js.native
  def write(
    value: scala.Double,
    cb: js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* value */ scala.Double, scala.Unit]

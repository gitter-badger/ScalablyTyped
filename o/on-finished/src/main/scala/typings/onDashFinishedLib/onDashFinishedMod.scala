...
object onDashFinishedMod extends js.Object {
  def apply[T /* <: nodeLib.httpMod.IncomingMessage | nodeLib.httpMod.OutgoingMessage */](
    msg: T,
    listener: js.Function2[/* err */ (nodeLib.Error with stdLib.Error) | scala.Null, /* msg */ T, scala.Unit]
  ): T = js.native

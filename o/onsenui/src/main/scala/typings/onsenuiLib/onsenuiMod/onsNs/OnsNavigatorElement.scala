...
trait OnsNavigatorElement
  ...
  /**
    ...
    **/
  var onSwipe: js.UndefOr[coreDashJsLib.Function with js.Function] = js.native
  /**
  ...
  def bringPageTop(item: js.Any, options: coreDashJsLib.Object with js.Object): js.Promise[stdLib.HTMLElement] = js.native
  /**

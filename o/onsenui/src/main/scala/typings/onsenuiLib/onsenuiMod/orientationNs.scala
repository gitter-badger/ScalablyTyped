...
object orientationNs extends js.Object {
  ...
  def off(eventName: java.lang.String, listener: coreDashJsLib.Function with js.Function): scala.Unit = js.native
  /**
    * @description Add an event listener.
    */
  def on(eventName: java.lang.String, listener: coreDashJsLib.Function with js.Function): scala.Unit = js.native
  /**
    * @description Add an event listener that's only triggered once.
    */
  def once(eventName: java.lang.String, listener: coreDashJsLib.Function with js.Function): scala.Unit = js.native
}

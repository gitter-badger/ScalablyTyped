...
@js.native
object officeDashUiDashFabricDashReactModMembers extends js.Object {
  ...
  val DirectionalHint: officeDashUiDashFabricDashReactLib.Anon_TopLeftEdge0 = js.native
  ...
  val PulsingBeaconAnimationStyles: atUifabricStylingLib.Anon_ContinuousPulseAnimationDouble = js.native
  ...
  val ScrollToMode: officeDashUiDashFabricDashReactLib.Anon_Auto = js.native
  val ScrollbarVisibility: officeDashUiDashFabricDashReactLib.Anon_AutoAlways = js.native
  ...
  def getColorFromRGBA(rgba: officeDashUiDashFabricDashReactLib.Anon_R): officeDashUiDashFabricDashReactLib.libUtilitiesColorColorsMod.IColor = js.native

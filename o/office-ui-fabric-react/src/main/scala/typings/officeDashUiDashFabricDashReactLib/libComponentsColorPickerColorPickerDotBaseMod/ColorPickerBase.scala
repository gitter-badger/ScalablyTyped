...
class ColorPickerBase protected ()
  ...
  var _aText: js.Any = js.native
  var _bText: js.Any = js.native
  var _gText: js.Any = js.native
  var _hexText: js.Any = js.native
  var _onAChanged: js.Any = js.native
  var _onHChanged: js.Any = js.native
  var _onHexChanged: js.Any = js.native
  var _onRGBAChanged: js.Any = js.native
  var _onSVChanged: js.Any = js.native
  var _rText: js.Any = js.native

...
trait ngStomp extends js.Object {
  ...
  def setDebug(callback: angularLib.angularMod.Global.Function with js.Function): scala.Unit = js.native
  def subscribe(
    destination: java.lang.String,
    callback: js.Function3[
      /* payload */ java.lang.String, 
      /* headers */ ngDashStompLib.ngStompNs.Headers, 
      /* res */ angularLib.angularMod.Global.Function with js.Function, 
      scala.Unit
    ]
  ): js.Any = js.native
  def subscribe(

...
class Migration protected () extends js.Object {
  ...
  def executeDown(callback: js.Function1[/* err */ nodeLib.Error with stdLib.Error, scala.Unit]): scala.Unit = js.native
  def executeDown(
    callback: js.Function1[/* err */ nodeLib.Error with stdLib.Error, scala.Unit],
    prevId: java.lang.String
  ): scala.Unit = js.native
  def executeUp(callback: js.Function1[/* err */ nodeLib.Error with stdLib.Error, scala.Unit]): scala.Unit = js.native

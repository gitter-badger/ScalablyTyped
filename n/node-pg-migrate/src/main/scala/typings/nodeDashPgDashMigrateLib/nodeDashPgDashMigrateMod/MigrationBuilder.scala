...
trait MigrationBuilder extends js.Object {
  ...
  def addTypeValue(typeName: Name, value: Value, options: nodeDashPgDashMigrateLib.Anon_IfNotExists): scala.Unit = js.native
  ...
  def createSchema(
    ...
    schemaOptions: nodeDashPgDashMigrateLib.Anon_IfNotExistsAuthorization
  ): scala.Unit = js.native
  // Sequences

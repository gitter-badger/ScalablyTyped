...
trait IBadgeService extends js.Object {
  ...
  def clear(callback: angularLib.angularMod.Global.Function with js.Function): angularLib.angularMod.angularNs.IPromise[_] = js.native
  def clear(callback: angularLib.angularMod.Global.Function with js.Function, scope: js.Object): angularLib.angularMod.angularNs.IPromise[_] = js.native
  ...
  def decrease(count: scala.Double, callback: angularLib.angularMod.Global.Function with js.Function): angularLib.angularMod.angularNs.IPromise[_] = js.native
  def decrease(
    count: scala.Double,
  ...
  def increase(count: scala.Double, callback: angularLib.angularMod.Global.Function with js.Function): angularLib.angularMod.angularNs.IPromise[_] = js.native
  def increase(
    count: scala.Double,
    callback: angularLib.angularMod.Global.Function with js.Function,
    scope: js.Object
  ...
  def set(badge: scala.Double, callback: angularLib.angularMod.Global.Function with js.Function): angularLib.angularMod.angularNs.IPromise[_] = js.native
  def set(
    badge: scala.Double,
    callback: angularLib.angularMod.Global.Function with js.Function,
    scope: js.Object

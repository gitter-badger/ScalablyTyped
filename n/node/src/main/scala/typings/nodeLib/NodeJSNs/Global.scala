...
trait Global extends js.Object {
  ...
  var Set: nodeLib.SetConstructor = js.native
  @JSName("String")
  ...
  var WeakMap: nodeLib.WeakMapConstructor = js.native
  var WeakSet: nodeLib.WeakSetConstructor = js.native
  ...
  def clearImmediate(immediateId: Immediate): scala.Unit = js.native
  def clearInterval(intervalId: Timeout): scala.Unit = js.native
  def clearTimeout(timeoutId: Timeout): scala.Unit = js.native

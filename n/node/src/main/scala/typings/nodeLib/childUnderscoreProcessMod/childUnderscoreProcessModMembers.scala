...
object childUnderscoreProcessModMembers extends js.Object {
  ...
  def execFile(
    file: java.lang.String,
    args: js.Array[java.lang.String],
    options: nodeLib.Anon_EncodingString with ExecFileOptions
  ): ChildProcess = js.native
  def execFile(
    file: java.lang.String,
    args: js.Array[java.lang.String],
  ...
  def execFile(file: java.lang.String, options: nodeLib.Anon_EncodingString with ExecFileOptions): ChildProcess = js.native
  // fallback if nothing else matches. Worst case is always `string | Buffer`.
  def execFile(
    file: java.lang.String,
    options: nodeLib.Anon_EncodingString with ExecFileOptions,

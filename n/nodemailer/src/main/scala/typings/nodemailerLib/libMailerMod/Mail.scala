...
trait Mail
  ...
  @JSName("emit")
  def emit_error(event: nodemailerLib.nodemailerLibStrings.error, error: nodeLib.Error with stdLib.Error): scala.Boolean = js.native
  @JSName("emit")
  ...
  @JSName("listeners")
  def listeners_error(event: nodemailerLib.nodemailerLibStrings.error): js.Array[js.Function1[/* err */ nodeLib.Error with stdLib.Error, scala.Unit]] = js.native
  @JSName("listeners")

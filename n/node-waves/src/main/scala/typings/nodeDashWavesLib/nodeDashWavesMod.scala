...
object nodeDashWavesMod extends js.Object {
  def attach(elements: nodeDashWavesLib.ElementSelector): scala.Unit = js.native
  def attach(elements: nodeDashWavesLib.ElementSelector, classes: java.lang.String): scala.Unit = js.native

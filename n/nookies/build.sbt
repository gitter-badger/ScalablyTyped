...
name := "nookies"
version := "1.1-dt-20181019Z-3f917a"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "cookie" % "0.3-dt-20181113Z-22885f",
  "org.scalablytyped" %%% "csstype" % "2.5.8-c53c8c",
  "org.scalablytyped" %%% "next" % "7.0-dt-20181222Z-880be8",
  "org.scalablytyped" %%% "next-server" % "7.0-dt-20181115Z-17f133",

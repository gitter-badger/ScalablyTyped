...
trait DevServer
  ...
  @JSName("renderOpts")
  var renderOpts_DevServer: nextDashServerLib.nextDashServerMod.nextNs.RenderOptions with nextLib.Anon_DevTrue = js.native
  def addExportPathMapRoutes(): js.Promise[scala.Unit] = js.native
  def getCompilationError(): js.Promise[_] = js.native
  def getHotReloader(dir: java.lang.String, options: nextLib.Anon_Quiet): js.Any = js.native
}

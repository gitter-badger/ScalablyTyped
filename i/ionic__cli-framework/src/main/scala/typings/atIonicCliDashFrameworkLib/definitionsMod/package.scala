...
package object definitionsMod {
  ...
  type HydratedCommandMetadata[C /* <: ICommand[C, N, M, I, O] */, N /* <: INamespace[C, N, M, I, O] */, M /* <: CommandMetadata[I, O] */, I /* <: CommandMetadataInput */, O /* <: CommandMetadataOption */] = M with (atIonicCliDashFrameworkLib.Anon_Command[I, N, O, M, C])

...
object cliDashFrameworkModMembers extends js.Object {
  ...
  val DEFAULT_LOGGER_HANDLERS: nodeLib.ReadonlySet[atIonicCliDashFrameworkLib.libLoggerMod.StreamHandler] with stdLib.ReadonlySet[atIonicCliDashFrameworkLib.libLoggerMod.StreamHandler] = js.native

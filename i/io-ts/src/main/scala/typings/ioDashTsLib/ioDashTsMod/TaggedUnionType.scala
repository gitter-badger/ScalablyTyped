...
@js.native
class TaggedUnionType[Tag /* <: java.lang.String */, RTS /* <: (fpDashTsLib.libArrayMod.Global.Array[Tagged[Tag, _, _]]) with (js.Array[Tagged[Tag, _, _]]) */, A, O, I] protected () extends UnionType[RTS, A, O, I] {

...
class Leads () extends js.Object {
  ...
  def listBy(params: intercomDashClientLib.Anon_EmailTagid): js.Promise[ApiResponse[intercomDashClientLib.leadMod.List]] = js.native
  def listBy(
    params: intercomDashClientLib.Anon_EmailTagid,

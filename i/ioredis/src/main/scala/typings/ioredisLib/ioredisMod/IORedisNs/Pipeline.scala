...
trait Pipeline extends js.Object {
  ...
  def discard(callback: js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* res */ js.Any, scala.Unit]): Pipeline = js.native
  ...
  def exec(callback: js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* res */ js.Any, scala.Unit]): js.Promise[_] = js.native
  ...
  def info(callback: js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* res */ js.Any, scala.Unit]): Pipeline = js.native
  ...
  def sync(callback: js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* res */ js.Any, scala.Unit]): Pipeline = js.native
  def time(): Pipeline = js.native
  def time(callback: js.Function2[/* err */ nodeLib.Error with stdLib.Error, /* res */ js.Any, scala.Unit]): Pipeline = js.native

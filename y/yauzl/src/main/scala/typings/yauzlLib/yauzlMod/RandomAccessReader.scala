...
abstract class RandomAccessReader ()
  ...
  def close(callback: js.Function1[/* err */ js.UndefOr[nodeLib.Error with stdLib.Error], scala.Unit]): scala.Unit = js.native
  def createReadStream(options: yauzlLib.Anon_Start): scala.Unit = js.native
  def read(

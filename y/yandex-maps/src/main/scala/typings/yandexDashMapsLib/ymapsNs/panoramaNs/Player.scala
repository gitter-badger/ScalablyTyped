...
class Player protected ()
  ...
  def this(element: java.lang.String, panorama: yandexDashMapsLib.ymapsNs.IPanorama, options: yandexDashMapsLib.Anon_AutoFitToViewport) = this()
  def this(element: stdLib.HTMLElement, panorama: yandexDashMapsLib.ymapsNs.IPanorama, options: yandexDashMapsLib.Anon_AutoFitToViewport) = this()
  /* CompleteClass */

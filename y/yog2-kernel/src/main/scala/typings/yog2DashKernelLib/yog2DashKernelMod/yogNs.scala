...
object yogNs extends js.Object {
  ...
  class Yog () extends js.Object {
    @JSName("RAL")
    var RAL_Original: yog2DashKernelLib.Anon_ServiceName = js.native
    ...
    var express_Original: (js.Function0[
      ...
      ]) with yog2DashKernelLib.Anon_Router = js.native
    var log: yogDashLogLib.yogDashLogMod.Logger = js.native
    // 当 yog.conf.promise.overrideRAL 为true时，可以当作promise使用
    var ral: yog2DashKernelLib.Anon_ServiceName | yog2DashKernelLib.Anon_Name = js.native
    @JSName("ralP")

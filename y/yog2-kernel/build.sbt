...
name := "yog2-kernel"
version := "1.9-dt-20181121Z-31d39a"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "node-ral" % "0.18-dt-20181121Z-d80a70",
  "org.scalablytyped" %%% "range-parser" % "1.2-dt-20181016Z-f21515",
  "org.scalablytyped" %%% "serve-static" % "1.13-dt-20180428Z-1666cb",
  "org.scalablytyped" %%% "std" % "3.2.2-3b2f2a",
  "org.scalablytyped" %%% "yog-bigpipe" % "0.4-dt-20180214Z-d5b92b",
  "org.scalablytyped" %%% "yog-log" % "0.1-dt-20181121Z-63fe0c")
